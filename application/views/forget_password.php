...
<head>
    ...
    <title>Forgot Password | Mahalla</title>
...
<div class="login-box">
    ...
    <div class="login-box-body" style="border-radius: 6px;">
        ...
        <p class="text-justify">If you have forgotten your password please enter your username below. You will receive an email that contains a link to set a new password</p>
        <?php echo form_open('login/forgetPasswordSubmit', ' id="login_form" role="form"'); ?>
        ...
        <div class="row" style="margin-top:14px">
            <div class="col-md-12">
                <button type="submit" class="btn btn-success btn-flat col-md-12">Get New Password</button>
            </div>
        </div>
        </form>
    </div>
