    ...
    function getAssetDisposalDetails(index) {
        $.ajax({
            ...
            success: function (data) {
                ...
                toggleMasterDetails('#assetDisposalDetail', 'Asset Disposal');
                $('.headerclose').attr('onclick', "toggleMasterDetails('#assetDisposalMaster', 'Asset Disposal')");
                stopLoad();
            },
