...
<?php //echo head_page('Add New Asset', false);
...
if ($editDatas['faCatID'] == 'NULL' || is_null($editDatas['faCatID'])) {
    $fetch_sub_cat = array();
} else {
    $fetch_sub_cat = fa_asset_category_sub($editDatas['faCatID']);
}

if ($editDatas['faSubCatID'] == 'NULL' || is_null($editDatas['faSubCatID'])) {
    $fetch_sub_sub_cat = array();
} else {
    $fetch_sub_sub_cat = fa_asset_category_sub($editDatas['faSubCatID']);
}

$groupTO = group_to($editDatas['faCatID']);
$companyid = current_companyID();

$costs = $this->db->query("SELECT companyLocalAmount,dateAQ,faCode FROM srp_erp_fa_asset_master WHERE faID='{$faID}'")->result_array();
...
$deps = $this->db->query("SELECT srp_erp_fa_depmaster.depCode,srp_erp_fa_depmaster.approvedYN, srp_erp_fa_assetdepreciationperiods.companyLocalAmount, srp_erp_fa_depmaster.depDate, srp_erp_fa_assetdepreciationperiods.faCode,srp_erp_fa_depmaster.depType,srp_erp_fa_depmaster.depMonthYear FROM srp_erp_fa_depmaster INNER JOIN srp_erp_fa_assetdepreciationperiods ON srp_erp_fa_depmaster.depMasterAutoID = srp_erp_fa_assetdepreciationperiods.depMasterAutoID WHERE srp_erp_fa_assetdepreciationperiods.faID = '{$faID}' AND srp_erp_fa_depmaster.approvedYN = 1")->result_array();
    ...
    /*base_url("uploads/assets/{$editDatas['image']}");*/
...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab">
        <?php echo $this->lang->line('assetmanagement_asset'); ?><!--Asset--></a>
    <a class="btn btn-default btn-wizard" href="#step2" data-toggle="tab">
        <?php echo $this->lang->line('assetmanagement_asset_categorization'); ?><!--Asset Categorization--></a>
    <a class="btn btn-default btn-wizard" href="#step3" data-toggle="tab">
        <?php echo $this->lang->line('assetmanagement_asset_valuation'); ?><!--Asset Valuation--></a>
    <a class="btn btn-default btn-wizard" href="#step4" data-toggle="tab">
        <?php echo $this->lang->line('assetmanagement_asset_attachment'); ?><!--Asset Attachment--></a>
</div>
        ...
        <div class="row">
            <div class="col-sm-3">
                <div style="text-align: center;">
                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;margin: 0 auto;;">
                        <img class="img-responsive" style="height: 141px !important;"
                             src="<?php echo is_null($editDatas['image']) ? $this->s3->getMyAuthenticatedURL('images/item/no-image.png', 3600) : $this->s3->getMyAuthenticatedURL('uploads/assets/'.$editDatas['image'], 3600) ?>"
                             id="asset_img" alt="...">
                ...
                <div class="form-group col-sm-12 no-padding">
                    ...
                    <h4 class="" id="faCode"
                        style="margin-top: 2px;color: #48bbce;"><?php echo $editDatas['faCode'] ?></h4>
                </div>
                ...
                <div class="form-group col-sm-12 no-padding" style="margin-top:1px;">
                    ...
                    <textarea tabindex="1" style="color: #48bbce;" class="form-control" rows="2" id="assetDescription"
                              name="assetDescription"><?php echo $editDatas['assetDescription'] ?></textarea>
                </div>
            </div>
            <div class="col-sm-9">
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input tabindex="4" type="text" class="form-control " id="MANUFACTURE" name="MANUFACTURE"
                               value="<?php echo $editDatas['manufacture'] ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-sm-3">
                        ...
                        <div class=" input-group">
                            ...
                            <input tabindex="5" type="text" name="dateAQ" readonly
                                   value="<?php echo format_date($editDatas['dateAQ']); ?>"
                                   id="dateAQ"
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <div class=" input-group">
                            ...
                            <input type="text" name="postDate" readonly
                                   value="<?php echo format_date($editDatas['postDate']); ?>"
                                   id="postDate"
                                   class="form-control">
                        </div>
                    </div>
                    <div class="form-group col-sm-3">
                        ...
                        <div class=" input-group">
                            ...
                            <input tabindex="6" type="text" name="dateDEP" readonly
                                   value="<?php echo format_date($editDatas['dateDEP']); ?>"
                                   id="dateDEP"
                                   class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input tabindex="7" onchange="DepPerUpdate()" type="text" class="form-control number" id="depMonth"
                               name="depMonth" value="<?php echo $editDatas['depMonth'] ?>" onkeypress="return validateFloatKeyPress(this,event)">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-3">
                        ...
                        <input tabindex="8" type="text" readonly class="form-control " id="DEPpercentage"
                               name="DEPpercentage"
                               value="<?php echo $editDatas['DEPpercentage'] ?>">
                    </div>
                    <div class="form-group col-sm-3">
                        <label for="customerCurrency">
                            <?php echo $this->lang->line('common_currency'); ?><!--Currency--> <?php required_mark(); ?></label>
                        <?php
                        if ($editDatas['transactionCurrency'] == '' || is_null($editDatas['transactionCurrency'])) {
                            $cur = $this->common_data['company_data']['company_default_currencyID'];
                        } else {
                            $cur = $editDatas['transactionCurrencyID'];
                        }
                        if(!empty($documentdrilldownasset['docOrigin']!='')) {
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input tabindex="10" type="text" class="form-control text-right number" id="COSTUNIT" name="COSTUNIT"
                               value="<?php echo $editDatas['transactionAmount'] ?>" onkeypress="return validateFloatKeyPress(this,event)" readonly>
                    </div>
                    <?php } else {?>
                        <div class="form-group col-sm-3">
                            <label for=""><?php echo $this->lang->line('assetmanagement_unit_price'); ?><!--Unit Price-->
                                <?php required_mark(); ?></label>
                            <input tabindex="10" type="text" class="form-control text-right number" id="COSTUNIT" name="COSTUNIT"
                                   value="<?php echo $editDatas['transactionAmount'] ?>" onkeypress="return validateFloatKeyPress(this,event)">
                        </div>
                    <?php }?>
                    <div class="form-group col-sm-3">
                        <label for="segment">
                            <?php echo $this->lang->line('assetmanagement_asset_location'); ?><!--Asset Location--> <?php echo required_mark() ?></label>
                        <?php echo form_dropdown('currentLocation', $fetch_all_location, array($editDatas['currentLocation']), 'class="form-control" tabindex="12" id = "currentLocation"'); ?>
                    </div>
                    <div class="form-group col-sm-3">
                        <label for="">Acc Dep Amount </label>
                        <input tabindex="11" type="text" class="form-control text-right number" id="accDepAmount" name="accDepAmount"
                               value="<?php echo $editDatas['accDepAmount'] ?>" onkeyup="validateunitprice()" onkeypress="return validateFloatKeyPress(this,event)">
                    </div>
                    <div class="form-group col-sm-3">
                        <label for="">Acc Dep Date</label>
                        <div class=" input-group">
                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                            <input tabindex="6" type="text" name="accDepDate" readonly
                                   value="<?php echo format_date($editDatas['accDepDate']); ?>"
                                   id="accDepDate"
                                   class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-3 no-padding">
                        <label for="">Origin Document</label>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <textarea tabindex="13" class="form-control" rows="2" id="comments"
                                  name="comments"><?php echo $editDatas['comments'] ?></textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="step2" class="tab-pane" style="box-shadow: none;">
        ...
        <div class="row">
            <div class="form-group col-sm-4">
                ...
                <?php echo form_dropdown('assetType', array('1' => $this->lang->line('assetmanagement_own_asset')/*'Own Asset'*/, '2' => $this->lang->line('assetmanagement_thirdparty')/*'Third Party'*/), array($editDatas['assetType']), 'class="form-control" id="assetType" required onchange="enableSubplier(this)"'); ?>
            </div>

            <div class="form-group col-sm-4">
                <label for="segment"><?php echo $this->lang->line('common_supplier'); ?><!--Supplier--></label>
                <?php echo form_dropdown('supplier', $supplier_arr, array($editDatas['supplierID']), 'class="form-control select2" id="supplier"'); ?>
            </div>
            <div class="form-group col-sm-4">
                <label for="segment">
                    <?php echo $this->lang->line('common_segment'); ?><!--Segment--> <?php required_mark(); ?></label>
                <?php echo form_dropdown('segment', $segment_arr, array($editDatas['segment']), 'class="form-control select2" id="segment" required'); ?>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-sm-4">
                ...
                <?php echo form_dropdown('faCatID', $fetch_master_cat, array($editDatas['faCatID']), "class='form-control select2' id='faCatID' required onchange='getSubCategory(this);fetchGLCode(this)'"); ?>
            </div>
            <div class="form-group col-sm-4">
                <label for="faSubCatID">
                    <?php echo $this->lang->line('assetmanagement_sub_category'); ?><!--Sub Category--> <?php required_mark(); ?></label>
                <?php echo form_dropdown('faSubCatID', $fetch_sub_cat, array($editDatas['faSubCatID']), 'class="form-control" id="faSubCatID" required onchange="getSubCategory(this)"'); ?>
            </div>
            <div class="form-group col-sm-4">
                <label for="faSubCatID2">
                    <?php echo $this->lang->line('assetmanagement_sub_sub_category'); ?><!--Sub Sub Category--></label>
                <?php echo form_dropdown('faSubCatID2', $fetch_sub_sub_cat, array($editDatas['faSubCatID2']), 'class="form-control" id="faSubCatID2"'); ?>
            </div>
        </div>
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo form_dropdown('COSTGLCODEdes', $fetch_cost_account, array($editDatas['costGLAutoID']), 'class="form-control select2" id = "COSTGLCODEdes"'); ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo form_dropdown('ACCDEPGLCODEdes', $fetch_cost_account, array($editDatas['ACCDEPGLAutoID']), 'class="form-control select2" id = "ACCDEPGLCODEdes"'); ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo form_dropdown('DEPGLCODEdes', $fetch_dep_gl_code, array($editDatas['DEPGLAutoID']), 'class="form-control select2" id = "DEPGLCODEdes"'); ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo form_dropdown('DISPOGLCODEdes', $fetch_disposal_gl_code, array($editDatas['DISPOGLAutoID']), 'class="form-control select2" id = "DISPOGLCODEdes"'); ?>
                        </div>
                    </div>
                </fieldset>
            </div>
        ...
        <div class="row">
            <div class="form-group col-sm-5" id="postGLAutoID_divType">
                ...
                <div class="input-group">
                    ...
                    <?php
                    echo form_dropdown('postGLAutoID', $fetch_post_to_gl, array($editDatas['postGLAutoID']), 'class="form-control select2" disabled id = "postGLAutoID"'); ?>
                </div>
            </div>
            <div class="form-group col-sm-3">
                ...
                <div class="input-group">
                    ...
                    <?php echo form_dropdown('groupTO', $groupTO, array($editDatas['groupTO']), 'class="form-control" disabled id="groupTO"'); ?>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="text-right m-t-xs">
                    <input type="hidden" value="<?php echo $editDatas['isFromGRV'] ?>" name="isFromGRV">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h4 style="font-weight: bold;text-align: right">
                    ...
                    $totalCost = isset($cost['companyLocalAmount']) ? (float)$cost['companyLocalAmount'] : 0;
                    echo number_format(($totalCost - $depTotal), $local_decimal_place);
                    ?></h4>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#add_new_asset_form_2').bootstrapValidator({
            ...
            /*var form1 = new FormData($("#add_new_asset_form")[0]);*/
            //form1['faID'] = faID;
            /*$.extend(data, form1)*/
            /*var obj = Object.assign(data, form1);*/
...
//                dateexpired: {validators: {notEmpty: {message: 'Date of Expiry is required.'}}},
    ...
    function assetConfirm(item) {
        /*var a = $('#add_new_asset_form').isValid()
         console.log(a);*/
        /*var validator1 = $('#add_new_asset_form').data('bootstrapValidator');
         var validator2 = $('#add_new_asset_form_2').data('bootstrapValidator');
         validator1.validate();
         validator2.validate();

         if (validator1.isValid() == false || validator2.isValid() == false) {
         return false;
         }*/
        $("#transactionCurrency").prop("disabled", false);
    ...
    function validateunitprice(){
        var uint = $('#COSTUNIT').val();

        var accDepAmount = $('#accDepAmount').val();
        if(parseFloat(accDepAmount)>parseFloat(uint)){
