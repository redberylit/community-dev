...
<div id="assetRegisterTable">
    <table class="<?php echo table_class() ?> assetRegisterTable">
        ...
        <tfoot>
        <tr>
            <td><?php echo $this->lang->line('assetmanagement_as_at_end_of');?><!--As at end of--> <?php echo date('Y', strtotime($endFinanceYear)) . '/' . date('M', strtotime($dateAsOf)) ?></td>
            <?php
            foreach ($fa_categories as $fa_category) {
    ...
    <table class="<?php echo table_class() ?> assetRegisterTable">
        ...
        <tfoot>
        <tr>
            <th style=""><?php echo $this->lang->line('assetmanagement_as_at_end_of');?><!--As at end of--> <?php echo date('Y', strtotime($endFinanceYear)) . '/' . date('M', strtotime($dateAsOf)) ?></th>
            <?php
            $netBookValue = 0;
            foreach ($fa_categories as $fa_category) {
