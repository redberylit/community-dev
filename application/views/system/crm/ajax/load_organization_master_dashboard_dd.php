        ...
        <table class="table table-hover table-striped">
            ...
            foreach ($header as $val) { ?>
                <tr>
                    ...
                    <td class="mailbox-name"><div class="contact-box">
                            <div class="link-box">
                                <div class="link-box"><strong class="contacttitle"><a class="link-person noselect" href="#"  onclick="organization_edit_view('system/crm/organization_edit_view','<?php echo $val['organizationID'] ?>','View Organization','CRM')"><?php echo $val['Name'] ?></a><br><?php echo $val['email'] ?></a></strong></div></div>
                    </td>
