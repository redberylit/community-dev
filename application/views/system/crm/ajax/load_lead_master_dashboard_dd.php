        ...
        <td class="task-cat-upcoming" colspan="12">
            ...
            foreach ($header as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-name">
                    <div class="link-box"><strong class="contacttitle "><a class="link-person noselect" href="#"  onclick="lead_edit_view('system/crm/lead_edit_view','<?php echo $val['leadID'] ?>','View Lead','CRM')"><?php echo $val['firstName']." ".$val['lastName'] ?></a><br><?php echo $val['email'] ?></strong></div></div>
                    </td>
