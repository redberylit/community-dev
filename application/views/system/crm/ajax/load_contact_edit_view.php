...
<div class="row">
    <div class="col-md-1">
        <div>
            <?php if ($header['contactImage'] != '') { ?>
                <img style="width: 40px; height: 40px;"  src="<?php echo base_url('uploads/crm/profileimage/' . $header['contactImage']); ?>" alt="Contact">
                <?php
            } else { ?>
    ...
    <div class="col-md-8" style="padding: 0px;">
        ...
        <h1 style="margin-top: 4px;font-size: 20px;"><?php echo $header['firstName'] . " " . $header['lastName']; ?></h1>
    </div>
...
<ul class="nav nav-tabs" id="main-tabs">
    ...
    <li><a href="#opportunities" onclick="link_opportunities()" data-toggle="tab"><i class="fa fa-television"></i>Opportunities</a>
    </li>
</ul>
