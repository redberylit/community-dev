...
<script type="text/javascript">
    ...
    function getProjectManagement_tableView(filtervalue) {
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: {'searchTask': searchTask, 'filtervalue': filtervalue,status:status,catergory:catergory,isactivestatus:isactivestatus},
            url: "<?php echo site_url('CrmLead/load_projectManagement_view'); ?>",
            beforeSend: function () {
                startLoad();
            },
