<?php echo head_page('Expense Claim', false);
...
<div class="row">
    ...
    <div class="col-md-4">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/crm/create_new_expenseclaim',null,'New Expense Claim','CRM');"><i class="fa fa-plus"></i> New Expense Claim
        </button>
    </div>
</div>
<div class="row">
