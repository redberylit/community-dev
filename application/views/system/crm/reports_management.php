...
<div class="row" style="margin-top: 1%;">
    <div class="col-md-12">
        <div id="list-main" class="top15 ">
            <aside class="sidebar-left col-md-2" style="width: 21%;">
            ...
            <div id="load_configuration_view" class="col-md-10" style="width: 79%;">
                <fieldset>
