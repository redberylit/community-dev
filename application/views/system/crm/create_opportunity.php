    ...
    <div class="col-md-12 animated zoomIn">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-3">
                <?php echo form_dropdown('convertProject', array('0' => $this->lang->line('crm_select_close_status')/*'Select Close Status'*/, '1' => $this->lang->line('common_closed')/*'Closed'*/, '2' => $this->lang->line('crm_convert_to_project')/*'Convert to Project'*/), '', 'class="form-control" id="convertProject"'); ?>
            </div>
        </div>
        <div class="row" style="margin-top: 10px;">
            <div class="form-group col-sm-1">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-7">
                <div class="row">
                    ...
                    <div class="form-group col-sm-3">
                        <input type="text" name="price" id="price" class="form-control number" placeholder="<?php echo $this->lang->line('crm_bid_amount');?>"><!--Bid Amount-->
                    </div>
