...
<div class="row">
    <div class="col-md-12 animated zoomIn">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                <input type="text" name="title" id="title" class="form-control valcontact calcontactread"
                       placeholder="<?php echo $this->lang->line('common_title');?>"><!--Title-->
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                <span class="input-req"
                      title="Required Field"><?php echo form_dropdown('responsiblePersonEmpID', $employees_arr, $CI->session->userdata("empID"), 'class="form-control select2" id="responsiblePersonEmpID"  required'); ?>
                    <span class="input-req-inner"></span></span>
            </div>
        </div>
