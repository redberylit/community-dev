...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab"><?php echo $this->lang->line('crm_step_one');?> - <?php echo $this->lang->line('crm_task_header');?> </a><!--Step 1--><!--Task Header-->
    <a class="btn btn-default btn-wizard subtasktabehide hide" href="#step3" id="subtask"  data-toggle="tab">Step 3 Sub Task </a><!--Step 2--><!--Task Attachments-->
    <a class="btn btn-default btn-wizard" href="#step2" onclick="task_multiple_attachemts()" data-toggle="tab" id="taskttachment"><?php echo $this->lang->line('crm_step_two');?> - <?php echo $this->lang->line('crm_task_attachments');?> </a><!--Step 2--><!--Task Attachments-->
</div>
<hr>
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                <span class="input-req"
                      title="Required Field"><?php echo form_dropdown('statusID', $status_arr, '', 'class="form-control" id="statusID"  required'); ?>
                    <span class="input-req-inner"></span></span>
                    </div>
                    <div class="form-group col-sm-2" style="padding-right: 0px;">
                        <label class="title"><?php echo $this->lang->line('crm_is_closed');?></label><!--IS Closed-->
                    </div>
                        ...
                        <div class="col-sm-1">
                            <div class="skin skin-square">
                                <div class="skin-section extraColumns"><input id="isClosed" type="checkbox"
                                                                              data-caption="" class="columnSelected isClosedcls"
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div class="input-group duedateDatepic">
                            ...
                            <input type="text" name="duedate" value=""
                                   id="duedate" class="form-control dateFields frm_input" style="z-index: 100">
                        </div>
                             <span class="input-req-inner" style="z-index: 100;"></span></span>
                    </div>
               <div class="form-group col-sm-2" style="padding-right: 0px;">
        ...
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4"
                                style="margin-top: 5px;"><?php echo form_dropdown('employees[]', $employees_arr, '', 'class="form-control select2" id="employeesID"  multiple="" style="z-index: 0;"'); ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                <header class="head-title">
                    <h2><?php echo $this->lang->line('crm_visibility_capital');?></h2><!--VISIBILITY-->
                </header>
                <div class="row">
                    <div class="form-group col-sm-1" style="margin-top: 10px;">
                        &nbsp
                    ...
                    <div class="form-group col-sm-2" style="margin-top: 10px;">
                        <label class="title"></label><?php echo $this->lang->line('crm_visibility');?><!--Visibility-->
                    </div>
                    <div class="form-group col-sm-4" style="margin-top: 5px;">
                        <?php echo form_dropdown('visibility', array('' => $this->lang->line('crm_select_visibility')/*'Select Visibility'*/, '1' => $this->lang->line('crm_public_task')/*'Public Task'*/, '2' => $this->lang->line('crm_private_task')/*'Private Task'*/), '1', 'class="form-control" id="visibility"'); ?>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form role="form" id="sub_task_addform" class="form-horizontal">
                    ...
                    <table class="table table-bordered table-condensed no-color" id="subTask_add_table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="indays[]" onfocus="this.select();" class="form-control indays number" value="1" id="indays" readonly></td>
                            <td><input type="text" style="width: 100%;" class="form-control inhrs" name="inhrs[]" placeholder="HH" /> <input type="hidden" name="assign[]"  class="assign-cls"></td>
                            <td><input type="text" style="width: 100%;" class="form-control inmns" name="inmns[]" placeholder="MM" onkeyup="cheack_minutes_count(this)" /></td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (masterID != null && masterID.length > 0) {
            ...
            if (related_document == 5) {
                load_taskRelated_fromLead(masterIDNew[0]);
                $('.headerclose').click(function () {
                    fetchPage('system/crm/lead_edit_view', masterIDNew, 'View Lead', 'Lead');
                });
                ...
                if (masterIDNew[1] != '') {
                    $('.headerclose').click(function () {
                        fetchPage('system/crm/opportunities_edit_view', masterIDNew[0], 'View Opportunity', 'CRM');
                    });
                }
            } else if (related_document == 9) {
                load_taskRelated_fromProject(masterIDNew[0]);
                $('#projectID').val(masterIDNew[0]);
                $('#pipelineStageID').val(masterIDNew[1]);
                if (masterIDNew[1] != '') {
                    $('.headerclose').click(function () {
                        fetchPage('system/crm/project_edit_view', masterIDNew[0], 'View Project', 'CRM');
                    });
                }
                ...
                $('.headerclose').click(function () {
                    fetchPage('system/crm/dashboard', '', 'CRM');
                });
                ...
                success: function (data) {
                    ...
                    if (data[0] == 's') {
                        ...
                        if ($("#issubtask").is(':checked')) {
                            ...
                            $('#subtask').html('Step 2 Sub Task');
                            $('#taskttachment').html('Step 3 Task Attachments');
                            $('[href=#step3]').tab('show');
                            $('#progress').slider({
                                formatter: function (value) {
                                    return 'Current value: ' + value + '%';
                            ...
                            $('[href=#step2]').tab('show');
                            $('#taskttachment').html('Step 2 Task Attachments');
                            $('#progress').slider({
                                formatter: function (value) {
                                    return 'Current value: ' + value + '%';
                                }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (!jQuery.isEmptyObject(data['assignpermission'])) {
                        if((data['assignpermission'] == 1) && ('<?php echo $admin['isSuperAdmin']?>' != 1) && ('<?php echo $isgroupadmin['adminYN']?>' != 1)&& (data['header']['createdUserID'] != '<?php echo $current_userid?>'))
                        {
    ...
    function add_more_subtask() {
        ...
        $('.subtaskdateest').datetimepicker({
            ...
            calculatesubtask(this);
            subtaskdatevalidation(this)
            $('#sub_task_addform').bootstrapValidator('revalidateField', 'subtaskdateest');
    ...
    function save_sub_task_assignee()
    {
        $(".employeessubtask").each(function(){
            v = $(this).val();
            $(this).parent().parent().find('.assign-cls').val(v);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data == 1) {
                        ...
                        $(element).closest('tr').find('.estsubtaskdate').val('');
                        $(element).closest('tr').find('.indays').val('');
                    }
                },
                error: function () {
                    alert('An Error Occurred! Please Try Again.');
    ...
    {
        var endstartDate = $(element).closest('tr').find('.estsubtaskdateend').val();
        var startdatesub = $(element).closest('tr').find('.estsubtaskdate').val();
        var enddatesub = $(element).closest('tr').find('.estsubtaskdateend').val();
        if (startdatesub > enddatesub) {
