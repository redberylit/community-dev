...
<div class="row">
    <div class="col-md-12 animated zoomIn">
        <header class="head-title">
            <h2>EXPENSE CLAIM INFORMATION</h2>
        </header>
<!--        <div class="row" style="margin-top: 10px;">
            <div class="form-group col-sm-2">
                <label class="title">Lead</label>
            </div>
            <div class="form-group col-sm-4">
                            <span class="input-req"
                                  title="Required Field">
                                        <?php /*echo form_dropdown('leadID', $leadsArr, '', 'class="form-control select2" id="leadID"  required');
                                        */?>
                                <span class="input-req-inner"></span></span>
            </div>
            <div class="form-group col-sm-2">
                <label class="title">Opportunity</label>
            </div>
            <div class="form-group col-sm-3">
                            <span class="input-req"
                                  title="Required Field">
                                        <?php /*echo form_dropdown('opportunityID', $opportunitiesArr, '', 'class="form-control select2" id="opportunityID"  required');
                                        */?>
                                <span class="input-req-inner"></span></span>
            </div>
        </div>
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                            <span class="input-req"
                                  title="Required Field">
                                        <?php /*echo form_dropdown('projectID', $projectArr, '', 'class="form-control select2" id="projectID"  required');
                                        */?>
                                <span class="input-req-inner"></span></span>
            </div>-->
        <div class="row" style="margin-top: 10px;">
