...
<script type="text/javascript">
    ...
    function viewEvent(id) {
        fetchPage('system/crm/task_edit_view', id, 'View Task', 'CRM', 'Dashboard');
    }
