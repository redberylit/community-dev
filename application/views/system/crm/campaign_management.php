...
<script type="text/javascript">
    ...
    function getCampaignManagement_tableView() {
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: {'searchCampaign': searchCampaign, status: status, type: type, assignee: assignee},
            url: "<?php echo site_url('crm/load_campaignManagement_view'); ?>",
            beforeSend: function () {
                startLoad();
            },
