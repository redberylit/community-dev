...
if (!empty($header)) { ?>
    ...
    <tr class="task-cat noselect" style="background: white;">
        <td class="task-cat-upcoming" colspan="8">
            <div class="task-cat-upcoming-label">Latest IOU Users</div>
    ...
    <tr>
        ...
        <td class="headrowtitle" style="border-top: 1px solid #F76F01; text-align: center">Address</td>
        <td class="headrowtitle" style="border-top: 1px solid #F76F01;">Phone Number</td>
        <td class="headrowtitle" style="border-top: 1px solid #F76F01;">Status</td>
    ...
    foreach ($header as $val) { ?>
        <tr>
            ...
            <td class="mailbox-attachment"><span class="pull-center">
                            <a href="#"
                               onclick="fetchPage('system/iou/create_iou_user','<?php echo $val['userID'] ?>','Edit IOU User','IOU USER')"><span
                                        title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;|


                            <a
                                    onclick="delete_iou_user(<?php echo $val['userID'] ?>);"><span title="Delete"
                                                                                                   rel="tooltip"
    ...
    <br>
    <div class="search-no-results">THERE ARE NO USERS TO DISPLAY.</div>
    <?php
}
?>
