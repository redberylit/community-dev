...
echo head_page('IOU Users', false);
...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right"
                onclick="fetchPage('system/iou/create_iou_user',null,'Add New IOU User',' ');"><i
...
<div class="row" style="margin-top: 2%;">
    ...
    <div class="col-md-2">
        <?php echo form_dropdown('iouuserstatus', array('' => 'Status', '1' => 'Active', '2' => 'In Active'), '', 'class="form-control" onchange="startMasterSearch()" id="iouuserstatus"'); ?>
    </div>
</div>
<br>
<div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/iou/iou_user','','IOU User');
        });
