...
echo head_page('IOU Expenses', true);
...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right"
                onclick="fetchPage('system/iou/create_iou_booking',null,'Add New IOU Expense','IOUE');"><i
...
<div class="row" style="margin-top: 2%;">
    ...
    <div class="col-md-2">
        <?php echo form_dropdown('iouvoucherstatus', array('' => 'Status', '1' => 'Draft', '2' => 'Confirmed', '3' => 'Approved','4' => 'Submitted'), '', 'class="form-control" onchange="startMasterSearch()" id="iouvoucherstatus"'); ?>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/iou/iou_booking','','IOU Booking');
        });
