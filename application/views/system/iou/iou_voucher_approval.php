...
echo head_page('IOU Voucher Approval', false);
?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">IOU Voucher Approval</h4>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/iou/iou_voucher_approval', '', 'IOU Voucher Approval')
        });
        Return_table();
        $('#pv_approval_form').bootstrapValidator({
            ...
            fields: {
                ...
                iouvoucherid: {validators: {notEmpty: {message: 'IOU Voucher Auto Id is required.'}}},
