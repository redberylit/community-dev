                ...
                <div class="modal-body">
                    <table class="table table-bordered table-condensed" id="">
                        ...
                        <tr>
                            ...
                            <!--UOM-->
                            <th style="width:200px;" >No Item<?php required_mark(); ?></th>
                            <th style="width:200px;" >Gross Qty<?php required_mark(); ?></th>
...
<div class="table-responsive">
    <table id="add_new_grv_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 10%">Gross Qty</th>
...
<script type="text/javascript">
                ...
                success: function (data) {
                    ...
                    if (jQuery.isEmptyObject(data['detail'])) {
                        ...
                        $.each(data['detail'], function (key, value) {
                            ...
                            $('#table_body').append('<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-right">' + (value['requestedQty'] - value['receivedQty']) + '</td><td class="text-right">' + parseFloat(value['unitAmount']).toFixed(currency_decimal) + '</td><td class="text-center"><input type="text" class="number" size="8" id="qty_' + value['purchaseOrderDetailsID'] + '" onkeyup="select_check_box(this,' + value['purchaseOrderDetailsID'] + ',' + value['unitAmount'] + ' )" ></td><td class="text-center">' + cost_status + '</td><td class="text-center"><p id="tot_' + value['purchaseOrderDetailsID'] + '"> </p></td><td class="text-right" style="display: none;"><input class="checkbox" id="check_' + value['purchaseOrderDetailsID'] + '" type="checkbox" value="' + value['purchaseOrderDetailsID'] + '"></td></tr>');
                            x++;
    ...
    function cal_deduction_netQty(element) {
        ...
        if (grossQty) {
            $(element).closest('tr').find('.quantityRequested').val((parseFloat(grossQty - deduction).toFixed(2)));
    ...
    function cal_deduction_netQtyEdit_buyback() {
        ...
        if (grossQty) {
            $('#quantityRequested').val((parseFloat(grossQty - deduction).toFixed(2)));
