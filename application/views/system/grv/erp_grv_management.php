...
<div class="row">
    ...
    <div class="col-md-7 text-right">
        <button type="button" class="btn btn-primary pull-right"
                onclick="fetchPage('system/grv/erp_grv_new',null,'Add New Goods Received Voucher','GRV');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('transaction_goods_received_voucher_create_grv');?>
        </button><!--Create GRV-->
    </div>
</div>
<hr>
    ...
    function grv_table(selectedID=null) {
         Otable = $('#grv_table').DataTable({
            ...
            "aoColumns": [
             ...
             "columnDefs": [{"targets": [6], "orderable": false},{"visible":false,"searchable": true,"targets": [7,8,9,10,11,12] }],
