<?php echo head_page('Attendance Summary', false);
...
<div class="row" >
    ...
    <div class="col-sm-3">
        <button type="button" class="btn btn-primary pull-right" style="margin-top: 23px;" onclick="openOtMasterModel()"><i
                class="fa fa-plus"></i> Create Attendance Summary
        </button>
    </div>
</div>
<hr>
    ...
    <div class="modal-dialog" style="width: 40%">
        <div class="modal-content" id="">
            ...
            <div class="modal-body" style="margin-left: 20px">
                <div class="row">
                    <div class="form-group col-sm-8">
                        <label for="">Date <?php required_mark(); ?></label>
                ...
                <div class="row">
                    <div class="form-group col-sm-8">
                        <label for="currency">Currency <?php required_mark(); ?></label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary btn-sm" id="btnSave">Save
                </button>
            </div>
            </form>
        </div>
