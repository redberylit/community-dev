...
?>
    ...
    <div class="row">
        ...
        <div class="col-md-9 text-right">
            <button type="button" class="btn btn-primary btn-sm pull-right" onclick="fetchPage('system/Fleet_Management/load_Driver_edit_view', '', 'Add New Driver')"><i
    ...
    <div class="table-responsive">
        <table id="driver_table" class="<?php echo table_class(); ?>">
            ...
            <tr>
                ...
                <th style="min-width: 14%">Driver ID</th><!--Driver ID-->
                <th style="min-width: 10%">Driver Name</th><!--Reference-->
                <th style="min-width: 14%">Contact Number</th><!--Number-->
                <th style="min-width: 20%">Address</th><!--Address-->
                <th style="min-width: 10%">Licence Number</th><!--Licence Number-->
                <th style="min-width: 6%">Status</th><!--Status-->
