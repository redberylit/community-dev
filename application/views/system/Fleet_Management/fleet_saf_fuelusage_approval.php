...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <?php echo form_dropdown('approvedYN', array('0' => $this->lang->line('common_pending')/*'Pending'*/, '1' => $this->lang->line('common_approved')/*'Approved'*/), '', 'class="form-control" id="approvedYN" required onchange="FuelUsage_approval_table()"'); ?>
    </div>
</div>
<hr>
...
<script type="text/javascript">
    ...
    function FuelUsage_approval_table() {
        var Otable = $('#FuelUsage_approval_table').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            "bDestroy": true,
            "bStateSave": true,
