...
<?php echo form_open('', 'role="form" id="AddVehicleForm"'); ?>
    ...
    <div class="row">
        <div class="col-md-12 animated zoomIn">
            <header class="head-title">
                <h2>
                 <!--   --><?php /*echo $this->lang->line('fleet_Vehicle_Master'); */?>Asset Details</h2>
            </header>
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="form-group col-sm-2">
                    <label class="title">
                        <?php /*echo $this->lang->line('fleet_vehicle_Brand'); */?>Brand<label>
                </div>
            ...
            <div class="form-group col-sm-2">
                <label class="title">
                  <!--  --><?php /*echo $this->lang->line('fleet_vehicle_engine'); */?>Capacity<!--Date of Birth--></label>
            </div>
            <div class="form-group col-sm-4">
                            <span class="input-req" title="Required Field">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-2">
                <label class="title">
                    <?php /*echo $this->lang->line('fleet_vehicle_model'); */?>Model</label>
            </div>
            <div class="form-group col-sm-4">
                               <span class="input-req" title="Required Field">
                            <div class="input-group">
        ...
        <div class="form-group col-sm-2">
            <label class="title">
               <!-- --><?php /*echo $this->lang->line('fleet_vehicle_speed'); */?>Expected KM/hrs<label>
        </div>
        <div class="form-group col-sm-4">
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="form-group col-sm-2">
            <label class="title">
               <!-- --><?php /*echo $this->lang->line('fleet_vehicle_type'); */?> Body Type</label>
        </div>
        ...
        <div class="form-group col-sm-2">
            <label class="title">
                <?php /*echo $this->lang->line('fleet_vehicle_No'); */?>Product Number</label>
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="form-group col-sm-2">
            <label class="title">
                <?php /*echo $this->lang->line('fleet_vehicle_color'); */?><!--Vehicle color :-->Color</label>
        </div>
        <div class="form-group col-sm-4">
                            <span class="input-req" title="Required Field">
    ...
    <div class="row" style="margin-top: 10px;">
        ...
        <div class="form-group col-sm-2">
            <label class=" title"
                   for="status"><?php /*echo $this->lang->line('fleet_vehicle_status'); */?> Type</label>
        </div>
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="form-group col-sm-2">
            <label class=" title"
                   for="status">Initial Usage </label>
        </div>
    ...
    <div class="row" style="margin-top: 10px;">
        ...
        <div class="form-group col-sm-2">
            <label class=" title" for="ivmsnumber">Fixed Asset</label>
        </div>
        <div class="form-group col-sm-4">
    ...
    <div class="row" style="margin-top: 10px;">
        ...
        <div class="form-group col-sm-2">
            <label class=" title"
                   for="status"><?php /*echo $this->lang->line('fleet_vehicleDescription'); */?>Description</label>
        </div>
    ...
    <div class="pull-right" id="statusbtns">
        <button type="submit" class="btn btn-primary" data-dismiss="modal">Save</button><!--Close-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div role="form" id="" class="form-horizontal" autocomplete="off">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-sm" id="vehicale-add">Save</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div role="form" id="" class="form-horizontal" autocomplete="off">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-sm" id="vehicale-add_brand">Save</button>
                        <button data-dismiss="modal" class="btn btn-default btn-sm" type="button">Close</button>
                    </div>
                </div>
            </div>
