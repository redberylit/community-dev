...
?>
    ...
    <div class="m-b-md" id="wizardControl">
        ...
        <a class="btn btn-default btn-wizard" href="#step2" data-toggle="tab">
            ...
            <?php echo $this->lang->line('fuel_purchase_details'); ?> Detail</a>
        ...
        <div id="step2" class="tab-pane">
            ...
            <table class="table table-bordered table-striped table-condesed">
                ...
                <tr>
                    ...
                    <th style="min-width: 25%">Vehicle</th>
                    ...
                    <th style="min-width: 10%">Fuel Rate</th>
                        ...
                        <table class="table table-bordered table-condensed no-color" id="po_detail_add_table">
                            ...
                            <tr>
                                <th style="min-width: 10px;">
                                    Category<!--GL Code--> <?php required_mark(); ?></th>
