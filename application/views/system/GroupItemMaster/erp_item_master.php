<?php echo head_page('Item Master', false);
...
<div class="row">
    <div class="col-md-6">
        <table class="<?php echo table_class(); ?>">
            <tr>
                <td><span class="glyphicon glyphicon-stop" style="color:green; font-size:15px;"></span> Active
                </td>
                <td><span class="glyphicon glyphicon-stop" style="color:red; font-size:15px;"></span> Inactive
                </td>
            </tr>
        </table>
    </div>
    <div class="col-md-6 text-right">
        <button type="button" class="btn btn-primary pull-right"
                onclick="fetchPage('system/GroupItemMaster/erp_group_item_new',null,'Add New Item','SUP');"><i
                class="fa fa-plus"></i>
            Create
            Item
        </button>
...
<div class="table-responsive">
    <table id="item_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 10%">Current Stock</th>
    ...
    <div class="modal-dialog" style="width: 60%">
        <div class="modal-content" id="">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Item Master Link <span id=""></span></h4>
            </div>
            <div class="modal-body" style="margin-left: 10px">
                <div class="row">
                    <div class="col-sm-12">
                        <label for="customerName"><h4>Item Name :- </h4></label>
...
<div class="modal fade" id="itemDuplicateModal" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" style="width: 60%">
        <div class="modal-content" id="">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Item Replicate <span id=""></span></h4>
            </div>
            <div class="modal-body" style="margin-left: 10px">
                <div class="row">
                    <div class="col-sm-12">
