        ...
        <div class="row">
            <div class="form-group col-sm-4">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="requestedByName" name="requestedByName" required>
                    ...
                    <table class="table table-bordered table-condensed no-color" id="po_detail_edit_table">
                        ...
                        <tr>
                            ...
                            <th style="width: 150px;">
                                <?php echo $this->lang->line('common_uom'); ?><!--UOM--> <?php required_mark(); ?></th>
                            <th style="width: 100px;">
                                <?php echo $this->lang->line('procurement_approval_po_qty'); ?><!--PO Qty--> <?php required_mark(); ?></th>
                            <th style="width: 150px;">
                                <?php echo $this->lang->line('common_unit_cost'); ?><!--Unit Cost--> <span
                ...
                success: function (data) {
                    ...
                    if (jQuery.isEmptyObject(data['detail'])) {
                        ...
                        $.each(data['detail'], function (key, value) {
                            ...
                            /* <a onclick="edit_item(' + value['purchaseRequestDetailsID'] + ',\'' + value['itemDescription'] + '\');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; |*/
                            x++;
                ...
                $('.itemAutoID').each(function () {
                    if (this.value) {
                        if (this.value == suggestion.itemAutoID) {
                            ...
                            $('#f_search_' + id).closest('tr').find('.net_amount').html('0.00');
