...
?>
    ...
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            ...
            <button type="button" class="btn btn-primary btn-sm pull-right" style="margin-right: 2px;" onclick="openUploadData_modal()" ><i class="fa fa-plus-square"></i>&nbsp; <?php echo $this->lang->line('communityngo_upload_new');?><!--Add--> </button>
        </div>
    </div>
    <br>
    <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-2">
                    ...
                    <select id="ComUpload1Submited" class="form-control select2"
                            data-placeholder="Upload Status"
                ...
                <div class="form-group col-sm-2">
                    ...
                    <label></label>
                    <select id="ComUploadExpire" class="form-control select2"
                            data-placeholder="Expiring Status"
                            name="ComUploadExpire" onchange="get_uploads_delByDt();">
                        <option value=""></option>
                        <option value="1" selected="selected">Not Expired</option>
...
<?php echo footer_page('Right foot', 'Left foot', false); ?>
                    ...
                    <div class="row modal-body">
                        <div class="col-md-12">
                            <div class="form-group col-sm-6" style="margin-right: 3px;">
                                ...
                                <select id="ComUploadType" class="form-control select2" data-placeholder="Select Upload Type" name="ComUploadType" onchange="get_comUpload_type();">
                                    <option value=""></option>
                                    <option value="1">Video</option>
                                    <option value="2">Audio</option>
                                    <option value="3">Document</option>
                        ...
                        <div class="col-md-12">
                            <div id="videoAudioDiv" class="form-group col-sm-6" style="display:block;margin-right: 3px;">
                            ...
                            <div id="uploadDocDiv" class="form-group col-sm-6" style="display:none;margin-right: 3px;">
                                <label for=""><?php echo $this->lang->line('communityngo_upload_doc');?><!--doc--> <?php required_mark(); ?></label>
    ...
    <script type="text/javascript">
        ...
        function get_comUpload_type() {

            var ComUploadType= document.getElementById('ComUploadType').value;

            if(ComUploadType==1 || ComUploadType==2){

                document.getElementById('videoAudioDiv').style.display = 'block';
                ...
                document.getElementById('videoAudioDiv').style.display = 'none';
            }
        ...
        function com_uploadEdit(ComUploadID) {
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    var ComUploadType= data['ComUploadType'];
                    ...
                    if(ComUploadType==1 || ComUploadType==2){
                        ...
                        document.getElementById('uploadDocDiv').style.display = 'block';
                        document.getElementById('videoAudioDiv').style.display = 'none';
                        $('#document_file').val(data['document_file']).change();
        ...
        function com_uploadDelete(id,ComUploadType,ComUploadFileName) {
            swal({
                ...
                function () {
                    $.ajax({
                        ...
                        type: 'post',
                        dataType: 'json',
                        data: {'ComUploadID': id,'ComUploadType':ComUploadType,'ComUploadFileName':ComUploadFileName},
        ...
        function saveCom_uploadData() {
            var formData = new FormData($("#add_comUpload_form")[0]);
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
        ...
        function get_uploads_delByDt() {
            ...
            var ComUploadExpire = document.getElementById('ComUploadExpire').value;
            ...
            $.ajax({
                ...
                data: {'dateUFrom':dateUFrom,'dateUTo':dateUTo,'ComUploadType':ComUpload1Type,'ComUploadSubmited':ComUploadSubmited,'ComUploadExpire':ComUploadExpire},
                success: function (data) {
