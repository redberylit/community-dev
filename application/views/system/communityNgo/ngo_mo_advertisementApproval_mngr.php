...
<style>
    ...
    @media (min-width:20em) {
        ...
        .videoModal.active.videoModal-medium {
            width: 35em
        }

        .videoModal.active.videoModal-small {
            width: 25em
        }
    }
                    ...
                    <div class="white-container mb0">
                        <div class="widget sidebar-widget jobs-search-widget" style="margin-top: -30px;">
                            <div class="widget-content">
                                <input type="text" id="searchKey" class="form-control mt10" onkeyup="approveMem_search(this)" placeholder="<?php echo $this->lang->line('common_search'); ?>">
                                <!--Search-->
                            </div>
                        </div>
                        ...
                        <div class="widget sidebar-widget jobs-filter-widget">
                            <div class="widget-content">
                                ...
                                <h6 style="font-size: 16px;"><?php echo $this->lang->line('communityngo_AddApproval_status'); ?>
                                    <!--Approval Status-->
                                </h6>
                                <div>
                                    <ul class="filter-list" id="status-area">
                                        <li class="status-list" onclick="select_adFilter('status-list', this)" data-val="1">
                                            <a href="#"><?php echo $this->lang->line('communityngo_approved') . '<span> (' . $statusCount['adApproved'] . ') </span>'; ?>
                                                <!--Approved-->
                                            </a>
                                        </li>
                                ...
                                <h6 style="font-size: 16px; margin-top: 50px;"><?php echo $this->lang->line('communityngo_advertisement_type'); ?>
                                    <!--Types-->
                                </h6>
                                <div>
                                ...
                                <h6 style="font-size: 16px; margin-top: 50px;"><?php echo $this->lang->line('common_category'); ?>
                                    <!--category-->
                                </h6>
                                <div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="memAdDoc_title"> <?php echo $this->lang->line('communityngo_memDoc_approval_verify'); ?>
                    <!--Advertisement Document Approval Verification-->
                </h4>
            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group col-md-9">
                            <div class="skin skin-square item-iCheck">
                                <div class="skin-section extraColumns" style="float: left;"><input id="IsActive" type="checkbox" class="IsActive" value="1" checked><label for="checkbox">&nbsp;</label></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> <?php echo $this->lang->line('common_save'); ?>
                    <!--Save-->
                </button>
                <button data-dismiss="modal" class="btn btn-default btn-sm" type="button" onclick="close_verifyAppMod();"><?php echo $this->lang->line('common_Close'); ?>
                    <!--Close-->
                </button>
            </div>
            </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div role="form" id="" class="form-horizontal" autocomplete="off">
                ...
                <div class="modal-footer">
                    <button data-dismiss="modal" class="btn btn-default btn-sm" type="button"><?php echo $this->lang->line('common_Close'); ?>
                        <!--Close-->
                    </button>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function adFilter_data() {
        ...
        if (adTypeAr != undefined) {
            str += '<li ><?php echo $this->lang->line('communityngo_advertisement_type'); ?> > ' + adTypeAr + ' &nbsp;&nbsp;&nbsp;&nbsp;</li>';
        }
    ...
    function advertiseApprovalFilter(letter, isFromAlphas = null, obj = null) {
        ...
        if (isInitialLoad == 1) {
            ...
            dataPost.push({
                'name': 'data_pagination',
                'value': data_pagination
            });
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('communityngo_upld_audio_player'); ?>
                            <!--Audio Player--> - &nbsp;&nbsp;<span id="audioSubject"></span>
                        </h4>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal" onclick="close_adAudio_com();"><?php echo $this->lang->line('common_Close'); ?>
                            <!--Close-->
                        </button>
                    </div>
                </div>
