                ...
                <div class="past-info">
                    <div id="toolbar">
                        <div class="toolbar-title">
                            <i class="fa fa-long-arrow-right" aria-hidden="true"></i> <?php echo $this->lang->line('communityngo_edit_famLoginConf');?>
                        </div>
                                    ...
                                    <form id="form_editFamLog">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group col-sm-4" style="">
                                                    <a onclick="submitEditFamLog();" style="float: right;" id="Save" class="btn btn-primary btn-xxs CA_Submit_btn"><?php echo $this->lang->line('common_save');?></a><!--Save-->
