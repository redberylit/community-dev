        ...
        <form method="post" name="comUploadForm" id="comUploadForm" class="">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <label></label>
                    <select id="upldUserExpire" class="form-control select2"
                            data-placeholder="Select Upload Status"
                            name="upldUserExpire" onchange="get_user_uploads_byDt();">
                        <option value=""></option>
                        <option value="0">All</option>
...
<?php echo footer_page('Right foot', 'Left foot', false); ?>
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" id="mngUser_upload_form" >
                    ...
                    <div class="row modal-body">
                        ...
                        <div class="col-md-12">
                            <div id="usrVideoAudioDv" class="form-group col-sm-6" style="display:block;margin-right: 3px;">
                                <label for=""><?php echo $this->lang->line('communityngo_upload_url');?><!--Url--> <?php required_mark(); ?></label>
                                    <input type="text" class="form-control" id="ComUpload_url"
                                           name="ComUpload_url" readonly="readonly">

                            </div>
                            <div id="usrUploadDocDv" class="form-group col-sm-6" style="display:none;margin-right: 3px;">
                                <label for=""><?php echo $this->lang->line('communityngo_upload_doc');?><!--doc--> <?php required_mark(); ?></label>
                                    <input type="text" class="form-control" id="ComUploadFileName"
                                           name="ComUploadFileName" readonly="readonly">
                            </div>
    ...
    <script type="text/javascript">
        ...
        function get_user_uploads_byDt() {
            ...
            var upldUserExpire = document.getElementById('upldUserExpire').value;

            if(ComUpldUserType || upldUserExpire){
            ...
            $.ajax({
                ...
                data: {'dateUsrFrom':dateUsrFrom,'dateUsrTo':dateUsrTo,'ComUpldUserType':ComUpldUserType,'upldUserExpire':upldUserExpire},
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(ComUploadType==1 || ComUploadType==2){
                        ...
                        document.getElementById('usrVideoAudioDv').style.display = 'block';
                        document.getElementById('usrUploadDocDv').style.display = 'none';
                        $('#ComUpload_url').val(data['ComUpload_url']).change();
                    }
                    else if(ComUploadType==3){

                        document.getElementById('usrUploadDocDv').style.display = 'block';
                        document.getElementById('usrVideoAudioDv').style.display = 'none';
                        $('#ComUploadFileName').val(data['ComUploadFileName']).change();
