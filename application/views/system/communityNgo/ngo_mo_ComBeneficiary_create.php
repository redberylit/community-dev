...
?>
    ...
    <div class="tab-content">
        ...
        <div id="step2" class="tab-pane">
            <div class="row">
                <div class="col-md-8"><h4><i class="fa fa-hand-o-right"></i> <?php echo $this->lang->line('CommunityNgo_benificiary_family_details');?><!--Beneficiary Family Details--> </h4></div>
                <div class="col-md-4">
                       ...
                       <span class="input-req-inner"></span></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <input class="form-control" id="CImage" name="CImage"
                                       type="hidden" value=""><!--CImage-->
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body" id="modal_contact" style="min-height:100px;background-color: #F5F5F5">
                ...
                <fieldset>
                    ...
                    <input type="hidden" class="form-control" value="" id="empfamilyComID"
                           name="empfamilyComID">
    ...
    <script type="text/javascript">
        ...
        function modaluploadimages(empfamilydetailsID,Com_MasterID) {
            $('#empfamilydetailzID').val(empfamilydetailsID);
            $('#empfamilyComID').val(Com_MasterID);
