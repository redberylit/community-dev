...
<div id="div1">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <button type="button" class="btn btn-primary btn-sm CA_Alter_btn" onclick="openAddSubCom_modal()" style=""><i class="fa fa-plus-square"></i>&nbsp; <?php echo $this->lang->line('communityngo_addSubCommittee'); ?>
                <!--Add-->
            </button>
                                        ...
                                        <div class="post-area">
                                            ...
                                            <article class="page-content">
                                                ...
                                                <div class="system-settings">
                                                    <p><?php echo $this->lang->line('communityngo_CommittSetup_alert'); ?>.</p>
                                                    <!--Member assigning allows you to change system wide settings for all members-->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('communityngo_addSubCommittee'); ?>
                    <!--Add Sub Committee-->
                </h4>
            </div>
            <form class="form-horizontal" id="add-subCmt_form">
                <div class="row modal-body">
                    <div class="col-md-12">
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                            <label><?php echo $this->lang->line('communityngo_Description'); ?>
                                <!--Description--> <?php required_mark(); ?>
                            </label>
                            <input type="text" step="any" class="form-control" id="subCmtDesc" name="subCmtDesc" value="">
                        </div>
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                            <label for="areaSubCmnt"><?php echo $this->lang->line('communityngo_region'); ?>
                                <!--Area / Mahalla--> <?php required_mark(); ?>
                            </label>
                            <?php echo form_dropdown('areaSubCmnt', $com_area, '', 'class="form-control select2" id="areaSubCmnt" onchange="get_comMaserHd();" required '); ?>
                        </div>
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                            <label><?php echo $this->lang->line('communityngo_CommitteeHead'); ?>
                                <!--Committee Head--> <?php required_mark(); ?>
                            </label>
                            <select onchange="" id="subCmtHead" class="form-control select2" name="subCmtHead">
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                            <label for="hdCommtPosID"><?php echo $this->lang->line('communityngo_CommitPosition'); ?>
                                <!--Position--> <?php required_mark(); ?>
                            </label>
                            <select id="hdCommtPosID" class="form-control select2" name="hdCommtPosID">
                        ...
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                            ...
                            <div class="input-group datepic">
                                ...
                                <input onchange="$('#subCmtAddedDate').val(this.value);" type="text" name="subCmtAddedDate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="<?php echo $current_date; ?>" id="subCmtAddedDate" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                            ...
                            <div class="input-group datepic">
                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                <input onchange="$('#subCmtExrDate').val(this.value);" type="text" name="subCmtExrDate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="" id="subCmtExrDate" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm" onclick="save_subCommittee()"><?php echo $this->lang->line('common_save'); ?>
                        <!--Save-->
                    </button>
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal" onclick="closeAddCommit();"><?php echo $this->lang->line('common_Close'); ?>
                        <!--Close-->
                    </button>
                </div>
            </form>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('communityngo_editSubCommittees'); ?>
                    <!--Edit Sub Committee-->
                </h4>
            </div>
            <form class="form-horizontal" id="edit-subCmt_form">
                <div class="row modal-body">
                    <div class="col-md-12">
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                            ...
                            <input type="text" step="any" class="form-control" id="editsubCmtDesc" name="editsubCmtDesc" value="">
                        </div>
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                        ...
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                            ...
                            <select onchange="" id="editsubCmtHead" class="form-control select2" name="editsubCmtHead">
                                <option>Select Committee Head</option>
                                <option></option>
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                            ...
                            <div class="input-group datepic">
                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                <input onchange="$('#editCmtAddedDate').val(this.value);" type="text" name="editCmtAddedDate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="<?php echo $current_date; ?>" id="editCmtAddedDate" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                            <label for=""><?php echo $this->lang->line('communityngo_ExpiryDate'); ?>
                            ...
                            <div class="input-group datepic">
                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                <input onchange="$('#editCmtExrDate').val(this.value);" type="text" name="editCmtExrDate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="" id="editCmtExrDate" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group col-sm-4" style="margin-right: 3px;">
                            <label>Is Active</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm CA_Submit_btn" onclick="save_editSubCommittee()"><?php echo $this->lang->line('common_save'); ?>
                        <!--Save-->
                    </button>
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal" onclick="closeEditSubCommit();"><?php echo $this->lang->line('common_Close'); ?>
                        <!--Close-->
                    </button>
                </div>
            </form>
...
<script type="text/javascript">
    ...
    function get_comMaserHd() {
        ...
        if (areaSubCmnt == "" || areaSubCmnt == null) {} else {

            $.ajax({
                type: "POST",
                url: "CommunityNgo/get_comMaserHd",
                data: {
                    'areaSubCmnt': areaSubCmnt
                },
                success: function(data) {
    ...
    function get_editComMaserHd() {
        ...
        if (areaEditCmnt == "" || areaEditCmnt == null) {} else {
    ...
    function redirect_cmtMemPage(cmnte, CommitteeAreawiseID, CommitteeID) {
        ...
        $.ajax({
            ...
            data: {
                cmnte: cmnte,
                masterID: CommitteeAreawiseID,
                CommittID: CommitteeID
            },
