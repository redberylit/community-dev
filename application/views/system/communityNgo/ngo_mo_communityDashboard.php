                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="comGeneral_dashboardTemp">
                                ...
                                src="<?php //echo base_url("images/community/cancel-search.gif") 
                                        ?>"></a></span>
                                                    </div>-->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-xs-6">
                                                <!--<div class="white-box">
                                                        ...
                                                        <div class="bodystate">
                                                            <div class="numberStar" onclick="open_comMemberModel();" style="text-transform: uppercase;"><?php // echo $this->lang->line('comNgo_dash_members'); 
                                                                                                                                                        ?></div>
                                                        </div>
                                                    </div>-->
                                            ...
                                            <div class="col-lg-3 col-xs-6">
                                                <!--<div class="white-box">
                                                        ...
                                                        <div class="bodystate">
                                                            <div class="numberStar" onclick="open_comFamiliesModel();" style="text-transform: uppercase;"><?php //echo $this->lang->line('comNgo_dash_families'); 
                                                                                                                                                            ?></div>
                                                        </div>
                                                    </div>-->
                                                <div class="box hvr-underline-from-center">
                                            ...
                                            <div class="col-lg-3 col-xs-6">
                                                <!--<div class="white-box">
                                                        ...
                                                        <div class="bodystate">
                                                            <div class="numberStar" onclick="open_comCommitteesModel();" style="text-transform: uppercase;"><?php //echo $this->lang->line('comNgo_dash_committees'); 
                                                                                                                                                            ?></div>
                                                        </div>
                                                    </div>-->
                                                <div class="box hvr-underline-from-center">
