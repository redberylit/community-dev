    ...
    <div class="row">
        <form method="post" name="searchForm" id="searchForm" class="">
            <div class="form-group col-md-3" style="margin-left:14px;">
                <div class="box-tools">
                    <div class="has-feedback">
                        <input name="logFemKey" type="text" class="form-control input-sm" placeholder="<?php echo $this->lang->line('communityngo_searchLogFam'); ?>" id="logFemKey">
                        <!--Search Family-->
            ...
            <div class="form-group col-sm-2 hide" id="search_cancel">
                <span class="tipped-top"><a id="cancelSearch" href="#" onclick="clearSearchedFamily()"><img src="<?php echo base_url("images/crm/cancel-search.gif") ?>"></a></span>
                                        ...
                                        <div class="post-area">
                                            ...
                                            <article class="page-content">
                                                ...
                                                <div class="system-settings">
                                                    <p><?php echo $this->lang->line('communityngo_famLogConfig_alert'); ?>.</p>
                                                    <!--Family Login Configuration allows you to set the login config for the families.-->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        control_staff_access(0, 'system/communityNgo/ngo_mo_familyLoginConfig', 0);
        ...
        $('.headerclose').click(function() {
            fetchPage('system/communityNgo/ngo_mo_familyLoginConfig', '', "<?php echo $this->lang->line('communityngo_famLogin'); ?>");
        });
