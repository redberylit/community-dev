                        ...
                        <div class="col-md-12" id="occuMemTypeDiv">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <select id="memberType" class="form-control select2" onchange="get_commMemDetails();"
                                        name="memberType" data-placeholder="Select Member Type" style="height:30px;width:200px;font-size: 13px;">
                            ...
                            <div class="form-group col-sm-3" id="jobDiv" style="display:none;margin-left: 10px !important;">
                                ...
                                <select class="form-control select2" id="JobCatId" name="JobCatId"
                                        style="height:30px;width:200px;font-size: 13px;" data-placeholder="Select Job Category">
                                    <option value=""></option>
                                    <?php
                                    if (!empty($occupation)) {
                            ...
                            <div class="form-group col-sm-3" id="schlDiv" style="display:none;margin-left: 10px !important;">
                                ...
                                <select class="form-control select2" id="schlId" name="schlId"
                                        style="height:30px;width:200px;font-size: 13px;" data-placeholder="Select School">
                                    <option value=""></option>
                                    <?php
                                    if (!empty($ngoSchools)) {
                            ...
                            <div class="form-group col-sm-2" id="MediumDiv" style="display:none;margin-left: 10px !important;">
                                ...
                                <select class="form-control select2" id="MedumId" name="MedumId"
                                        style="height:30px;width:200px;font-size: 13px;" data-placeholder="Select Medium">
                                    <option value=""></option>
                                    <?php
                                    if (!empty($language)) {
                            ...
                            <div class="form-group col-sm-2" id="classDiv" style="display:none;margin-left: 10px !important;">
                                ...
                                <select class="form-control select2" id="classId" name="classId"
                                        style="height:30px;width:200px;font-size: 13px;" data-placeholder="Select Grade">
                                    <option value=""></option>
                                    <?php
                                    if (!empty($grades)) {
                        ...
                        <div class="col-md-12" id="qualMemTypeDiv">
                            ...
                            <div class="form-group col-sm-3" id="qualMemDiv">
                                ...
                                <select id="qualMemType" class="form-control select2" onchange="get_commMemQualDetails();"
                                        name="qualMemType" data-placeholder="Select Qualification" style="height:30px;font-size: 13px;">
                            ...
                            <div class="form-group col-sm-3" id="InstituteDiv" style="margin-left: 10px;">
                                ...
                                <select class="form-control select2" id="InstituteId" name="InstituteId" onchange="get_commMemQualDetails();"
                                        style="height:30px;font-size: 13px;" data-placeholder="Select Institute">
                                    <option value=""></option>
                            ...
                            <div class="form-group col-sm-3" id="qualSerchDiv" style="margin-left: 10px;">
                                ...
                                <input name="qualSerch" type="text" class="form-control input-sm" style="height:30px;width:250px;font-size: 13px;"
                                       placeholder="Search by all"
                        ...
                        <?php } ?>
                            ...
                            <div class="form-group col-sm-3" id="gsDivitnDiv">
                                ...
                                <div class="form-group col-sm-3" id="divSerchDiv" style="margin-left: 10px;">
                                    ...
                                    <input name="divitnSerch" type="text" class="form-control input-sm" style="height:30px;width:220px;font-size: 13px;"
                                           placeholder="Search by all"
                                           id="divitnSerch"><!--Search by all-->
                                </div>
                        ...
                        <div class="col-md-12" id="otrMemTypeDiv">
                            ...
                            <div class="form-group col-sm-2" id="abroadDiv" style="margin-left:20px; !important;">
                                ...
                                <select class="form-control select2" id="IsAbroad" name="IsAbroad" onchange="get_commMemOtrDetails();"
                                        style="font-size: 13px;" data-placeholder="Select Abroad">
                            ...
                            <div class="form-group col-sm-3" id="bloodDiv" style="margin-left:20px; !important;">
                                <label for="bloodGrpID" class="control-label" style="margin-right:10px !important;"><?php echo $this->lang->line('communityngo_bloodGroup'); ?><!--Blood Group--></label>
                                 <br>
                        ...
                        <div class="col-md-12" id="otrMemTypeDiv2">
                            ...
                            <div class="form-group col-sm-2" id="ageOpDiv">
                                ...
                                <select class="form-control select2" id="ageOps" name="ageOps" onchange="get_commMemOtrDetails();"
                                        style="" data-placeholder="Select Operator">
                            ...
                            <div class="form-group col-sm-2" id="placeComDiv" style="margin-left: 10px;">
                                ...
                                <input name="PlaceComDes" type="text" class="form-control input-sm" style="height:30px;width:100%;font-size: 13px;"
                                       placeholder="Search by all"
                                       id="PlaceComDes"><!--Search by all-->
                            </div>
