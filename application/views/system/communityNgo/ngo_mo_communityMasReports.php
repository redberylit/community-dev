                        ...
                        <div class="col-md-12">
                            <div class="form-group col-sm-3" style="margin-bottom: 0px">
                                <label class="col-md-4 control-label text-left"
                                       for="GS_Division"><?php echo $this->lang->line('communityngo_GS_Division'); ?></label>
                            ...
                            <div class="form-group col-sm-3" style="margin-bottom: 0px">
                                <label class="col-md-6 control-label text-left"
                                       for="RegionID"><?php echo $this->lang->line('communityngo_region'); ?></label>
                            ...
                            <div class="form-group col-sm-3" style="margin-bottom: 0px">
                                <label class="col-md-4 control-label text-left"
                                       for="FamMasterID"><?php echo $this->lang->line('comNgo_dash_families'); ?></label>
                                <div class="form-group col-md-8" id="famMasIddrp">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group col-sm-3" style="margin-bottom: 0px">
                                <label class="col-md-5 control-label text-left"
                                       for="houseOwnshp"><?php echo $this->lang->line('communityngo_famOwnType'); ?></label>
                            ...
                            <div class="form-group col-sm-3" style="margin-bottom: 0px">
                                <label class="col-md-4 control-label text-left"
                                       for="houseType"><?php echo $this->lang->line('communityngo_famHouseType'); ?></label>
                                <div class="form-group col-md-8">
                            ...
                            <div class="form-group col-sm-3" id="placeComDiv" style="margin-left: 10px;">
                                <label class="col-md-4 control-label text-left"
                                       for="familyText"><?php echo $this->lang->line('common_search'); ?></label>
                                <div class="form-group col-md-8">
                                <input name="familyText" type="text" class="form-control input-sm" style="height:30px;width:100%;font-size: 13px;"
                                       placeholder="Search by all"
                                       id="familyText"><!--Search by all-->
                                </div>
                            </div>
                            <div class="form-group col-sm-2" style="margin-bottom: 0px;">
                                <button type="button" class="btn btn-primary pull-left" onclick="generateFamilyReport()" name="filterDivisubmit" id="filterDivisubmit"><i class="fa fa-plus"></i> <?php echo $this->lang->line('common_generate'); ?>
                                </button>
                            </div>
                        </div>
                    </form>
                ...
                <fieldset class="scheduler-border">
                    ...
                    <form method="post" name="form_rpt_ngoCommittee" id="form_rpt_ngoCommittee" class="form-horizontal">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group col-sm-3" style="margin-bottom: 0px">
                                <label class="col-md-6 control-label text-left"
                                       for="employeeID"><?php echo $this->lang->line('communityngo_region'); ?></label>
                            ...
                            <div class="form-group col-sm-3" style="margin-bottom: 0px">
                                <label class="col-md-4 control-label text-left"
                                       for="employeeID"><?php echo $this->lang->line('communityngo_CommitteesHead'); ?></label>
                            ...
                            <div class="form-group col-sm-2" id="placeComDiv" style="margin-left: 10px;">
                                <label class="col-md-4 control-label text-left"
                                       for="committeeText"><?php echo $this->lang->line('common_search'); ?></label>
                                <div class="form-group col-md-8">
                                    <input name="committeeText" type="text" class="form-control input-sm" style="font-size: 13px;width: 200px;"
                                           placeholder="Search by all"
                                           id="committeeText"><!--Search by all-->
                                </div>
                            </div>
