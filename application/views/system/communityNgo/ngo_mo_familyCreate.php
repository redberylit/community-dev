    ...
    <span class="input-req-inner"></span></span>
                ...
                <div id="viewDivCls4" class="row" style="margin-top: 10px;display: none;">
                    ...
                    <div class="form-group col-sm-2">
                       <span class="input-req" title="Required Field">
                        <select id="ownershipAutoID" class="form-control select2"
                                name="ownershipAutoID" onchange="checkHome_isRent()">
                            <option data-currency=""
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <select id="rentHouseOwnerId" class="form-control select2"
                                name="rentHouseOwnerId">
                            <option data-currency=""
                                    value=""><?php echo $this->lang->line('communityngo_selFamHouseExist'); ?><!--Select Existing Family --></option>
                            <?php
                            if (!empty($house_ex)) {
                    ...
                    <div class="col-sm-8" style="margin-bottom: 0px;margin-top:10px;">
                        <table class="<?php echo table_class(); ?>" id="facilityColumns">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <select id="drinkSourceId" class="form-control select2 hideDrinkState"
                                            name="drinkSourceId">
                                        <option data-currency=""
                                                value=""><?php echo $this->lang->line('communityngo_selWaterSource'); ?></option>
                                        <?php
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle"><?php echo $this->lang->line('communityngo_waterSource'); ?></td>
                                <td colspan="3">
                                    <select id="agriculSourceId" class="form-control select2 hideAgriculState"
                                            name="agriculSourceId">
                                        <option data-currency=""
                                                value=""><?php echo $this->lang->line('communityngo_selWaterSource'); ?></option>
                                        <?php
                                        if (!empty($water_source)) {
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <select id="SanitationStateID" class="form-control select2 hideToiletState"
                                            name="SanitationStateID">
                                        <option data-currency=""
                                                value=""><?php echo $this->lang->line('CommunityNgo_status'); ?></option>
                                        <?php
                ...
                <fieldset id="viewDivCls6" class="scheduler-border" style="margin-top: 10px;display: none;">
                    <legend class="scheduler-border"><?php echo $this->lang->line('communityngo_affected_by_disaster');?><!--Affected By Disaster--></legend>
                    <div class="col-sm-8" style="margin-bottom: 0px;margin-top:10px;">
                        <table class="<?php echo table_class(); ?>" id="disasterColumns">
                            <tr>
                                ...
                                <td style="width: 30%;">
                                    <select id="DisasterTypeID" class="form-control select2 hideAffByDisaster"
                                            name="DisasterTypeID">
                                        <option data-currency=""
                                                value=""><?php echo $this->lang->line('common_type'); ?></option>
                                        <?php
                                ...
                                <td>
                                    <select id="DisasterYear" class="form-control select2 hideAffByDisaster"
                                            name="DisasterYear">
                                        <option data-currency=""
                                                value=""><?php echo $this->lang->line('common_year'); ?></option>
                                        <?php
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-condensed no-color" id="income_edit_table">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line('communityngo_com_member_father'); ?><!--Member Father--></th>
                            <th><?php echo $this->lang->line('communityngo_com_member_mother'); ?><!--Member Mother--></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="edit2_cfComMasID" class="form-control select2"
                                         name="cfComMasID">
                                    <option data-currency=""
                                            value=""><?php echo $this->lang->line('communityngo_select_member'); ?></option>
                                    <?php
                                    $ComMale_drop = fetch_maleMember_drop();
                            ...
                            <td>
                                <select id="edit2_cmComMasID" class="form-control select2"
                                        name="cmComMasID">
                                    <option data-currency=""
                                            value=""><?php echo $this->lang->line('communityngo_select_member'); ?></option>
                                    <?php
                                    $ComFemale_drop = fetch_femaleMember_drop();
