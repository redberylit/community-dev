...
$water_source = fetch_water_supply_master();
...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab">
        ...
        <!--Step 1 -->-
        <?php echo $this->lang->line('CommunityNgo_ngo_family_header'); ?>
        <!--NGO Family Header--></a>
    <a class="btn btn-default btn-wizard" href="#step2" onclick="load_ngoHouseHeader();" data-toggle="tab">
        ...
        <!--Step 2--> -
        <?php echo $this->lang->line('CommunityNgo_family_house_details'); ?>
        <!--Family House Details--></a>
    <a class="btn btn-default btn-wizard" href="#step3" onclick="load_confirmation();" data-toggle="tab">
        ...
        <!--Step 3--> -
        <?php echo $this->lang->line('CommunityNgo_family_Master_cofirmation'); ?>
        <!--Family Master Confirmation--></a>
</div>
<hr>
    ...
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                <header class="head-title">
                    <h2>
                        <?php echo $this->lang->line('CommunityNgo_family_header'); ?>
                        <!--NGO Family Master-->
                    </h2>
                </header>
                <div class="row" style="margin-top: 10px;">
                    <div class="form-group col-sm-2">
                        <label class="title">
                            <?php echo $this->lang->line('CommunityNgo_famAddedDate'); ?>
                            <!--Family Added Date--></label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                            <div class="input-group datepic">
                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                <input onchange="$('#FamilyAddedDate').val(this.value);" type="text" name="FamilyAddedDate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="<?php echo $current_date; ?>" id="FamilyAddedDate" class="form-control" required>
                            </div>
                    ...
                    <div class="form-group col-sm-2">
                        <label class="title">
                            <?php echo $this->lang->line('CommunityNgo_ref_no'); ?>
                            <!--Reference No--><label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-2">
                        <label class="title"><?php echo $this->lang->line('CommunityNgo_leader'); ?>
                            <!--Leader--></label>
                    </div>
                    <div class="form-group col-sm-4">

                        <span class="input-req" title="Required Field">
                            <select onchange="get_comMaserDel();" id="LeaderID" class="form-control select2" name="LeaderID">
                                <option data-currency="" value=""><?php echo $this->lang->line('CommunityNgo_select_family'); ?>
                                    <!--Select leader-->
                                </option>
                                <?php
                    ...
                    <div class="form-group col-sm-2">
                        <label class="title">
                            <?php echo $this->lang->line('CommunityNgo_familyName'); ?>
                            <!--Family Name--></label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                            <select onchange="" id="FamHgender" class="form-control select2" name="FamHgender" disabled>
                                <option><?php echo $this->lang->line('CommunityNgo_fam_SelGender'); ?>
                                    <!--Select Gender-->
                                </option>
                                <option></option>
                    ...
                    <div class="form-group col-sm-4">
                        <select onchange="" id="FamHaddress" class="form-control select2" name="FamHaddress" disabled>
                            <option data-currency="" value=""><?php echo $this->lang->line('CommunityNgo_fam_SelAddress'); ?>
                                <!--Select Address-->
                            </option>
                            <option></option>
                        </select>
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                            <select onchange="" id="FamArea" class="form-control select2" name="FamArea" disabled>
                    ...
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                            <select onchange="" id="FamHouseNo" class="form-control select2" name="FamHouseNo" disabled>
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="form-group col-sm-2">
                        <label class="title">
                            <?php echo $this->lang->line('CommunityNgo_fam_ancestryState'); ?>
                            <!--Ancestory Status--><label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                            <select onchange="get_AncesCategory();" id="FamAncestory" class="form-control select2" name="FamAncestory">
                                <option><?php echo $this->lang->line('CommunityNgo_fam_SelAncestryState'); ?>
                                    <!--Select Ancestory Status-->
                                </option>
                    ...
                    <div class="form-group col-sm-2" id="AncesDesDiv" style="display:none;">
                        <label class="title">
                            <?php echo $this->lang->line('CommunityNgo_fam_ancestry'); ?>
                            <!--Ancestory--><label>
                    </div>
                    <div class="form-group col-sm-4" id="AncesSelDiv" style="display:none;">
                        <span class="input-req" title="Required Field">
                            <select onchange="" id="AncestryCatID" class="form-control select2" name="AncestryCatID">
                                <option data-currency="" value=""><?php echo $this->lang->line('CommunityNgo_fam_SelAncestry'); ?>
                                    <!--Select Ancestry-->
                                </option>
                                <?php
        ...
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                <header class="head-title">
                    <h2>
                        <?php echo $this->lang->line('CommunityNgo_fam_ecoStatus'); ?>
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="form-group col-sm-2">
                        <label class="title">
                            <?php echo $this->lang->line('CommunityNgo_fam_econState'); ?>
                            <!--Economic Status --><label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                            <select id="ComEconSteID" class="form-control select2" name="ComEconSteID">
                                <option value=""><?php echo $this->lang->line('CommunityNgo_fam_selEconState'); ?>
                                    <!--Select Economic Status-->
                                </option>
                                <?php
                    ...
                    <div class="form-group col-sm-2">
                        <label class="title">
                            <?php echo $this->lang->line('CommunityNgo_fam_expenses'); ?>
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="form-group col-sm-2">
                        <label class="title">
                            <?php echo $this->lang->line('CommunityNgo_famHelpNeed'); ?>
                            <!--Any Urgent Help Need--><label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                            <select onchange="get_econStatus();" id="femHelpNeedId" class="form-control select2" name="femHelpNeedId">
                                <option value=""><?php echo $this->lang->line('CommunityNgo_famSelHelpNeed'); ?>
                                    <!--Select Help Need Status-->
                                </option>
                    ...
                    <div class="form-group col-sm-2" id="fmHelpDNeed" style="display:none;">
                        <label class="title">
                            <?php echo $this->lang->line('CommunityNgo_fam_neededHelp'); ?>
                            <!--Needed Help Details--><label>
                    </div>
        ...
        <div class="row addTableView">
            <div class="col-md-12 animated zoomIn">
                <header class="head-title">
                    <h2><?php echo $this->lang->line('CommunityNgo_famMem_del'); ?>
                        <!--Fam Mem DETAILS-->
                    </h2>
                </header>
                <div class="row">
                    <div class="col-sm-12">
                        <button type="button" class="btn btn-primary pull-right" onclick="gt_femMemAdding_modal()">
                            <i class="fa fa-plus"></i>
                            <?php echo $this->lang->line('CommunityNgo_add_members'); ?>
                            <!--Add Members-->
                        </button>
                    </div>
                </div>
    ...
    <div id="step2" class="tab-pane">
        ...
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                <header class="head-title">
                    <h2>
                        <?php echo $this->lang->line('CommunityNgo_family_house'); ?>
                        <!--Family House Master-->
                    </h2>
                </header>
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="form-group col-sm-2">
                        ...
                        <label class="title">
                            <?php echo $this->lang->line('communityngo_famHouseCount'); ?>
                            <!--House Count--><label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                            <select id="FamHouseCn" class="form-control select2" name="FamHouseCn" onchange="checkHome_state()">
                                <option><?php echo $this->lang->line('CommunityNgo_status'); ?>
                                    <!--Select Status-->
                                </option>
                                <option value="1">Yes</option>
                                <option value="0">No</option>
                ...
                <div id="viewDivCls1" class="row" style="margin-top: 10px;display: none;">
                    <div class="form-group col-sm-2">
                        ...
                        <label class="title">
                            <?php echo $this->lang->line('communityngo_famExistHouse'); ?>
                            <!--House Count--><label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                    ...
                    <div class="form-group col-sm-2" id="houseExitHd" style="display:none;">
                        <label class="title">
                            <?php echo $this->lang->line('communityngo_famHouseExisting'); ?>
                            <!--Existing Family--><label>
                    </div>
                    <div class="form-group col-sm-4" id="houseExitDiv" style="display: none;">
                        <span class="input-req" title="Required Field">
                            <select id="housesExitId" class="form-control select2" name="housesExitId" onchange="getDel_inExist();">
                                <option data-currency="" value=""><?php echo $this->lang->line('communityngo_selFamHouseExist'); ?>
                ...
                <div id="viewDivCls2" class="row" style="margin-top: 10px;display: none;">
                    <div class="form-group col-sm-2">
                        <label class="title">
                            <?php echo $this->lang->line('communityngo_JammiyaDivision'); ?>
                            <!--Jammiyah Division--><label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                            <select onchange="" id="hEjammiyahDivisionID" class="form-control select2" name="hEjammiyahDivisionID" disabled>
                    ...
                    <div class="form-group col-sm-2">
                        <span class="input-req" title="Required Field">
                            <select onchange="" id="hEGS_Division" class="form-control select2" name="hEGS_Division" disabled>
                    ...
                    <div class="form-group col-sm-2">
                        <span class="input-req" title="Required Field">
                            <select onchange="" id="hEGS_No" class="form-control select2" name="hEGS_No" disabled>
                                <option>GS No</option>
                                <option></option>
                ...
                <div id="viewDivCls3" class="row" style="margin-top: 10px;display: none;">
                    ...
                    <div class="form-group col-sm-2">
                        <span class="input-req" title="Required Field">
                            <select onchange="" id="hERegionID" class="form-control select2" name="hERegionID" disabled>
                    ...
                    <div class="form-group col-sm-2">
                        <span class="input-req" title="Required Field">
                            <select onchange="" id="hEHouseNo" class="form-control select2" name="hEHouseNo" disabled>
                    ...
                    <div class="form-group col-sm-4">
                        <select onchange="" id="hEC_Address" class="form-control select2" name="hEC_Address" disabled>
                            <option data-currency="" value=""><?php echo $this->lang->line('CommunityNgo_fam_SelAddress'); ?>
                                <!--Select Address-->
                            </option>
                            <option></option>
                ...
                <div id="viewDivCls4" class="row" style="margin-top: 10px;display: none;">
                    ...
                    <div class="form-group col-sm-2">
                        <span class="input-req" title="Required Field">
                            <select id="ownershipAutoID" class="form-control select2" name="ownershipAutoID" onchange="checkHome_isRent()">
                                <option data-currency="" value=""><?php echo $this->lang->line('communityngo_selfamOwnType'); ?></option>
                                <?php
                    ...
                    <div class="form-group col-sm-2">
                        <span class="input-req" title="Required Field" id="rentHouseOwnerDiv" style="display: none;">
                            <select id="rentHouseOwnerId" class="form-control select2" name="rentHouseOwnerId">
                                <option data-currency="" value=""><?php echo $this->lang->line('communityngo_selFamHouseExist'); ?>
                                    <!--Select Existing Family -->
                                </option>
                                <?php
                    ...
                    <div class="form-group col-sm-2">
                        <label class="title">
                            <?php echo $this->lang->line('communityngo_famHouseType'); ?>
                            <!--House Type--><label>
                    </div>
                    <div class="form-group col-sm-2">
                        <select id="hTypeAutoID" class="form-control select2" name="hTypeAutoID">
                            <option data-currency="" value=""><?php echo $this->lang->line('communityngo_selfamHouseType'); ?>
                                <!--Select House Type -->
                            </option>
                            <?php
                ...
                <fieldset id="viewDivCls5" class="scheduler-border" style="margin-top: 10px;display: none;">
                    <legend class="scheduler-border"><?php echo $this->lang->line('communityngo_famHouseFacilities'); ?>
                        <!--Home Facilities-->
                    </legend>
                    <div class="col-sm-8" style="margin-bottom: 0px;margin-top:10px;">
                        <table class="<?php echo table_class(); ?>" id="facilityColumns">
                            <tr>
                                <td style="vertical-align: middle;width: 30%;">Electricity</td>
                                <td style="width: 20%;">
                                ...
                                <td style="vertical-align: middle;width: 20%;">Telephone</td>
                            ...
                            <tr>
                                <td style="vertical-align: middle">Water Supply (For Drinking)</td>
                                <td>
                                ...
                                <td style="vertical-align: middle"><?php echo $this->lang->line('communityngo_waterSource'); ?></td>
                                <td colspan="3">
                                    <select id="drinkSourceId" class="form-control select2 hideDrinkState" name="drinkSourceId">
                                        <option data-currency="" value=""><?php echo $this->lang->line('communityngo_selWaterSource'); ?></option>
                                        <?php
                                        if (!empty($water_source)) {
                                            foreach ($water_source as $val) {
                                        ?>
                                                <option value="<?php echo $val['SourceOfWaterID'] ?>"><?php echo $val['SOWDescription'] ?></option>
                                        <?php
                            ...
                            <tr>
                                <td style="vertical-align: middle">Water Supply (For Agriculture)</td>
                                <td>

                                    <input type="checkbox" id="isAgriWaterSup1" name="isAgriWaterSup1" onchange="isAgriWaterSupChk();">

                                    <input class="form-control" type="number" name="isAgriWaterSup" id="isAgriWaterSup" value="0" style="display: none ;">

                                </td>
                                <td style="vertical-align: middle"><?php echo $this->lang->line('communityngo_waterSource'); ?></td>
                                <td colspan="3">
                                    <select id="agriculSourceId" class="form-control select2 hideAgriculState" name="agriculSourceId">
                                        <option data-currency="" value=""><?php echo $this->lang->line('communityngo_selWaterSource'); ?></option>
                                        <?php
                                        if (!empty($water_source)) {
                                            foreach ($water_source as $val) {
                            ...
                            <tr>
                                <td style="vertical-align: middle">Sanitation (Toilet)</td>
                                <td>
                                ...
                                <td colspan="3">
                                    <select id="SanitationStateID" class="form-control select2 hideToiletState" name="SanitationStateID">
                                        <option data-currency="" value=""><?php echo $this->lang->line('CommunityNgo_status'); ?></option>
                                        <?php
                                        $sanitation_state = fetch_sanitation_status_master();
                                        if (!empty($sanitation_state)) {
                                            foreach ($sanitation_state as $val) {
                                        ?>
                                                <option value="<?php echo $val['SanitationStateID'] ?>"><?php echo $val['SstatusDescription'] ?></option>
                                        <?php
                    ...
                    <div class="col-sm-4" style="margin-bottom: 0px;margin-top:10px">
                        <?php echo $this->lang->line('communityngo_famCheckFacility'); ?>
                        <!--Un-check the facility, If It doesn't exist.-->
                    </div>
                </fieldset>
                <fieldset id="viewDivCls6" class="scheduler-border" style="margin-top: 10px;display: none;">
                    <legend class="scheduler-border"><?php echo $this->lang->line('communityngo_affected_by_disaster'); ?>
                        <!--Affected By Disaster-->
                    </legend>
                    <div class="col-sm-8" style="margin-bottom: 0px;margin-top:10px;">
                        <table class="<?php echo table_class(); ?>" id="disasterColumns">
                            <tr>
                                <td style="vertical-align: middle;width: 30%;"><?php echo $this->lang->line('communityngo_affected_by_disaster'); ?></td>
                                <td style="width: 20%;">
                                    <input type="checkbox" id="isAffByDisaster1" name="isAffByDisaster1" onchange="isAffByDisasterChk();">

                                    <input class="form-control" type="number" name="isAffByDisaster" id="isAffByDisaster" value="0" style="display: none ;">
                                </td>
                                <td style="vertical-align: middle;width: 20%;"><?php echo $this->lang->line('communityngo_disaster_type'); ?></td>
                                <td style="width: 30%;">
                                    <select id="DisasterTypeID" class="form-control select2 hideAffByDisaster" name="DisasterTypeID">
                                        <option data-currency="" value=""><?php echo $this->lang->line('common_type'); ?></option>
                                        <?php
                                        $disaster_type = fetch_disaster_type_master();
                                        if (!empty($disaster_type)) {
                                            foreach ($disaster_type as $val) {
                                        ?>
                                                <option value="<?php echo $val['DisasterTypeID'] ?>"><?php echo $val['DisasterDescription'] ?></option>
                                        <?php
                                ...
                                <td style="vertical-align: middle"><?php echo $this->lang->line('common_year'); ?></td>
                                <td>
                                    <select id="DisasterYear" class="form-control select2 hideAffByDisaster" name="DisasterYear">
                                        <option data-currency="" value=""><?php echo $this->lang->line('common_year'); ?></option>
                                        <?php
                                        for ($yr = 1950; $yr <= date('Y'); $yr++) {
                                        ?>
                    ...
                    <div class="col-sm-4" style="margin-bottom: 0px;margin-top:10px">
                        <table>
                            <tr>
                                <td style="vertical-align: middle"><?php echo $this->lang->line('common_remarks'); ?></td>

                                <td>
                                    <textarea class="form-control hideAffByDisaster" rows="3" name="DisasterRemarks" id="DisasterRemarks"></textarea>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?php echo $this->lang->line('communityngo_add_new_member'); ?>
                    <!--Add New Member-->
                </h5>
            </div>
            ...
            <form role="form" id="comMem_detail_form" class="form-horizontal">
                <div class="modal-body">
                    <table class="table table-bordered table-condensed no-color" id="comMem_add_table">
                        <thead>
                            <tr>
                                <th><?php echo $this->lang->line('communityngo_title'); ?>
                                    <!--Title--> <?php required_mark(); ?></th>
                                <th><?php echo $this->lang->line('communityngo_name_with_initial'); ?>
                                    <!--Name with Initial--> <?php required_mark(); ?></th>
                                <th><?php echo $this->lang->line('communityngo_name'); ?>
                                    <!--Full Name--> <?php required_mark(); ?></th>
                                <th><?php echo $this->lang->line('communityngo_gender'); ?>
                                    <!--Gender-->
                                </th>
                                <th><?php echo $this->lang->line('communityngo_dob'); ?>
                                    <!--Date of Birth-->
                                </th>
                                <th><?php echo $this->lang->line('communityngo_relationship'); ?>
                                    <!--Relationship-->
                                </th>

                                <th style="width: 40px;">
                                    <button type="button" class="btn btn-primary btn-xs" onclick="add_more_communityMem()"><i class="fa fa-plus"></i></button>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="nameWithIni[]" placeholder="Name With Initial" class="form-control " required>
                                </td>
                                <td>
                                    <input type="text" name="nameWithFull[]" placeholder="Full Name" class="form-control " required>
                                </td>
                                <td> <?php echo form_dropdown(
                                            'genderID[]',
                                            fetch_com_gender(),
                                ...
                                <td>
                                    <div class="input-group datepic">
                                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        <input type="text" name="newMemDOB[]" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" class="form-control" required>
                                    </div>
                                </td>
                                <td>
...
<div aria-hidden="true" role="dialog" id="femMemAdding_modal" class="modal fade" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="color-line"></div>
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="clsRel" onclick="dis_clsModal();"><span aria-hidden="true">&times;</span></button>
                <h5 class="modal-title"><?php echo $this->lang->line('CommunityNgo_add_member'); ?>
                    <!--Add Family Member-->
                </h5>
            </div>
            <form role="form" id="femMemAdding_form" class="form-horizontal">
                <div class="modal-body">
                    <div id="PD_modalMainFm" style="display: block;">
                        <button type="button" class="btn btn-success pull-right" onclick="comMem_detail_modal()">
                            <i class="fa fa-plus"></i>
                            <?php echo $this->lang->line('communityngo_add_new'); ?>
                            <!--New Members-->
                        </button>

                        <div class="form-group col-sm-3">
                            <label class="title">
                                <?php echo $this->lang->line('CommunityNgo_famMem_AddedDate'); ?>
                                <!--Member Added Date--><label>
                        </div>
                        <div class="form-group col-sm-4 input-group datepic">
                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                            <input type="text" name="FamMemAddedDate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="" class="form-control">
                        </div>

                        <div class="col-sm-12" style="margin-top:15px;margin-bottom:10px;">
                            <div class="col-sm-5">
                                <select name="Com_MasterIDFrom[]" id="search" class="form-control" style="font-size: 13px;" size="8" multiple="multiple">
                                    <?php
                            ...
                            <div class="col-sm-5">
                                <select name="Com_MasterID[]" id="search_to" class="form-control" style="font-size: 13px;" size="8" multiple="multiple">
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <tr>
                            <td style="padding:2px;">
                                ...
                                <button class="btn btn-danger comRltn3" type="button" style="display: none" id="PD_ModalBack2Btn" onclick="display_backHm()"><i class="fa fa-reply"></i>
                                    <?php echo $this->lang->line('communityngo_back'); ?>
                                    <!--Back--> </button>
...
<div aria-hidden="true" role="dialog" id="edit_femilyMem_model" class="modal fade" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="color-line"></div>
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><?php echo $this->lang->line('CommunityNgo_edit_famMember'); ?>
                    <!--Edit Member-->
                </h4>
            </div>
            <form role="form" id="edit_rv_income_detail_form" class="form-horizontal">
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-condensed no-color" id="income_edit_table">
                        <thead>
                            <tr>
                                <th><?php echo $this->lang->line('communityngo_name_of_member'); ?>
                                    <!--Family Member--> <?php required_mark(); ?></th>
                                <th><?php echo $this->lang->line('communityngo_relationship'); ?>
                                    <!--Relationship-->
                                </th>

                                <th><?php echo $this->lang->line('CommunityNgo_famMem_AddedDate'); ?>
                                    <!--Member Added Date-->
                                </th>
                                <th><?php echo $this->lang->line('communityngo_com_member_father'); ?>
                                    <!--Member Father-->
                                </th>
                                <th><?php echo $this->lang->line('communityngo_com_member_mother'); ?>
                                    <!--Member Mother-->
                                </th>
                                <th><?php echo $this->lang->line('CommunityNgo_famMem_isDef'); ?>
                                    <!--Is Default-->
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-default" type="button" id="add-Relatn" style="height: 27px; padding: 2px 10px;display: none;"><i class="fa fa-plus" style="font-size: 11px"></i></button>
                                        </span>
                                ...
                                <td style="">
                                    <div class="input-group datepic">
                                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        <input type="text" name="FamMemAddedDate" id="edit2_FamMemAddedDate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="" class="form-control">
                                    </div>
                                </td>
                                <td>
                                    <select id="edit2_cfComMasID" class="form-control select2" name="cfComMasID">
                                        <option data-currency="" value=""><?php echo $this->lang->line('communityngo_select_member'); ?></option>
                                        <?php
                                        $ComMale_drop = fetch_parentMale_drop();
                                        if (!empty($ComMale_drop)) {
                                            foreach ($ComMale_drop as $val) {
                                        ?>
                                ...
                                <td>
                                    <select id="edit2_cmComMasID" class="form-control select2" name="cmComMasID">
                                        <option data-currency="" value=""><?php echo $this->lang->line('communityngo_select_member'); ?></option>
                                        <?php
                                        $ComFemale_drop = fetch_parentFemale_drop();
                                        if (!empty($ComFemale_drop)) {
                                            foreach ($ComFemale_drop as $val) {
                                        ?>
                                                <option value="<?php echo $val['Com_MasterID'] ?>"><?php echo $val['CName_with_initials'] . ' | ' . trim($val['CNIC_No']) ?></option>
                                        <?php
                                            }
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <div class="form-group" style="margin-bottom: 0px;">
                                        <input class="form-control" type="number" name="isMoveId" id="moveSt2" value="0" style="display: none ;">
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" type="button" onclick="updateDirectRvDetails()">
                        <?php echo $this->lang->line('common_update_changes'); ?>
                        <!--Update changes-->
                    </button>
                </div>
            </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('communityngo_relationship'); ?> </h4>
                <!--New Relationship Title-->
            </div>
            <div role="form" id="" class="form-horizontal" autocomplete="off">
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group">
                            <label class="col-sm-4 control-label"><?php echo $this->lang->line('common_title'); ?> </label>
                            <!--Title-->

                            <div class="col-sm-6">
                                <span class="input-req" title="Required Field">
                                    <input type="text" class="form-control" id="add-mem-Relatn" name="add-mem-Relatn" required><span class="input-req-inner"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm" id="Relatn-btn"><?php echo $this->lang->line('common_save'); ?> </button>
                    <!--Save-->
...
<script>
        ...
        $('#dispatchNote_header_form').bootstrapValidator({
            ...
            fields: {
                FamilyAddedDate: {
                    validators: {
                        notEmpty: {
                            message: '<?php echo $this->lang->line('CommunityNgo_famAddeddate_is_required'); ?>.'
                        }
                    }
                },
                /*Family Added Date is required*/
                LeaderID: {
                    validators: {
                        notEmpty: {
                            message: '<?php echo $this->lang->line('CommunityNgo_leader_is_required'); ?>.'
                        }
                    }
                },
                ...
                FamAncestory: {
                    validators: {
                        notEmpty: {
                            message: '<?php echo $this->lang->line('CommunityNgo_AncestryState_required'); ?>.'
                        }
                    }
                } /*Ancestry State is required*/
            },
        ...
        $('#dispatchFam_house_form').bootstrapValidator({
            ...
            fields: {
                FamHouseCn: {
                    validators: {
                        notEmpty: {
                            message: 'Enroll To House Count status is required.'
                        }
                    }
                },
                /*Enroll To House Count is required*/
                FamHouseSt: {
                    validators: {
                        notEmpty: {
                            message: 'Enroll To Existing House Count status is required.'
                        }
                    }
                }
            },
    ...
    function chkDuplicate() {
        ...
        if (ledger_num == "" || ledger_num == null) {} else {
            $.ajax({
                async: true,
    ...
    function get_comMaserDel() {
        ...
        if (LeaderID == "" || LeaderID == null) {} else {
    ...
    function checkHome_state() {
        ...
        if (FamHouseCn == '1') {
            ...
            document.getElementById('viewDivCls6').style.display = "block";
        } else {
            ...
            document.getElementById('viewDivCls6').style.display = "none";
        ...
        $.ajax({
            ...
            data: {
                'FamHouseSt': FamHouseSt,
                'housesExitId': housesExitId,
                'LeaderID': LeaderID
            },
            success: function(data) {
    ...
    function checkHome_isRent() {
        var ownershipAutoID = document.getElementById('ownershipAutoID').value;
        var FamHouseSt = document.getElementById('FamHouseSt').value;
        var housesExitId = document.getElementById('housesExitId').value;

        $('#rentHouseOwnerId').val('').change();

        if (ownershipAutoID == '1' || ownershipAutoID == '') {
            document.getElementById('rentHouseOwnerDiv').style.display = "none";
        } else {

            document.getElementById('rentHouseOwnerDiv').style.display = "block";

            if (FamHouseSt == '1') {
                $("#rentHouseOwnerId").val(housesExitId).change();
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (!jQuery.isEmptyObject(data)) {
                        ...
                        $("#rentHouseOwnerId").val(data['rentHouseOwnerId']).change();

                        $('#hTypeAutoID').val(data['hTypeAutoID']).change();
                        $('#drinkSourceId').val(data['drinkSourceId']).change();
                        $('#agriculSourceId').val(data['agriculSourceId']).change();
                        $('#SanitationStateID').val(data['SanitationStateID']).change();
                        $('#DisasterTypeID').val(data['DisasterTypeID']).change();
                        $('#DisasterYear').val(data['DisasterYear']).change();
                        $('#DisasterRemarks').val(data['DisasterRemarks']).change();
                        ...
                        if (data['isHmWaterSup'] == 1) {
                            ...
                            $('.hideDrinkState').prop('disabled', false);
                        } else {
                            document.getElementById('isHmWaterSup1').checked = false;
                            document.getElementById('isHmWaterSup').value = 0;
                            $('.hideDrinkState').prop('disabled', true);
                        }
                        if (data['isAgriWaterSup'] == 1) {
                            document.getElementById('isAgriWaterSup1').checked = true;
                            document.getElementById('isAgriWaterSup').value = 1;
                            $('.hideAgriculState').prop('disabled', false);
                        } else {
                            document.getElementById('isAgriWaterSup1').checked = false;
                            document.getElementById('isAgriWaterSup').value = 0;
                            $('.hideAgriculState').prop('disabled', true);
                        }
                        if (data['isHmToilet'] == 1) {
                            document.getElementById('isHmToilet1').checked = true;
                            document.getElementById('isHmToilet').value = 1;
                            $('.hideToiletState').prop('disabled', false);
                        } else {
                            document.getElementById('isHmToilet1').checked = false;
                            document.getElementById('isHmToilet').value = 0;
                            $('.hideToiletState').prop('disabled', true);
                        }
                        ...
                        if (data['isAffByDisaster'] == 1) {
                            document.getElementById('isAffByDisaster1').checked = true;
                            document.getElementById('isAffByDisaster').value = 1;
                            $('.hideAffByDisaster').prop('disabled', false);
                        } else {
                            document.getElementById('isAffByDisaster1').checked = false;
                            document.getElementById('isAffByDisaster').value = 0;
                            $('.hideAffByDisaster').prop('disabled', true);
                        }
    ...
    function isAgriWaterSupChk() {

        var f = document.getElementById('isAgriWaterSup1').checked;
    ...
    function isAffByDisasterChk() {
        var f = document.getElementById('isAffByDisaster1').checked;
                ...
                function() {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#edit2_cfComMasID').val(data['cfComMasID']).change();
                            $('#edit2_cmComMasID').val(data['cmComMasID']).change();
    ...
    function saveCommunityMem() {
        ...
        data.push({
            'name': 'FamilyAddedDate',
            'value': FamilyAddedDate
        });
    ...
    function confirmation() {
        if (FamMasterID) {
            swal({
                    title: "<?php echo $this->lang->line('common_are_you_sure'); ?>",
                    /*Are you sure?*/
                    text: "<?php echo $this->lang->line('CommunityNgo_you_want_to_confirm_this_sub'); ?>",
