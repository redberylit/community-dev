                    ...
                    <table>
                        <tr>
                            <td colspan="3">
                                ...
                                <h4><?php echo $this->lang->line('CommunityNgo_com_family'); ?>
                                    <!--Community Family--> - <?php echo $extra['master']['FamilyName']; ?></h4>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table>
                        <tr style="text-align: center;">
                            <td colspan="3">
                                ...
                                if ($extra['master']['CImage'] != '') { ?>
                                    <img src="<?php echo $communityimage; ?>" id="changeImg" style="width: 180px; height: 145px;">
                                <?php
                                } else { ?>
                                    <img src="<?php echo $communityimage; ?>" id="changeImg" style="width:180px; height: 145px;">
                                <?php } ?>
...
<h6 style="font-weight: bold"><?php echo $this->lang->line('CommunityNgo_family_members'); ?>
    ...
    <table id="add_new_grv_table" class="<?php echo table_class(); ?>">
        <thead>
            <tr>
                ...
                <th class='theadtr' style="width: 21%"><?php echo $this->lang->line('communityngo_name_of_member'); ?>
                    <!--Family Member-->
                </th>
                <th class='theadtr' style="width: 15%"><?php echo $this->lang->line('communityngo_gender'); ?>
                    <!--Gender-->
                </th>
                <th class='theadtr' style="width: 13%"><?php echo $this->lang->line('communityngo_dob'); ?>
                    <!--DOB-->
                </th>
                <th class='theadtr' style="width: 15%"><?php echo $this->lang->line('communityngo_relationship'); ?>
                    <!--Relationship-->
                </th>
                <th class='theadtr' style="width: 13%"><?php echo $this->lang->line('CommunityNgo_famMem_AddedDate'); ?>
                    <!--Member Added Date-->
                </th>
                <th class='theadtr' style="width: 18%"><?php echo $this->lang->line('communityngo_status'); ?>
                    <!--Current Status-->
                </th>
        ...
        <tbody id="grv_table_body">
            ...
            if (!empty($extra['family_mem'])) {
                for ($i = 0; $i < count($extra['family_mem']); $i++) {
                    if ($extra['family_mem'][$i]['isMove'] == 1) {
                    ...
                    if ($extra['family_mem'][$i]['isActive'] == 1) {
                        $activeState = '';
                    } else {
                        if ($extra['family_mem'][$i]['DeactivatedFor'] == 2) {
                            $INactReson = 'Migrate';
                        } else {
                            $INactReson = 'Death';
                        }
                    ...
                    if ($extra['family_mem'][$i]['isLeader'] == '1') {
...
<div class="table-responsive">
    <?php if ($extra['master']['confirmedYN']) { ?>
        <table style="width: 500px !important;">
            <tbody>
                <tr>
                    <td><b><?php echo $this->lang->line('CommunityNgo_electronically_confirmed_by'); ?>
                            <!--Electronically Confirmed By--> </b></td>
                    <td><strong>:</strong></td>
                    <td><?php echo $extra['master']['confirmedByName']; ?></td>
                </tr>
                <tr>
                    <td><b><?php echo $this->lang->line('CommunityNgo_electronically_confirmed_date'); ?>
                            <!--Electronically Confirmed Date--> </b></td>
                    <td><strong>:</strong></td>
