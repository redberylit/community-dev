...
<style>
    ...
    .with-nav-tabs.panel-success .mainpanel>li.active>a,
    .with-nav-tabs.panel-success .mainpanel>li.active>a:hover,
    .with-nav-tabs.panel-success .mainpanel>li.active>a:focus {
        color: #000000;
                ...
                <div class="panel with-nav-tabs panel-success" style="border: none;">
                    <div class="panel-heading">
                        <ul class="nav nav-tabs mainpanel">
                            <li class="active">
                                <a onclick="community_generalDash()" id="" data-id="0" href="#comGeneral_dashboardTemp" data-toggle="tab" aria-expanded="true"><span><i class="lni lni-world" aria-hidden="true" style="color: #50749f;font-size: 16px;"></i> <?php echo $this->lang->line('comNgo_dash_community'); ?></span></a>
                            </li>
                            <li class="">
                                <a onclick="jammiya_find_people()" id="" data-id="0" href="#find_peopleDashbrdTemp" data-toggle="tab" aria-expanded="true"><span><i class="lni lni-user" aria-hidden="true" style="color: #1a8b83;font-size: 16px;"></i> <?php echo $this->lang->line('comNgo_dash_family_find_people'); ?></span></a>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            <div class="col-md-12" id="">
                                                ...
                                                <div class="col-sm-1 hide" id="search_dashMah_cancel">
                                                    <span class="tipped-top" style="margin-left: auto;"><a id="cancelSearchDashboard" href="#" onclick="clearDashboardSearchFilter()"><img src="<?php echo base_url("images/community/cancel-search.gif") ?>"></a></span>
                                                </div>
                                            </div>
                                            <form method="post" name="form_dash_famDivi" id="form_dash_famDivi" class="form-horizontal">
                                                <div class="col-md-12" STYLE="width: 100%;">
                                                    <div style="display: none;">
                                                        <label for="countyID" class="title"><?php echo $this->lang->line('communityngo_country'); ?>
                                                            <!--Country-->
                                                        </label>
                                                        ...
                                                        <div class="col-md-7">
                                                            <div class="row">
                                                                <div style="" class="col-sm-4">
                                                                    <label for="provinceID" class="title"><?php echo $this->lang->line('communityngo_Province'); ?>
                                                                        <!--Province-->
                                                                    </label>
                                                                    <select name="provinceID" class="select2 btn btn-default" id="provinceID" style="width: 90%;" onchange="loadDshcountry_District();">
                                                                        <option value="" selected="selected"><?php echo $this->lang->line('comNgo_dash_select_a_province'); ?></option>
                                                                    </select>
                                                                </div>
                                                                <div style="" class="col-sm-4">
                                                                    <label for="districtID" class="title"><?php echo $this->lang->line('communityngo_District'); ?>
                                                                        <!--District-->
                                                                    </label>
                                                                    <select name="districtID" class=" btn btn-default select2" id="districtID" style="width: 90%;" onchange="loadDshcountry_districtDivision()">
                                                                        <option value="" selected="selected"><?php echo $this->lang->line('comNgo_dash_select_a_district'); ?></option>
                                                                    </select>
                                                                </div>
                                                                <div style="" class="col-sm-4">
                                                                    <label class="title"><?php echo $this->lang->line('communityngo_DistrictDivision'); ?>
                                                                        <!--District Division-->
                                                                    </label>
                                                                    <select name="districtDivisionID" class=" btn btn-default select2" id="districtDivisionID" style="width: 90%;" onchange="loadDshcountry_GSDivision(this.value);loadDshcountry_Division_Area(this.value)">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="row">
                                                                <div class="col-sm-5 set-input-style-1" id="areaMemIddrp">
                                                                    <label class="title"><?php echo $this->lang->line('communityngo_region'); ?>
                                                                        <!--Area-->
                                                                    </label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-xs-6">
                                                <!-- <div class="white-box">
                                                        ...
                                                        <div class="bodystate">
                                                            <div class="numberStar" onclick="jammiyaOpen_MemberModel();" style="text-transform: uppercase;"><?php //echo $this->lang->line('comNgo_dash_members'); 
                                                                                                                                                            ?></div>
                                                        </div>
                                                    </div>-->
                                            ...
                                            <div class="col-lg-3 col-xs-6">
                                                <!--<div class="white-box">
                                                        ...
                                                        <div class="bodystate">
                                                            <div class="numberStar" onclick="jammiyaOpen_FamiliesModel();" style="text-transform: uppercase;"><?php //echo $this->lang->line('comNgo_dash_families'); 
                                                                                                                                                                ?></div>
                                                        </div>
                                                    </div>-->
                                            ...
                                            <div class="col-lg-3 col-xs-6">
                                                <!--<div class="white-box">
                                                        ...
                                                        <div class="bodystate">
                                                            <div class="numberStar" onclick="jammiyaOpen_CommitteesModel();" style="text-transform: uppercase;"><?php //echo $this->lang->line('comNgo_dash_committees'); 
                                                                                                                                                                ?></div>
                                                        </div>
                                                    </div>-->
                                                ...
                                                <!--<div class="white-box">
                                                        <div class="control-label infoComm-box">
                                                            ...
                                                            <div class="infoComm-box-content">
                                                                <span class="infoComm-box-text" style="color: #0099CC;" onclick="fetch_comHousingData();"><?php //echo $this->lang->line('comNgo_dash_totalHouseEn'); 
                                                                                                                                                            ?></span>
                            ...
                            <div class="tab-pane" id="find_peopleDashbrdTemp">
                                <div class="row" style="margin-top: 5px">
                                    <div class="col-md-12" id="1T17">
                                        ...
                                        <br>
                                        <div class="overlay" id="overlay117" style="display: none;"><i class="fa fa-refresh fa-spin"></i></div>
...
<script type="text/javascript">
    ...
    function communityDashSum_Count() {
        ...
        $.ajax({
            ...
            data: {
                areaMemId: areaMemId,
                gsDivitnId: gsDivitnId,
                countyID: countyID,
                provinceID: provinceID,
                districtID: districtID,
                districtDivisionID: districtDivisionID
            },
