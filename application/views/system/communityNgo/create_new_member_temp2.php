                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-4">
                        <div id="div_load_village">
                            <select name="VillageID" class="form-control select2" id="VillageID">
                                <option value="" selected="selected"><?php echo $this->lang->line('communityngo_select_village'); ?></option>
                            </select>
                        </div>
                    </div>
                    <!--Jammiyah Division-->
                    ...
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                            <div id="div_load_area">
                                <select name="RegionID" class="form-control select2" id="RegionID" onchange="loadcountry_member_village(this.value)">
...
<script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (!jQuery.isEmptyObject(data)) {
                        ...
                        $("#CmWasakamaName").val(data['CmWasakamaName']);
                        $('#CNIC_No').val(data['CNIC_No']);
                        $('#CDOB').val(data['CDOB']);
                        $("#CountryOfOrigin").val(data['CountryOfOrigin']).change();
                        $("#CPlaceOfBirth").val(data['CPlaceOfBirth']).change();
                        $('#Age').val(data['Age']);
                        $('#Age_hidden').val(data['Age']);
                        $('#CBC_No').val(data['CBC_No']);
                        $('#CBC_Date').val(data['CBC_Date']);
                        ...
                        $('#C_Latitude').val(data['C_Latitude']);
                        $('#C_Longitude').val(data['C_Longitude']);
                        ...
                        $('#TP_mobileNo2').val(data['TP_mobileNo2']);
                        $("#AreaCodeMobile2").val(data['AreaCodeMobile2']).change();
                        $("#CountryCodeMobile2").val(data['CountryCodeMobile2']).change();
                        $('#EmailID').val(data['EmailID']);
                        $('#CmHeight').val(data['CmHeight']);
                        ...
                        $("#MrgCertificateNo").val(data['MrgCertificateNo']).change();
                        $("#MrgRegisteredDate").val(data['MrgRegisteredDate']).change();
                        ...
                        $("#CmPassportNo").val(data['CmPassportNo']);
                        $("#CmPassportIssueDate").val(data['CmPassportIssueDate']);
                        $("#CmPassportExpiryDate").val(data['CmPassportExpiryDate']);
                        $("#CmDrivingLicenseNo").val(data['CmDrivingLicenseNo']);
    ...
    function load_grandParentDetails() {
    ...
    function loadcountry_member_village(masterID) {
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'html',
