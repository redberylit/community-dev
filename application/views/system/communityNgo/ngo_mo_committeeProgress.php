            ...
            <div class="posts-holder settings">
                <div class="past-info">
                    <div class="arrow-steps clearfix">
                        ...
                        <div class="step" style="font-size:9px;"><span style="font-weight: bold;"><?php echo $this->lang->line('CommunityNgo_famAddedDate') . ': '; ?></span><span><?php echo $startDatet; ?></span><span style="font-weight: bold;"><?php if ($endDatet) {
                                                                                                                                                                                                                                                            echo 'Expiry : '; ?></span><span><?php echo $endDatet;
                                                                                                                                                                                                                                                                                        } ?></span></div>
                    </div>
                    <br>
                                    ...
                                    <form method="post" name="form_subComite" id="form_subComite" class="">
                                        ...
                                        <table id="fetchCmteCondent" class="table">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th><?php echo $this->lang->line('communityngo_CommitteeMem'); ?> </th>
                                                    <!--Committee Mem-->
                                                    <th><?php echo $this->lang->line('communityngo_CommitPosition'); ?></th>
                                                    <!--Position-->
                                                    <th><?php echo $this->lang->line('communityngo_CommitJoinDate'); ?> </th>
                                                    <!--Joined Date-->
                                                    <th><?php echo $this->lang->line('communityngo_com_member_header_Status'); ?> </th>
                                                    <!--Status-->
                                                    <th></th>
                                                </tr>
                                            </thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        <div class="input-group datepic">
                                                            ...
                                                            <input onchange="$('#joinedDate').val(this.value);" type="text" name="joinedDate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="<?php echo $current_date; ?>" id="joinedDate" class="form-control" required>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td colspan=""><a onclick="submitSubCmntMem();" id="AddNewPipeline" class="btn btn-primary btn-xs CA_Alter_btn"><?php echo $this->lang->line('communityngo_CommitAddMems'); ?></a></td>
                                                    <!--Add Member-->
                                                </tr>
        ...
        function fetch_comtMembers() {
            var Otable = $('#fetchCmteCondent').DataTable({
                ...
                "fnServerData": function(sSource, aoData, fnCallback) {
                    ...
                    aoData.push({
                        "name": "CommitteeAreawiseID",
                        "value": $("#CommitteeAreawiseID").val()
                    });
