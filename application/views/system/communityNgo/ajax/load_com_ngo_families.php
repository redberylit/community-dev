    ...
    <div class="table-responsive mailbox-messages">
        <table class="table table-hover table-striped">
            <tbody>
                <tr class="task-cat noselect" style="background: white;">
                    <td class="task-cat-upcoming" colspan="11">
                        <div class="task-cat-upcoming-label"><?php echo $this->lang->line('CommunityNgo_latest_fam'); ?>
                            <!--Latest Family-->
                        </div>
                ...
                <tr>
                    ...
                    <td class="" style="font-size: 11px;font-weight: bold;border-top: 1px solid #ffffff;"><?php echo $this->lang->line('CommunityNgo_ledger_no'); ?>
                        <!--Ledger No-->
                    </td>
                    <td class="" style="font-size: 11px;font-weight: bold;border-top: 1px solid #ffffff;"><?php echo $this->lang->line('CommunityNgo_ref_no'); ?>
                        <!--Reference No-->
                    </td>
                    <td class="" style="font-size: 11px;font-weight: bold;border-top: 1px solid #ffffff;"><?php echo $this->lang->line('CommunityNgo_famName'); ?>
                        <!--Family Name-->
                    </td>
                    <td class="" style="font-size: 11px;font-weight: bold;border-top: 1px solid #ffffff;"><?php echo $this->lang->line('CommunityNgo_leader'); ?>
                        <!--Leader-->
                    </td>
                    <td class="" style="font-size: 11px;font-weight: bold;border-top: 1px solid #ffffff;"><?php echo $this->lang->line('CommunityNgo_fam_ancestry'); ?>
                        <!--Ancestory-->
                    </td>
                    <td class="" style="font-size: 11px;font-weight: bold;border-top: 1px solid #ffffff;"><?php echo $this->lang->line('CommunityNgo_famAddedDate'); ?>
                        <!--Added Date-->
                    </td>
                    <td class="" style="font-size: 11px;font-weight: bold;border-top: 1px solid #ffffff;" title="Total Members"><?php echo $this->lang->line('CommunityNgo_famTotMem'); ?>
                        <!--Total Members-->
                    </td>
                    <td class="" style="font-size: 11px;font-weight: bold;border-top: 1px solid #ffffff;" title="Is Enroll To House Count"><?php echo $this->lang->line('communityngo_famHusEnrl'); ?>
                        <!-- House Enrolled -->
                    </td>
                    <td class="" style="font-size: 11px;font-weight: bold;border-top: 1px solid #ffffff;"><?php echo $this->lang->line('common_status'); ?>
                        <!--Status-->
                    </td>
                    <td class="" style="font-size: 11px;font-weight: bold;border-top: 1px solid #ffffff;"></td>
            ...
            <tfoot style="border-color: saddlebrown;">
                <tr style="background: white;color: #8b8b8b;font-size: 11px;">
                    <td class="task-cat-upcoming" colspan="11">Total House Enrolled Families : <?php echo $totHs; ?></td>
                </tr>
            </tfoot>
        </table><!-- /.table -->
    </div>
<?php
    ...
    <div class="search-no-results"><?php echo $this->lang->line('community_there_are_no_rec_to_display'); ?>
