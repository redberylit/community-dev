                            ...
                            <div class="row">
                                <div class="col-md-12 animated zoomIn">
                                    <header class="head-title">
                                        <h2><?php echo $this->lang->line('communityngo_com_member_father_Profile'); ?><!--FATHER DETAILS HEADER--></h2>
                                    </header>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title"><?php echo $this->lang->line('communityngo_com_member_father'); ?><!--Member--></label>
                                        </div>
                                        <div class="form-group col-sm-4">
    <select onchange="get_comMemFatherDel();" id="cfComMasID" class="form-control select2"
            name="cfComMasID">
        ...
        ?>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="fatherIsAlive" class="form-control select2" name="fatherIsAlive" onchange="get_ftrAliveStatus();">
                                                <option value=""></option>
                                                <?php $aliveFg=''; $notAliveFg=''; if($memPrt['fatherIsAlive'] == '1') { $aliveFg ='selected="selected"';} else if($memPrt['fatherIsAlive'] == '0'){ $notAliveFg ='selected="selected"';} ?>
                                        ...
                                        <div id="ftrDateOfDeathDiv" style="display: none;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    ...
                                                    <input type="text" name="cfDateOfDeath"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $memPrt['cfDateOfDeath']; ?>" id="cfDateOfDeath" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cFatherDOB"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $memPrt['cFatherDOB']; ?>" id="cFatherDOB" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cfBornCountry" class="form-control select2"
                                                    name="cfBornCountry" data-placeholder="<?php echo $this->lang->line('communityNgo_born_country'); ?>" onchange="get_fatherBornArea();">
                                                <option value=""></option>
                                                <?php
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cfBC_No"
                                                   placeholder="<?php echo $this->lang->line('communityNgo_bc_no'); ?>"
                                                   value="<?php echo $memPrt['cfBC_No']; ?>" id="cfBC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cfBCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $memPrt['cfBCDate']; ?>" id="cfBCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cfOccupationId" class="form-control select2"
                                                    name="cfOccupationId"
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cfNIC_No"
                                                   maxlength="12"
                                                   placeholder="<?php echo $this->lang->line('communityngo_nic'); ?>"
                                                   value="<?php echo $memPrt['cfNIC_No']; ?>" id="cfNIC_No" class="form-control">
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cfDC_No" placeholder="<?php echo $this->lang->line('communityNgo_dc_no'); ?>"
                                                   value="<?php echo $memPrt['cfDC_No']; ?>" id="cfDC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cfDCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $memPrt['cfDCDate']; ?>" id="cfDCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 animated zoomIn">
                                    <header class="head-title">
                                        <h2><?php echo $this->lang->line('communityngo_com_member_mother_Profile'); ?><!--Mother DETAILS HEADER--></h2>
                                    </header>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title"><?php echo $this->lang->line('communityngo_com_member_mother'); ?><!--Member--></label>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <select onchange="get_comMemMoFatherDel();" id="cmComMasID" class="form-control select2"
                                                    name="cmComMasID">
                                                <option data-currency=""
                                                        value=""><?php echo $this->lang->line('communityngo_select_member'); ?></option>
                                                <?php
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="motherIsAlive" class="form-control select2" name="motherIsAlive" onchange="get_mtrAliveStatus();">
                                                <option value=""></option>
                                                <?php $aliveMg=''; $notAliveMg=''; if($memPrt['motherIsAlive'] == '1') { $aliveMg ='selected="selected"';} else if($memPrt['motherIsAlive'] == '0'){ $notAliveMg ='selected="selected"';} ?>
                                        ...
                                        <div id="mtrDateOfDeathDiv" style="display: none;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cmDateOfDeath"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $memPrt['cmDateOfDeath']; ?>" id="cmDateOfDeath" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cMotherDOB"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $memPrt['cMotherDOB']; ?>" id="cMotherDOB" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cmBornCountry" class="form-control select2"
                                                    name="cmBornCountry"
                                                    data-placeholder="<?php echo $this->lang->line('communityNgo_born_country'); ?>" onchange="get_motherBornArea();">
                                                <option value=""></option>
                                                <?php
                                                if (!empty($country_drop)) {
                                                    foreach ($country_drop as $val) {
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cmBC_No" placeholder="<?php echo $this->lang->line('communityNgo_bc_no'); ?>"
                                                   value="<?php echo $memPrt['cmBC_No']; ?>" id="cmBC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cmBCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $memPrt['cmBCDate']; ?>" id="cmBCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cmOccupationId" class="form-control select2"
                                                    name="cmOccupationId"
                                                    data-placeholder="<?php echo $this->lang->line('communityngo_Job'); ?>">
                                                <option value=""></option>
                                                <?php
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cmNIC_No"
                                                   maxlength="12"
                                                   placeholder="<?php echo $this->lang->line('communityngo_nic'); ?>"
                                                   value="<?php echo $memPrt['cmNIC_No']; ?>" id="cmNIC_No" class="form-control">
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cmDC_No"
                                                   placeholder="<?php echo $this->lang->line('communityNgo_dc_no'); ?>"
                                                   value="<?php echo $memPrt['cmDC_No']; ?>" id="cmDC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cmDCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $memPrt['cmDCDate']; ?>" id="cmDCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        function get_comMemFatherDel() {
            ...
            if (cfComMasID == "" || cfComMasID == null) {
                ...
                $.ajax({
                    ...
                    data: {famComMasterID: cfComMasID},
        ...
        function get_comMemMoFatherDel(){
            ...
            if (cmComMasID == "" || cmComMasID == null) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "CommunityNgo/get_comMemBloodRelative",
                    data: {famComMasterID: cmComMasID},
                    success: function (datum) {
