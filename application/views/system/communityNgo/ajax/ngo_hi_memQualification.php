...
?>
            ...
            <ul class="nav nav-tabs" id="education-tab"
                ...
                <li class="other_details_li" data-value="vehicleStatus_Tab">
                    <a href="#vehicleStatus_Tab" data-toggle="tab" id="vehTab"
                       aria-expanded="true"> <i class="glyphicon glyphicon-duplicate"></i> <?php echo $this->lang->line('communityngo_properties_details'); ?></a>
                    <!--properties Status-->
                </li>
                ...
                <li class="other_details_li" data-value="willingToHelp_Tab">
                    <a href="#willingToHelp_Tab" data-toggle="tab" id="willingToHeplTab"
                       aria-expanded="true"><i
                            class="glyphicon glyphicon-leaf"></i> <?php echo $this->lang->line('communityNgo_willing_to_help'); ?>
                    </a>
                    <!--willing to help-->
                </li>
                <li class="other_details_li" data-value="socialGrants_Tab">
                    <a href="#socialGrants_Tab" data-toggle="tab" id="socialGrantTab"
                       aria-expanded="true"><i
                                class="fa fa-users"></i> <?php echo $this->lang->line('communityNgo_socialGrant'); ?>
                    </a>
                    <!--social grants-->
                </li>
                <li class="pull-right" style="padding: 4px 0px;">
                    <div class="pull-right">
                        <a onclick="open_add_modal()" data-toggle="modal" class="btn btn-mini btn-primary"
    ...
    <div class="modal fade bs-example-modal-lg" id="com_memLangAdd_modal" role="dialog"
                    ...
                    <form class="form-horizontal">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-3 control-label">
                                <?php echo $this->lang->line('communityngo_Language'); ?><!--Language--></label>
                            <div class="col-sm-7">
                                <input type="text" name="memNewLanguage" value="" id="memNewLanguage"
                                       class="form-control"
                                       placeholder="<?php echo $this->lang->line('communityngo_Language'); ?>">
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="sickAutoID">
                                    <?php echo $this->lang->line('communityngo_Disease'); ?><!--Sickness--> <?php required_mark(); ?></label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group JobMonthlyIncome hide" style="padding:15px;">
                                <label class="col-sm-4 control-label">
                                    <?php echo $this->lang->line('communityngo_Job_MonthlyIncome'); ?><!--Monthly Income--></label>
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        <div class="input-group-addon"><?php echo $currencyCode; ?></div>
                            ...
                            <div class="form-group MonthlyExpenditure hide" style="padding: 15px;">
                                <label class="col-sm-4 control-label">
                                    <?php echo $this->lang->line('communityngo_Expenditure'); ?><!--Monthly HH Expenditure--></label>
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        <div class="input-group-addon"><?php echo $currencyCode; ?></div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="PropertyID">
                                    <?php echo $this->lang->line('communityngo_property_type'); ?><!--Properties Types--> <?php required_mark(); ?></label>
                                <div class="col-sm-7">
                                    <select id="PropertyID" class="form-control select2 occupationType"
                                            onchange="change_property_dropdown();"
                                            data-placeholder="<?php echo $this->lang->line('communityngo_property_type'); ?>"
                                            name="PropertyID">
                                        <option value=""></option>
                                        <?php
                                        if (!empty($propertyTypes)) {
                                            foreach ($propertyTypes as $val) {
                                                if ($val['PropertyID'] == 1) {
                                                    ?>
                                                    <option selected="selected"
                                                            value="<?php echo $val['PropertyID'] ?>"><?php echo $val['PropertyDes'] ?></option>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <option
                            ...
                            <div class="form-group" style="margin-top: 6%;">
                                <label class="col-sm-4 control-label">
                                    <?php echo $this->lang->line('communityngo_property_desc'); ?><!--property Description--></label>
                                <div class="col-sm-7">
                                    <input type="text" name="vehiDescription" value="" id="vehiDescription"
                                           class="form-control"
                                           placeholder="<?php echo $this->lang->line('communityngo_property_desc'); ?>">
                                </div>
                            </div>
                            <div class="form-group" style="margin-top: 12%;">
                                <label class="col-sm-4 control-label">
                                    <?php echo $this->lang->line('communityngo_property_status'); ?><!--property Status--></label>
                                <div class="form-group col-sm-7">
                                    <select id="vehiStatus" class="form-control select2"
                                            name="vehiStatus"
                                            data-placeholder="<?php echo $this->lang->line('communityngo_property_status'); ?>">
                                        <option value=""></option>
                            ...
                            <div class="form-group" style="margin-top: 18%;">
                                <label class="col-sm-4 control-label">
                                    <?php echo $this->lang->line('common_value'); ?><!--Value--></label>
                            ...
                            <div class="form-group" style="margin-top: 18%;">
                                ...
                                <div class="col-sm-7">
                                    <textarea class="form-control" id="vehiRemark"
                                              placeholder="<?php echo $this->lang->line('communityngo_Remarks'); ?>"
                                              name="vehiRemark" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="margin-top: 6%;">
                                ...
                                <div class="col-sm-7">
                                    <textarea class="form-control" id="hlprDescription"
                                              ...
                                              name="hlprDescription" rows="4"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="margin-top: 6%;">
                                ...
                                <div class="col-sm-7">
                                    <textarea class="form-control" id="helpComments"
                                              ...
                                              name="helpComments" rows="4"></textarea>
                                </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="SocialGrantID">
                                    <?php echo $this->lang->line('communityNgo_socialGrant_category'); ?><!--social Grant category--> <?php required_mark(); ?></label>
                                <div class="form-group col-sm-7">
                                    <div class="input-group">
                                        <select name="SocialGrantID" class="form-control select2" id="SocialGrantID"  data-placeholder="Select a social grant">
                                            ...
                                            if (!empty($socialGrants)) {
                                                foreach ($socialGrants as $val) {
                                                    ?>
                                                    <option
                                                            value="<?php echo $val['SocialGrantID'] ?>"><?php echo $val['SocialGrantDescription'] ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                        ...
                                        <span class="input-group-btn">
                                                    <button class="btn btn-default" type="button" id="email_btn_grant"
                                                            onclick="sendemail('social_grant')"
                                                            style="height: 27px; padding: 2px 10px;">
                                                        <i class="fa fa-envelope" style="font-size: 11px"></i>
                                                    </button>
                                                </span>
                            ...
                            <div class="form-group" style="margin-top: 6%;">
                                <label class="col-sm-4 control-label">
                                    <?php echo $this->lang->line('common_period'); ?><!--Period--></label>
                                <div class="col-sm-7">
                                    <select name="PeriodTypeID" class="form-control select2" id="PeriodTypeID"  data-placeholder="Select a period">
                                        ...
                                        if (!empty($communityPeriods)) {
                                            foreach ($communityPeriods as $val) {
                                                ?>
                                                <option
                                                        value="<?php echo $val['PeriodTypeID'] ?>"><?php echo $val['Description'] ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
                            ...
                            <div class="form-group" style="margin-top: 6%;">
                                <label class="col-sm-4 control-label">
                                    <?php echo $this->lang->line('communityNgo_socialGrant_amount'); ?><!--Grant Amount--></label>
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        <div class="input-group-addon"><?php echo $currencyCode; ?></div>
                            ...
                            <div class="form-group" style="margin-top: 6%;">
                                <label class="col-sm-4 control-label">
                                    <?php echo $this->lang->line('common_remarks'); ?><!--Comments--></label>
                                <div class="col-sm-7">
                                    <textarea class="form-control" id="SocialGrantRemark"
                                              placeholder="<?php echo $this->lang->line('common_remarks'); ?>"
                                              name="SocialGrantRemark" rows="4"></textarea>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-sm actionBtn" id="save-btn-socialGrant"
                            onclick="save_memSocialGrant()">
                        <?php echo $this->lang->line('common_save'); ?><!--Save-->
                    </button>
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">
                        <?php echo $this->lang->line('common_Close'); ?><!--Close--></button>
    ...
    <script type="text/javascript">
        ...
        function fetch_newMem_language() {
            ...
            if (memNewLanguage) {
                $.ajax({
                    ...
                    type: 'post',
                    dataType: 'json',
                    data: {'Com_MasterID': Com_MasterID,'memNewLanguage':memNewLanguage},
        ...
        function add_memSocialGrant() {
            ...
            $('#socialGrant_modal').modal({backdrop: "static"});
        }
