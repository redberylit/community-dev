...
?>
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" id="grandParents-tab"
                ...
                <li class="grand_parents_li active" data-value="ftrSideGrandTab">
                    <a href="#ftrSideGrandTab" data-toggle="tab" id="ftrGrandTab" onclick="get_ftrParent();"
                       aria-expanded="true"> <i
                            class="fa fa-male"></i> <?php echo $this->lang->line('communityngo_fatherSide_grandparent'); ?></a>
                </li>
                <li class="grand_parents_li" data-value="mtrSideGrandTab">
                    <a href="#mtrSideGrandTab" data-toggle="tab" id="mtrGrandTab" onclick="get_mtrParent();"
                       aria-expanded="true"> <i
                            class="fa fa-female"></i> <?php echo $this->lang->line('communityngo_motherSide_grandparent'); ?></a>
                    <!--Occupation-->
                </li>
            </ul>
                        ...
                        foreach ($memGrandParents as $key => $ftr) {
                           ?>
                            <div class="row">
                                <div class="col-md-12 animated zoomIn">
                                    <header class="head-title">
                                        <h2>
                                            <?php echo $this->lang->line('communityngo_com_member_gFather_Profile'); ?><!--g FATHER DETAILS HEADER--></h2>
                                    </header>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title"><?php echo $this->lang->line('communityngo_com_member_gfather'); ?><!--Member--></label>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <select onchange="get_memFgrdFatherDel();" id="cf_GdFComMasID" class="form-control select2"
                                                    name="cf_GdFComMasID">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cf_GrandFIsAlive" class="form-control select2" name="cf_GrandFIsAlive" onchange="get_ftrGPAliveStatus();">
                                                <option value=""></option>
                                                <?php $aliveFpg=''; $notAliveFpg=''; if($ftr['cf_GrandFIsAlive'] == '1') { $aliveFpg ='selected="selected"';} else if($ftr['cf_GrandFIsAlive'] == '0'){ $notAliveFpg ='selected="selected"';} ?>
                                        ...
                                        <div id="ftrGPDateOfDeathDiv" style="display: none;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    ...
                                                    <input type="text" name="cf_GrandFDateOfDeath"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $ftr['cf_GrandFDateOfDeath'];?>" id="cf_GrandFDateOfDeath" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_GrandFDOB"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $ftr['cf_GrandFDOB'];?>" id="cf_GrandFDOB" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cf_GrandFBornCountry" class="form-control select2"
                                                    name="cf_GrandFBornCountry" data-placeholder="<?php echo $this->lang->line('communityNgo_born_country'); ?>" onchange="get_ftrGPBornArea();">
                                                <option value=""></option>
                                                <?php
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_GrandFBC_No"
                                                   placeholder="<?php echo $this->lang->line('communityNgo_bc_no'); ?>"
                                                   value="<?php echo $ftr['cf_GrandFBC_No'];?>" id="cf_GrandFBC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_GrandFBCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $ftr['cf_GrandFBCDate'];?>" id="cf_GrandFBCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cf_GrandFOccupationId" class="form-control select2"
                                                    name="cf_GrandFOccupationId"
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_GrandFNIC_No"
                                                   maxlength="12"
                                                   placeholder="<?php echo $this->lang->line('communityngo_nic'); ?>"
                                                   value="<?php echo $ftr['cf_GrandFNIC_No'];?>" id="cf_GrandFNIC_No" class="form-control">
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_GrandFDC_No" placeholder="<?php echo $this->lang->line('communityNgo_dc_no'); ?>"
                                                   value="<?php echo $ftr['cf_GrandFDC_No'];?>" id="cf_GrandFDC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_GrandFDCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $ftr['cf_GrandFDCDate'];?>" id="cf_GrandFDCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 animated zoomIn">
                                    <header class="head-title">
                                        <h2><?php echo $this->lang->line('communityngo_com_member_gMother_Profile'); ?><!--g Mother DETAILS HEADER--></h2>
                                    </header>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title"><?php echo $this->lang->line('communityngo_com_member_gmother'); ?><!--Member--></label>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <select onchange="get_memFgrdMotherDel();" id="cf_GdMComMasID" class="form-control select2"
                                                    name="cf_GdMComMasID">
                                                <option data-currency=""
                                                        value=""><?php echo $this->lang->line('communityngo_select_member'); ?></option>
                                                <?php
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cf_GrandMIsAlive" class="form-control select2" name="cf_GrandMIsAlive" onchange="get_ftrGMAliveStatus();">
                                                <option value=""></option>
                                                <?php $aliveFg=''; $notAliveFg=''; if($ftr['cf_GrandMIsAlive'] == '1') { $aliveFg ='selected="selected"';} else if($ftr['cf_GrandMIsAlive'] == '0'){ $notAliveFg ='selected="selected"';} ?>
                                        ...
                                        <div id="ftrGMDateOfDeathDiv" style="display: none;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cf_GrandMDateOfDeath"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $ftr['cf_GrandMDateOfDeath'];?>" id="cf_GrandMDateOfDeath" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_GrandMDOB"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $ftr['cf_GrandMDOB'];?>" id="cf_GrandMDOB" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cf_GrandMBornCountry" class="form-control select2"
                                                    name="cf_GrandMBornCountry"
                                                    data-placeholder="<?php echo $this->lang->line('communityNgo_born_country'); ?>" onchange="get_ftrGMBornArea();">
                                                <option value=""></option>
                                                <?php
                                                if (!empty($country_drop)) {
                                                    foreach ($country_drop as $val) {
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_GrandMBC_No" placeholder="<?php echo $this->lang->line('communityNgo_bc_no'); ?>"
                                                   value="<?php echo $ftr['cf_GrandMBC_No'];?>" id="cf_GrandMBC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_GrandMBCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $ftr['cf_GrandMBCDate'];?>" id="cf_GrandMBCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cf_GrandMOccupationId" class="form-control select2"
                                                    name="cf_GrandMOccupationId"
                                                    data-placeholder="<?php echo $this->lang->line('communityngo_Job'); ?>">
                                                <option value=""></option>
                                                <?php
                                                if (!empty($memParentJob)) {
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_GrandMNIC_No"
                                                   maxlength="12"
                                                   placeholder="<?php echo $this->lang->line('communityngo_nic'); ?>"
                                                   value="<?php echo $ftr['cf_GrandMNIC_No'];?>" id="cf_GrandMNIC_No" class="form-control">
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_GrandMDC_No"
                                                   placeholder="<?php echo $this->lang->line('communityNgo_dc_no'); ?>"
                                                   value="<?php echo $ftr['cf_GrandMDC_No'];?>" id="cf_GrandMDC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_GrandMDCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $ftr['cf_GrandMDCDate'];?>" id="cf_GrandMDCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 animated zoomIn">
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <select onchange="get_memMgrdFatherDel();" id="cm_GdFComMasID" class="form-control select2"
                                                        name="cm_GdFComMasID">
                                                    <option data-currency=""
                                                            value=""><?php echo $this->lang->line('communityngo_select_member'); ?></option>
                                                    <?php
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <select id="cm_GrandFIsAlive" class="form-control select2" name="cm_GrandFIsAlive" onchange="get_mtrGPAliveStatus();">
                                                    <option value=""></option>
                                                    <?php $aliveMpg=''; $notAliveMpg=''; if($mtr['cm_GrandFIsAlive'] == '1') { $aliveMpg ='selected="selected"';} else if($mtr['cm_GrandFIsAlive'] == '0'){ $notAliveMpg ='selected="selected"';} ?>
                                            ...
                                            <div id="mtrGPDateOfDeathDiv" style="display: none;">
                                                ...
                                                <div class="form-group col-sm-4">
                                                    <div class="input-group datepic">
                                                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                        <input type="text" name="cm_GrandFDateOfDeath"
                                                               data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                               value="<?php echo $mtr['cm_GrandFDateOfDeath'];?>" id="cm_GrandFDateOfDeath" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cm_GrandFDOB"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $mtr['cm_GrandFDOB'];?>" id="cm_GrandFDOB" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <select id="cm_GrandFBornCountry" class="form-control select2"
                                                        name="cm_GrandFBornCountry" data-placeholder="<?php echo $this->lang->line('communityNgo_born_country'); ?>" onchange="get_mtrGPBornArea();">
                                                    <option value=""></option>
                                                    <?php
                                                    if (!empty($country_drop)) {
                                                        foreach ($country_drop as $val) {
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <input type="text" name="cm_GrandFBC_No"
                                                       placeholder="<?php echo $this->lang->line('communityNgo_bc_no'); ?>"
                                                       value="<?php echo $mtr['cm_GrandFBC_No'];?>" id="cm_GrandFBC_No" class="form-control">
                                            </div>
                                            <div class="form-group col-sm-2">
                                                <label class="title">
                                                    <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cm_GrandFBCDate"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $mtr['cm_GrandFBCDate'];?>" id="cm_GrandFBCDate" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <select id="cm_GrandFOccupationId" class="form-control select2"
                                                        name="cm_GrandFOccupationId"
                                                        data-placeholder="<?php echo $this->lang->line('communityngo_Job'); ?>">
                                                    <option value=""></option>
                                                    <?php
                                                    if (!empty($memParentJob)) {
                                            ...
                                            <div class="form-group col-sm-4">
                                                <input type="text" name="cm_GrandFNIC_No"
                                                       maxlength="12"
                                                       placeholder="<?php echo $this->lang->line('communityngo_nic'); ?>"
                                                       value="<?php echo $mtr['cm_GrandFNIC_No'];?>" id="cm_GrandFNIC_No" class="form-control">
                                            </div>
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <input type="text" name="cm_GrandFDC_No" placeholder="<?php echo $this->lang->line('communityNgo_dc_no'); ?>"
                                                       value="<?php echo $mtr['cm_GrandFDC_No'];?>" id="cm_GrandFDC_No" class="form-control">
                                            </div>
                                            <div class="form-group col-sm-2">
                                                <label class="title">
                                                    <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cm_GrandFDCDate"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $mtr['cm_GrandFDCDate'];?>" id="cm_GrandFDCDate" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 animated zoomIn">
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <select onchange="get_memMgrdMotherDel();" id="cm_GdMComMasID" class="form-control select2"
                                                        name="cm_GdMComMasID">
                                                    <option data-currency=""
                                                            value=""><?php echo $this->lang->line('communityngo_select_member'); ?></option>
                                                    <?php
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <select id="cm_GrandMIsAlive" class="form-control select2" name="cm_GrandMIsAlive" onchange="get_mtrGMAliveStatus();">
                                                    <option value=""></option>
                                                    <?php $aliveMmg=''; $notAliveMmg=''; if($mtr['cm_GrandMIsAlive'] == '1') { $aliveMmg ='selected="selected"';} else if($mtr['cm_GrandMIsAlive'] == '0'){ $notAliveMmg ='selected="selected"';} ?>
                                            ...
                                            <div id="mtrGMDateOfDeathDiv" style="display: none;">
                                                ...
                                                <div class="form-group col-sm-4">
                                                    <div class="input-group datepic">
                                                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                        <input type="text" name="cm_GrandMDateOfDeath"
                                                               data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                               value="<?php echo $mtr['cm_GrandMDateOfDeath'];?>" id="cm_GrandMDateOfDeath" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cm_GrandMDOB"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $mtr['cm_GrandMDOB'];?>" id="cm_GrandMDOB" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 10px;">
                                            <div class="form-group col-sm-2">
                                                <label class="title">
                                                    <?php echo $this->lang->line('communityNgo_born_country'); ?><!--Born Country--></label></div>
                                            <div class="form-group col-sm-4">
                                                <select id="cm_GrandMBornCountry" class="form-control select2"
                                                        name="cm_GrandMBornCountry"
                                                        data-placeholder="<?php echo $this->lang->line('communityNgo_born_country'); ?>" onchange="get_mtrGMBornArea();">
                                                    <option value=""></option>
                                                    <?php
                                                    if (!empty($country_drop)) {
                                                        foreach ($country_drop as $val) {
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <input type="text" name="cm_GrandMBC_No" placeholder="<?php echo $this->lang->line('communityNgo_bc_no'); ?>"
                                                       value="<?php echo $mtr['cm_GrandMBC_No'];?>" id="cm_GrandMBC_No" class="form-control">
                                            </div>
                                            <div class="form-group col-sm-2">
                                                <label class="title">
                                                    <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cm_GrandMBCDate"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $mtr['cm_GrandMBCDate'];?>" id="cm_GrandMBCDate" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <select id="cm_GrandMOccupationId" class="form-control select2"
                                                        name="cm_GrandMOccupationId"
                                                        data-placeholder="<?php echo $this->lang->line('communityngo_Job'); ?>">
                                                    <option value=""></option>
                                                    <?php
                                                    if (!empty($memParentJob)) {
                                            ...
                                            <div class="form-group col-sm-4">
                                                <input type="text" name="cm_GrandMNIC_No"
                                                       maxlength="12"
                                                       placeholder="<?php echo $this->lang->line('communityngo_nic'); ?>"
                                                       value="<?php echo $mtr['cm_GrandMNIC_No'];?>" id="cm_GrandMNIC_No" class="form-control">
                                            </div>
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <input type="text" name="cm_GrandMDC_No"
                                                       placeholder="<?php echo $this->lang->line('communityNgo_dc_no'); ?>"
                                                       value="<?php echo $mtr['cm_GrandMDC_No'];?>" id="cm_GrandMDC_No" class="form-control">
                                            </div>
                                            <div class="form-group col-sm-2">
                                                <label class="title">
                                                    <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cm_GrandMDCDate"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $mtr['cm_GrandMDCDate'];?>" id="cm_GrandMDCDate" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        function get_memFgrdFatherDel(){
            ...
            if (cf_GdFComMasID == "" || cf_GdFComMasID == null) {
            } else {
                ...
                $.ajax({
                    ...
                    data: {famComMasterID: cf_GdFComMasID},
        ...
        function get_memFgrdMotherDel(){
            ...
            if (cf_GdMComMasID == "" || cf_GdMComMasID == null) {
            } else {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "CommunityNgo/get_comMemBloodRelative",
                    data: {famComMasterID: cf_GdMComMasID},
                    success: function (datum) {
        ...
        function get_memMgrdFatherDel(){
            ...
            if (cm_GdFComMasID == "" || cm_GdFComMasID == null) {
            } else {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "CommunityNgo/get_comMemBloodRelative",
                    data: {famComMasterID: cm_GdFComMasID},
                    success: function (datum) {
        ...
        function get_memMgrdMotherDel(){
            ...
            if (cm_GdMComMasID == "" || cm_GdMComMasID == null) {
            } else {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "CommunityNgo/get_comMemBloodRelative",
                    data: {famComMasterID: cm_GdMComMasID},
                    success: function (datum) {
