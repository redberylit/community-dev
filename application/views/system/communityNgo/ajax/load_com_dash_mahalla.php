...
?>
    ...
    <div class="no_padding col-md-9" style="padding: 2px;">
        <div class="col-md-6 col-sm-6 col-xs-12" style="padding:10px;">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
                <div class="box box-primary" style="margin-bottom: 12px;">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('comNgo_dash_population_status'); ?></h3>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
                <div class="box box-primary" style="margin-bottom: 12px;">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('comNgo_dash_occupation-wise'); ?></h3>
                        <div class="box-tools pull-right"></div>
                    </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12" style="padding:10px;">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
                <div class="box box-primary" style="margin-bottom: 12px;">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('comNgo_dash_blood_group_status'); ?></h3>
                        <div class="box-tools pull-right"></div>
                    </div>
    ...
    <div class="col-md-3 col-sm-6" style=" padding: 10px; ">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
            <div class="box box-primary" style="margin-bottom: 12px;">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo $this->lang->line('communityngo_status'); ?></h3>
                    <div class="box-tools pull-right"></div>
                </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
            <div class="box box-primary" style="margin-bottom: 12px;">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo $this->lang->line('comNgo_dash_outside_family_ancestry'); ?></h3>
                    <div class="box-tools pull-right"></div>
                </div>
            ...
            $(function() {
                ...
                var bloodTypesData = {
                    ...
                    datasets: [{
                        ...
                        data: [<?php foreach ($loadBloodCount as $row) {
                                    echo "'" . $row['NoOfGrpMem'] . "',";
                                } ?>]
                    }]
                };
        ...
        $(function() {
            ...
            ?>
                ...
                var donut = new Morris.Donut({
                    ...
                    data: [{
                            label: "<?php echo $this->lang->line('common_male'); ?> (%)",
                            value: '<?php echo $malesPecrnt; ?>'
                        },
                        {
                            label: "<?php echo $this->lang->line('common_female'); ?> (%)",
                            value: '<?php echo $femalesPecrnt; ?>'
                        }
        ...
        <?php if (!empty($OccupationBase)) { ?>
            ...
            $(function() {
                ...
                var donut = new Morris.Donut({
                    ...
                    data: [{
                            label: "<?php echo $occupation_type1['Description']; ?> (%)",
                            value: '<?php echo $occ1Pecrnt; ?>'
                        },
                        {
                            label: "<?php echo $occupation_type2['Description']; ?> (%)",
                            value: '<?php echo $occ2Pecrnt; ?>'
                        },
                        {
                            label: "<?php echo $occupation_type3['Description']; ?> (%)",
                            value: '<?php echo $occ3Pecrnt; ?>'
                        },
                        {
                            label: "<?php echo $occupation_type4['Description']; ?> (%)",
                            value: '<?php echo $occ4Pecrnt; ?>'
                        },
                        {
                            label: "<?php echo $occupation_type5['Description']; ?> (%)",
                            value: '<?php echo $occ5Pecrnt; ?>'
                        },
                        {
                            label: "<?php echo $occupation_type6['Description']; ?> (%)",
                            value: '<?php echo $occ6Pecrnt; ?>'
                        }
        ...
        <?php if (!empty($loadFamAnces)) { ?>
            $(function() {
                ...
                var areaChartDataFeeDel = {
                    labels: [<?php foreach (array_reverse($loadFamAnces) as $row) {
                                    echo "'" . $row['AncestryDes'] . "',";
                                } ?>],
                    datasets: [{
                        ...
                        data: [<?php foreach (array_reverse($loadPerFamilyAnces) as $row) {
                                    echo "'" . $row['count'] . "',";
                                } ?>]
                    }]
                };
    ...
    <script>
        ...
        Highcharts.chart('econStatusBarChart', {
            title: {
                text: '<?php echo $this->lang->line('comNgo_dash_community_economic_status'); ?>',
                style: {
                    color: 'black'
                }
            },
...
?>
    <div class="no_padding col-md-12" style="padding:40px;text-align: center;">
    </div>
    <div class="no_padding col-md-12" style="padding:20px;text-align: center;font-weight:bold;background:linear-gradient(to right, #e24952 , whitesmoke);">
