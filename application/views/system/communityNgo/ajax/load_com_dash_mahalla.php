...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var bloodTypesData = {
            ...
            labels: [<?php foreach($loadBloodCount as $resBloDes){ echo "'".$resBloDes['BloodDescription']."',";} ?>],
            datasets: [
                {
                    ...
                    data: [<?php foreach($loadBloodCount as $row){echo "'".$row['NoOfGrpMem']."'," ;} ?>]
                }
            ]
        };
    ...
    $(function () {
        ...
        var donut = new Morris.Donut({
            ...
            data: [
                {label: "<?php echo $this->lang->line('common_male');?> (%)", value: '<?php echo $malesPecrnt; ?>'},
                {label: "<?php echo $this->lang->line('common_female');?> (%)", value: '<?php echo $femalesPecrnt; ?>'}
