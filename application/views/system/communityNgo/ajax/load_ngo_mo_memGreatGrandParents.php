...
?>
    ...
    <div id="memGrandParentDiv">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" id="grandParents-tab"
                ...
                <li class="grand_parents_li active" data-value="ftrSideGrtGrandTab">
                    <a href="#ftrSideGrtGrandTab" data-toggle="tab" id="grtFtrGrandTab" onclick="get_grtFtrParent();"
                       aria-expanded="true"> <i
                            class="fa fa-male"></i> <?php echo $this->lang->line('communityngo_fatherSideGrt_grandparent'); ?></a>
                </li>
                <li class="grand_parents_li" data-value="mtrSideGrtGrandTab">
                    <a href="#mtrSideGrtGrandTab" data-toggle="tab" id="grtMtrGrandTab" onclick="get_grtMtrParent();"
                       aria-expanded="true"> <i
                            class="fa fa-female"></i> <?php echo $this->lang->line('communityngo_motherSideGrt_grandparent'); ?></a>
                    <!--Occupation-->
                </li>
            </ul>
                    ...
                    <div class="" style="" id="">
                        ...
                        foreach ($mem_grtGrandParents as $key => $gFtr) {
                            ...
                            <div class="row">
                                <div class="col-md-12 animated zoomIn">
                                    <header class="head-title">
                                        <h2>
                                            <?php echo $this->lang->line('communityngo_com_member_ggFather_Profile'); ?><!--g FATHER DETAILS HEADER--></h2>
                                    </header>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title"><?php echo $this->lang->line('communityngo_com_member_ggfather'); ?><!--Member--></label>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <select onchange="get_grt_memFgrdFatherDel();" id="cf_grt_GdFComMasID" class="form-control select2"
                                                    name="cf_grt_GdFComMasID">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_is_alive'); ?><!--is alive--></label>
                                        </div>

                                        <div class="form-group col-sm-4">
                                            <select id="cf_grt_GrandFIsAlive" class="form-control select2" name="cf_grt_GrandFIsAlive" onchange="get_grtFtrGPAliveStatus();">
                                                <option value=""></option>
                                                <?php $aliveFpg=''; $notAliveFpg=''; if($gFtr['cf_grt_GrandFIsAlive'] == '1') { $aliveFpg ='selected="selected"';} else if($gFtr['cf_grt_GrandFIsAlive'] == '0'){ $notAliveFpg ='selected="selected"';} ?>
                                        ...
                                        <div id="ftrGrtGPDODDiv" style="display: none;">
                                            <div class="form-group col-sm-2">
                                                <label class="title">
                                                    <?php echo $this->lang->line('communityNgo_dateOfDeath'); ?><!--DOD --></label>
                                            </div>
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cf_grt_GrandFDateOfDeath"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $gFtr['cf_grt_GrandFDateOfDeath'];?>" id="cf_grt_GrandFDateOfDeath" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityngo_name'); ?><!--full name--></label>
                                        </div>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_grt_GrandFDOB"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gFtr['cf_grt_GrandFDOB'];?>" id="cf_grt_GrandFDOB" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_born_country'); ?><!--Born Country--></label>

                                        </div>
                                        <div class="form-group col-sm-4">
                                            <select id="cf_grt_GrandFBornCountry" class="form-control select2"
                                                    name="cf_grt_GrandFBornCountry" data-placeholder="<?php echo $this->lang->line('communityNgo_born_country'); ?>" onchange="get_grtFtrGPBornArea();">
                                                <option value=""></option>
                                                <?php
                                        ...
                                        <div class="form-group col-sm-2">
                                            <label class="title"><?php echo $this->lang->line('communityNgo_born_area'); ?><!--Born Area--></label>
                                        </div>
                                        <div class="form-group col-sm-4">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title"><?php echo $this->lang->line('communityNgo_bc_no'); ?><!--bc NO--><label>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_grt_GrandFBC_No"
                                                   placeholder="<?php echo $this->lang->line('communityNgo_bc_no'); ?>"
                                                   value="<?php echo $gFtr['cf_grt_GrandFBC_No'];?>" id="cf_grt_GrandFBC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_grt_GrandFBCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gFtr['cf_grt_GrandFBCDate'];?>" id="cf_grt_GrandFBCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityngo_Job'); ?><!--FATHER OCCUPATION--></label>

                                        </div>
                                        <div class="form-group col-sm-4">
                                            <select id="cf_grt_GrandFOccupationId" class="form-control select2"
                                                    name="cf_grt_GrandFOccupationId"
                                                    data-placeholder="<?php echo $this->lang->line('communityngo_Job'); ?>">
                                                <option value=""></option>
                                                <?php
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_grt_GrandFNIC_No"
                                                   maxlength="12"
                                                   placeholder="<?php echo $this->lang->line('communityngo_nic'); ?>"
                                                   value="<?php echo $gFtr['cf_grt_GrandFNIC_No'];?>" id="cf_grt_GrandFNIC_No" class="form-control">
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_dc_no'); ?><!--DC NO--><label>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_grt_GrandFDC_No" placeholder="<?php echo $this->lang->line('communityNgo_dc_no'); ?>"
                                                   value="<?php echo $gFtr['cf_grt_GrandFDC_No'];?>" id="cf_grt_GrandFDC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_grt_GrandFDCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gFtr['cf_grt_GrandFDCDate'];?>" id="cf_grt_GrandFDCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 animated zoomIn">
                                    <header class="head-title">
                                        <h2><?php echo $this->lang->line('communityngo_com_member_ggMother_Profile'); ?><!--g Mother DETAILS HEADER--></h2>
                                    </header>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title"><?php echo $this->lang->line('communityngo_com_member_ggmother'); ?><!--Member--></label>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <select onchange="get_grt_memFgrdMotherDel();" id="cf_grt_GdMComMasID" class="form-control select2"
                                                    name="cf_grt_GdMComMasID">
                                                <option data-currency=""
                                                        value=""><?php echo $this->lang->line('communityngo_select_member'); ?></option>
                                                <?php
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cf_grt_GrandMIsAlive" class="form-control select2" name="cf_grt_GrandMIsAlive" onchange="get_grtFtrGMAliveStatus();">
                                                <option value=""></option>
                                                <?php $aliveFg=''; $notAliveFg=''; if($gFtr['cf_grt_GrandMIsAlive'] == '1') { $aliveFg ='selected="selected"';} else if($gFtr['cf_grt_GrandMIsAlive'] == '0'){ $notAliveFg ='selected="selected"';} ?>
                                        ...
                                        <div id="ftrGrtGmDODDiv" style="display: none;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cf_grt_GrandMDateOfDeath"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $gFtr['cf_grt_GrandMDateOfDeath'];?>" id="cf_grt_GrandMDateOfDeath" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_grt_GrandMDOB"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gFtr['cf_grt_GrandMDOB'];?>" id="cf_grt_GrandMDOB" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_born_country'); ?><!--Born Country--></label></div>
                                        <div class="form-group col-sm-4">
                                            <select id="cf_grt_GrandMBornCountry" class="form-control select2"
                                                    name="cf_grt_GrandMBornCountry"
                                                    data-placeholder="<?php echo $this->lang->line('communityNgo_born_country'); ?>" onchange="get_grtFtrGMBornArea();">
                                                <option value=""></option>
                                                <?php
                                                if (!empty($country_drop)) {
                                                    foreach ($country_drop as $val) {
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_grt_GrandMBC_No" placeholder="<?php echo $this->lang->line('communityNgo_bc_no'); ?>"
                                                   value="<?php echo $gFtr['cf_grt_GrandMBC_No'];?>" id="cf_grt_GrandMBC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_grt_GrandMBCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gFtr['cf_grt_GrandMBCDate'];?>" id="cf_grt_GrandMBCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityngo_Job'); ?><!--MOTHER OCCUPATION--></label>

                                        </div>
                                        <div class="form-group col-sm-4">
                                            <select id="cf_grt_GrandMOccupationId" class="form-control select2"
                                                    name="cf_grt_GrandMOccupationId"
                                                    data-placeholder="<?php echo $this->lang->line('communityngo_Job'); ?>">
                                                <option value=""></option>
                                                <?php
                                                if (!empty($memParentJob)) {
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_grt_GrandMNIC_No"
                                                   maxlength="12"
                                                   placeholder="<?php echo $this->lang->line('communityngo_nic'); ?>"
                                                   value="<?php echo $gFtr['cf_grt_GrandMNIC_No'];?>" id="cf_grt_GrandMNIC_No" class="form-control">
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cf_grt_GrandMDC_No"
                                                   placeholder="<?php echo $this->lang->line('communityNgo_dc_no'); ?>"
                                                   value="<?php echo $gFtr['cf_grt_GrandMDC_No'];?>" id="cf_grt_GrandMDC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cf_grt_GrandMDCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gFtr['cf_grt_GrandMDCDate'];?>" id="cf_grt_GrandMDCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 animated zoomIn">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select onchange="get_grt_memMgrdFatherDel();" id="cm_grt_GdFComMasID" class="form-control select2"
                                                    name="cm_grt_GdFComMasID">
                                                <option data-currency=""
                                                        value=""><?php echo $this->lang->line('communityngo_select_member'); ?></option>
                                                <?php
                                                if (!empty($memMale_drop)) {
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cm_grt_GrandFIsAlive" class="form-control select2" name="cm_grt_GrandFIsAlive" onchange="get_grtMtrGPAliveStatus();">
                                                <option value=""></option>
                                                <?php $aliveMpg=''; $notAliveMpg=''; if($gMtr['cm_grt_GrandFIsAlive'] == '1') { $aliveMpg ='selected="selected"';} else if($gMtr['cm_grt_GrandFIsAlive'] == '0'){ $notAliveMpg ='selected="selected"';} ?>
                                        ...
                                        <div id="mtrGrtGpDODDiv" style="display: none;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cm_grt_GrandFDateOfDeath"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $gMtr['cm_grt_GrandFDateOfDeath'];?>" id="cm_grt_GrandFDateOfDeath" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cm_grt_GrandFDOB"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gMtr['cm_grt_GrandFDOB'];?>" id="cm_grt_GrandFDOB" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cm_grt_GrandFBornCountry" class="form-control select2"
                                                    name="cm_grt_GrandFBornCountry" data-placeholder="<?php echo $this->lang->line('communityNgo_born_country'); ?>" onchange="get_grtMtrGPBornArea();">
                                                <option value=""></option>
                                                <?php
                                                if (!empty($country_drop)) {
                                                    foreach ($country_drop as $val) {
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cm_grt_GrandFBC_No"
                                                   placeholder="<?php echo $this->lang->line('communityNgo_bc_no'); ?>"
                                                   value="<?php echo $gMtr['cm_grt_GrandFBC_No'];?>" id="cm_grt_GrandFBC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cm_grt_GrandFBCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gMtr['cm_grt_GrandFBCDate'];?>" id="cm_grt_GrandFBCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cm_grt_GrandFOccupationId" class="form-control select2"
                                                    name="cm_grt_GrandFOccupationId"
                                                    data-placeholder="<?php echo $this->lang->line('communityngo_Job'); ?>">
                                                <option value=""></option>
                                                <?php
                                                if (!empty($memParentJob)) {
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cm_grt_GrandFNIC_No"
                                                   maxlength="12"
                                                   placeholder="<?php echo $this->lang->line('communityngo_nic'); ?>"
                                                   value="<?php echo $gMtr['cm_grt_GrandFNIC_No'];?>" id="cm_grt_GrandFNIC_No" class="form-control">
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cm_grt_GrandFDC_No" placeholder="<?php echo $this->lang->line('communityNgo_dc_no'); ?>"
                                                   value="<?php echo $gMtr['cm_grt_GrandFDC_No'];?>" id="cm_grt_GrandFDC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cm_grt_GrandFDCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gMtr['cm_grt_GrandFDCDate'];?>" id="cm_grt_GrandFDCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 animated zoomIn">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select onchange="get_grt_memMgrdMotherDel();" id="cm_grt_GdMComMasID" class="form-control select2"
                                                    name="cm_grt_GdMComMasID">
                                                <option data-currency=""
                                                        value=""><?php echo $this->lang->line('communityngo_select_member'); ?></option>
                                                <?php
                                                if (!empty($memFemale_drop)) {
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cm_grt_GrandMIsAlive" class="form-control select2" name="cm_grt_GrandMIsAlive" onchange="get_grtMtrGMAliveStatus();">
                                                <option value=""></option>
                                                <?php $aliveMmg=''; $notAliveMmg=''; if($gMtr['cm_grt_GrandMIsAlive'] == '1') { $aliveMmg ='selected="selected"';} else if($gMtr['cm_grt_GrandMIsAlive'] == '0'){ $notAliveMmg ='selected="selected"';} ?>
                                        ...
                                        <div id="mtrGrtGmDODDiv" style="display: none;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="cm_grt_GrandMDateOfDeath"
                                                           data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                           value="<?php echo $gMtr['cm_grt_GrandMDateOfDeath'];?>" id="cm_grt_GrandMDateOfDeath" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cm_grt_GrandMDOB"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gMtr['cm_grt_GrandMDOB'];?>" id="cm_grt_GrandMDOB" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_born_country'); ?><!--Born Country--></label></div>
                                        <div class="form-group col-sm-4">
                                            <select id="cm_grt_GrandMBornCountry" class="form-control select2"
                                                    name="cm_grt_GrandMBornCountry"
                                                    data-placeholder="<?php echo $this->lang->line('communityNgo_born_country'); ?>" onchange="get_grtMtrGMBornArea();">
                                                <option value=""></option>
                                                <?php
                                                if (!empty($country_drop)) {
                                                    foreach ($country_drop as $val) {
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cm_grt_GrandMBC_No" placeholder="<?php echo $this->lang->line('communityNgo_bc_no'); ?>"
                                                   value="<?php echo $gMtr['cm_grt_GrandMBC_No'];?>" id="cm_grt_GrandMBC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cm_grt_GrandMBCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gMtr['cm_grt_GrandMBCDate'];?>" id="cm_grt_GrandMBCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <select id="cm_grt_GrandMOccupationId" class="form-control select2"
                                                    name="cm_grt_GrandMOccupationId"
                                                    data-placeholder="<?php echo $this->lang->line('communityngo_Job'); ?>">
                                                <option value=""></option>
                                                <?php
                                                if (!empty($memParentJob)) {
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cm_grt_GrandMNIC_No"
                                                   maxlength="12"
                                                   placeholder="<?php echo $this->lang->line('communityngo_nic'); ?>"
                                                   value="<?php echo $gMtr['cm_grt_GrandMNIC_No'];?>" id="cm_grt_GrandMNIC_No" class="form-control">
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <input type="text" name="cm_grt_GrandMDC_No"
                                                   placeholder="<?php echo $this->lang->line('communityNgo_dc_no'); ?>"
                                                   value="<?php echo $gMtr['cm_grt_GrandMDC_No'];?>" id="cm_grt_GrandMDC_No" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label class="title">
                                                <?php echo $this->lang->line('communityNgo_regDate'); ?><!--reg Date --></label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <div class="input-group datepic">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="cm_grt_GrandMDCDate"
                                                       data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                                                       value="<?php echo $gMtr['cm_grt_GrandMDCDate'];?>" id="cm_grt_GrandMDCDate" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function get_grtFtrGPBornArea(){
            ...
            $.ajax({
                ...
                type: 'post',
                dataType: 'html',
                data: {bornConutryId: bornConutryId,'Com_MasterID':Com_MasterID,'areaFor':areaFor,'bldComMasID':bldComMasID},
        ...
        function get_grt_memFgrdFatherDel(){
            ...
            if (cf_grt_GdFComMasID == "" || cf_grt_GdFComMasID == null) {
            } else {
                ...
                $.ajax({
                    ...
                    data: {famComMasterID: cf_grt_GdFComMasID},
        ...
        function get_grt_memFgrdMotherDel(){
            ...
            if (cf_grt_GdMComMasID == "" || cf_grt_GdMComMasID == null) {
            } else {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "CommunityNgo/get_comMemBloodRelative",
                    data: {famComMasterID: cf_grt_GdMComMasID},
                    success: function (datum) {
        ...
        function get_grt_memMgrdFatherDel(){
            ...
            if (cm_grt_GdFComMasID == "" || cm_grt_GdFComMasID == null) {
            } else {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "CommunityNgo/get_comMemBloodRelative",
                    data: {famComMasterID: cm_grt_GdFComMasID},
                    success: function (datum) {
        ...
        function get_grt_memMgrdMotherDel(){
            ...
            if (cm_grt_GdMComMasID == "" || cm_grt_GdMComMasID == null) {
            } else {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "CommunityNgo/get_comMemBloodRelative",
                    data: {famComMasterID: cm_grt_GdMComMasID},
                    success: function (datum) {
