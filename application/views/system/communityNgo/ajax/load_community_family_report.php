                ...
                <table id="tbl_rpt_salesorder" class="borderSpace report-table-condensed" style="width: 100%">
                    ...
                    $r = 1;
                        ...
                        foreach ($rowFMem as $valSm) {
                            if($valSm->isMove ==1 ){
                               $moveStatus= '<span onclick="get_memMoved_history('.$valSm->Com_MasterID.','.$valSm->FamMasterID.', \'' . $valSm->CName_with_initials. '\');" style="width:10px;height:10px;font-size: 0.73em;float: right;background-color: #00a5e6; display:inline-block;color: #00a5e6;" title="Moved To Another Family">mv</span>';
                            ...
                            if($valSm->isActive == 1){ $activeState=''; } else{
                                ...
                                $activeState='<span style="width:10px;height:10px;font-size: 0.73em;float: right;background-color:red; display:inline-block;color: red;margin-left:2px;" title="The Member Is Inactive :'.$INactReson.'">da</span>';}
                            if($valSm->isLeader == '1'){
                            ...
                            ?>
                            <tr>
                                <td><?php echo $r .' '.$rowUserImg; ?></td>
                                <td><?php echo $valSm->CName_with_initials ."&nbsp;". $activeState ."&nbsp;&nbsp;&nbsp;". $moveStatus ?></td>
                                <td><?php echo $valSm->name; ?></td>
                                <td><?php echo $valSm->CDOB; ?></td>
                                <td><?php echo $valSm->Age; ?></td>
        ...
        <div class="modal-dialog" style="width:400px;">
            <div class="modal-content" style="border-radius:12px;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="cmntModTitle">Member - <lable style="font-size: 15px;font-weight: normal;" id="memDetail"></lable></h4>
                </div>
