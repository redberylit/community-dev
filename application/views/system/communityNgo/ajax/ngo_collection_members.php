...
?>
    ...
    <input type="hidden" name="companyFinanceYearID" value="<?php echo $companyFinanceYearID; ?>">
            ...
            <fieldset class="scheduler-border">
                ...
                <div class="col-sm-2" style="">
                    <label class="control-label title"
                           for="companyFinance1YearID"><?php echo $this->lang->line('communityngo_collection_Financial_Year'); ?></label>
                    <?php echo form_dropdown('companyFinance1YearID', $financeyear_arr, $this->common_data['company_data']['companyFinanceYearID'], 'class="form-control select2" id="companyFinance1YearID" disabled '); ?>
                </div>

                <div class="col-sm-2">
                    <label class="control-label title"
                           for="companyFinanceYear"><?php echo $this->lang->line('communityngo_selected_year'); ?></label>
                    <input name="companyFinanceYear" value="<?php echo $companyFinanceYear; ?>" disabled="disabled">

                </div>
                <div class="col-sm-2 filterDivMahallaType">
                    <label class="control-label title" for="MemberAraeID"><?php echo $this->lang->line('communityngo_region'); ?></label>
                    <?php echo form_dropdown('MemberAraeID[]', load_region_fo_members(), '', 'multiple  class="form-control MemberAraeID" onchange="get_memberAreaType(\'ngoMemberAraeID\')" id="MemberAraeID" required'); ?>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var ngoMemberAraeID = localStorage.ngoMemberAraeID;
            if (ngoMemberAraeID != undefined) {
                if (ngoMemberAraeID != 'null') {
                    $('#MemberAraeID').val(localStorage.ngoMemberAraeID).change();
                }
            }
            ...
            $("#MemberAraeID").multiselect2('selectAll', false);
            $("#MemberAraeID").multiselect2('updateButtonText');
        ...
        function get_memberAreaType(MemberAraeID){

            if (MemberAraeID != undefined) {
                window.localStorage.setItem(MemberAraeID, $('#MemberAraeID').val());
            } else {
            }
            get_member_for_collection();
        }
