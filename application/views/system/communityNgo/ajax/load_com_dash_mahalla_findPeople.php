        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="padding:10px;">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
                ...
                <div class="" role="group" aria-label="...">
                                    ...
                                    <div class="has-feedback">
                                        <div class="input-group">
                                            <input name="searchTask" type="text" class="form-control input-sm"
                                                   placeholder="Search..."
                                                   id="searchTask" title="Search by NIC or Contact NO or Contact Address">
                                            <span class="input-group-addon" data-toggle="tooltip" title="Search"
                                                  onclick="start_peopleSearch();"><i class="fa fa-search" aria-hidden="true"></i></span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <span class="tipped-top"><a id="cancelSearch" href="#" onclick="clear_peopleSearch()"><img
