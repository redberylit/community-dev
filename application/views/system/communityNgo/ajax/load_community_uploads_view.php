...
if(!empty($uploadDate)) {
    foreach ($uploadDate as $resReNd) {
        ...
        if($ComUploadExpire == 0){
            ...
            $date = " AND ( ComUploadExpireDate >= '". $dateto ."')";
        }else if($ComUploadExpire == 2){
            $date = " AND ( ComUploadExpireDate BETWEEN '". $datefrom ."' AND '" . $dateto . " ')";
        }
        ...
        $where_comUpld = join(" ", array_keys($set_filter_ne));
        ?>
                ...
                <div class="box-body" style="margin-top:-20px;">
                    ...
                    <ul class="timeline timeline-inverse">
                        ...
                        foreach ($resEvn1List as $res1Elist) {
                            ...
                            if($date2->y != 0 && $date2->m !=0 && $date2->d != 0 && $date2->h !=0 && $date2->i != 0 && $date2->s != 0){
                                $get_tmDiff=  $upYears .$upMonths .$upDays .'ago';
                            }
                            elseif($date2->y ==0 && $date2->m !=0){
                                 $get_tmDiff=  $upMonths .$upDays .'ago';
                             }
                            elseif(($date2->y ==0 && $date2->m == 0) && $date2->d != 0){
                                $get_tmDiff=  $upDays .'ago';
                            }
                            ...
                            <?php if ($res1Elist->ComUploadType == 1) { ?>
                                <li>
                                    ...
                                    <div class="timeline-item" style="overflow-y: auto;">

                                        <div class="btn-group" role="group">
                                            <?php if($res1Elist->ComUploadSubmited == 1){ ?>

                                                <button class="btn btn-xs btn-danger" onclick="com_uploadDelete(<?php echo $res1Elist->ComUploadID; ?>,<?php echo $res1Elist->ComUploadType; ?>,'<?php echo $res1Elist->ComUploadFileName; ?>')"
                                        ...
                                        <div class="timeline-body">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><strong>:</strong></td>
                                                    <td colspan="4"><?php echo $res1Elist->UploadPublishedDate; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong><?php echo $this->lang->line('common_expire_date');?></strong></td>
                                                    <td><strong>:</strong></td>
                                                    <td colspan="4"><?php echo $res1Elist->ComUploadExpireDate; ?></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="timeline-footer">
                                            <div class="text-muted" style="float:right;font-size: 12px;color: #d6d6d6;">Video</div>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12" style="padding:2px;">
                        <ul class="timeline timeline-inverse">
                            <!-- timeline for general -->
                            <?php
                            $eventsList= $this->db->query("SELECT srp_erp_ngo_com_uploads.ComUploadID, srp_erp_ngo_com_uploads.ComUploadType,ComUploadFileName, (DATE_FORMAT(UploadPublishedDate,'{$convertFormat}'))as UploadPublishedDate, ComUploadSubject,ComUpload_url, ComUploadDescription, (DATE_FORMAT(ComUploadExpireDate,'{$convertFormat}'))as ComUploadExpireDate,  ComUploadSubmited,srp_erp_ngo_com_uploads.CreatedDate FROM srp_erp_ngo_com_uploads WHERE srp_erp_ngo_com_uploads.companyID = {$companyID} AND familyUplaod='0' AND ComUploadType='2' AND srp_erp_ngo_com_uploads.UploadPublishedDate ='".$publisedDat."' $date $where_comUpld ORDER BY srp_erp_ngo_com_uploads.ComUploadID DESC ");
                                        ...
                                        <div class="timeline-item" style="overflow-y: auto;">
                                            <div class="btn-group" role="group">
                                                <?php if($resElist->ComUploadSubmited == 1){ ?>
                                                    <button class="btn btn-xs btn-danger" onclick="com_uploadDelete(<?php echo $resElist->ComUploadID; ?>,<?php echo $resElist->ComUploadType; ?>,'<?php echo $resElist->ComUploadFileName; ?>')"
                                                            title="Delete" rel="tooltip" type="button">
                                                        <i class="fa fa-trash"></i>
                                                    </button>
                                                <?php } else{?>
                                            ...
                                            <div class="timeline-body">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td><strong><?php echo $this->lang->line('communityngo_upload_publish');?></strong></td>
                                                        <td><strong>:</strong></td>
                                                        <td colspan="4"><?php echo $resElist->UploadPublishedDate; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong><?php echo $this->lang->line('common_expire_date');?></strong></td>
                                                        <td><strong>:</strong></td>
                                                        <td colspan="4"><?php echo $resElist->ComUploadExpireDate; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong><?php echo $this->lang->line('common_description');?></strong></td>
                                                        <td><strong>:</strong></td>
                                                    ...
                                                    <tr style="text-align: center;">
                                                        ...
                                                        <span class="tipped-top"><a data-modal="#comAudio_modal" onclick="openComAudio_modal('<?php echo $resElist->ComUpload_url; ?>','<?php echo $resElist->ComUploadSubject; ?>');"><img
                                                                    src="<?php echo base_url("images/community/videoImg2.jpg") ?>"></a></span>
                                            ...
                                            <div class="timeline-footer">
                                                <div class="text-muted" style="float:right;font-size: 12px;color: #d6d6d6;">Audio</div>
                                            </div>
                                        </div>
                                    </li>
    ...
    <?php } ?>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12" style="padding:2px;">
                        <ul class="timeline timeline-inverse">
                            <!-- timeline for general -->
                            <?php
                            $eventsList= $this->db->query("SELECT srp_erp_ngo_com_uploads.ComUploadID, srp_erp_ngo_com_uploads.ComUploadType, (DATE_FORMAT(UploadPublishedDate,'{$convertFormat}'))as UploadPublishedDate, ComUploadSubject,ComUploadFileName,ComUploadFileType,ComUploadFileSize, ComUploadDescription, (DATE_FORMAT(ComUploadExpireDate,'{$convertFormat}'))as ComUploadExpireDate,  ComUploadSubmited,srp_erp_ngo_com_uploads.CreatedDate FROM srp_erp_ngo_com_uploads WHERE srp_erp_ngo_com_uploads.companyID = {$companyID} AND familyUplaod='0' AND ComUploadType='3' AND srp_erp_ngo_com_uploads.UploadPublishedDate ='".$publisedDat."' $date $where_comUpld ORDER BY srp_erp_ngo_com_uploads.ComUploadID DESC ");
                            $resupldDoc = $eventsList->result();
                            if(!empty($resupldDoc)){
                                foreach ($resupldDoc as $resuDoc) {

                                    $date1 = new DateTime($resuDoc->CreatedDate);
                                    $date2 = $date1->diff(new DateTime($current_dtTime));
                                    $upYears= $date2->y.' years'."\n";
                                    $upMonths= $date2->m.' months'."\n";
                                    $upDays = $date2->d.' days'."\n";
                                    ...
                                    ?>
                                    <?php if ($resuDoc->ComUploadType == 3) { ?>
                                        <li>
                                            <i class="fa fa-file-o bg-green"></i>

                                            <div class="timeline-item" style="overflow-y: auto;">
                                                <div class="btn-group" role="group">
                                                    <button class="btn btn-xs btn-danger" onclick="com_uploadDelete(<?php echo $resuDoc->ComUploadID; ?>,<?php echo $resuDoc->ComUploadType; ?>,'<?php echo $resuDoc->ComUploadFileName; ?>')"
                                                            title="Delete" rel="tooltip" type="button">
                                                        <i class="fa fa-trash"></i>
                                                    </button>
                                                </div>
                                                ...
                                                <h4 style="font-size: 12px;" class="timeline-header"><a href="#"><?php echo $resuDoc->ComUploadSubject; ?></a></h4>
                                                ...
                                                <div class="timeline-body">
                                                    <table>
                                                        <tbody>
                                                        <tr>
                                                            <td><strong><?php echo $this->lang->line('communityngo_upload_doc');?></strong></td>
                                                            <td><strong>:</strong></td>
                                                            <td colspan="4">
                                                                <img src="<?php echo base_url('images/community/icon_pic.gif'); ?>"
                                                                     style="vertical-align:top"> &nbsp;<a target="_blank" class="nopjax"
                                                                                                          href="<?php echo base_url() . 'attachments/' . $resuDoc->ComUploadFileName ?>"><?php echo $resuDoc->ComUploadFileName; ?></a>
                                                                <span style="display: inline-block;"><?php echo $resuDoc->ComUploadFileSize ?> KB</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong><?php echo $this->lang->line('communityngo_upload_publish');?></strong></td>
                                                            <td><strong>:</strong></td>
                                                            <td colspan="4"><?php echo $resuDoc->UploadPublishedDate; ?></td>

                                                        </tr>
                                                        <tr>
                                                            <td><strong><?php echo $this->lang->line('common_expire_date');?></strong></td>
                                                            <td><strong>:</strong></td>
                                                            <td colspan="4"><?php echo $resuDoc->ComUploadExpireDate; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong><?php echo $this->lang->line('common_description');?></strong></td>
                                                            <td><strong>:</strong></td>
                                                            <td colspan="4"><?php echo $resuDoc->ComUploadDescription; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong><?php echo $this->lang->line('common_status');?></strong></td>
                                                            <td><strong>:</strong></td>
                                                            <td colspan="4">
                                                                <?php if($resuDoc->ComUploadSubmited==1) {?>
                                                                    <span class="label label-success">Submitted for Public</span>
                                                                <?php } else{ ?>
                                                                    <span class="label label-warning">Save As Draft</span>
                                                                <?php }  ?>
                                                ...
                                                <div class="timeline-footer">
                                                    <div class="text-muted" style="float:right;font-size: 12px;color: #d6d6d6;">Document</div>
                                                </div>
                                            </div>
                                        </li>
...
<?php } ?>
    ...
    <div class="example-modal">
        <div class="modal fade" id="comAudio_modal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="closeUpldAudio_com();"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal" onclick="closeUpldAudio_com();"><?php echo $this->lang->line('common_Close');?><!--Close--></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function openComAudio_modal(ComUpload_url,ComUploadSubject)
        {

            $("iframe#taudio").attr('src',ComUpload_url);

            document.getElementById('audioSubject').innerHTML = ComUploadSubject;

            $('#comAudio_modal').modal('show');



        }

        function closeUpldAudio_com() {

            $("iframe#taudio").attr('src','');

            $('#comAudio_modal').modal({backdrop: "static"});
