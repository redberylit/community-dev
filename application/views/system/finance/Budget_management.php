...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="modal_budget_header();"><i
                ...
                <div class="row">
                 ...
                 <!--   <div class="form-group col-sm-4 "><label for="financeyear">Financial
                    ...
                    <div class="form-group col-sm-4 "><label
                        ...
                        <div
                            class=""> <?php echo form_dropdown('segment_gl', $segment_arr, $this->common_data['company_data']['default_segment'], 'class="form-control" id="segment_gl" required'); ?> </div>
                    </div>
