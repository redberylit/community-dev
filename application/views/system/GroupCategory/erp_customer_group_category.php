<?php echo head_page('Customer Category', false); ?>
...
<div class="row table-responsive">
    ...
    <div class="col-md-7 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="opencustomercategorymodel()"><i class="fa fa-plus"></i> Create Category </button>
    </div>
</div>
<hr>
            ...
            <?php echo form_open('', 'role="form" id="customer_category_form"'); ?>
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-primary " onclick="saveCategory()"><i class="fa fa-plus"></i> Save
                        </button>
    ...
    <div class="modal-dialog" style="width: 60%">
        <div class="modal-content" id="">
            ...
            <div class="modal-body" style="margin-left: 10px">
                <div class="row">
                    <div class="col-sm-12">
                        <label for="customerName"><h4>Customer Category :- </h4></label>
...
<script type="text/javascript">
    ...
    function link_group_customer_category(partyCategoryID) {
        $('#customerCategoryLinkModal').modal({backdrop: "static"});
        //$('#companyID').val('').change();
