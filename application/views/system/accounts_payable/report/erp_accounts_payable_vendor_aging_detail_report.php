                ...
                <div class="fixHeader_Div">
                    <table class="borderSpace report-table-condensed" id="tbl_report">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line('accounts_payable_invoice_code');?><!--Invoice Code--></th>
                            ...
                            foreach ($category as $key => $mainCategory) {
                                ...
                                foreach ($mainCategory as $key2 => $subCategory) {
                                    ...
                                    if ($isRptCost || $isLocCost) {
                                        echo "<tr>";
                                        echo "<td colspan='5'><strong>$subtot<!--Sub Total--></strong></td>";
                                        if ($isRptCost) {
                        ...
                        if ($isRptCost || $isLocCost) {
                            echo "<tr>";
                            echo "<td colspan='5'><strong>$grand<!--Grand Total--></strong></td>";
                            if ($isRptCost) {
