    ...
    <table style="width: 100%">
        <tbody>
            ...
            <tr>
                ...
                <td><strong>:</strong></td>
                <td colspan="3"> <?php echo $extra['master']['comments']; ?></td>
            </tr>
       </tbody>
    </table>
</div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-condensed">
            ...
            <tr>
                ...
                <th class='theadtr'
                    style="min-width: 15%">Item Code</th>
                <th class='theadtr'
                    style="min-width: 45%">Item Description</th>
                <!---->
                <th class='theadtr'
                    style="min-width: 10%">UOM</th>
                <!---->
                <th class='theadtr'
                    style="min-width: 5%">Qty</th>
                <!---->
                <th class='theadtr'
                    style="min-width: 10%">Unit</th>
                <!---->
