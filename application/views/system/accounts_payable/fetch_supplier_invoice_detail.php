...
<div class="row">
    <div class="col-md-8"><h4>&nbsp;&nbsp;&nbsp;<i class="fa fa-hand-o-right"></i> <?php echo $this->lang->line('accounts_payable_add_item_grv_base');?><!--Add Item GRV Base--> </h4></div>
    <div class="col-md-4">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('accounts_payable_grv_base');?><!--GRV Base--></h4>
            </div>
            <div class="modal-body">
                <table class="table table-bordered table-striped table-condesed ">
                    <thead>
                    <tr>
                        <th colspan="4"><?php echo $this->lang->line('accounts_payable_grv_detail');?><!--GRV Details--></th>
                        <th colspan="4"><?php echo $this->lang->line('common_amount');?><!--Amount--> <span class="currency"> (<?php echo $master['transactionCurrency']; ?>
                                )</span></th>
                    </tr>
                    <tr>
                        <th style="width: 5%">#</th>
                        <th style="width: 30%"><?php echo $this->lang->line('accounts_payable_grv_code');?><!--GRV Code--></th>
                        <th style="width: 30%"><?php echo $this->lang->line('accounts_payable_grv_date');?><!--GRV Date--></th>
                        <th style="width: 20%"><?php echo $this->lang->line('accounts_payable_reference_no');?><!--Reference No--></th>
                        <th style="width: 15%"><?php echo $this->lang->line('accounts_payable_grv_total');?><!--GRV Total--></th>
                        <th style="width: 10%"><?php echo $this->lang->line('accounts_payable_invoiced');?><!--Invoiced--></th>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="save_grv_base_items()"><?php echo $this->lang->line('common_save_change');?><!--Save changes--></button>
            </div>
        </div>
    </div>
</div>
<div class="table-responsive">
    <table id="add_new_grv_table" class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <th class='theadtr' style="min-width: 12%"><?php echo $this->lang->line('common_transaction');?><!--Transaction--> (<?php echo $master['transactionCurrency']; ?>)</th>
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs pull-right">
            <li class="active itmtb" id="tabli_1"><a class="boldtab" data-toggle="tab" href="#tab_1" aria-expanded="false">GL</a></li>
            <li class="itmtb" id="tabli_2"><a class="boldtab" data-toggle="tab" href="#tab_2" aria-expanded="false"><?php echo $this->lang->line('common_item'); ?><!--Item--></a></li>
            <li class="itmtb" id="tabli_3"><a class="boldtab" data-toggle="tab" href="#tab_3" aria-expanded="false">PO</a></li>
        ...
        <div class="tab-content">
            <div id="tab_1" class="tab-pane itmtb active">
                <table id="add_new_grv_table" class="<?php echo table_class(); ?>">
                    ...
                    <tr>
                        ...
                        <th><button type="button" onclick="load_supplier_detail_modal()" class="btn btn-primary btn-xs"><i
                    ...
                    <tr>
                        ...
                        <th style="min-width: 35%"><?php echo $this->lang->line('common_gl_code_description');?><!--GL Code Description--></th>
                        <th style="min-width: 15%"><?php echo $this->lang->line('common_segment');?><!--Segment--></th>
                        <th style="min-width: 12%"><?php echo $this->lang->line('common_transaction');?><!--Transaction--> (<?php echo $master['transactionCurrency']; ?>)</th>
            ...
            <th style="min-width: 10%">Supplier (<?php //echo $master['supplierCurrency']; ?>)</th> -->
                    ...
                    <tfoot>
                    <tr>
                        <td class="text-right" colspan="4"><?php echo $this->lang->line('common_total');?><!--Total--></td>
                        <td class="text-right total"><?php echo format_number($transaction_total, $master['transactionCurrencyDecimalPlaces']); ?></td>
                        <!-- <td class="text-right total"><?php //echo format_number($Local_total, $master['companyLocalCurrencyDecimalPlaces']); ?></td>
            <td class="text-right total"><?php //echo format_number($supplier_total, $master['supplierCurrencyDecimalPlaces']); ?></td> -->
                        <td>&nbsp;</td>
                ...
                <table class="table table-bordered table-striped table-condesed">
                    ...
                    if (!empty($detail['ItemDetail'])) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $itmd['unittransactionAmount'] ?></td>
                            <td style="text-align: right;"><?php echo format_number($itmd['transactionAmount'], $master['transactionCurrencyDecimalPlaces'])  ?></td>
                            <td class="text-right"><a onclick="edit_bsi_item(<?php echo $itmd['InvoiceDetailAutoID'] ?>);"><span style="color:#3c8dbc;" class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a onclick="delete_item(<?php echo $itmd['InvoiceDetailAutoID'] ?>,2);"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td>
                        </tr>
                        <?php
            ...
            <div id="tab_3" class="tab-pane itmtb">
                <div class="row">
                    <div class="col-md-8"><h4>&nbsp;&nbsp;&nbsp;<i
                                class="fa fa-hand-o-right"></i>Add Item PO Base
                        </h4><h4></h4><!--Add Item PO Base-->
                    </div>
                    <div class="col-md-4">
                        <button type="button" data-toggle="modal" data-target="#po_base_modal" class="btn btn-primary pull-right"><i
                ...
                <div class="table-responsive">
                    <table id="add_new_grv_table" class="<?php echo table_class(); ?>">
                        ...
                        <tbody id="po_table_body">
                            ...
                            foreach($detail['poDetail'] as $itmd){
                                ...
                                <tr>
                                    <td><?php echo $p ?></td>
                                    <td><?php echo $itmd['itemSystemCode'] ?></td>
                                    <td><?php echo $itmd['purchaseOrderCode'] ?> - <?php echo $itmd['Itemdescriptionpartno'] ?></td>
                                    ...
                                    <td class="text-right"><a onclick="edit_item_po(<?php echo $itmd['InvoiceDetailAutoID'] ?> ,<?php echo $itmd['purchaseOrderMastertID'] ?>)"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; | &nbsp;&nbsp;  <a onclick="delete_item(<?php echo $itmd['InvoiceDetailAutoID'] ?>,3);"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td>
                                </tr>
                                <?php
                                $transaction_total += ($itmd['transactionAmount']);
                                ...
                                ?>
                                <tr class="danger"><td colspan="11" class="text-center"><b>No Records Found</b></td></tr>
                            <?php
                            }
                            ?>
                        </tbody>
                        <tfoot>
                        <tr>
                            <td class="text-right" colspan="6">Ordered Item Total (<?php echo $master['transactionCurrency']; ?>)</td>
                            <td class="text-right total"><?php echo format_number($orded_total, $master['transactionCurrencyDecimalPlaces'])  ?> </td>
                            <td class="text-right" colspan="2">Received Item Total (<?php echo $master['transactionCurrency']; ?>)</td>
                                    ...
                                    <div class="col-md-9">
                                        <table class="table table-bordered table-striped table-condesed ">
                                            ...
                                            <tr>
                                                ...
                                                <th colspan='2'>Ordered Item (<?php echo $master['transactionCurrency'] ?>)</th><!--Ordered Item-->
                                                <th colspan='3'>Received Item (<?php echo $master['transactionCurrency'] ?>)</th><!--Received Item-->
                                            <tr>
                                            <tr>
                                                <th>#</th>
                                                <th>Code </th><!--Code-->
    ...
    <div class="table-responsive">
            ...
            <div class="modal-dialog" style="width: 80%;">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                        <h5 class="modal-title"><?php echo $this->lang->line('common_add_detail');?><!--Add Detail--></h5>
                    </div>
                    <div class="modal-body">
                        <form role="form" id="bsi_detail_form" class="form-horizontal">
                            <table class="table table-bordered table-condensed no-color"
                                ...
                                <tr>
                                    ...
                                    <th style="width: 150px;"><?php echo $this->lang->line('common_segment');?><!--Segment--></th>
                                    <?php if ($projectExist == 1) { ?>
                                        <th><?php echo $this->lang->line('common_project');?><!--Project--> <?php required_mark(); ?></th>
                                    <?php } ?>
                                    <th style="width: 150px;"><?php echo $this->lang->line('common_amount');?><!--Amount--> (<span
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" type="button" onclick="saveSupplierINvoiceDetails()"><?php echo $this->lang->line('common_save_change');?><!--Save Changes-->
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog" style="width: 80%;">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                        <h5 class="modal-title"><?php echo $this->lang->line('accounts_payable_edit_item_detail');?><!--Edit Item Detail--></h5>
                    </div>
                    <div class="modal-body">
                        <form role="form" id="edit_bsi_detail_form" class="form-horizontal">
                            <table class="table table-bordered table-condensed no-color"
                                ...
                                <thead>
                                <tr>
                                    <th style="width: 350px;"><!--GL Code--><?php echo $this->lang->line('common_gl_code');?> <?php required_mark(); ?></th>
                                    <th><!--Segment--><?php echo $this->lang->line('common_segment');?></th>
                                    <?php if ($projectExist == 1) { ?>
                                        <th><!--Project--><?php echo $this->lang->line('common_project');?> <?php required_mark(); ?></th>
                                    <?php } ?>
                                    <th style="width: 150px;"><?php echo $this->lang->line('common_amount');?><!--Amount--> (<span
                                            class="currency"> (LKR)</span>) <?php required_mark(); ?></th>
                                    <th style="width: 200px;"><?php echo $this->lang->line('common_description');?><!--Description--> <?php required_mark(); ?></th>
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <td>
                                        <input type="text" name="amount" id="edit_amount" onfocus="this.select();" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number">
                                    </td>
                                    <td>
                    ...
                    <div class="modal-footer">
                        <button data-dismiss="modal" class="btn btn-default" type="button"><?php echo $this->lang->line('common_Close');?><!--Close--></button>
                        <button class="btn btn-primary" type="button" onclick="UpdateSupplierINvoiceDetails()"><?php echo $this->lang->line('common_update_changes');?><!--Update Changes-->
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div aria-hidden="true" role="dialog" id="edit_bsi_po_detail_modal" class="modal fade" style="display: none;">
            <div class="modal-dialog" style="width: 80%;">
                <div class="modal-content">
                        ...
                        <form role="form" id="edit_bsi_po_detail_form" class="form-horizontal">
                            <table class="table table-bordered table-condensed no-color"
                                ...
                                <tr>
                                    ...
                                    <th style="width: 150px;">Net Amount (<span class="currency"> (LKR)</span>) <?php required_mark(); ?></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" onchange="po_edit_amount_cal(1)" name="requestedQty" id="edit_qtyPO" onfocus="this.select();" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number">
                                    </td>
                                    <td>
                                        <input type="text" onchange="po_edit_amount_cal(2)" name="unittransactionAmount" id="edit_UnitamountPO" onfocus="this.select();" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number">
                                    </td>
                                    <td>
                                        <input type="text" onchange="po_edit_amount_cal(3)" name="transactionAmount" id="edit_transactionAmountPO" onfocus="this.select();" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number">
                                    </td>
                                    <td>
                                        <textarea class="form-control" rows="1" id="edit_descriptionPO" name="description"></textarea>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="modal-footer">
                        <button data-dismiss="modal" class="btn btn-default" type="button"><?php echo $this->lang->line('common_Close');?><!--Close--></button>
                        <button class="btn btn-primary" type="button" onclick="UpdateSupplierINvoicePODetails()"><?php echo $this->lang->line('common_update_changes');?><!--Update Changes-->
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <label for="exampleInputName2"><?php echo $this->lang->line('accounts_payable_tax_applicable_amount');?><!--Tax Applicable Amount-->
                    ( <?php echo number_format($transaction_total, $master['transactionCurrencyDecimalPlaces']); ?>
                    ) </label>

                <form class="form-inline" id="tax_form">
                    <div class="form-group">
                        <?php echo form_dropdown('text_type', all_tax_drop(), '', 'class="form-control" id="text_type" required onchange="select_text(this,' . $transaction_total . ')" style="width: 200px;"'); ?>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <input type="text" class="form-control number" id="percentage" name="percentage"
                                   style="width: 80px;" onkeyup="cal_tax(this.value,<?php echo $transaction_total; ?>)">
            ...
            <div class="col-md-6">
                <table class="<?php echo table_class(); ?>">
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('common_amount');?><!--Amount--> (<?php echo $master['transactionCurrency']; ?>)</th>
                        <th>&nbsp;</th>
                    </tr>
                    </thead>
                    <body>
                    ...
                    if (!empty($detail['tax'])) {
                        for ($i = 0; $i < count($detail['tax']); $i++) {
                            ...
                            echo '<td class="text-right">' . format_number((($detail['tax'][$i]['taxPercentage'] / 100) * $transaction_total), $master['transactionCurrencyDecimalPlaces']) . '</td>';
                            // echo '<td class="text-right">'.format_number($detail['detail'][$i]['companyLocalAmount'],$master['companyLocalCurrencyDecimalPlaces']).'</td>';
                            // echo '<td class="text-right">'.format_number($detail['detail'][$i]['supplierAmount'],$master['supplierCurrencyDecimalPlaces']).'</td>';
                            ...
                            echo '</tr>';
                            $tax_total += ($detail['tax'][$i]['taxPercentage'] / 100) * $transaction_total;
                        }
                    } else {
                        $norec= $this->lang->line('common_no_records_found');
    ...
    <script type="text/javascript">
        ...
        function initializeitemTypeahead(id) {
            $('#f_search_' + id).autocomplete({
                serviceUrl: '<?php echo site_url();?>/Procurement/fetch_itemrecode_po/',
                    ...
                    success: function (data) {
                        ...
                        if (jQuery.isEmptyObject(data['detail'])) {
                            ...
                            $.each(data['detail'], function (key, value) {
                                ...
                                cost_status = '<input type="text" class="number" size="15" id="amount_' + value['purchaseOrderDetailsID'] + '" value="' + parseFloat(value['unitAmount']-(value['generalDiscountAmount']/value['requestedQty'])) + '" onkeyup="select_value(' + value['purchaseOrderDetailsID'] + ')" >';

                                if (data['policy_po_cost_change'] == 0) {
                                    cost_status = '<input type="hidden" class="number" size="15" id="amount_' + value['purchaseOrderDetailsID'] + '" value="' + parseFloat(value['unitAmount']-(value['generalDiscountAmount']/value['requestedQty'])) + '" onkeyup="select_value(' + value['purchaseOrderDetailsID'] + ')" >' + parseFloat(value['unitAmount']);
                                }
        ...
        function save_po_base_items() {
            ...
            if (!jQuery.isEmptyObject(selected)) {
                $.ajax({
                    ...
                    type: 'post',
                    dataType: 'json',
                    data: {'DetailsID': selected, 'InvoiceAutoID': InvoiceAutoID, 'amount': amount, 'qty': qty, 'location': location},
