...
$mrClass = '';
$colspan = 7;
if ($extra['master']['receiptType'] != 'Material Request') {
    $mrClass = 'hide';
    $colspan = 6;
}?>
<div class="table-responsive">
    ...
    <table class="table table-bordered table-striped">
        <thead>
            ...
            <tr>
                ...
                <th class='theadtr <?php echo $mrClass; ?>' style="min-width: 10%">MI Code</th>
                ...
                <th class='theadtr' style="min-width: 10%"><?php echo $this->lang->line('common_unit_cost');?> </th><!--Unit Cost-->
        ...
        <tbody>
            ...
            if (!empty($extra['detail'])) {
                ...
                <tr>
                    ...
                    <td class="<?php echo $mrClass; ?>"><?php echo $val['itemIssueCode']; ?>.&nbsp;</td>
                ...
                echo '<tr class="danger"><td colspan="8" class="text-center">'.$norec.'<!--No Records Found--></td></tr>';
            } ?>
        </tbody>
        <tfoot>
            <tr>
