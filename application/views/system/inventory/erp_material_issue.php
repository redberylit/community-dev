                ...
                if (jQuery.isEmptyObject(data['detail'])) {
                    ...
                    $.each(data['detail'], function (key, value) {
                        ...
                        if (value['isSubitemExist'] == 1) {
                            ...
                            string = '<tr><td>' + x + '</td><td class="mrBaseDiveTable">' + value['MRCode'] + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-right">' + value['qtyIssued'] + '</td><td class="text-right">' + parseFloat(value['currentlWacAmount']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right">' + parseFloat(value['totalValue']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right"><a onclick="edit_glaccount(' + value['itemIssueDetailID'] + ',' + value['PLGLAutoID'] + ',' + value['BLGLAutoID'] + ');"><span class="glyphicon glyphicon-transfer"></span></a> &nbsp;&nbsp;|&nbsp;&nbsp; &nbsp;&nbsp; <a onclick="edit_item(' + value['itemIssueDetailID'] + ',this);"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; |&nbsp;&nbsp; <a onclick="delete_item(' + value['itemIssueDetailID'] +');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
            ...
            success: function (data) {
                ...
                if (!jQuery.isEmptyObject(data)) {
                    $.each(data, function (key, value) {
                        var balanceQTY = value['qtyRequested'] - value['mrQty'];
                        if(balanceQTY>0){
