        ...
        <table class="<?php echo table_class(); ?>">
            ...
            <tr>
                <td class="text-right sub_total"
                    colspan="10">Adjustment Item Total
                </td>
                    ...
                    if (jQuery.isEmptyObject(data)) {
                        ...
                        $.each(data, function (key, value) {
                            ...
                            if (value['isSubitemExist'] == 1 && previousStock != currentStock && value['isUpdated'] == 1) {
                                ...
                                var string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-center">' + adjeststk + '</td><td class="text-right">' + jsSet + '<a onclick="edit_item(' + value['stockCountingDetailsAutoID'] + ',\'' + value['itemDescription'] + '\');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="delete_item(' + value['stockCountingDetailsAutoID'] + ');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td><td style="text-align: center;"><input type="checkbox" class="deletechk" name="deletechk[]" id="deletechk_' + value['stockCountingDetailsAutoID'] + '" value="' + value['stockCountingDetailsAutoID'] + '"></td></tr>';
                                ...
                                var string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-center">' + adjeststk + '</td><td class="text-right"><a onclick="edit_glaccount(' + value['stockCountingDetailsAutoID'] + ',\'' + value['PLGLAutoID'] + '\',\'' + value['BLGLAutoID'] + '\');"><span class="glyphicon glyphicon-transfer"></span></a> &nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="edit_item(' + value['stockCountingDetailsAutoID'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="delete_item(' + value['stockCountingDetailsAutoID'] + ');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td><td style="text-align: center;"><input type="checkbox" class="deletechk" name="deletechk[]" id="deletechk_' + value['stockCountingDetailsAutoID'] + '" value="' + value['stockCountingDetailsAutoID'] + '"></td></tr>';
                            }
