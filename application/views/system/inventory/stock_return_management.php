...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right"
                onclick="fetchPage('system/inventory/erp_stock_return',null,'Add New Purchase Return','GRV');"><i
...
<script type="text/javascript">
    ...
    function stock_return_table(selectedID=null) {
         ...
         Otable = $('#stock_return_table2').DataTable({
            ...
            "columnDefs": [{"targets": [7], "orderable": false},{"visible":false,"searchable": true,"targets": [8] }],
