        ...
        if (stockTransferAutoID) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (jQuery.isEmptyObject(data)) {
                        ...
                        $.each(data, function (key, value) {
                            ...
                            if (value['isSubitemExist'] == 1) {
                                ...
                                string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-right">' + value['transfer_QTY'] + '</td><td class="text-right">' + parseFloat(value['currentlWacAmount']).formatMoney(descm, '.', ',') + '</td><td class="text-right">' + parseFloat(value['totalValue']).formatMoney(descm, '.', ',') + '</td><td class="text-right"><a style="' + colour + '" onclick="load_itemMasterSub_config_modal(' + value['stockTransferDetailsID'] + ',\'ST\',' + value['from_wareHouseAutoID'] + ')"><i class="fa fa-list"></i></a> &nbsp;&nbsp; | &nbsp;&nbsp; <a onclick="edit_item(' + value['stockTransferDetailsID'] + ');"><span class="glyphicon glyphicon-pencil"></span></a>  &nbsp;&nbsp; | &nbsp;&nbsp;<a onclick="delete_stock_transferDetails(' + value['stockTransferDetailsID'] + ');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
                            } else {

                                string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-right">' + value['transfer_QTY'] + '</td><td class="text-right">' + parseFloat(value['currentlWacAmount']).formatMoney(descm, '.', ',') + '</td><td class="text-right">' + parseFloat(value['totalValue']).formatMoney(descm, '.', ',') + '</td><td class="text-right"><a onclick="edit_item(' + value['stockTransferDetailsID'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; | &nbsp;&nbsp;<a onclick="delete_stock_transferDetails(' + value['stockTransferDetailsID'] + ');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
                    ...
                    $('#item_table_tfoot').html('<tr> <td class="text-right" colspan="6"> <?php echo $this->lang->line('common_total');?> </td><td class="text-right total">' + total.formatMoney(descm, '.', ',') + '</td><td></td></tr>')
                    stopLoad();<!--Total-->
