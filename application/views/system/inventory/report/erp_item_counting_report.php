...
-- REVISION HISTORY
-- Modified By : Shafri on 15-05-2017 sub item configuration in the reports | to incorporate sub item master only in item counting report
-- =============================================-->
<?php
...
<div class="row">
    <div class="col-md-12">
        <?php
        if ($type == 'html') {
            echo export_buttons('tbl_item_counting', 'Item Counting');
        } ?>
    </div>
</div>
            ...
            <?php if (!empty($output)) { ?>
                <table class="borderSpace report-table-condensed" id="demo">
                        ...
                        foreach ($category as $key => $mainCategory) {
                            ...
                            foreach ($mainCategory as $key2 => $subCategory) {
                                ...
                                foreach ($subsubCategory as $item) {
                                    ...
                                    /** Added by shafri on 15-05-2017 to incorporate sub item master only in item counting report */
                    ...
                    <tr>
                        ...
                        echo "<td colspan='5'><strong>$grandtot<!--Grant Total--></strong></td>";
