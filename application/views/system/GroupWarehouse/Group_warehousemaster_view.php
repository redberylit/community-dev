<?php echo head_page('Group Warehouse Master', false); ?>
...
<div class="table-responsive">
    <table id="warehousemaster_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 20%">Warehouse Code</th>
    ...
    <div class="modal-dialog" style="width: 60%">
        <div class="modal-content" id="">
            ...
            <div class="modal-body" style="margin-left: 10px">
                <div class="row">
                    <div class="col-sm-12">
                        <label for="warehouseName"><h4>Warehouse :- </h4></label>
...
<script type="text/javascript">
    ...
    function open_warehouse_model() {
        ...
        $('#WarehouseHead').html('Add New Warehouse');
    ...
    function link_group_warehouse(wareHouseAutoID) {
        $('#WarehouseLinkModal').modal({backdrop: "static"});
        $('#companyID').val('').change();
    ...
    function load_company(wareHouseAutoID) {
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: {wareHouseAutoID: wareHouseAutoID, All: 'true'},
    ...
    function load_warehouse_details_table() {
        Otable = $('#warehouse_group_details').DataTable({
            ...
            "fnServerData": function (sSource, aoData, fnCallback) {
                aoData.push({"name": "groupWarehouseMasterID", "value": $('#groupwareHouseAutoID').val()});
                $.ajax({
                    'dataType': 'json',
                    'type': 'POST',
                    'url': sSource,
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    type: 'post',
                    dataType: 'json',
                    data: {'groupWarehouseDetailID': id},
    ...
    function load_all_companies_warehouses() {
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: {groupwareHouseAutoID: $('#groupwareHouseAutoID').val()},
