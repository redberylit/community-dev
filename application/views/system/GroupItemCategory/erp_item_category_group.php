                ...
                if (trim($value['masterID']) == trim($pageID)) {
                   ...
                   // $depMaster = $this->db->query("SELECT itemCategoryID,categoryTypeID,masterID FROM `srp_erp_itemcategory` WHERE `itemCategoryID` = '{$pageID}'")->row_array();
                    ...
                    <tr class="header">
                        ...
                        <!--   <td></td>-->
                        <td><span class="pull-right"><a onclick="subsubcategory(<?php echo $value['itemCategoryID'] ?>),resetform()"><button
                                        type="button" class="btn btn-xs btn-default"><span
                                            class="glyphicon glyphicon-plus"
                                            style="color:green;"></span></button></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="link_group_sub_itemcategory(<?php echo $value['itemCategoryID'] ?>)"><span title="Link" rel="tooltip" class="glyphicon glyphicon-link"></span></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
                                    onclick="opensubcategoryedit(<?php echo $value['itemCategoryID'] ?>)"><span title="Edit" class="glyphicon glyphicon-pencil" style="" rel="tooltip"></span></a></span>
                        </td>
                    </tr>
                    <?php
                        ...
                        foreach ($subtable as $val) {
                            if(trim($val['masterID'])==trim($value['itemCategoryID'])) {
                                ...
                                <tr>
                                    ...
                                    <!--   <td></td>-->
                                    <td><span class="pull-right"><a onclick="link_group_sub_sub_itemcategory(<?php echo $val['itemCategoryID'] ?>)"><span title="Link" rel="tooltip" class="glyphicon glyphicon-link"></span></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="opensubsubcategoryedit(<?php echo $val['itemCategoryID'] ?>)"><span title="Edit" class="glyphicon glyphicon-pencil" rel="tooltip"></span></a></span>
                                    </td>
                                </tr>
                                <?php
                            }
