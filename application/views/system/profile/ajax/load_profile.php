                                                ...
                                                <table class="table table-striped" id="profileInfoTable"
                                                    ...
                                                    <tr>
                                                        <td style="width:30%"><strong>
                                                                <?php echo $this->lang->line('profile_employee_id'); ?><!--Emp ID:--> </strong>
                                                        </td>
                                                        <td style="width:60%">
...
//echo '<pre>'; print_r(search_pendingData($pendingData, 'initial')); echo '</pre>';
                                                    ...
                                                    <tr>
                                                        <td><strong>
                                                                <?php echo $this->lang->line('common_email'); ?><!--Email :--></strong>
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="col-md-3">
                                        <img
                                            src="<?php echo base_url() . "images/users/" . $empData['EmpImage'];  //echo base_url('images/users/default.gif'); ?>"
                                            class="img-thumbnail" alt="<?php echo $empData['ECode'] ?>" width="304"
                                            height="236">
                                        <h3 style="text-align: center;margin: 0;color: #095db3;font-weight: bold">
                                            <?php echo empty($empData['Ename1']) ? '' : $empData['Ename1']; ?>
                                        </h3>
