...
<div class="row table-responsive">
    ...
    <div class="col-md-7 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="opencustomercategorymodel()"><i class="fa fa-plus"></i> <?php echo $this->lang->line('sales_maraketing_masters_create_category');?>  </button><!--Create Category-->
    </div>
</div>
<hr>
