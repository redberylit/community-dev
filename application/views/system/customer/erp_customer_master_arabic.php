...
<div class="row">
    ...
    <div class="col-md-7 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/customer/erp_customer_master_new_otherlang',null,'Add New Customer','CUS');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('sales_maraketing_masters_create_customer');?>  </button><!--Create Customer-->
    </div>
</div><hr>
