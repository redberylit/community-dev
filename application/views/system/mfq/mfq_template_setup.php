<?php echo head_page('TEMPLATE', false); ?>
        ...
        <div class="table-responsive">
            <table id="workflow_template" class="table table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th style="min-width: 12%">WORKFLOW CATEGORY</th>
                    <th style="min-width: 12%">DESCRIPTION</th>
                    <th style="min-width: 12%">PAGE LINK</th>
                    <th style="min-width: 5%">&nbsp;</th>
                </tr>
                </thead>
            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modal_title_category">Workflow Template </h4>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            <label class="title">Workflow Category</label>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            <label class="title">Page Link </label>
                        </div>
                        <div class="form-group col-sm-6">
                            <span class="input-req" title="Required Field">
