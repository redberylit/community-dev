<?php echo head_page('Manage Segment', false);
        ...
        <div class="col-md-12 animated zoomIn">
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <span class="input-req" title="Required Field">
                    <input type="text" name="segmentCode" id="segmentCode" class="form-control" placeholder="Segment Code"
                           required>
        ...
        <div class="row" style="margin-top: 10px;">
            <div class="col-sm-7">
                <div class="pull-right">
                    <button class="btn btn-primary" type="submit" id="submitSegmentBtn"><i class="fa fa-plus"></i> Add Segment
                    </button>
                </div>
            </div>
        </div>
