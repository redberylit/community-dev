<?php echo head_page('WAREHOUSE', false);
    ...
    <div class="table-responsive">
        <table id="warehouse_table" class="table table-striped table-condensed">
            ...
            <tr>
                ...
                <th style="min-width: 20%">WAREHOUSE CODE </th><!--Warehouse Code-->
                <th style="min-width: 40%">DESCRIPTION</th><!--Description-->
                <th style="min-width: 20%">LOCATION </th><!--Location-->
                <th style="min-width: 20%">LINK DESCRIPTION </th><!--Location-->
    ...
    <div class="modal-dialog modal-lg" style="width:80%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Warehouse from ERP </h4>
            </div>
