...
<div class="pull-right">
    <button type="button" data-text="Add" id="btnAdd"
            onclick="fetchPage('system/mfq/item-master/manage-item','','Item')" class="btn btn-sm btn-default">
    ...
    <button type="button" data-text="Sync" id="btnSync_fromErp" class="btn button-royal "
            ><i class="fa fa-level-down" aria-hidden="true"></i> Pull Item from ERP
    </button>
</div>
<div id="itemmaster">
    <div class="row">
    ...
    <div class="table-responsive" id="itemMasterTbl">
        <table id="item_table" class="table table-striped table-condensed">
            ...
            <tr>
                ...
                <th style="min-width: 12%">SUB SUB <abbr title="Category"> CAT..</abbr></th>
                ...
                <th style="min-width: 12%"><abbr title="Description">LINK&nbsp;ITEM</abbr></th>
