<?php $all_mfq_document_arr = all_mfq_documents(); ?>
                ...
                <div class="past-info">
                    <div id="toolbar">
                        <div class="toolbar-title">
                            <i class="fa fa-flag" aria-hidden="true"></i> Document Status
                        </div>
                        <div class="btn-toolbar btn-toolbar-small pull-right">
                            <button class="btn btn-primary btn-xs bottom10" onclick="open_document_status()">Add New Status
                            </button>
                        </div>
                    </div>
                                ...
                                <form class="form-horizontal" role="form">
                                    <div class="col-md-9">
                                        <label for="inputStatus" class="col-md-3 control-label"><b><i
                                                    class="fa fa-filter"></i> Document</b></label>
                                        <div class="col-md-4">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="crm_documentStatus">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="selectbasic">Document</label>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="selectbasic">Background Color</label>
                            <div class="col-md-6" id="">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="selectbasic">Status color</label>
                            <div class="col-md-6" id="">
