...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <div class="form-group" id="stockadjustment">
                        ...
                        <?php echo form_dropdown('stockadjust', $stock_adjustment, '', 'class="form-control form1 select2" id="stockadjust" '); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="text-right m-t-xs">
            <button class="btn btn-primary" type="submit" id="submitbtn"><?php echo $this->lang->line('common_save');?><!--Save--></button>
        </div>
        </form>
    </div>
                        ...
                        <tr>
                            ...
                            if(!empty($binlocations)){
                                ...
                                <td>
                                    ...
                                    <select class="form-control" name="binloc[]" id="binloc_<?php echo $val['wareHouseAutoID'] ?>">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (!jQuery.isEmptyObject(data)) {
                        ...
                        console.log(data['itemSystemCode']);
