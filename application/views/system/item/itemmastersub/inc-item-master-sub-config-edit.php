        ...
        <div class="modal-content">
            ...
            <form id="subItemList_frm">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="save_subItemList()" class="btn btn-primary"><?php echo $this->lang->line('common_save');?><!--Save--></button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    function load_itemMasterSub_config_modal(id, documentID, warehouseID) {
        $("#itemMasterSubConfig_modal").modal('show');
        load_subItemList(id, documentID, warehouseID);
    }

    function load_subItemList(detailID, documentID, warehouseID) {
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'html',
            data: {detailID: detailID, documentID: documentID, warehouseID: warehouseID},
