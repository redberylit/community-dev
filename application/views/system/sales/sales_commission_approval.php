...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <?php echo form_dropdown('approvedYN', array('0' => $this->lang->line('common_pending')/*'Pending'*/, '1' => $this->lang->line('common_approved')/*'Approved'*/), '', 'class="form-control" id="approvedYN" required onchange="sc_table_approval()"'); ?>
    </div>
</div>
<hr>
...
<script type="text/javascript">
    ...
    function sc_table_approval() {
        var Otable = $('#sc_table_approval').DataTable({
            "language": {
        ...
        if (salesCommisionID) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#comments').val('');
                    grv_attachment_View_modal('GRV',salesCommisionID);
                    stopLoad();
                    refreshNotifications(true);
                }, error: function () {
                    stopLoad();
