        ...
        <div class="col-md-12 " id="salespersonrpt">
            ...
            <div style="">
                <table id="tbl_rpt_salesorder" class="borderSpace report-table-condensed" style="width: 100%">
                    ...
                    <tr>
                        <th rowspan="2" style="font-size: 18px;">Name</th>
                        <th rowspan="2" style="font-size: 18px;">Currency</th>
                        <th colspan="2" style="font-size: 18px;">Contract / Sales Order</th>
                        <th colspan="2" style="font-size: 18px;">Invoiced</th>
                        <th rowspan="2" style="font-size: 18px;">Balance</th>
                    </tr>
                    <tr>
                        <th style="width: 9%;font-size: 18px;">Qty</th>
                        <th style="font-size: 18px;">Value</th>
                        <th style="width: 9%;font-size: 18px;">Qty</th>
                        <th style="font-size: 18px;">Value</th>
                    </tr>
...
condetails.contractAutoID = '{$value['contractAutoID']}' ")->row_array();
                                ...
                                ?>
                                <tr>
                                    <td style="font-size: 18px;"> <?php echo $val["salesPersonName"] ?></td>
                                    ...
                                    <td width="200px" style="text-align: right;font-size: 18px;"><?php echo number_format($totalamt,$contractdecplaces); ?></td>
                                    <td width="200px" style="text-align: right;font-size: 18px;"><?php
                                        ...
                                        ?></td>
                                    <td width="200px" style="text-align: right;font-size: 18px;"><?php echo number_format($invoice,$invoicedecimalplaces) ?></td>
                                    <?php
                                    $balance = ($value - $invoice);
                                    ?>
                                    <td width="200px" style="text-align: right;font-size: 18px;"><?php echo number_format($balance,$contractdecplaces) ?></td>
                                </tr>
                                <?php
                            ...
                            ?>
                            <tr>
                                <td colspan="6" style="font-size: 18px;"><b>Total</b></td>
                                <td class="text-right reporttotal" style="font-size: 18px;"><?php echo number_format($totalbalance,$contractdecplaces) ?></td>
                            </tr>
                            <?php
                        }
                    } ?>
