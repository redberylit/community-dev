...
<div class="text-right m-t-xs">
    <button class="btn btn-primary" type="button" onclick="save_sale_commission()"><?php echo $this->lang->line('common_save');?></button><!--Save-->
</div>
</form>
<script type="text/javascript">
    ...
    function calculate_invoice_total(salesPersonID) {
        ...
        console.log(sales_target[salesPersonID]);
