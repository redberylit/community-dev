...
echo head_page('Discount and extra charges', false);
...
<div class="row table-responsive">
    ...
    <div class="col-md-7 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="opendiscountmodel()"><i class="fa fa-plus"></i> <?php echo $this->lang->line('sales_maraketing_masters_create_category');?>  </button><!--Create Category-->
    </div>
</div>
<hr>
<div class="table-responsive">
    <table id="discount_extra_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 15%">Is charged to expense</th>
            <th style="min-width: 15%">Is Tax Applicable</th>
            <th style="min-width: 28%">GL Code</th>
                    ...
                    <div class="row" >
                        <div class="col-md-6" id="extrachargesrow">
                            <div class="form-group">
                                <label for="">Is Charge To Expense</label>
                        ...
                        <div class="col-md-6 hidden" id="taxapplicablrrow">
                            <div class="form-group">
                                <label for="">Is Tax Applicable</label>
                                <div class="skin skin-square">
                                    <div class="skin-section" id="extraColumns">
...
<script type="text/javascript">
    ...
    function opendiscountmodel(){
        ...
        $('#isChargeToExpense').iCheck('check');
        $('#discountExtraChargeID').val('');
        $('#categoryHead').html('Add New Discount');
        $('#discount_extra_form')[0].reset();
        $('#discount_extra_modal').modal('show');
    }
