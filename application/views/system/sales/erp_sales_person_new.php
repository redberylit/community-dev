...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab"><?php echo $this->lang->line('sales_maraketing_masters_step_one');?> - <?php echo $this->lang->line('sales_maraketing_masters_header');?></a><!--Step 1 --><!--Header-->
    <a class="btn btn-default btn-wizard" href="#step2" onclick="fetch_sales_person_details()" data-toggle="tab"><?php echo $this->lang->line('sales_maraketing_masters_step_two');?>
        - <?php echo $this->lang->line('sales_maraketing_masters_commision');?></a><!--Step 2--><!--Commision-->
    <a class="btn btn-default btn-wizard" href="#step3" onclick="load_conformation()" data-toggle="tab"><?php echo $this->lang->line('sales_maraketing_masters_step_three');?> - <?php echo $this->lang->line('sales_maraketing_masters_confirmation');?>
    </a><!--Step 3--><!-- Confirmation-->
</div>
<hr>
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="text-right m-t-xs">
            <button class="btn btn-primary" id="sales_person_btn" type="submit"><?php echo $this->lang->line('sales_maraketing_masters_add_sales_person');?> </button><!--Add Sales Person-->
        </div>
        </form>
    </div>
