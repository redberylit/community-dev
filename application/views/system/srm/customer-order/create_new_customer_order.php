...
<div class="tab-content">
        ...
        <div class="row">
            <div class="col-sm-11">
                <div class="text-right m-t-xs">
                    ...
                    <button class="btn btn-success" onclick="confirmation()"><?php echo $this->lang->line('common_confirm');?><!--Confirm--></button>
                </div>
            </div>
        </div>
    </div>
    <div id="step2" class="tab-pane">
        <div class="row">
            ...
            <div class="col-md-4">
                <button type="button" onclick="show_order_button()" class="btn btn-primary pull-right"><i
