...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary"
                onclick="fetchPage('system/srm/customer-order/create_new_order_inquiry',null,'<?php echo $this->lang->line('srm_new_order_inquiry');?>'/*New Order Inquiry*/,'SRM');">
            <i class="fa fa-plus"></i> <?php echo $this->lang->line('srm_order_inquiry');?><!--Order Inquiry-->
        </button>
    </div>
</div>
<div class="row">
