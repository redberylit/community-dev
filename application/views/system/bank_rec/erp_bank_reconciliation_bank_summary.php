...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="bankrecheader('<?php echo $page_id ?>');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('treasury_bta_new_bank_reconcilation');?><!--New Bank Reconciliation--> </button>
