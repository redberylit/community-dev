            ...
            <td style="width: 20%; vertical-align: top;">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width:220px;  font-weight: bold; font-size: 1em;  text-align: center; vertical-align: top;"><?php echo $day[0]; ?><?php echo $day[1]; ?>-<?php echo $month[0]; ?><?php echo $month[1]; ?>-<?php echo $year[0]; ?><?php echo $year[1]; ?><?php echo $year[2]; ?><?php echo $year[3]; ?></td>
        ...
        <tr>
            ...
            <td style="width: 33%;padding-top:0px; padding-right: 15px;">
                <table style="border: 1px solid white;">
                    ...
                    <tr>
                        <td
                            style="font-weight: bold;text-align: center;height: 60px;font-size: 0.9em; vertical-align: top;">
