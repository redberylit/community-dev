...
<div id="confrimDiv" style="margin-bottom: 60px">
    <div class="col-sm-12 ">
        ...
        <button class="pull-right btn btn-primary btn-xs" onclick="insert_bank_rec_data()"><i class="fa fa-plus" aria-hidden="true"></i><?php echo $this->lang->line('treasury_common_add_new_entry');?> <!--Add New Entry-->
        </button>
    </div>
    </br>
