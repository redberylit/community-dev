...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab"><?php echo $this->lang->line('promana_common_step_one');?><!--Step 1--> - <?php echo $this->lang->line('promana_pm_header');?> <!--Header--></a>
    <a class="btn btn-default btn-wizard" href="#step2" data-toggle="tab"><?php echo $this->lang->line('promana_common_step_two');?><!--Step 2--> - <?php echo $this->lang->line('promana_pm_cost');?> <!--Cost--> </a>
    <a class="btn btn-default btn-wizard" href="#step3" onclick="show_summary_data()" data-toggle="tab"><?php echo $this->lang->line('promana_common_step_three');?><!--Step 3--> - <?php echo $this->lang->line('promana_pm_cost_reveiew');?> <!--Cost Review--></a>
    <a class="btn btn-default btn-wizard" href="#step4" data-toggle="tab"><?php echo $this->lang->line('promana_common_step_four');?><!--Step 4--> - <?php echo $this->lang->line('promana_pm_cost_project_planning');?><!--Project Planning--> </a>
    <a class="btn btn-default btn-wizard" onclick="getchart()" href="#step5" data-toggle="tab"><?php echo $this->lang->line('promana_common_step_five');?><!--Step 5 -->- <?php echo $this->lang->line('promana_pm_cost_project_planning_review');?> <!--Project Planning Review--> </a>
</div>
<hr>
...
<div class="tab-content">
      ...
      <?php echo form_open('login/loginSubmit', 'role="form" id="boq_create_form"') ?>
        <div class="row">
            ...
            <div class="form-grou col-sm-4">
                <label for="" class=" control-label"><?php echo $this->lang->line('common_project');?><!--Project--></label>
            ...
            <div class="form-group col-sm-4">
                <label for="servicelinecode"><?php echo $this->lang->line('common_segment');?><!--Segment--> <?php required_mark(); ?></label>
            ...
            <div class="form-group col-sm-4">
                <label for="location"><?php echo $this->lang->line('common_customer_name');?><!--Customer Name--> <?php required_mark(); ?></label>
        ...
        <div class="row" id="">
            ...
            <div class="form-group col-sm-4">
                <label><?php echo $this->lang->line('promana_pm_cost_project_start_date');?><!--Project Start Date--></label>
            ...
            <div class="form-group col-sm-4">
                <label><?php echo $this->lang->line('promana_pm_cost_project_end_date');?><!--Project End Date--></label>
                <div class="input-group">
                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
    ...
    background-color: rgba(175, 213, 175, 0.27);">
                <table width="100%" class="">
                    ...
                    <tr>
                        ...
                        <td><b><?php echo $this->lang->line('promana_pm_cost_project_start_date');?><!--Project Start Date-->:</b></td>
                        <td>
                            <div id="pstartdate"></div>
                        </td>
                        <td><b><?php echo $this->lang->line('promana_pm_cost_project_end_date');?><!--Project End Date-->:</b></td>
                        <td>
                            <div id="penddate"></div>
                        </td>
                    ...
                    <tr>
                        <td><b><?php echo $this->lang->line('promana_pm_cost_customer_currency');?><!--Customer Currency-->:</b></td>
                        <td>
        ...
        <div class="row">
            <div class="col-sm-12">
                <a onclick="modalheaderdetails()" class="btn btn-primary btn-xs pull-right"><?php echo $this->lang->line('common_create_new');?><!--Create New--></a>
            </div>
                ...
                <div id="loadheaderdetail">
                    <table id="loadcosttable" class="<?php echo table_class() ?> custometbl">
                        ...
                        <tr>
                            ...
                            <th rowspan="3"><?php echo $this->lang->line('common_description');?><!--Description--></th>
                            <th rowspan="3"><?php echo $this->lang->line('common_unit');?><!--Unit--></th>

                            <th rowspan="2" colspan="3"><?php echo $this->lang->line('promana_common_selling_price');?><!--Selling Price--></th>
                            <th rowspan="3" width="70px"><?php echo $this->lang->line('promana_pm_markup');?><!--Markup--> %</th>
                            <th colspan="4"><?php echo $this->lang->line('common_cost');?><!--Cost--></th>
                            <th></th>
                        </tr>
                        <tr>
                            <th colspan="2"><?php echo $this->lang->line('promana_pm_material_cost');?><!--Material Cost--></th>
                            <th rowspan="2"><?php echo $this->lang->line('promana_pm_total_labour_cost');?><!--Total Labour Cost--></th>
                            <th rowspan="2"><?php echo $this->lang->line('promana_pm_total_cost');?><!--Total Cost--></th>
                            <th rowspan="2"></th>
                        </tr>
        ...
        <hr>
        <div class="text-right m-t-xs">
            <a class="btn btn-default prev" onclick=""><?php echo $this->lang->line('common_previous');?><!--Previous--></a>
            <a class="btn btn-primary " onclick="show_summary_data();"><?php echo $this->lang->line('common_next');?><!--Next--></a>
        </div>
    </div>
    ...
    background-color: rgba(175, 213, 175, 0.27);">
            ...
            <div class="col-md-12">
                <div class="text-right m-t-xs">
                    <a class="btn btn-default prev" onclick=""><?php echo $this->lang->line('common_previous');?><!--Previous--></a>
                    <button class="confirmYNbtn btn btn-success submitWizard" onclick="confirm_boq()"><?php echo $this->lang->line('common_confirmation');?><!--Confirmation-->
                    </button>
                </div>
            </div>
    ...
    <div id="step4" class="tab-pane ">
        <div class="row">
            <div class="col-md-12">
                <div class="text-right m-t-xs">
                    <button onclick="addMasterTask()" type="button" class="btn btn-sm btn-primary"><?php echo $this->lang->line('common_add');?><!--Add--> <span
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 id="" class="modal-title"><?php echo $this->lang->line('promana_common_item_search');?><!--Item Search--></h5>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h5 id="" class="modal-title"><?php echo $this->lang->line('promana_pm_create_detail_header');?><!--Create Detail header--></h5>
            </div>
            <form role="form" id="boq_create_detail_header" class="form-horizontal">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="vehicle"
                               class="col-sm-3 control-label"><?php echo $this->lang->line('common_category');?><!--Category--> <?php required_mark(); ?></label>
                    ...
                    <div class="form-group">
                        <label for="vehicle" class="col-sm-3 control-label"><?php echo $this->lang->line('promana_common_sub_cat');?><!--Sub Category--> <?php required_mark(); ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="vehicle"
                               class="col-sm-3 control-label"><?php echo $this->lang->line('common_description');?><!--Description--> <?php required_mark(); ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="vehicle"
                               class="col-sm-3 control-label"><?php echo $this->lang->line('common_unit');?><!--Unit--> <?php required_mark(); ?></label>
                        <div class="col-sm-8">
            ...
            <form role="form" id="boq_cost_form_sheet" class="form-horizontal">
                <div class="modal-body" style="overflow: auto;max-height: 400px">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="vehicle" class="col-sm-3 control-label"><?php echo $this->lang->line('common_item');?><!--Item--></label>
                                <div class="  col-sm-9">
                                    <div class="input-group">
                            ...
                            <div class="form-group">
                                <label for="vehicle" class="col-sm-3 control-label"><?php echo $this->lang->line('common_uom');?><!--UOM--></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label for="vehicle" class="col-sm-3 control-label"><?php echo $this->lang->line('promana_pm_total_cost');?><!--Total Cost--></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <button type="submit" class="btn btn-xs btn-primary" id="submitcostsheet"><?php echo $this->lang->line('common_add');?><!--Add-->
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="vehicle" class="col-sm-3 control-label"><?php echo $this->lang->line('common_qty');?><!--Qty--></label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label for="vehicle" class="col-sm-3 control-label"><?php echo $this->lang->line('common_unit_cost');?><!--Unit Cost--></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label for="vehicle" class="col-sm-3 control-label"><?php echo $this->lang->line('common_currency');?><!--Currency--></label>
                                <div class="col-sm-9">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h5 id="title" class="modal-title"><?php echo $this->lang->line('promana_pm_cost_project_planning');?><!--Project Planning--></h5>
            </div>
            <form role="form" id="formProjectPlanning" class="form-horizontal">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="vehicle"
                               class="col-sm-3 control-label"><?php echo $this->lang->line('common_note');?><!--Note--> <?php required_mark(); ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="vehicle" class="col-sm-3 control-label"><?php echo $this->lang->line('promana_pm_assign_employee');?><!--Assign Employee--> <?php required_mark(); ?></label>
                        <div class="col-sm-8">
                          <?php
                            $empArr = array();
                    ...
                    <div class="form-group">
                        <label for=""
                               class="col-sm-3 control-label"><?php echo $this->lang->line('common_start_date');?><!--Start Date--> <?php required_mark(); ?></label>
                        <div class="col-sm-8">
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                    ...
                    <div class="form-group">
                        <label for=""
                               class="col-sm-3 control-label"><?php echo $this->lang->line('common_end_date');?><!--End Date--> <?php required_mark(); ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="vehicle"
                               class="col-sm-3 control-label"><?php echo $this->lang->line('promana_common_completed');?><!--Completed--> %</label>
                        <div class="col-sm-8">
                            <input type="number" max="100" min="0"  name="percentage" id="percentage" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="vehicle"
                               class="col-sm-3 control-label"><?php echo $this->lang->line('promana_pm_color');?><!--Color--></label>
                        <div class="col-sm-8">
                            <select id="color" name="color" class="form-control searchbox">
                                <option value="ggroupblack"><?php echo $this->lang->line('promana_pm_black');?><!--Black--></option>
                                <option value="gtaskblue"><?php echo $this->lang->line('promana_pm_blue');?><!--Blue--></option>
                                <option value="gtaskred"><?php echo $this->lang->line('promana_pm_red');?><!--Red--></option>
                                <option value="gtaskpurple"><?php echo $this->lang->line('promana_pm_purple');?><!--Purple--></option>
                                <option value="gtaskgreen"><?php echo $this->lang->line('promana_pm_green');?><!--Green--></option>
                                <option value="gtaskpink"><?php echo $this->lang->line('promana_pm_pink');?><!--Pink--></option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="vehicle"
                               class="col-sm-3 control-label"><?php echo $this->lang->line('common_sort_order');?><!--Sort Order--></label>
                        <div class="col-sm-8">
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    // url :"<?php// echo site_url('Procurement/confirm_purchase_request'); ?>",
