<?php echo head_page('Chart of Accounts', false);
...
<div class="row">
    <div class="col-md-2">
        <table class="<?php echo table_class(); ?>">
            <tr>
                <td>
                    <span class="glyphicon glyphicon-stop" style="color:green; font-size:15px;"></span> Active
                </td>
                <td>
                    <span class="glyphicon glyphicon-stop" style="color:red; font-size:15px;"></span> Inactive
                </td>
            </tr>
        </table>
    </div>
    <div class="col-md-3">
        <span style="">Account Category</span>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="chart_of_accont_form">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="masterCategory" class="col-sm-4 control-label">Account Type  <?php required_mark(); ?></label>
                            ...
                            <div class="form-group">
                                <label for="masterAccountYN1" class="col-sm-4 control-label">Master Account  <?php required_mark(); ?></label>
                            ...
                            <div class="form-group isCash" style="display: none;">
                                <label for="bankCheckNumber" class="col-sm-4 control-label">Type</label>
                            ...
                            <div class="form-group set_bank set_controll">
                                <label for="bankName" class="col-sm-4 control-label">Bank Name  <?php required_mark(); ?></label>
                            ...
                            <div class="form-group set_bank">
                                <label for="bankAccountNumber" class="col-sm-4 control-label">B/Account Number  <?php required_mark(); ?></label>
                            ...
                            <div class="form-group set_bank set_controll">
                                <label for="bankCheckNumber" class="col-sm-4 control-label">Check Number  <?php required_mark(); ?></label>
                            ...
                            <div class="form-group activeSub">
                                <label for="bankCheckNumber" class="col-sm-4 control-label">isActive</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="GLSecondaryCode" class="col-sm-4 control-label">Secondary Code  <?php required_mark(); ?></label>
                            ...
                            <div class="form-group">
                                <label for="GLDescription" class="col-sm-4 control-label">Account Name  <?php required_mark(); ?></label>
                            ...
                            <div class="form-group set_bank set_controll">
                                <label for="bank_branch" class="col-sm-4 control-label">Bank Branch  <?php required_mark(); ?></label>
                            ...
                            <div class="form-group set_bank set_controll">
                                <label for="bank_swift_code" class="col-sm-4 control-label">Bank Swift Code  <?php required_mark(); ?></label>
                            ...
                            <div class="form-group set_bank set_controll">
                                <label for="bank_branch" class="col-sm-4 control-label">Bank Currency  <?php required_mark(); ?></label>
                            ...
                            <div class="form-group set_bank">
                                <label for="bankCheckNumber" class="col-sm-4 control-label">isCard</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="Submit" class="btn btn-primary" id="chartofaccountbtn">Save changes</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog" style="width: 60%">
        <div class="modal-content" id="">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Chart of account Link <span id=""></span></h4>
            </div>
...
<div class="modal fade" id="chartofaccountDuplicateModal" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" style="width: 60%">
        <div class="modal-content" id="">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Chart of account Replication <span id=""></span></h4>
            </div>
            <div class="modal-body" style="margin-left: 10px">
                <div class="row">
                    <div class="col-sm-12">
            ...
            <div class="modal-footer">
                <button data-dismiss="modal" class="btn btn-default btn-sm" type="button">Close</button>
                <button type="submit" class="btn btn-primary btn-sm" id="btnSavedup">Duplicate
                </button>
            </div>
            </form>
        </div>
