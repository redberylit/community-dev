...
switch ($pvType) {
                        ...
                        <form class="form-inline" id="tax_form">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control number" id="tax_amount" name="tax_amount"
                                       style="width: 100px;" onkeypress="return validateFloatKeyPress(this,event);" onkeyup="cal_tax_amount(this.value)">
                            </div>
                        ...
                        <form role="form" id="pv_detail_form" class="form-horizontal">
                            <table class="table table-bordered table-condensed no-color" id="payment_voucher_table">
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <td>
                                        <input type="text" name="amount[]" id="amount" onkeyup="calculateNetAmount(this,'amount')" onkeypress="return validateFloatKeyPress(this,event)" class="form-control amount number">
                                    </td>
                        ...
                        <form role="form" id="edit_pv_detail_form" class="form-horizontal">
                            <table class="table table-bordered table-condensed no-color"
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <td>
                                        <input type="text" name="amount" onkeyup="calculateNetAmount_edit(this,'amount')" id="edit_amount" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number">
                                    </td>
    ...
    case "Supplier":
        ...
        <div class="modal fade" id="inv_base_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog modal-lg" role="document" style="width: 67%;">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                        ...
                        <form role="form" id="edit_pv_detail_form" class="form-horizontal">
                            <table class="table table-bordered table-condensed no-color"
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <td>
                                        <input type="text" name="amount" id="edit_amount" onkeyup="calculateNetAmount_edit(this,'amount')" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number">
                                    </td>
                                    <td><input type="text" name="discountPercentage" id="discountPercentage_edit" onkeypress="return validateFloatKeyPress(this,event)" onkeyup="calculateNetAmount_edit(this,'discountPercentage')" value="00" class="form-control number "></td>
                                    <td><input type="text" name="discountAmount" id="discountAmount_edit" onkeypress="return validateFloatKeyPress(this,event)" onkeyup="calculateNetAmount_edit(this,'discountAmount')" value="00" class="form-control number "></td>
                                    <td><input type="text" name="Netamount" id="Netamount_edit" value="00" class="form-control number " readonly></td>
    ...
    function save_inv_base_items() {
        ...
        if (!jQuery.isEmptyObject(selected)) {
            ...
            $.ajax({
                ...
                type: 'post',
                dataType: 'json',
                data: {'InvoiceAutoID': selected, 'payVoucherAutoId': payVoucherAutoId, 'amount': amount,'settlementAmount':totalsettlement},
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (jQuery.isEmptyObject(data['detail'])) {
                    $('#gl_table_body,#item_table_body,#invoice_table_body,#advance_table_body,#commission_table_body').append('<tr class="danger"><td colspan="9" class="text-center"><b><?php echo $this->lang->line('common_no_records_found');?><!--No Records Found--></b></td></tr>');
                    ...
                    $.each(data['detail'], function (key, value) {
                        ...
                        if (value['type'] == 'Item') {
                            ...
                            if (value['isSubitemExist'] == 1) {
                                ...
                                colour = '';
                                string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription']+ ' - ' + value['Itemdescriptionpartno'] + '</td><td>' + value['unitOfMeasure'] + '</td><td class="text-center">' + value['requestedQty'] + '</td><td class="text-right">' + parseFloat(value['unittransactionAmount']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right">' + parseFloat(value['transactionAmount']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right"><a style="' + colour + '" onclick="load_itemMasterSub_modal(' + value['payVoucherDetailAutoID'] + ',\'PV\')"><i class="fa fa-list"></i></a> &nbsp;&nbsp; | &nbsp;&nbsp; <a onclick="edit_item(' + value['payVoucherDetailAutoID'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; | &nbsp;&nbsp;<a onclick="delete_item_direct(' + value['payVoucherDetailAutoID'] + ',3);"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
                            } else {
                                string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription']+ ' - ' + value['Itemdescriptionpartno'] + '</td><td>' + value['unitOfMeasure'] + '</td><td class="text-center">' + value['requestedQty'] + '</td><td class="text-right">' + parseFloat(value['unittransactionAmount']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right">' + parseFloat(value['transactionAmount']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right"><a onclick="edit_item(' + value['payVoucherDetailAutoID'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; | &nbsp;&nbsp;<a onclick="delete_item_direct(' + value['payVoucherDetailAutoID'] + ',3);"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
                            ...
                            $('#gl_table_body').append('<tr><td>' + y + '</td><td>' + value['GLCode'] + '</td><td>' + value['GLDescription']+ ' - '+ value['description'] +'</td><td class="text-center">' + value['segmentCode'] + '</td><td class="text-right">' + parseFloat(transamnt).formatMoney(currency_decimal, '.', ',') + '</td> <td class="text-right">('+parseFloat(value['discountPercentage']).formatMoney(2, '.', ',')+' %) ' + parseFloat(value['discountAmount']).formatMoney(currency_decimal, '.', ',') + '</td> <td class="text-right">' + parseFloat(value['transactionAmount']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right"><a onclick="edit_gl_item(' + value['payVoucherDetailAutoID'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; | &nbsp;&nbsp;<a onclick="delete_item_direct(' + value['payVoucherDetailAutoID'] + ',4);"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>');
                            y++;
                    ...
                    $('#item_table_tfoot').append('<tr><td colspan="6" class="text-right"><?php echo $this->lang->line('common_total');?> <!--Total--> </td><td class="text-right total">' + parseFloat(item_trans_amount).formatMoney(currency_decimal, '.', ',') + '</td><td>&nbsp;</td></tr>');
                ...
                success: function (data) {
                    ...
                    if (jQuery.isEmptyObject(data['detail'])) {
                        ...
                        $.each(data['detail'], function (key, value) {
                            ...
                            if(qty>0){
                                $('#table_body_pr_detail').append('<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center"><select class="whre_drop" style="width: 110px;"  id="whre_' + value['purchaseRequestDetailsID'] + '"><option value="">Select WareHouse</option></select></td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-right">' + qty + '</td><td class="text-right">' + parseFloat(value['unitAmount']).toFixed(currency_decimal) + '</td><td class="text-center"><input type="text" class="number" size="8" id="qty_' + value['purchaseRequestDetailsID'] + '" onkeyup="select_check_box_prq(this,' + value['purchaseRequestDetailsID'] + ',' + value['unitAmount'] + ',' + (value['requestedQty'] - value['prQty'] ) + ' )" ></td><td class="text-center">' + cost_status + '</td><td class="text-center"><p id="tot_' + value['purchaseRequestDetailsID'] + '"> </p></td><td class="text-right" style="display: none;"><input class="checkbox" id="check_' + value['purchaseRequestDetailsID'] + '" type="checkbox" value="' + value['purchaseRequestDetailsID'] + '"></td></tr>');
                            }
                            x++;
