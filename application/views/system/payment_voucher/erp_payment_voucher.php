    ...
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            <div class="form-group col-sm-4">
                ...
                <?php echo form_dropdown('vouchertype', array('' => $this->lang->line('common_select_type')/*'Select Type'*/, 'Direct' => $this->lang->line('accounts_payable_tr_pv_direct_payment') /*'Direct Payment'*/, 'Supplier' =>$this->lang->line('accounts_payable_tr_pv_supplier_payment') /*'Supplier Payment'*/, 'Employee' =>$this->lang->line('accounts_payable_tr_pv_employee_payment') /*'Employee Payment'*/, 'PurchaseRequest' =>'Purchase Request'), 'Direct', 'class="form-control select2" id="vouchertype" required onchange="voucher_type(this.value)"'); ?>
            </div>
            <div class="form-group col-sm-4">
