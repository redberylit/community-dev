    ...
    <div class="table-responsive">
        <table id="leaveMaster" class="<?php echo table_class(); ?>">
            ...
            <tr>
                ...
                <th style="min-width: 15%"><?php echo $this->lang->line('hrms_leave_management_is_annual_leave');?></th>
                <th style="min-width: 10%"><?php echo $this->lang->line('hrms_leave_management_is_sick_leave');?><!--Is sick leave--></th>
                <th style="min-width: 10%"><?php echo  $this->lang->line('hrms_leave_management_isshortleave')?> </th>
...
<script>
        ...
        $('#leaveMaster').DataTable({
            ...
            "fnDrawCallback": function (oSettings) {
                ...
                for (var i = tmp_i; (iLen + tmp_i) > i; i++) {
                    ...
                    $('td:eq(3)', oSettings.aoData[oSettings.aiDisplay[x]].nTr).html('<div style="text-align: center">'+annualLeave+'</div>');

                    var sickLeaveStr = parseInt(oSettings.aoData[x]._aData['sickLeaveStr']);
                    var sickLeave = 'No';
                    if(sickLeaveStr == 1){ sickLeave = 'Yes'; }
                    $('td:eq(4)', oSettings.aoData[oSettings.aiDisplay[x]].nTr).html('<div style="text-align: center">'+sickLeave+'</div>');

                    var isShortLeave = parseInt(oSettings.aoData[x]._aData['isShortLeave']);
                    var isShortLeaves = 'No';
                    if(isShortLeave == 1){ isShortLeaves = 'Yes'; }
                    $('td:eq(5)', oSettings.aoData[oSettings.aiDisplay[x]].nTr).html('<div style="text-align: center">'+isShortLeaves+'</div>');
    ...
    function new_leave(){
        ...
        $('#isAnnualLeave, #isPaid, #attachment , #leavePlanApplicable, #isNotSickLeave,#no_isShortLeave').prop('checked', true);
    ...
    function edit_LeaveType( editID, des, isPaidLeave, isAnnualLeave, attachmentRequired, isPlanApplicable,isShortLeave,shortLeaveMaxHours,shortLeaveMaxMins){
        $('.sick-leave-div').hide();
