    ...
    <div style="height: 450px">
        <table id="salaryComparisonTB" class="table table-bordered"  style="margin-top: -2px">
            ...
            <tr>
                <td></td>
                <td></td>
                <td style="text-align: right;background-color: #FDFAF7;"><?php echo number_format($fr_fixPayment, $val['dPlace']); ?></td>
                <td style="text-align: right;background-color: #FDFAF7;"><?php echo number_format($sn_fixPayment, $val['dPlace']); ?></td>
                <td style="text-align: right;background-color: #FDFAF7;<?php echo ($diffFixPayment == 0)? 'color:green':'color:red';?>">
                    <?php echo number_format($diffFixPayment, $val['dPlace']); ?>
                </td>
                <td style="text-align: right;background-color: #EFEFF2;"><?php echo number_format($fr_Variables, $val['dPlace']); ?></td>
                <td style="text-align: right;background-color: #EFEFF2;"><?php echo number_format($sn_Variables, $val['dPlace']); ?></td>
                <td style="text-align: right;background-color: #EFEFF2; <?php echo ($DiffVariables == 0)? 'color:green':'color:red';?>">
                    <?php echo number_format($DiffVariables, $val['dPlace']); ?>
                </td>
                <td style="text-align: right;background-color: #ECF4F7;"><?php echo number_format($fr_MA, $val['dPlace']); ?></td>
                <td style="text-align: right;background-color: #ECF4F7;"><?php echo number_format($sn_MA, $val['dPlace']); ?></td>
                <td style="text-align: right;background-color: #ECF4F7;<?php echo ($DiffMA == 0)? 'color:green':'color:red';?>">
                    <?php echo number_format($DiffMA, $val['dPlace']); ?>
                </td>
                <td  style="text-align: right;background-color: #F6F3F4;"><?php echo number_format($fr_MD, $val['dPlace']); ?></td>
                <td  style="text-align: right;background-color: #F6F3F4;"><?php echo number_format($sn_MD, $val['dPlace']); ?></td>
                <td  style="text-align: right;background-color: #F6F3F4;<?php echo ($DiffMD == 0)? 'color:green':'color:red';?>">
                    <?php echo number_format($DiffMD, $val['dPlace']); ?>
                </td>
                <td  style="text-align: right;background-color: #F7FBFB;"><?php echo number_format($fr_OtherAdditions, $val['dPlace']); ?></td>
                <td  style="text-align: right;background-color: #F7FBFB;"><?php echo number_format($sn_OtherAdditions, $val['dPlace']); ?></td>
                <td  style="text-align: right;background-color: #F7FBFB;<?php echo ($DiffOtherAdditions == 0)? 'color:green':'color:red';?>">
                    <?php echo number_format($DiffOtherAdditions, $val['dPlace']); ?>
                </td>
                <td style="text-align: right;background-color: #FDFEFD;"><?php echo number_format($fr_OtherDeductions, $val['dPlace']); ?></td>
                <td style="text-align: right;background-color: #FDFEFD;"><?php echo number_format($sn_OtherDeductions, $val['dPlace']); ?></td>
                <td style="text-align: right;background-color: #FDFEFD;<?php echo ($DiffOtherAddition == 0)? 'color:green' :'color:red';?>">
                    <?php echo number_format($DiffOtherAddition, $val['dPlace']); ?>
                </td>
                <td style="text-align: right;background-color: #EFEFF2;"><?php echo number_format($fr_netSalary, $val['dPlace']); ?></td>
                <td style="text-align: right;background-color: #EFEFF2;"><?php echo number_format($sn_netSalary, $val['dPlace']); ?></td>
                <td style="text-align: right;background-color: #EFEFF2;<?php echo ($differentSalary == 0)? 'color:green' :'color:red';?>">
                    <?php echo number_format($differentSalary, $val['dPlace']); ?>
                </td>
            </tr>
            </tfoot>
        </table>
