...
<fieldset class="scheduler-border">
    ...
    <form role="form" id="frm_rpt" class="form-horizontal" autocomplete="off">
        ...
        <div class="row">
            <div class="col-sm-12">
                <label class="col-lg-1 col-md-2 col-sm-2 col-xs-6 control-label" for="segmentID">Segment</label>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="form-btn-group">
                    ...
                    <button type="button" class="btn btn-primary btn-xs pull-right" style="margin-right: 10px" onclick="get_report()" >Generate</button>
