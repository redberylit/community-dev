...
<div class="nav-tabs-custom" style="margin-bottom: 0px; box-shadow: none;">
    <ul class="nav nav-tabs" style="border: 1px solid rgba(112, 107, 107, 0.21);">
        <li class="active">
            <a href="#emp-EPF-conf" id="" data-toggle="tab" aria-expanded="true" onclick="setMasterID(1)">EPF Configuration</a>
        </li>
        <li class="">
            <a href="#emp-ETF-conf" id="" data-toggle="tab" aria-expanded="false" onclick="setMasterID(2)">ETF Configuration</a>
        </li>
    </ul>
