    ...
    <form role="form" id="frm_rpt" class="form-horizontal" autocomplete="off">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <label class="col-lg-2 col-md-2 col-sm-2 col-xs-6 control-label" for="segmentID">Segment</label>
                ...
                <div class="col-sm-3 col-xs-12" id="form-btn-group">
                    <button type="button" class="btn btn-primary btn-xs" onclick="get_report()">Generate</button>
