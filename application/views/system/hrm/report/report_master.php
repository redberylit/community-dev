...
<div class="row">
    ...
    <div class="col-md-2 pull-right">
        <button type="button" onclick="open_model()" class="btn btn-primary btn-sm pull-right" >
            <i class="fa fa-cogs"></i> Employee Configuration
        </button>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Employee configurations</h3>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="save_empLevelReportDetails()">Save</button>
...
<div class="modal fade" id="payeeConfig_model" role="dialog" data-keyboard="false" data-backdrop="static" >
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h3 class="modal-title">Payee configurations</h3>
            </div>
            <form class="form-horizontal" id="payeConfig_form">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="payGroupID"  class="control-label col-sm-4">Payee<?php  required_mark(); ?></label>
                        <div class="col-sm-6">
                            <?php echo form_dropdown('payeeID', $payee_arr, $defaultPayeeID,'class="form-control" id="payeeID" required'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="cashBenefits"  class="control-label col-sm-4">Cash Benefits<?php  required_mark(); ?></label>
                        <div class="col-sm-6">
...
<div class="modal fade" id="SSO_Config_model" role="dialog" data-keyboard="false" data-backdrop="static" >
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h3 class="modal-title">SSO configurations</h3>
            </div>
            <form class="form-horizontal" id="ssoConfig_form">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="payGroupID"  class="control-label col-sm-4">Employee <?php  required_mark(); ?></label>
                        <div class="col-sm-6">
                            <?php echo form_dropdown('sso_employee', $sso_drop, $sso_employee, 'class="form-control" id="sso_employee" required'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="cashBenefits"  class="control-label col-sm-4">Employer <?php  required_mark(); ?></label>
                        <div class="col-sm-6">
