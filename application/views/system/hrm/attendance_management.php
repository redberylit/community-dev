                    ...
                    <div id="" class="box box-default " style="background-color: #f5f5f5;border: 1px solid #e3e3e3;">
                        ...
                        <div class="box-body " style="background: #ffffff;">
                            <div class="col-sm-12" style="padding:0px">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="upload_toDate"> Manual Attendance</label>
                                        <div class="input-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="upload_toDate">Excel Upload</label>
                                        <div class="input-group">
                ...
                <div class="col-md-6"> <!--Fetching attendance details-->
                    <div id="" class="box box-default " style="background-color: #f5f5f5;border: 1px solid #e3e3e3;">
                        ...
                        <div class="box-footer div-view2 clearfix">
                            <button type="submit" class="pull-right btn btn-primary btn-sm" id="loadBtn">
                ...
                <div class="fixHeader_Div" style="max-width: 100%;">
                    <table id="attendanceReview" class="table tb "
                        ...
                        <tr style="white-space: nowrap">
                            ...
                            <th style="width: 85px">
                                <?php echo $this->lang->line('hrms_attendance_floor'); ?><!--Dept--></th>
                            <th style="width: 120px">
    ...
    <div class="modal-dialog" style="width: 95%" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="salary-cat-title">Attendance List</h4>
            </div>
    ...
    <div class="modal-dialog" style="width: 50%;">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Following attendance are not approved. Do you want to Continue</h4>
            </div>
