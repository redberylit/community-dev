...
//$row['DayDesc']
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                    <label class="checkbox-inline"><input type="checkbox" onclick="checkHalfDay(this)" name="HalfDay[]" id="HalfDay_' . $row['DayID'] . '">' . $this->lang->line('hrms_attendance_is_half_day') . '</label>
