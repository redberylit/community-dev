...
<div style="max-height: 400px">
    <table id="attendanceReview" class="table">
        ...
        <tr style="white-space: nowrap">
            <th style="z-index: 10;"><span class="hideremove"> <input type="checkbox" id="checkAll"/> <!--Select All--> </span></th>
            ...
            <th style="z-index: 10;"> <?php echo $this->lang->line('hrms_attendance_floor');?><!--Department--></th>
            ...
            <!--<th style=" "><?php /*echo $this->lang->line('hrms_payroll_normal_time');*/?><!--Normal Time--></th>-->
