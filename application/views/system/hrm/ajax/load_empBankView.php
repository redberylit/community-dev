            ...
            <table class="table table-bordered" id="bankAccDetTb" >
                ...
                if(!empty($accountDetails)){
                    ...
                    foreach($accountDetails as $row){
                        ...
                        $action = '<a onclick="'.$editFn.'" title="Edit" rel="tooltip"><span class="glyphicon glyphicon-eye-open"></span></a>';
            ...
            <form class="form-horizontal" id="bankAcc_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="accHolder" id="accHolder" class="form-control" readonly/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="bank_id" id="bank_id" class="form-control select2 bankSelect" onchange="get_bankBranches(this.value)" disabled>
                                <option></option>
                                <?php
                                $banks = all_banks_drop();
                                foreach ($banks as $bank) {
                                    echo '<option value="' . $bank->bankID . '">' . $bank->bankCode . ' | ' . $bank->bankName . '</option>';
                                }
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="branch_id" id="branch_id" class="form-control select2 bankAccSave_input branch_id" disabled>
                                <option></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="accountNo" id="accountNo" class="form-control bankAccSave_input number" readonly/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="salPerc" id="salPerc" class="form-control bankAccSave_input number" onkeyup="validatePer(this)" readonly />
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xs-6">
                                    ...
                                    <span class="input-group-addon">
                                        <input type="checkbox" name="payrollType[]" id="payroll" value="1" readonly>
                                    </span>
                                        <input type="text" class="form-control" disabled value="<?php echo $this->lang->line('emp_bank_payroll');?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="input-group">
                                    <span class="input-group-addon">
                                        <input type="checkbox" name="payrollType[]" id="nonPayroll" value="2" readonly>
                                    </span>
                                        <input type="text" class="form-control" disabled value="<?php echo $this->lang->line('emp_bank_non_payroll');?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group accountStatusContainer">
                        <label class="col-sm-4 control-label" for="accStatus">Status</label>
                        <div class="col-sm-6">
                            <div class="row">
                                <div class="col-sm-6 col-xs-6">
                                    <div class="input-group">
                                    <span class="input-group-addon">
                                        <input type="radio" name="accStatus" id="accStatusAct" value="1" disabled>
                                    </span>
                                        <input type="text" class="form-control" disabled value="Active" disabled>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="input-group">
                                    <span class="input-group-addon">
                                        <input type="radio" name="accStatus" id="accStatusInAct" value="0" disabled>
                                    </span>
                                        <input type="text" class="form-control" disabled value="In Active" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group payrollType-in-update-container">
                        <label class="col-sm-4 control-label" for="accStatus">Payroll Type</label>
                        <div class="col-sm-6">
