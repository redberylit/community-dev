...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        ...
        $('#monthlyDeductionMaster_form').bootstrapValidator({
            ...
            excluded: [':disabled'],
            fields: {
                monthDescription: {validators: {notEmpty: {message: '<?php echo $this->lang->line('common_are_you_sure');?>.'}}},/*Description is required*/
                dateDesc: {validators: {notEmpty: {message: '<?php echo $this->lang->line('common_description_is_required');?>.'}}},/*Date is required*/
            },
