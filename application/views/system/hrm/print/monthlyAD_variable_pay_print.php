            ...
            <td style="width:80%;" valign="top">
                <table border="0px">
                    ...
                    <tr>
                        ...
                        <td><h4 style="margin-bottom: 0px"><?php echo $this->lang->line('common_monthly');?> <?php echo $title; ?> </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td colspan="2"> <h5 style="margin-bottom: 0px"><?php echo $masterData[$date]; ?></h5> </td>
                    </tr>
                </table>
            </td>
        </tr>
