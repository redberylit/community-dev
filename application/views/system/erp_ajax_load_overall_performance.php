...
<div class="box box-warning">
    ...
    <div class="box-body" style="display: block;width: 100%">
        <div class="col-md-2 text-center">
            ...
            <div id="totalRevenue<?php echo $userDashboardID; ?>" style="margin-top: 70px">
                <?php
                if ($totalRevenue == 0) {
                    echo "<h3 style='cursor: pointer;' class='text-yellow' onclick='totalRevenue".$userDashboardID."()'><i class='fa fa-angle-left'></i> " . number_format($totalRevenue) . "</h3>";
                } else if ($totalRevenue > 0) {
                    echo "<h3 style='color: #4B94C0; cursor: pointer;' onclick='totalRevenue".$userDashboardID."()'><i class='fa fa-angle-up'></i> " . number_format($totalRevenue) . "</h3>";
                } else {
                    echo "<h3 style='cursor: pointer;' class='text-red' onclick='totalRevenue".$userDashboardID."()'><i class='fa fa-angle-down'></i> " . number_format($totalRevenue) . "</h3>";
                }
                ?>
            </div>
        </div>
        <div class="col-md-8">
            ...
            <div id="overallperformance<?php echo $userDashboardID; ?>" style="height: 200px"></div>
        </div>
        <div class="col-md-2 text-center">
            <div class="small">
                <i class="fa fa-clock-o"></i> <?php echo $this->lang->line('dashboard_net_profit');?><!--Net Profit-->
            </div>
            <div id="netProfit<?php echo $userDashboardID; ?>" style="margin-top: 70px">
                <?php
                if ($netProfit == 0) {
                    echo "<h3 style='cursor: pointer;' class='text-yellow' onclick='totalRevenue".$userDashboardID."()'><i class='fa fa-angle-left'></i> " . number_format($netProfit) . "</h3>";
                } else if ($netProfit > 0) {
                    echo "<h3 style='color: #4B94C0;cursor: pointer;' onclick='totalRevenue".$userDashboardID."()'><i class='fa fa-angle-up'></i> " . number_format($netProfit) . "</h3>";
                } else {
                    echo "<h3 style='cursor: pointer;' class='text-red' onclick='totalRevenue".$userDashboardID."()'><i class='fa fa-angle-down'></i> " . number_format($netProfit) . "</h3>";
                }
                ?>
            </div>
        </div>
...
?>
<script>
    var reflowoverallperformanceWidget<?php echo $userDashboardID; ?> = 0;
    var overallperformance<?php echo $userDashboardID; ?>;
    ...
    function totalRevenue<?php echo $userDashboardID; ?>(){
        ...
        var RptID = 'FIN_IS';
        var fieldNameChk = ['companyReportingAmount'];
        var captionChk = new Array('Reporting Currency');
        $.ajax({
            type: "POST",
