...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        <?php echo form_open('', 'role="form" id="GoodReceiptNote_header_form"'); ?>
            ...
            <div class="col-md-12 animated zoomIn">
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <?php echo form_dropdown('grnType', array('' => 'Select Type', '1' => 'Buyback', '2' => 'Others'), '', 'class="form-control" id="grnType"'); ?>
    ...
    <div id="step2" class="tab-pane">
        <?php echo form_open('', 'role="form" id="GoodReceiptNote_transport_form"'); ?>
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-4">
                        <div class="input-group">
                            ...
                            <input type="hidden" class="form-control" id="HelperID" name="HelperID">
                            <span class="input-group-btn">
                        <button class="btn btn-default" type="button" title="Clear" rel="tooltip"
                                onclick="clear_helper()"
                                style="height: 29px; padding: 2px 10px;"><i class="fa fa-repeat"></i></button>
                        <button class="btn btn-default" type="button" title="Add Driver" rel="tooltip"
                                onclick="link_helper_model()"
                                style="height: 29px; padding: 2px 10px;"><i class="fa fa-plus"></i></button>
                            </span>
                        </div>
                    </div>
                ...
                <form role="form" id="goodReceiptNote_add_item_form" class="form-horizontal">
                    ...
                    <table class="table table-bordered table-condensed no-color" id="po_detail_add_table">
                        ...
                        <tr>
                            ...
                            <th style="width: 150px;">Qty Chicks<?php required_mark(); ?></th>
                            <th style="width: 150px;">UOM <?php required_mark(); ?></th>
                            <th style="width: 100px;">Mortality <?php required_mark(); ?></th>
                            <th style="width: 100px;">Return <?php required_mark(); ?></th>
                            <th style="width: 100px;">Balance <?php required_mark(); ?></th>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="qtybirds[]" onfocus="this.select();"
                            ...
                            <td><input type="text" name="mortality[]" onfocus="this.select();"
                                       class="form-control number mortality" required readonly></td>

                            <td><input type="text" name="return[]" onfocus="this.select();"
                                       class="form-control number return" required readonly></td>

                            <td><input type="text" name="balance[]" class="form-control number balance" readonly></td>
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-condensed" id="">
                        ...
                        <tr>
                            ...
                            <td><?php echo form_dropdown('UnitOfMeasureID', $uom_arr, 'Each', 'class="form-control umoDropdown" id="UnitOfMeasureID"  required '); ?></td>

                            <td><input type="text" name="mortality" onfocus="this.select();"
                                       class="form-control number mortality" id="mortality_edit" required readonly>

                            <td><input type="text" name="returnedit" onfocus="this.select();"
                                       class="form-control number mortality" id="return_edit" required readonly></td>

                            <td><input type="text" name="balance" class="form-control number balance" id="balance_edit" readonly></td>
...
<script>
    ...
    function fetch_helper_detail() {
        ...
        if (helper_id == '') {
            ...
            /*  var empNameSplit = empName.split('|');*/
            $('#helperName').val($.trim(vehName)).trigger('input');
            $('#HelperID').val($.trim(EIdNo));
                ...
                function () {
                    $.ajax({
                        ...
                        $('#grnDetailsID_edit').val(data['grnDetailsID']);
                            ...
                            fetch_goodReciptNote_batch_chicks_edit();
                            fetch_goodReciptNote_batch_mortality_edit();
                            fetch_balancechicks_edit();
    ...
    function fetch_balancechicks_edit() {
        var batchID = $('#batchMasterID').val();
        $.ajax({
            async: true,
            type: 'post',
