...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label for="financeyear">Farmer<?php required_mark(); ?></label>
            ...
            <div class="form-group col-sm-4">
                <label for="financeyear">Batch<?php required_mark(); ?></label>
                <div id="batchload">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label for="transactionCurrencyID">Currency</label>
        ...
        <div class="row">
            <div class="form-group col-sm-4">
                <label>Segment<?php required_mark(); ?></label>
            ...
            <div class="form-group col-sm-4">
                <label>Narration<?php required_mark(); ?></label>
    ...
    <div id="step2" class="tab-pane">
        <div class="row">
            <div class="col-md-8"><h4>&nbsp;&nbsp;&nbsp;<i
                            class="fa fa-hand-o-right"></i>Add Dispatch Details
                </h4></div>
            <div class="col-md-4">
                ...
                success: function (data) {
                    ...
                    if (jQuery.isEmptyObject(data)) {
                        ...
                        $.each(data , function (key, value) {
                            ...
                            $('#table_body_pr_detail').append('<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-right">' + (value['qtygrn'] - value['returnqty'] ) + '</td><td class="text-right">' +parseFloat(value['unitTransferCost']).toFixed(2) + '</td><td class="text-center"><input type="text" class="number" id="qty_' + value['dispatchDetailsID'] + '" onkeyup="select_check_box(this,' + value['dispatchDetailsID'] + ',' + (value['qtygrn'] - value['returnqty'] ) + ' )" ></td><td class="text-right" style="display: none;"><input class="checkbox" id="check_' + value['dispatchDetailsID'] + '" type="checkbox" value="' + value['dispatchDetailsID'] + '"></td></tr>');
                            x++;
