            ...
            <div class="col-md-12 animated zoomIn">
                ...
                <fieldset class="scheduler-border" style="margin-top: 10px">
                    ...
                    <div class="form-group col-sm-4" style="margin-top: 10px">
                        <?php echo form_dropdown('documentCode[]', array('BBDPN' => 'Dispatch Note', 'BBGRN' => 'Goods Received Note', 'BBRV' => 'Receipt Voucher', 'BBPV' => 'Payment Voucher' , 'BBSV' => 'Settlement', 'BBDR' => 'Dispatch Return'), '', ' multiple class="form-control" id="documentCode"'); ?>
                    </div>
                </fieldset>
                <fieldset class="scheduler-border" style="margin-top: 10px">
                    <legend class="scheduler-border">
