...
echo head_page('Buyback Performance', false);
$csrf = array(
        ...
        <form name="buybackpreformance_rpt" id="buybackpreformance_rpt" method="post">
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-1">
                    <label for=""></label>
                    <button style="margin-top: 5px" type="button" onclick="get_buyback_prefoormance_report()"
...
<script type="text/javascript">
    ...
    function get_buyback_prefoormance_report() {
        var data = $('#buybackpreformance_rpt').serialize()
        $.ajax({
            type: "POST",
