...
echo head_page('WIP Report', false);
?>
<style>
    .bgc {
    ...
    <fieldset class="scheduler-border">
        ...
        <div class="col-md-12">
            ...
            <label for="inputData" class="col-md-1 control-label">
              Search :</label>
            <div class="col-md-2">
                <input type="text" id="search" name="search" class="form-control" onkeyup="get_wip_rep()">
            </div>
            ...
            <div class="col-sm-2">
                <div class="input-group" id="hide_total_row">
                    ...
                    <input type="text" class="form-control" disabled="" value="View Total">
                </div>
            </div>
        </div>
        <?php echo form_close(); ?>
