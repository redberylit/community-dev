...
if (!empty($cause)) { ?>
            ...
            foreach ($cause as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-attachment" width="10%">
                        <span class="pull-right"><a href="#" onclick="edit_mortalityCourse(<?php echo $val['causeID'] ?>)"><span
                                        title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="delete_mortalityCourse(<?php echo $val['causeID'] ?>);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a>
                        </span>
                    </td>
                </tr>
                <?php
    ...
    <br>
    <div class="search-no-results">THERE ARE NO MORTALITY COURSES TO DISPLAY.</div>
    <?php
}
?>