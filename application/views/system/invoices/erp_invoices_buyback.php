...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label><?php echo $this->lang->line('sales_markating_transaction_document_reference');?> # <span class="starmark"><?php required_mark(); ?></span></label><!--Reference-->
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label><?php echo $this->lang->line('sales_markating_transaction_document_narration');?> <span class="starmark"><?php required_mark(); ?></span></label></label><!--Narration-->
        ...
        <div class="row">
            <div class="form-group col-sm-12">
                ...
                <textarea class="form-control" rows="3" name="invoiceNote" id="invoiceNote"></textarea>
            </div>
        </div>
        <hr>
