...
if(!empty($extra['item_detail'])){
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            <thead>
            <tr>
                <th <?php if ($html) { echo "class='theadtr'"; }?> colspan="4"><?php echo $this->lang->line('sales_markating_view_invoice_item_details');?></th><!--Item Details-->
                <th <?php if ($html) { echo "class='theadtr'"; }?> colspan="4"> </th><!--Price-->
                <th <?php if ($html) { echo "class='theadtr'"; }?> colspan="5"><?php echo $this->lang->line('common_price');?> (<?php echo $extra['master']['transactionCurrency']; ?>) </th><!--Price-->
            </tr>
            <tr>
                ...
                <th <?php if ($html) { echo "class='theadtr'"; }?>> No Item</th>
                <th <?php if ($html) { echo "class='theadtr'"; }?> > Gross Qty</th>
                <th <?php if ($html) { echo "class='theadtr'"; }?>> Units</th>
                <th <?php if ($html) { echo "class='theadtr'"; }?>> Deduction</th>
                <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 5%"><?php echo $this->lang->line('common_qty');?></th><!--Qty-->
                <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 10%"><?php echo $this->lang->line('sales_markating_view_invoice_unit');?></th><!--Unit-->
                <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 10%"><?php echo $this->lang->line('sales_markating_view_invoice_discount');?></th><!--Discount-->
                <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 10%"><?php echo $this->lang->line('sales_markating_sales_net_unit_price');?></th><!--Net Unit Cost-->
                <!--<th class='theadtr' style="min-width: 10%">Total</th>
                <th class='theadtr' style="min-width: 10%">Tax</th>-->
                <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 10%"><?php echo $this->lang->line('sales_markating_view_invoice_net');?></th><!--Net-->

                <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 10%"> </th><!--Net-->
            ...
            if ($extra['item_detail']) {
                ...
                foreach ($extra['item_detail'] as $value) {
                    ...
                    foreach ($value as $val) {
                        ...
                        if($html) {
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;"><?php echo format_number($val['unittransactionAmount'] + ($txAmnt), $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                                <td style="text-align:right;"><?php echo format_number($val['discountAmount'], $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                                <td style="text-align:right;"><?php echo format_number(($val['unittransactionAmount'] - $val['discountAmount']) + ($txAmnt), $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                                <td style="text-align:right;"><?php echo format_number($val['transactionAmount'], $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>

                                <?php if (($html == 'true') && ($val['printTagYN'] == 1)) { ?>
                        ...
                        $Unitbuyback += ($val['unittransactionAmount']+($txAmnt));
                    ...
                    <tr>
                        ...
                        <?php } else{
                            echo '<td style="text-align:center;">' . $pdfNo . '</td>';
                            echo '<td style="text-align:center;">' . $itemCodePDF . '</td>';
                            echo '<td style="text-align:center;">' . $itemDescriptionPDF . '</td>';
                        } ?>
                        ...
                        <td class="sub_total reporttotal" style="text-align: right;"><b><?php echo $requestedQty;?></b></td>
                        <td class="sub_total reporttotal" style="text-align: right;"><b><?php echo number_format($Unitbuyback,$extra['master']['transactionCurrencyDecimalPlaces']) ;?></b></td>
                        <td class="sub_total reporttotal" style="text-align: right;"><b><?php echo number_format($discount,$extra['master']['transactionCurrencyDecimalPlaces']) ;;?></b></td>
                        <td class="sub_total reporttotal" style="text-align: right;"><b><?php echo number_format($netunitprice,$extra['master']['transactionCurrencyDecimalPlaces']) ;;?></b></td>
                        <td class="sub_total reporttotal" style="text-align: right;"><b><?php echo number_format($netprice,$extra['master']['transactionCurrencyDecimalPlaces']) ;;?></b></td>
...
<?php $transaction_total = 0;$Local_total = 0;$party_total = 0; if(!empty($extra['gl_detail'])){  ?>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            <thead>
            <tr>
                <th <?php if ($html) { echo "class='theadtr'"; }?> style="width: 5%">#</th>
                <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 45%;text-align: left;"><?php echo $this->lang->line('common_description');?></th><!--Description-->
                <th <?php if ($html) { echo "class='theadtr'"; }?> style="width: 15%"><?php echo $this->lang->line('common_segment');?></th><!--Segment-->
                <th <?php if ($html) { echo "class='theadtr'"; }?> style="width: 15%"><?php echo $this->lang->line('common_amount');?>(<?php echo $extra['master']['transactionCurrency']; ?>) </th><!--Amount-->
            ...
            <tr>
                ...
                <td style="width:60%;padding: 0;">
                    <table style="width: 100%" class="<?php echo table_class(); ?>">
                        <thead>
                        <tr>
                            <td  <?php if ($html) { echo "class='theadtr'"; }?> colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;<strong><?php echo $this->lang->line('sales_markating_view_invoice_tax_details');?></strong></td><!--Tax Details-->
                        </tr>
                        <tr>
                            <th  <?php if ($html) { echo "class='theadtr'"; }?>>#</th>
                            <th  <?php if ($html) { echo "class='theadtr'"; }?>><?php echo $this->lang->line('common_type');?></th><!--Type-->
                            <th  <?php if ($html) { echo "class='theadtr'"; }?>> <?php echo $this->lang->line('sales_markating_view_invoice_detail');?></th><!--Detail-->
                            <th  <?php if ($html) { echo "class='theadtr'"; }?>><?php echo $this->lang->line('sales_markating_view_invoice_tax');?></th><!--Tax-->
                            <th  <?php if ($html) { echo "class='theadtr'"; }?>><?php echo $this->lang->line('common_transaction');?><!--Transaction -->(<?php echo $extra['master']['transactionCurrency']; ?>) </th>
            ...
            <td style="width:50%;">
                <?php  if (!empty($extra['taxledger']) && $extra['master']['showTaxSummaryYN']==1) { ?>
                    <table style="width: 100%;" class="<?php echo table_class(); ?>">
                        <thead>
                        <tr>
                            <td  <?php if ($html) { echo "class='theadtr'"; }?> colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;<strong><?php echo $this->lang->line('sales_markating_view_invoice_tax_details');?></strong></td><!--Tax Details-->
                        </tr>
                        <tr>
                            <th <?php if ($html) { echo "class='theadtr'"; }?>>#</th>
                            <th <?php if ($html) { echo "class='theadtr'"; }?>> Short Code</th>
                            <th <?php if ($html) { echo "class='theadtr'"; }?>>Transaction (<?php echo $extra['master']['transactionCurrency']; ?>) </th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
            ...
            <tr>
                ...
                <td style="width:50%;padding: 0;">
                    <table style="width: 100%" class="<?php echo table_class(); ?>">
                        <thead>
                        <tr>
                            <td <?php if ($html) { echo "class='theadtr'"; }?> colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;<strong>Extra Charges</strong></td>
                        </tr>
                        <tr>
                            <th <?php if ($html) { echo "class='theadtr'"; }?>>#</th>
                            <th <?php if ($html) { echo "class='theadtr'"; }?>>Description</th>
                            <th <?php if ($html) { echo "class='theadtr'"; }?>>Transaction (<?php echo $extra['master']['transactionCurrency']; ?>) </th>
                        </tr>
                        </thead>
                        <tbody>
        ...
        <?php $gran_total=0; $tax_transaction_total = 0;$tax_Local_total = 0;$tax_customer_total = 0; $p_total=0; if(!empty($extra['item_detail'])){ ?>
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    <thead>
                    <tr>
                        <th <?php if ($html) { echo "class='theadtr'"; }?> colspan="9"><?php echo $this->lang->line('sales_markating_view_invoice_item_details');?></th><!--Item Details-->
                    </tr>
                    <tr>
                        <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 5%">#</th>
                        <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 15%"><?php echo $this->lang->line('sales_markating_view_invoice_item_code');?></th><!--Item Code-->
                        <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 65%"><?php echo $this->lang->line('sales_markating_view_invoice_item_description');?></th><!--Item Description-->
                        <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 10%"><?php echo $this->lang->line('sales_markating_view_invoice_uom');?></th><!--UOM-->
                        <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 5%"> No Item</th>
                        <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 5%"> Gross Qty</th>
                        <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 5%"> Units</th>
                        <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 5%"> Deduction</th>
                        <th <?php if ($html) { echo "class='theadtr'"; }?> style="min-width: 5%"><?php echo $this->lang->line('sales_markating_view_invoice_qty');?></th><!--Qty-->
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    if ($extra['buyback_detail_delivery']) {
                        ...
                        foreach ($extra['buyback_detail_delivery'] as $value) {
                            ...
                            <tr>
                                ...
                                <td class="sub_total reporttotal" style="text-align: right;"><b><?php echo $Units;?></b></td>
                                <td class="sub_total reporttotal" style="text-align: right;"><b><?php echo $deduction;?></b></td>
                                <td class="sub_total reporttotal" style="text-align: right;"><b><?php echo $qty;?></b></td>
