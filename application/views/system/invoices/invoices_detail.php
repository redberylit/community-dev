                    ...
                    <table class="table table-bordered table-condensed" id="item_edit_table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="quantityRequested" placeholder="0.00"
                                       ...
                                       id="edit_quantityRequested" onkeyup="checkCurrentStockEdit(this)" required></td>
                            <td>
                                <div class="input-group">
...
<script type="text/javascript">
    ...
    function cal_con_base_tax(id, element) {
        ...
        if (discount) {
            ...
            if (result) {
                ...
                $('#tax_amount_' + id).val(parseFloat((percentage / 100) * total).toFixed(2));
            } else {
    ...
    function change_tax_amount(id, discount_amount) {
        if (discount_amount > 0) {
            ...
            $('#item_taxPercentage_' + id).val(((parseFloat(discount_amount) / total) * 100).toFixed(2));
        } else {
            $('#item_taxPercentage_' + id).val(0);
        }
        select_check_box(id);
                    ...
                    $.each(data['detail'], function (key, value) {
                        ...
                        if (value['type'] == 'Item') {
                            ...
                            if (value['isSubitemExist'] == 1) {
                                ...
                                string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + val + value['itemDescription'] +  '-' + wareLocation + ' - ' + value['remarks'] + '</td><td>' + value['unitOfMeasure'] + '</td><td class="text-center">' + value['requestedQty'] + '</td><td class="text-right">' + parseFloat(value['unittransactionAmount']).formatMoney(transactionDecimalPlaces, '.', ',') + '</td><td class="text-right">' + parseFloat(value['discountAmount']).formatMoney(transactionDecimalPlaces, '.', ',') + '(' + value['discountPercentage'] + '%)</td><td class="text-right">' + parseFloat(value['unittransactionAmount'] - value['discountAmount']).formatMoney(transactionDecimalPlaces, '.', ',') + '</td><td class="text-right">' + parseFloat((value['requestedQty'] * (value['unittransactionAmount'] - value['discountAmount']))).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right">' + parseFloat((value['requestedQty'] * value['taxAmount'])).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right">' + (parseFloat(value['transactionAmount'])).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right"><a onclick="edit_glaccount(' + value['invoiceDetailsAutoID'] + ',' + value['expenseGLAutoID'] + ',' + value['revenueGLAutoID'] + ');"><span class="glyphicon glyphicon-transfer"></span></a> &nbsp;&nbsp;|&nbsp;&nbsp;<a style="' + colour + '" onclick="load_itemMasterSub_config_modal(' + value['invoiceDetailsAutoID'] + ',\'CINV\',' + value['wareHouseAutoID'] + ')"><i class="fa fa-list"></i></a> &nbsp;&nbsp; | &nbsp;&nbsp; <a onclick="edit_item(' + value['invoiceDetailsAutoID'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; | &nbsp;&nbsp;<a onclick="delete_item_direct(' + value['invoiceDetailsAutoID'] + ',2);"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
                            } else {
                                if (data['currency']['invoiceType'] == "Direct") {
                                    string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + val + value['itemDescription'] + '-' + wareLocation + ' - ' + partnoremarks  + '</td><td>' + value['unitOfMeasure'] + '</td><td class="text-center">' + value['requestedQty'] + '</td><td class="text-right">' + parseFloat(value['unittransactionAmount']).formatMoney(transactionDecimalPlaces, '.', ',') + '</td><td class="text-right">' + parseFloat(value['discountAmount']).formatMoney(transactionDecimalPlaces, '.', ',') + '(' + value['discountPercentage'] + '%)</td><td class="text-right">' + parseFloat(value['unittransactionAmount'] - value['discountAmount']).formatMoney(transactionDecimalPlaces, '.', ',') + '</td><td class="text-right">' + parseFloat((value['requestedQty'] * (value['unittransactionAmount'] - value['discountAmount']))).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right">' + parseFloat( value['totalAfterTax']).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right">' + (parseFloat(value['transactionAmount'])).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right"><a onclick="edit_glaccount(' + value['invoiceDetailsAutoID'] + ',' + value['expenseGLAutoID'] + ',' + value['revenueGLAutoID'] + ');"><span class="glyphicon glyphicon-transfer"></span></a> &nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="edit_item(' + value['invoiceDetailsAutoID'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; | &nbsp;&nbsp;<a onclick="delete_item_direct(' + value['invoiceDetailsAutoID'] + ',2);"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
                                } else {
                            ...
                            if (data['currency']['invoiceType'] == "Direct") {
                                $('#item_table_tfoot').append('<tr><td colspan="10" class="text-right"><?php echo $this->lang->line('sales_markating_transaction_sales_Item_tot');?> </td><td class="text-right total">' + parseFloat(item_trans_amount).formatMoney(transactionDecimalPlaces, '.', ',') + '</td><td>&nbsp;</td></tr>');
                                <!--Item Total-->
                            } else {
                                $('#item_table_tfoot').append('<tr><td colspan="10" class="text-right"><?php echo $this->lang->line('sales_markating_transaction_sales_Item_tot');?>  </td><td class="text-right total">' + parseFloat(item_trans_amount).formatMoney(transactionDecimalPlaces, '.', ',') + '</td><td>&nbsp;</td></tr>');
                            }
