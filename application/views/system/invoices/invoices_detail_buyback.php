            ...
            <div class="tab-content">
                ...
                <div id="tab_2" class="tab-pane">
                    <table class="table table-bordered table-striped table-condesed">
                        <thead>
                        <tr>
                            <th colspan="8"><?php echo $this->lang->line('sales_markating_transaction_document_item_details'); ?> </th>
                            <!--Item Details-->
                            <?php
                            ...
                            <th colspan="6"><?php echo $this->lang->line('common_price'); ?> <span class="currency">(
                                ...
                                ?>
                                <th colspan="5"><?php echo $this->lang->line('common_price'); ?> <span class="currency">(
                                        <?php echo $master['transactionCurrency']; ?><!--Price-->
                                    )</span></th>
                            <?php
                            }
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-condensed" id="item_add_table">
                        ...
                        <tr>
                            ...
                            ?>
                            <td>
                                <select name="item_text[]" class="form-control item_text input-mini" id="">
                                    <option value="" selected="selected">Select Tax Types</option>
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-condensed" id="item_edit_table">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" name="estimatedAmount" placeholder="0.00"
                                           class="form-control number input-mini" onfocus="this.select();"
                            ...
                            ?>
                            <td>
                                <select name="item_text" style="width: 80px;" class="form-control item_text input-mini" id="edit_item_text">
                        ...
                        if (value['type'] == 'Item') {
                            ...
                            if (value['isSubitemExist'] == 1) {
                                ...
                                if (data['currency']['invoiceType'] == "Direct") {
                                    ...
                                    if($policy==0 || $policy==null) {
                                    ?>
                                    string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + val + value['itemDescription'] + '-' + value['wareHouseLocation'] + '</td><td>' + value['noOfItems'] + '</td><td>' + value['grossQty'] + '</td><td>' + value['noOfUnits'] + '</td><td>' + value['deduction'] + '</td><td class="text-center">' + value['requestedQty'] + '</td><td class="text-right">' + parseFloat(value['unittransactionAmount']).formatMoney(transactionDecimalPlaces, '.', ',') + '</td><td class="text-right">' + parseFloat(value['discountAmount']).formatMoney(transactionDecimalPlaces, '.', ',') + '(' + value['discountPercentage'] + '%)</td><td class="text-right">' + parseFloat(value['unittransactionAmount'] - value['discountAmount']).formatMoney(transactionDecimalPlaces, '.', ',') + '</td><td class="text-right">' + parseFloat((value['requestedQty'] * (value['unittransactionAmount'] - value['discountAmount']))).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right">' + parseFloat((value['requestedQty'] * value['taxAmount'])).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right">' + (parseFloat(value['transactionAmount'])).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right"> '+ printag +' &nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="edit_glaccount(' + value['invoiceDetailsAutoID'] + ',' + value['expenseGLAutoID'] + ',' + value['revenueGLAutoID'] + ');"><span class="glyphicon glyphicon-transfer"></span></a> &nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="edit_item(' + value['invoiceDetailsAutoID'] +');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; | &nbsp;&nbsp;<a onclick="delete_item_direct(' + value['invoiceDetailsAutoID'] + ',2);"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
                                    <?php
                                    }else{
                                    ?>
                                    ...
                                    string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + val + value['itemDescription'] + '-' + value['wareHouseLocation'] + '</td><td>' + value['unitOfMeasure'] + '</td><td class="text-center">' + value['grossQty'] + '</td><td class="text-right">' + parseFloat(value['unittransactionAmount']).formatMoney(transactionDecimalPlaces, '.', ',') + '</td><td class="text-center">' + value['noOfItems'] + '</td><td class="text-center">' + value['grossQty'] + '</td><td class="text-center">' + value['deduction'] + '</td><td class="text-center">' + value['requestedQty'] + '</td><td class="text-right">' + parseFloat((value['requestedQty'] * (value['unittransactionAmount']))).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right">' + parseFloat((value['requestedQty'] * value['taxAmount'])).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right">' + (parseFloat(value['transactionAmount'])).formatMoney(LocalDecimalPlaces, '.', ',') + '</td><td class="text-right">'+ printag +'&nbsp;&nbsp;|&nbsp;&nbsp; <a onclick="edit_glaccount(' + value['invoiceDetailsAutoID'] + ',' + value['expenseGLAutoID'] + ',' + value['revenueGLAutoID'] + ');"><span class="glyphicon glyphicon-transfer"></span></a> &nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="edit_item(' + value['invoiceDetailsAutoID'] + ');"><span class="glyphicon glyphicon-pencil"></span></a>  | &nbsp;&nbsp; <a onclick="delete_item_direct(' + value['invoiceDetailsAutoID'] + ',2);"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
                            ...
                            if (data['currency']['invoiceType'] == "Direct") {
                                ...
                                if($policy==0 || $policy==null) {
                                ?>
                                $('#item_table_tfoot').append('<tr><td colspan="13" class="text-right"><?php echo $this->lang->line('sales_markating_transaction_sales_Item_tot');?> </td><td class="text-right total">' + parseFloat(item_trans_amount).formatMoney(transactionDecimalPlaces, '.', ',') + '</td><td>&nbsp;</td></tr>');
                                <?php
                                }else{
                                ?>
...
//            data.push({'name': 'uom', 'value': $('#UnitOfMeasureID option:selected').text()});
            ...
            $.ajax(
                {
                    ...
                    dataType: 'json',
                    data: data,
                    url: "<?php echo site_url('InvoicesPercentage/save_invoice_item_detail'); ?>",
                    beforeSend: function () {
                        startLoad();
    ...
    function saveDirectInvoiceDetails() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: data,
            url: "<?php echo site_url('InvoicesPercentage/save_direct_invoice_detail'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
...
//            data.push({'name': 'uom', 'value': $('#UnitOfMeasureID option:selected').text()});
    ...
    function fetch_sales_order_base()
    {
        ...
        mySelect.append($('<option></option>').val(<?php echo $val['contractAutoID']?>).html('<?php echo $val['contractCode']?>'));
        <?php   }
        }?>
