                ...
                <div class="panel with-nav-tabs panel-success" style="border: none;">
                    <div class="panel-heading">
                        <ul class="nav nav-tabs mainpanel">
                            ...
                            if (!empty($dashboardTab)) {
                                ?>
                                <button type="button" class="btn btn-primary btn-xs pull-right" style="margin-top: 8px;"
                                        onclick="modal_template_setup()"><i class="fa fa-plus"></i> <?php echo $this->lang->line('dashboard_new_dashboard');?><!--New Dashboard-->
                                </button>
                                <?php
                            } else {
                                ?>
