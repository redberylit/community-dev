                    ...
                    <td class="mailbox-name">
                        <div class="contact-box">
                            <div class="link-box"><strong class="contacttitle">Project Name : </strong><a
                                        ...
                                        class="contacttitle">Total Project Cost (LKR) : </strong><a class="link-person noselect" href="#"><?php echo number_format($val['totalProjectValue'],2)  ?></a><br><strong class="contacttitle">Total Claimed Amount (LKR) : </strong><a class="link-person noselect" href="#"><?php echo number_format($val['claimedamt'],2) ?></a>
                            </div>
                        </div>
                    </td>
