                    ...
                    <td class="mailbox-name">
                        <div class="contact-box">
                            <div class="link-box"><strong class="contacttitle">Proposal Name : </strong><a
                                        ...
                                        class="contacttitle">Qualified Beneficiaries : <?php echo $qualifieddonors['Ben'] ?>  / <?php echo $val['Beneficiarycount'] ?> </strong>  <a class="link-person noselect" href="#"> </a><br><strong class="contacttitle">Commited Amount (LKR) : <?php echo number_format($donoramt['commitedamt'],2)?> / <?php echo number_format($donoramt['totalamt'],2)?></strong><a class="link-person noselect" href="#"> </a>
                            </div>
                        </div>
                    </td>
                    <td class="mailbox-name">
