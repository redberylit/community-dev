    ...
    <div class="col-sm-12">
        <strong class="task-cat-upcoming-label">
            ...
            if (isset($project_steps_projectname[0])) {
                echo $project_steps_projectname[0]['projectName'] . ' | ' . 'Project Cost : ' . number_format($project_steps_projectname[0]['projectvalue'], 2);
            } ?></strong>
    </div>
</div>
<br>
                ...
                foreach ($detail as $row) {
                    if ($row['projectStageID'] == $val['projectStageID']) { ?>
                        <tr>
                            ...
                            <td class="mailbox-name"><a href="#" class="pull-right">&nbsp;&nbsp;&nbsp;LKR <?php echo number_format($row['amount']) ; ?></a></td>
