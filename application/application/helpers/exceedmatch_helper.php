...
if (!function_exists('exceed_double_entry')) { /*get po action list*/
    function exceed_double_entry($exceededMatchID)
    {
        ...
        foreach ($matchDetail as $val) {
            ...
            //$itemledger_arr['wareHouseCode'] = $details_arr['wareHouseCode'];
            //$itemledger_arr['wareHouseLocation'] = $details_arr['wareHouseLocation'];
            //$itemledger_arr['wareHouseDescription'] = $details_arr['wareHouseDescription'];
            ...
            $itemledger_arr['itemSystemCode'] = $item['itemSystemCode'];
            $itemledger_arr['itemDescription'] = $item['itemDescription'];
            $itemledger_arr['defaultUOMID'] = $val['defaultUOM'];
            ...
            $itemledger_arr['confirmedDate'] = $CI->common_data['current_date'];
            $itemledger_arr['approvedYN'] = 1;
            $itemledger_arr['approvedDate'] = $CI->common_data['current_date'];
            ...
            $itemledger_arr['companyID'] = $CI->common_data['company_data']['company_id'];
            $itemledger_arr['companyCode'] = $CI->common_data['company_data']['company_code'];
            $itemledger_arr['createdUserGroup'] = $CI->common_data['user_group'];
            $itemledger_arr['createdPCID'] = $CI->common_data['current_pc'];
            $itemledger_arr['createdUserID'] = $CI->common_data['current_userID'];
            $itemledger_arr['createdDateTime'] = $CI->common_data['current_date'];
            $itemledger_arr['createdUserName'] = $CI->common_data['current_user'];
            $itemledger_arr['modifiedPCID'] = $CI->common_data['current_pc'];
            $itemledger_arr['modifiedUserID'] = $CI->common_data['current_userID'];
            $itemledger_arr['modifiedDateTime'] = $CI->common_data['current_date'];
            $itemledger_arr['modifiedUserName'] = $CI->common_data['current_user'];

            if (!empty($item_arr)) {
                $CI->db->where('itemAutoID', $val['itemAutoID']);
                $CI->db->update('srp_erp_itemmaster', $item_arr);
            }
        ...
        for ($i = 0; $i < count($double_entry['gl_detail']); $i++) {
            ...
            $generalledger_arr[$i]['confirmedDate'] = $CI->common_data['current_date'];
            $generalledger_arr[$i]['approvedDate'] = $CI->common_data['current_date'];
            ...
            $generalledger_arr[$i]['createdUserGroup'] = $CI->common_data['user_group'];
            $generalledger_arr[$i]['createdPCID'] = $CI->common_data['current_pc'];
            $generalledger_arr[$i]['createdUserID'] = $CI->common_data['current_userID'];
            $generalledger_arr[$i]['createdDateTime'] = $CI->common_data['current_date'];
            $generalledger_arr[$i]['createdUserName'] = $CI->common_data['current_user'];
            $generalledger_arr[$i]['modifiedPCID'] = $CI->common_data['current_pc'];
            $generalledger_arr[$i]['modifiedUserID'] = $CI->common_data['current_userID'];
            $generalledger_arr[$i]['modifiedDateTime'] = $CI->common_data['current_date'];
            $generalledger_arr[$i]['modifiedUserName'] = $CI->common_data['current_user'];
        }
