...
if (!function_exists('taxChkbox')) {
    function taxChkbox($itemAutoID,$type,$taxCalculationformulaID)
    {
        ...
        if($type==$taxCalculationformulaID){
            ...
            $chkbox = '<div style="text-align: center;"><div class="skin skin-square"><div class="skin-section extraColumns"><input id="selectItem_'.$itemAutoID.'" type="checkbox" checked data-caption="" class="columnSelected" onclick="ItemsSelectedSync(this)" name="checkedInvoice[]" value="'.$itemAutoID.'"></div></div></div>';
        }else{
            $chkbox = '<div style="text-align: center;"><div class="skin skin-square item-iCheck"> <div class="skin-section extraColumns"><input id="selectItem_'.$itemAutoID.'" onclick="ItemsSelectedSync(this)" name="checkedInvoice[]" type="checkbox" class="columnSelected"  value="'.$itemAutoID.'" ><label for="checkbox">&nbsp;</label> </div></div></div>';
        }
