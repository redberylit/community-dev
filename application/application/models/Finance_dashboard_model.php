...
WHERE
	srp_erp_generalledger.documentDate BETWEEN '$beginingDate' AND '$endDate' AND srp_erp_chartofaccounts.accountCategoryTypeID = 11 AND srp_erp_generalledger.companyID IN (SELECT companyID FROM `srp_erp_companygroupdetails` where companyGroupID = '{$comapnyID}')")->row_array();
...
INNER JOIN srp_erp_chartofaccounts ON srp_erp_generalledger.GLAutoID = srp_erp_chartofaccounts.GLAutoID AND srp_erp_chartofaccounts.masterCategory = 'PL' AND srp_erp_chartofaccounts.companyID IN (SELECT companyID FROM `srp_erp_companygroupdetails` where companyGroupID = '{$comapnyID}')
WHERE
	srp_erp_generalledger.documentDate BETWEEN '$beginingDate' AND '$endDate' AND srp_erp_chartofaccounts.accountCategoryTypeID = 11 AND srp_erp_generalledger.companyID IN (SELECT companyID FROM `srp_erp_companygroupdetails` where companyGroupID = '{$comapnyID}') GROUP BY srp_erp_generalledger.GLAutoID")->result_array();
        }
...
WHERE
	srp_erp_generalledger.documentDate BETWEEN '$beginingDate' AND '$endDate' AND srp_erp_generalledger.companyID = " . $this->common_data['company_data']['company_id'] . " AND GLType='PLI' GROUP BY srp_erp_generalledger.segmentID")->result_array();
        ...
        {
            $result = $this->db->query("SELECT
	SUM( srp_erp_generalledger.companyLocalAmount ) *- 1 AS companyLocalAmount,
	SUM( srp_erp_generalledger.companyReportingAmount ) *- 1 AS companyReportingAmount,
	srp_erp_groupsegment.description,
	srp_erp_generalledger.GLAutoID 
FROM
	srp_erp_generalledger
	INNER JOIN srp_erp_segment ON srp_erp_generalledger.segmentID = srp_erp_segment.segmentID 
	INNER JOIN srp_erp_groupsegmentdetails on srp_erp_groupsegmentdetails.segmentID = srp_erp_segment.segmentID
	INNER JOIN srp_erp_groupsegment ON srp_erp_groupsegment.segmentID = srp_erp_groupsegmentdetails.groupSegmentID 
	
WHERE
	srp_erp_generalledger.documentDate BETWEEN '$beginingDate' AND '$endDate'
	AND srp_erp_generalledger.companyID IN ( SELECT companyID FROM `srp_erp_companygroupdetails` WHERE companyGroupID = {$comapnyID} ) 
	AND GLType = 'PLI' 
GROUP BY
