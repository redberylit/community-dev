...
class Budget_transfer_model extends ERP_Model
{
    ...
    function confirm_budget_transfer(){
        ...
        $this->db->select('budgetTransferAutoID, documentSystemCode,createdDate');
        ...
        if($autoApproval==0){
            $approvals_status = $this->approvals->auto_approve($bdt_data['budgetTransferAutoID'], 'srp_erp_budgettransfer','budgetTransferAutoID', 'BDT',$bdt_data['documentSystemCode'],$bdt_data['createdDate']);
        }elseif($autoApproval==1){
            $approvals_status = $this->approvals->CreateApproval('BDT', $bdt_data['budgetTransferAutoID'], $bdt_data['documentSystemCode'], 'Budget Transfer', 'srp_erp_budgettransfer', 'budgetTransferAutoID',0,$bdt_data['createdDate']);
        }else{
                ...
                if($result){
                    foreach($bdtdetails as $transdetl){
                        foreach($periods as $value){
                            ...
                            $dataD['transactionAmount'] = ($transdetl['transferAmount']/$monthcount)*-1;
                            ...
                            $dataD['companyLocalAmount'] = ($transdetl['transferAmountLocal']/$monthcount)*-1;
                            ...
                            $dataD['companyReportingAmount'] = ($transdetl['transferAmountRpt']/$monthcount)*-1;
                            ...
                            $dataDT['transactionAmount'] = ($transdetl['transferAmount']/$monthcount);
                            ...
                            $dataDT['companyLocalAmount'] = ($transdetl['transferAmountLocal']/$monthcount);
                            ...
                            $dataDT['companyReportingAmount'] = ($transdetl['transferAmountRpt']/$monthcount);
