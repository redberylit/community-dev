...
GROUP BY
    ...
    function update_bank_cash_generalLedger($shiftID)
    {
        $q = "INSERT INTO srp_erp_generalledger (
                ...
                LEFT JOIN srp_erp_pos_menusalesmaster menusalesmaster ON payments.menuSalesID = menusalesmaster.menuSalesID AND menusalesmaster.wareHouseAutoID = '" . $this->outletID . "'
