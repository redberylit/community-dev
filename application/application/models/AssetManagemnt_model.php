...
class AssetManagemnt_model extends ERP_Model
{
    ...
    function save_asset()
    {
        ...
        $data['DEPpercentage'] = trim($this->input->post('DEPpercentage'));
        ...
        $transactionCurrency = currency_conversionID($data['transactionCurrency'], $data['transactionCurrency']);
 ...
 /*       if ($isPostToGL != 1) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($approvals_status==1) {
                ...
                /*asset Cost*/
                //$cost_asset['originDocumentSystemCode'] = $assetDetails['faID'];
                //$cost_asset['originDocumentID'] = $assetDetails['faID'];
...
//            $reporting_currency = currency_conversion($cost_asset['companyLocalCurrency'], $cost_asset['companyReportingCurrency']);
    ...
    {
         $assetDetails = $this->db->query("SELECT srp_erp_fa_asset_master.faID,srp_erp_fa_asset_master.barcode,srp_erp_fa_asset_master.serialNo, srp_erp_fa_asset_master.companyID, srp_erp_fa_asset_master.currentLocation,srp_erp_fa_asset_master.companyCode, srp_erp_fa_asset_master.segmentID, srp_erp_fa_asset_master.segmentCode, srp_erp_fa_asset_master.faAssetDept, srp_erp_fa_asset_master.faCode, srp_erp_fa_asset_master.assetCodeS, srp_erp_fa_asset_master.faUnitSerialNo, srp_erp_fa_asset_master.assetDescription, srp_erp_fa_asset_master.comments, srp_erp_fa_asset_master.dateAQ, srp_erp_fa_asset_master.dateDEP, srp_erp_fa_asset_master.depMonth, srp_erp_fa_asset_master.DEPpercentage, srp_erp_fa_asset_master.faCatID, srp_erp_fa_asset_master.faSubCatID, srp_erp_fa_asset_master.companyLocalCurrency, srp_erp_fa_asset_master.companyLocalExchangeRate, srp_erp_fa_asset_master.companyReportingCurrency, srp_erp_fa_asset_master.companyReportingExchangeRate, srp_erp_fa_asset_master.companyLocalAmount, srp_erp_fa_asset_master.companyReportingAmount, srp_erp_fa_asset_master.auditCategory, srp_erp_fa_asset_master.partNumber, srp_erp_fa_asset_master.manufacture, srp_erp_fa_asset_master.unitAssign, srp_erp_fa_asset_master.unitAssignHistory, srp_erp_fa_asset_master.image, srp_erp_fa_asset_master.usedBy, srp_erp_fa_asset_master.usedByHistory, srp_erp_fa_asset_master.location, srp_erp_fa_asset_master.currentLocation, srp_erp_fa_asset_master.locationHistory, srp_erp_fa_asset_master.selectedForDisposal, srp_erp_fa_asset_master.disposed, srp_erp_fa_asset_master.disposedDate, srp_erp_fa_asset_master.dateDisposed, srp_erp_fa_asset_master.assetdisposalMasterAutoID, srp_erp_fa_asset_master.reasonDisposed, srp_erp_fa_asset_master.cashDisposal, srp_erp_fa_asset_master.costAtDisposal, srp_erp_fa_asset_master.ACCDEPDIP, srp_erp_fa_asset_master.profitLossDisposal, srp_erp_fa_asset_master.technicalHistory, srp_erp_fa_asset_master.costGLAutoID, srp_erp_fa_asset_master.costGLCode, srp_erp_fa_asset_master.costGLCodeDes, srp_erp_fa_asset_master.ACCDEPGLAutoID, srp_erp_fa_asset_master.ACCDEPGLCODE, srp_erp_fa_asset_master.ACCDEPGLCODEdes, srp_erp_fa_asset_master.DEPGLAutoID, srp_erp_fa_asset_master.DEPGLCODE, srp_erp_fa_asset_master.DEPGLCODEdes, srp_erp_fa_asset_master.DISPOGLAutoID, srp_erp_fa_asset_master.DISPOGLCODE, srp_erp_fa_asset_master.DISPOGLCODEdes, srp_erp_fa_asset_master.isPostToGL, srp_erp_fa_asset_master.postGLAutoID, srp_erp_fa_asset_master.postGLCode, srp_erp_fa_asset_master.postGLCodeDes, srp_erp_fa_asset_master.confirmedYN, srp_erp_fa_asset_master.confirmedByEmpID, srp_erp_fa_asset_master.confirmedByName, srp_erp_fa_asset_master.confirmedDate, srp_erp_fa_asset_master.approvedYN, srp_erp_fa_asset_master.approvedDate, srp_erp_fa_asset_master.approvedbyEmpID, srp_erp_fa_asset_master.approvedbyEmpName, srp_erp_fa_asset_master.createdUserGroup, srp_erp_fa_asset_master.selectedYN, srp_erp_fa_asset_master.assetType, srp_erp_fa_asset_master.supplierID, srp_erp_fa_asset_master.tempRecord, srp_erp_fa_asset_master.toolsCondition, srp_erp_fa_asset_master.selectedforJobYN, srp_erp_fa_asset_master.`timestamp`, srp_erp_fa_asset_master.createdPCID, srp_erp_fa_asset_master.createdUserID, srp_erp_fa_asset_master.createdDateTime, srp_erp_fa_asset_master.createdUserName, srp_erp_fa_asset_master.modifiedPCID, srp_erp_fa_asset_master.modifiedUserID, srp_erp_fa_asset_master.modifiedDateTime, srp_erp_fa_asset_master.modifiedUserName, srp_erp_itemcategory.itemCategoryID, srp_erp_itemcategory.description  MaincatDescription, srp_erp_itemcategory_sub.description SubcatDescription,locationName,srp_erp_fa_asset_master.companyLocalCurrencyDecimalPlaces,srp_erp_fa_asset_master.postDate,srp_erp_suppliermaster.supplierName,srp_erp_fa_asset_master.docOrigin,srp_erp_fa_asset_master.docOriginSystemCode FROM srp_erp_fa_asset_master LEFT JOIN srp_erp_itemcategory ON srp_erp_fa_asset_master.faCatID = srp_erp_itemcategory.itemCategoryID INNER JOIN srp_erp_itemcategory AS srp_erp_itemcategory_sub ON srp_erp_fa_asset_master.faSubCatID = srp_erp_itemcategory_sub.itemCategoryID
...
//        exit;
        ...
        /*if ($isAvaialbeDep) {
            $this->session->set_flashdata('e', "Depreciation for this selected month has been done already !.");
            return array('status' => false);
        }*/
        //echo '<pre>';print_r($assetsMasters); echo '</pre>'; die();
        if (!empty($assetsMasters)) {
            ...
            foreach ($assetsMasters as $assetsMaster) {
                ...
                $pendingDepreciation = dep_calculate($assetsMaster['companyLocalAmount'], $assetsMaster['DEPpercentage']);
...
FROM
	...
	AND faid = $faID")->row_array();
        ...
        {
            $this->s3->deleteMyObject('uploads/assets/'.$itemimageexist['image']);
        }
...
WHERE
	srp_erp_fa_asset_disposalmaster.assetdisposalMasterAutoID = '{$assetdisposalMasterAutoID}' GROUP BY srp_erp_fa_asset_master.faID")->result_array();
        ...
        return json_encode(array('a' => $this->db));
    }
