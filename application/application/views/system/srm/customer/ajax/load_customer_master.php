            ...
            foreach ($output as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-name" style="text-align: center">
                        <span class="label "
                            ...
                            <?php if ($val['isActive'] == 1) {
                                ...
                                echo '<span class="label" style="background-color: green; color: #FFFFFF; font-size: 11px;">'.$active.'</span>';
                            } else {
                                $notactive= $this->lang->line('srm_not_active');
                                echo '<span class="label" style="background-color: red; color: #FFFFFF; font-size: 11px;">'.$notactive.'</span>';
                            } ?>
                            <!--Active-->
                            <!--Not Active-->
                    ...
                    <td class="mailbox-name" style="text-align: center">
                        ...
                        | &nbsp;<a onclick="delete_customer(<?php echo $val['CustomerAutoID'] ?>);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a></span>
