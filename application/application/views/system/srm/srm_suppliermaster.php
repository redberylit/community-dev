                    ...
                    <form class="form-horizontal">
                        ...
                        <fieldset>
                            ...
                            <button type="button" id="" name="" class="btn btn-primary" style="float:right;"
                                    onclick="load_supplier_itemsmaster();"><?php echo $this->lang->line('common_add_item');?>
                            </button> <!--Add item-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-inline">
                    ...
                    <div>Search Item: <input id="keyword_itemDescription" name="itemID" type="text"
                                             placeholder="search"
            ...
            success: function (data) {
                ...
                if (jQuery.isEmptyObject(data)) {
                    ...
                    $.each(data, function (val, text) {
                        ...
                        var del = '<i class="fa fa-trash text-red" onclick="delete_supplier_item(' + text['supplierItemID'] + ')">&nbsp;</i>';
                        if (text['isActive'] == 1) {
...
//                $("#modal_itemmaster").modal('show')
            ...
            success: function (data) {
                ...
                $.each(data, function (val, text) {
                    if (text['supplierItemID'] > 0) {
                        $("#tableBody_Itemmaster").append('<tr><td >' + text['itemSystemCode'] + '</td><td>' + text['seconeryItemCode'] + '</td><td>' + text['itemDescription'] + '</td><td>' + text['mainCategory'] + '</td><td>' + text['catDescription'] + '</td><td><button class="btn btn-xs btn-default" id="save_itm_btn" type="submit" disabled onclick="save_supplierItem(' + text['itemAutoID'] + ');"><?php echo $this->lang->line('srm_added');?></button></td></tr>');<!--Added-->
                    } else {
                        $("#tableBody_Itemmaster").append('<tr><td >' + text['itemSystemCode'] + '</td><td>' + text['seconeryItemCode'] + '</td><td>' + text['itemDescription'] + '</td><td>' + text['mainCategory'] + '</td><td>' + text['catDescription'] + '</td><td><button class="btn btn-xs btn-primary" id="save_itm_btn" type="submit" onclick="save_supplierItem(' + text['itemAutoID'] + ');"><?php echo $this->lang->line('common_add');?></button></td></tr>');<!--Add-->
                    }
                });
