...
echo head_page('Customer Balance Summary', false);
?>
<style>
    .bgc {
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-2">
                    <label for="">Customer</label>
                        <?php echo form_dropdown('customerID[]', all_customer_drop(false), '', 'multiple  class="form-control select2" id="customerID"'); ?>
                </div>
...
<script type="text/javascript">
    ...
    $('.headerclose').click(function () {
        fetchPage('system/accounts_receivable/report/erp_customer_balance_report', '', 'Customer Balance Summary')
    });
