...
<style>
            ...
            <table class="<?php echo table_class(); ?>">
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <td>
                            <span class="label label-warning" style="padding: 0px 5px ;font-size: 100%;">&nbsp;</span> <?php echo $this->lang->line('common_partially_approved');?><!--Partially Approved-->
                        </td>
                </tr>
                </tbody>
            </table>
    ...
    <div class="col-md-12">
        ...
        <label for="inputData" class="col-md-1 control-label"><?php echo $this->lang->line('hrms_payroll_department');?><!--Department-->:</label>
        ...
        <label for="inputCodforn" class="col-md-2 control-label" style="width:95px"><?php echo $this->lang->line('common_date');?> <?php echo $this->lang->line('common_from');?><!--Date From--></label>
        ...
        <label for="inputCodforn" class="col-md-2 control-label" style="width:80px"><?php echo $this->lang->line('common_date');?> <?php echo $this->lang->line('common_to');?><!--Date To--></label>
        <div class="col-md-2" style="padding-left: 0px;">
            <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
        ...
        <label for="inputData" class="col-md-1 control-label"><?php echo $this->lang->line('hrms_payroll_group_by');?><!--Group By-->:</label>
        <div class="col-md-2" style="padding-left: 0px;">
            <?php echo form_dropdown('groupby', array('0'=>$this->lang->line('hrms_payroll_attendance_date')/*'Attendance Date'*/), '', ' onchange="filterAttendanceTable();" class="form-control select2" id="groupby" required'); ?>
        </div>


    </div>
    <div class="col-md-12">
        <button onclick="clearfilter()" class="btn btn-primary btn-xs"><?php echo $this->lang->line('common_clear');?><!--Clear--></button>
        <hr>
        </div>
    ...
    <div class="table-responsive">
        <table id="attendanceMasterTB" class="<?php echo table_class(); ?>">
            ...
            <tr>
                <th>#</th>
                <th><?php echo $this->lang->line('hrms_payroll_department');?><!--Department--></th>
                <th><span id="coltitle"><?php echo $this->lang->line('hrms_payroll_attendance_date');?><!--Attendance Date--></th>
                ...
                <th style="width: 80px;text-align: center"><?php echo $this->lang->line('common_status');?><!--Status--></th>
...
<?php echo footer_page('Right foot', 'Left foot', false); ?>
        ...
        <div class="modal-dialog" style="width: 95%" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="salary-cat-title"><?php echo $this->lang->line('hrms_payroll_attendance_list');?><!--Attendance List--></h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="approvaldata()"
                            class="btn btn-primary hideremove  btn-sm controlCls"><?php echo $this->lang->line('common_save_change');?><!--Save changes-->
                    </button>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" onclick="leaveClose()" class="close" ><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><?php echo $this->lang->line('hrms_payroll_leave_application');?><!--Leave Application--> </h4>
                </div>
                <div class="modal-body">
                    <div class="row" style="">
                        <div class="col-md-12">
                            <label for="inputCodforn" id="employeeName" class="col-md-12 control-label" style=""></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="inputCodforn" class="col-md-3 control-label" style=""><?php echo $this->lang->line('hrms_payroll_leave_type');?><!--leave Type--></label>
                        ...
                        <div class="col-md-6">
                            <table class="table table-bordered table-striped table-condensed table-row-select">
                                <tr style="">
                                    <td style="font-size: 11px" width="150px"><strong><?php echo $this->lang->line('hrms_payroll_balance');?><!--Leave Balance--></strong></td>
                                    <td><div id="leavebalance">0</div></td>
                                </tr>
                            </table>

                        </div>
                    </div>
                    <i><?php echo $this->lang->line('common_note');?><!--Note--> : <?php echo $this->lang->line('hrms_payroll_this_will_generate_automatic_leave_application_for_this_day');?><!--This will generate automatic leave application for this day--></i>
                </div>
                <div class="modal-footer">
                    <button type="button" onclick="saveLeaves()" class="btn btn-primary"><?php echo $this->lang->line('common_save_change');?><!--Save changes--></button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <script type="text/javascript">
        ...
        function filterAttendanceTable() {
                if($('#groupby').val()==0){
                    $('#coltitle').html('<?php echo $this->lang->line('hrms_payroll_attendance_date');?>');/*Attendance Date*/
                }
                else{
                    $('#coltitle').html('<?php echo $this->lang->line('hrms_payroll_employee');?>');/*Employee*/
                }
        ...
        function load_attendanceTB(selectedRowID=null) {
            ...
            attMasterTB = $('#attendanceMasterTB').DataTable({
                ...
                "fnServerData": function (sSource, aoData, fnCallback) {
                    ...
                    aoData.push({"name": "groupby", "value": $('#groupby').val()});
        ...
        function edit_attendance(attendanceDate, floorID, col) {
            $.ajax({
                ...
                type: 'post',
                dataType: 'html',
                data: {attendanceDate: attendanceDate, floorID: floorID,col:col, approvedYN: $('#approvedYN').val(),datefrom:$('#datefrom').val(),dateto:$('#dateto').val()},
        ...
        function loadautoleave_confirm_details(){
            ...
            $.ajax({
                type: 'post',
                dataType: 'json',
                data: {'leaveTypeID': leaveTypeID,'halfDay': halfDay,'shortLV': shortLV,'isAllowminus': isAllowminus,'isCalenderDays': isCalenderDays,'entitleSpan': entitleSpan,'startDate': startDate,'endDate': endDate},
        ...
        function saveLeaves(){
            ...
            $.ajax({
                type: 'post',
                dataType: 'json',
                data: {'leaveMasterID': leaveMasterID,'applicationType': applicationType,'empName': empName,'empID': empID,'entryDate': entryDate,'leaveTypeID': leaveTypeID,'coveringValidated': coveringValidated,'coveringAvailabilityValidated': coveringAvailabilityValidated,'coveringEmpID': coveringEmpID,'startDate': startDate,'endDate': endDate,'shift': shift,'comment': comment,'attachmentDescription': attachmentDescription,'document_name ':document_name,'document_file': document_file,'isConfirmed': isConfirmed,'isCalenderDays': isCalenderDays,'entitleSpan': entitleSpan,'appliedLeave': appliedLeave,'leaveBlance': leaveBlance,'policyMasterID': policyMasterID,'leaveGroupID': leaveGroupID,'workingDays': workingDays },
