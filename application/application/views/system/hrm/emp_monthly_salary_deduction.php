            ...
            <div class="form-horizontal">
                <div class="box-body">
                    <div class="form-group">
                        <label for="documentCode" class="col-sm-3 control-label"><?php echo $this->lang->line('hrms_payroll_employee_document_code');?><!--Document Code--></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group datepic">
                                ...
                                <input type="text" name="dateDesc" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="<?php echo $current_date ?>"
                                       id="desDate" class="form-control" required>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-6">
        <div class="box box-info" style="padding-top: 3%">
            <div class="form-horizontal">
                <div class="box-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="payrollType"><?php echo $this->lang->line('hrms_payroll_payroll_type');?><!--Payroll Type--></label>
                        <div class="col-sm-8">
...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        ...
        $('.headerclose').click(function(){
            fetchPage('system/hrm/monthly_salary_deduction',documentID,'HRMS')
        });
        $('.select2').select2();
