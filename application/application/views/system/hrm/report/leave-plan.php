        ...
        <div class="well" style="padding: 10px; margin-bottom: 0px">
            ...
            <div class="pull-right">
                <label class="radio-inline">
                    <span style="background-color: #166123; border-radius: 2px; border: 1px solid #ccc;">&nbsp;&nbsp; &nbsp;&nbsp;</span> <strong><?php echo $this->lang->line('common_approved')?> <!--Approved--></strong>
                </label>
                <label class="radio-inline">
                    <span style="background-color: #13f358; border-radius: 2px; border: 1px solid #ccc;">&nbsp;&nbsp; &nbsp;&nbsp;</span> <strong><?php echo $this->lang->line('common_confirmed')?><!--Confirmed--></strong>
                </label>
                <label class="radio-inline">
                    <span style="background-color: #61cde2; border-radius: 2px; border: 1px solid #ccc;">&nbsp;&nbsp; &nbsp;&nbsp;</span> <strong><?php echo $this->lang->line('common_draft')?><!--Draft--></strong>
                </label>
                <label class="radio-inline">
                    <span style="background-color: #fda70a; border-radius: 2px; border: 1px solid #ccc;">&nbsp;&nbsp; &nbsp;&nbsp;</span> <strong><?php echo $this->lang->line('hrms_leave_management_planned')?><!--Planned--></strong>
                </label>
            </div>
        </div>
    </div>
