...
<ul class="nav nav-tabs" id="main-tabs">
    <li class="active"><a href="#assignedtask" data-toggle="tab"><i class="fa fa-television"></i>Assigned Task</a></li>
    <li><a href="#createdtask" onclick="getcreatedtask();" data-toggle="tab"><i class="fa fa-television"></i>Created Task</a></li>
</ul>
<br>
