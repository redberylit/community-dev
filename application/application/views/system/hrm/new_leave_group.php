            ...
            <div class="modal-content">
                ...
                <form role="form" id="jv_detail_form" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group hourform hide">
                            <label class="col-sm-4 control-label"><?php echo $this->lang->line('hrms_leave_management_hours_to_be_completed');?><!--Hours to be completed--></label>
                            <div class="col-sm-6">
                                <div class="input-group" style="">
                                    <span class=""><input placeholder="00"  class="number " maxlength="2" min="0" style="width: 30px;" type="text" id="noOfHourscompleted" name="noOfHourscompleted"> : <input placeholder="00"  maxlength="2" type="text" min="0" max="60" style="width: 30px;" id="NoOfMinutesompleted" class="number limit" name="NoOfMinutesompleted"></span>

                                </div>
                                </div>
                        </div>
                        <div class="form-group hourform hide">
                            <label class="col-sm-4 control-label"><?php echo $this->lang->line('hrms_leave_management_no_of_hours');?><!--No of Hours--></label>
                            <div class="col-sm-6">
                                <div class="input-group" style="">
                                    <span class=""><input placeholder="00"   class="number" min="0" maxlength="2" style="width: 30px;" type="text" id="noOfHours" name="noOfHours"> : <input placeholder="00"  type="text" min="0" max="60"  value="00"  style="width: 30px;"  maxlength="2" id="NoOfMinutes" class="number limit" name="NoOfMinutes"></span>
