...
<script type="text/javascript">
    ...
    function saveNavigationgroupSetup() {
        ...
        var accessControlYN = [];
        $('.acControlVal:checked').each(function (i, e) {
            accessControlYN.push(e.value);
        });
        accessControlYN = accessControlYN.join(',');
       ...
       $('.viewVal:checked').each(function (i, e) {
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'json',
            data: {navigationID: navigationID,accessControlYN:accessControlYN,viewID:viewID,addEditID:addEditID,printExcelID:printExcelID,userGroupID: $('#userGroupID').val()},
