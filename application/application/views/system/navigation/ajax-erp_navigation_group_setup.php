                                ...
                                if ($data) {
                                    ...
                                    foreach ($data as $level2) {
                                                        ...
                                                        if ($data) {
                                                            ...
                                                            foreach ($data as $level3) {
                                                                if ($level3['levelNo'] == 2 && $level3['masterID'] == $level2['navigationMenuID']) {
                                                                    ...
                                                                    $acControlChked = '';
                                                                    if($level3['accessControlYN'] == 1){
                                                                        $acControlChked= 'checked';
                                                                    }
                                                                    ...
                                                                    <li class="subdetails">
                                                                        ...
                                                                        <input <?php echo $acControlChked ?> class="acControlVal" type="checkbox"
                                                                                                        name="<?php echo $i; ?>-<?php echo $x; ?>-<?php echo $y; ?>" id="<?php echo $i; ?>-<?php echo $x; ?>-<?php echo $y; ?>"
                                                                                                        value="<?php echo $level3['navigationMenuID'] ?>" style="display: none;">
                                                                        <?php  if($level3['accessControlYN'] == 1){ ?>
                                                                        <ul>
                                                                            <li>

                                                                                <lable class="accesscont">View</lable>
                                                                                <span>
                                     ...
                                     value="<?php echo $level3['navigationMenuID'] ?>">
                                                                                ...
                                                                                <lable class="accesscont">Add/Edit/Delete</lable>
                                                                                <span>
                                                                                ...
                                                                                <lable class="accesscont">Print/Excel</lable>
                                                                                <span>
