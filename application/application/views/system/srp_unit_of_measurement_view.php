...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        ...
        $('#uom_form').bootstrapValidator({
            ...
            excluded: [':disabled'],
            fields: {
                UnitShortCode: {validators: {notEmpty: {message: '<?php echo $this->lang->line('erp_warehouse_code_is_required');?>.'}}},/*Code is required*/
                UnitDes: {validators: {notEmpty: {message: '<?php echo $this->lang->line('common_description_is_required');?>.'}}}/* Description is required*/
            },
        }).on('success.form.bv', function (e) {
            e.preventDefault();
            var $form = $(e.target);
