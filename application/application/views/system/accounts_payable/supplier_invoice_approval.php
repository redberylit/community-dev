...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <?php echo form_dropdown('approvedYN', array('0' => $this->lang->line('common_pending')/*'Pending'*/, '1' => $this->lang->line('common_approved')/*'Approved'*/), '', 'class="form-control" id="approvedYN" required onchange="supplier_invoice_table()"'); ?>
    </div>
</div>
<hr>
...
<script type="text/javascript">
    ...
    function supplier_invoice_table() {
        var Otable = $('#supplier_invoice_table').DataTable({
            "language": {
