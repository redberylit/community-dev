    ...
    <div class="row" style="margin-top: 5px">
        <div class="col-md-12 " id="salesOrderReport">
            ...
            <div class="reportHeader reportHeaderColor" style="text-align: center">
                <strong>Supplier Balance Report</strong></div>
            <div style="">
                <table id="tbl_rpt_salesorder" class="borderSpace report-table-condensed" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <!--<th>Currency</th>-->
                        <th>Reporting Amount (<span><span><?php echo $repcurr; ?></span></span>)</th>
                            <?php
                        }else{
                        ?>
                        <th>Currency</th>
                        ...
                        foreach ($category as $key => $glcodes) {
                            ...
                            foreach ($glcodes as $key2 => $customer) {
                                ...
                                foreach ($customer as $key3 => $val) {
                                    ...
                                    if($currency==1){
                                        echo'<td align="right">'. number_format($val['companyLocalAmount']*-1, $val['companyLocalCurrencyDecimalPlaces'])  .'</td>';
                                        echo'<td align="right">'. number_format($val['companyReportingAmount']*-1, $val['companyReportingCurrencyDecimalPlaces']) .'</td>';
                                    }else{
                                        echo'<td>'. $val['transactionCurrency'] .'</td>';
                                        echo'<td align="right">'. number_format($val['transactionAmount']*-1, $val['transactionCurrencyDecimalPlaces']) .'</td>';
                            ...
                            if($currency==1){
                                ...
                                echo "<td class='reporttotal' align='right' style='font-weight: bold;'>".number_format($comploctot*-1, $decimalPlacel)."<!--Net Balance--></td>";
                                echo "<td class='reporttotal' align='right' style='font-weight: bold;'>".number_format($reporttot*-1, $decimalPlacer)."<!--Net Balance--></td>";
                            } /*else {
