                    ...
                    <table class="borderSpace report-table-condensed" id="tbl_report">
                                    ...
                                    foreach ($glcodes as $key2 => $suppliers) {
                                        ...
                                        if ($isLocCost || $isRptCost) {
                                            if ($isTransCost) {
                                                ...
                                                echo "<td colspan='5'><div style='margin-left: 30px' class='pull-right'>$tot<!--Total--></div></td>";
                                            }
                                        }
                                        if (!empty($fieldNameDetails)) {
                                            foreach ($fieldNameDetails as $key => $val2) {
                                        ...
                                        if ($isLocCost || $isRptCost) {
                                            if ($isTransCost) {
                                                ...
                                                echo "<td colspan='5'><div style='margin-left: 30px' class='pull-right'>$netbal<!--Net Balance--></div></td>";
                                            }
                                        }
                                        if (!empty($fieldNameDetails)) {
                                            foreach ($fieldNameDetails as $key => $val2) {
                        ...
                        if ($isLocCost || $isRptCost) {
                            if ($isTransCost) {
                                ...
                                echo "<td colspan='5'><div style='margin-left: 30px' class='pull-right'><strong>$grand<!--Grand Total--></strong></div></td>";
                            }
                        }
                        if (!empty($fieldNameDetails)) {
                            foreach ($fieldNameDetails as $key => $val2) {
