...
$total=0;
?>
<div style="border: 1px solid white; /*margin-top: 924px*/"><!--background-repeat: no-repeat; background-image: url(<?php //echo base_url('images/cheques/receipt_straight.jpg'); ?>); background-size: contain;-->


    <table style="margin-top: 170px; margin-right:35px; ">
        <tr>
            <td style="font-weight:bold; padding-left: 75px; padding-top: 10px"><?php echo $extra['master']['PVcode'] ?></td>
        </tr>
        <tr>
            <td style="font-weight:bold; padding-left: 75px; padding-top: 10px "><?php echo $extra['master']['PVdate'] ?></td>
        </tr>
        <tr>
            <td style="font-weight:bold; padding-left: 75px; padding-top: 10px ">
                <?php
                if($extra['master']['pvType']=='Direct' || $extra['master']['pvType']=='Employee'){
        ...
        <table style="font-size: 12px">
            <?php if(!empty($extra['invoices'])){?>
                ...
                foreach($extra['invoices'] as $invoicesval){
                    ?>
                    <tr>
                        <td style="border: 0px solid; width: 90px"><?php echo  $invoicesval['invoiceDate'] ?></td>
                        <td style="border: 0px solid; width: 120px"><?php echo  $invoicesval['invoiceCode'] ?> </td>
                        <td style="/*padding-left: 70px*/"><?=$invoicesval['supplierInvoiceNo'].' '.$invoicesval['comment'].' '.$invoicesval['inv_com'] ?></td>
                        <td style="text-align:right; padding-right: 33px"><?php echo  format_number($invoicesval['transactionAmount'],$extra['master']['transactionCurrencyDecimalPlaces']) ?></td>
                    </tr>
                    <?php
            ...
            <?php if(!empty($extra['GLs'])){?>
                ...
                foreach($extra['GLs'] as $glval){
                    ...
                    <tr>
                        ...
                        <td style="/*padding-left: 70px*/"><?=$glval['GLCode'].' '.$glval['description'].' '.$glval['comment']?></td>
                        <td style="text-align:right; padding-right: 33px"><?php echo format_number($glval['transactionAmount'],$extra['master']['transactionCurrencyDecimalPlaces']) ?></td>
                    </tr>
                    <?php
            ...
            <?php if(!empty($extra['Items'])){?>
                ...
                foreach($extra['Items'] as $Itemsval){
                    ...
                    <tr>
                        <td style="width: 90px;">&nbsp;</td>
                        <td style="width: 120px;">&nbsp;</td>
                        <td style="/*padding-left: 70px*/"><?=$Itemsval['itemSystemCode'].' '.$Itemsval['description'].' '.$Itemsval['comment'] ?></td>
                        <td style="text-align:right; padding-right: 33px"><?php echo format_number($Itemsval['transactionAmount'],$extra['master']['transactionCurrencyDecimalPlaces']) ?></td>
                    </tr>
                    <?php
            ...
            <?php if(!empty($extra['Advances'])){?>
                ...
                foreach($extra['Advances'] as $Advancesval){
                    ...
                    <tr>
                        <td style="width: 90px;">&nbsp;</td>
                        <td style="width: 120px;">&nbsp;</td>
                        <td style="/*padding-left: 70px*/"><?php echo  $Advancesval['description'] ?> - Advances</td>
                        <td style="text-align:right; padding-right: 33px"><?php echo format_number($Advancesval['transactionAmount'],$extra['master']['transactionCurrencyDecimalPlaces']) ?></td>
                    </tr>
                    <?php
            ...
            <?php if(!empty($extra['debitnote'])){?>
                ...
                foreach($extra['debitnote'] as $debitnoteval){
                    ...
                    <tr>
                        <td style="width: 90px;">&nbsp;</td>
                        <td style="width: 120px;">&nbsp;</td>
                        <td style="/*padding-left: 70px*/"><?php echo  $debitnoteval['description'] ?> - Debitnote</td>
                        <td style="text-align:right; padding-right: 33px"><?php echo format_number($debitnoteval['transactionAmount'] *-1,$extra['master']['transactionCurrencyDecimalPlaces']) ?></td>
                    </tr>
                    <?php
    ...
    <table style="">
        <tr>
            ...
            <td style="text-align:right; padding-right: 30px"><?php echo format_number($total,$extra['master']['transactionCurrencyDecimalPlaces']) ?></td>
        </tr>
    </table>
    <br>
    <br>
    ...
    <div style="border: 1px solid white;width: 759.68503937px; "><!--position: absolute;left: 6cm; rotate: 90;--><!--background-repeat: no-repeat; background-image: url(<?php //echo base_url('images/cheques/nbo_bank.png'); ?>); background-size: contain;-->
            ...
            <tr>
                ...
                <td style="width: 20%; vertical-align:bottom;">
                    <table>
                        <tbody>
                        <tr>
                            <td style="width:200px; font-weight: bold; font-size: 1em;  text-align:right; vertical-align:bottom;">
                                <?php echo $day[0]; ?><?php echo $day[1]; ?>-<?php echo $month[0]; ?><?php echo $month[1]; ?>-
                                <?php echo $year[0]; ?><?php echo $year[1];?><?php echo $year[2];?><?php echo $year[3]; ?>
                            </td>
        ...
        <table style="margin-top:0px;">
            <tbody>
            <tr>
                <td colspan="" style="border: 0px solid">
                    <table>
                        <tbody>
                        <tr>
                            <td style="font-size: 1em;font-weight: bold;vertical-align: top; border: 0px solid; padding-left: 50px">
                            <?php
                            if($extra['master']['pvType']=='Direct' || $extra['master']['pvType']=='Employee'){
                                echo $extra['master']['partyName'];
                            }else{
