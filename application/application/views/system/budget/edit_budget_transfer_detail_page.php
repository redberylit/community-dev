    ...
    <div class="col-md-6">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><strong>: </strong></td>
                <td><input type="text" id="commentedit" onchange="edit_transfer_comment()" name="comment" class="form-control"></td>
            </tr>
        </table>
    </div>
</div>
    ...
    function validateadjestmentamount(){
     ...
     var budgetAmount=  parseFloat($('#budgetAmount').val());
        ...
        if(adjustmentAmount < budgetAmount){
            myAlert('w','Transfer Amount canot be greater than budget amount');
            $('#adjustmentAmount').val('');
        }
    }
