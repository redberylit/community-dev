                        ...
                        <tr>
                            ...
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       ...
                                       value="<?php echo number_format($value['myJan'],2,'.', '') ?>">
                            </td>
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       data-name="<?php echo $key?>" data-budgetYear="<?php echo $value['budgetYear'] ?>"
                                       data-budgetMonth="2"
                                       data-GLAutoID="<?php echo $value['GLAutoID'] ?>"
                                       value="<?php echo number_format($value['myFeb'],2,'.', '') ?>">
                            </td>
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       data-name="<?php echo $key?>" data-budgetYear="<?php echo $value['budgetYear'] ?>"
                                       data-budgetMonth="3"
                                       data-GLAutoID="<?php echo $value['GLAutoID'] ?>"
                                       value="<?php echo number_format($value['myMar'],2,'.', '') ?>">
                            </td>
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       data-name="<?php echo $key?>" data-budgetYear="<?php echo $value['budgetYear'] ?>"
                                       data-budgetMonth="4"
                                       data-GLAutoID="<?php echo $value['GLAutoID'] ?>"
                                       value="<?php echo number_format($value['myApr'],2,'.', '') ?>">
                            </td>
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       data-name="<?php echo $key?>" data-budgetYear="<?php echo $value['budgetYear'] ?>"
                                       data-budgetMonth="5"
                                       data-GLAutoID="<?php echo $value['GLAutoID'] ?>"
                                       value="<?php echo number_format($value['myMay'],2,'.', '') ?>">
                            </td>
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       data-name="<?php echo $key?>" data-budgetYear="<?php echo $value['budgetYear'] ?>"
                                       data-budgetMonth="6"
                                       data-GLAutoID="<?php echo $value['GLAutoID'] ?>"
                                       value="<?php echo number_format($value['myJun'],2,'.', '') ?>">
                            </td>
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       data-name="<?php echo $key?>" data-budgetYear="<?php echo $value['budgetYear'] ?>"
                                       data-budgetMonth="7"
                                       data-GLAutoID="<?php echo $value['GLAutoID'] ?>"
                                       value="<?php echo number_format($value['myJul'],2,'.', '') ?>">
                            </td>
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       data-name="<?php echo $key?>" data-budgetYear="<?php echo $value['budgetYear'] ?>"
                                       data-budgetMonth="8"
                                       data-GLAutoID="<?php echo $value['GLAutoID'] ?>"
                                       value="<?php echo number_format($value['myAug'],2,'.', '') ?>">
                            </td>
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       data-name="<?php echo $key?>" data-budgetYear="<?php echo $value['budgetYear'] ?>"
                                       data-budgetMonth="9"
                                       data-GLAutoID="<?php echo $value['GLAutoID'] ?>"
                                       value="<?php echo number_format($value['mySep'],2,'.', '') ?>">
                            </td>
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       data-name="<?php echo $key?>" data-budgetYear="<?php echo $value['budgetYear'] ?>"
                                       data-budgetMonth="10"
                                       data-GLAutoID="<?php echo $value['GLAutoID'] ?>"
                                       value="<?php echo number_format($value['myOct'],2,'.', '') ?>">
                            </td>
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       data-name="<?php echo $key?>" data-budgetYear="<?php echo $value['budgetYear'] ?>"
                                       data-budgetMonth="11"
                                       data-GLAutoID="<?php echo $value['GLAutoID'] ?>"
                                       value="<?php echo number_format($value['myNov'],2,'.', '') ?>">
                            </td>
                            <td class="tdIn">
                                <input class="form-control amount" disabled type="text" name="amount"
                                       data-name="<?php echo $key?>" data-budgetYear="<?php echo $value['budgetYear'] ?>"
