...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab">Step 1 - Request Header</a>
    <a class="btn btn-default btn-wizard" href="#step2" onclick="fetch_material_request_detail()" data-toggle="tab"> Step 2 - Request Detail</a>
    <a class="btn btn-default btn-wizard" href="#step3" onclick="load_conformation()" data-toggle="tab"> Step 3 - Request Confirmation</a>
</div>
<hr>
...
<!--            <div class="form-group col-sm-4">
            ...
            <div class="form-group col-sm-4">
                <label
                    for="SalesPersonName">Requested By <?php required_mark(); ?></label>
            ...
            <div class="form-group col-sm-4">
                <label
                    for="">Requested Date<?php required_mark(); ?></label>
    ...
    <div id="step2" class="tab-pane">
        <div class="row">
            ...
            <div class="col-md-4">
                <button type="button" onclick="item_detail_modal()" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add Item</button>
        ...
        <table class="<?php echo table_class(); ?>">
            ...
            <tr>
                ...
                <th style="min-width: 10%">UOM </th><!--UOM-->
                <th style="min-width: 10%">Current Qty </th><!--QTY-->
                <th style="min-width: 10%">Requested Qty</th><!--QTY-->
<!--                <th style="min-width: 10%">WAC </th>
            ...
            <tr class="danger">
                <td colspan="8" class="text-center"><b>No Records Found </b>
                </td>
            </tr>
            </tbody>
    ...
    <div id="step3" class="tab-pane">
        ...
        <div id="conform_body_attachement">
            <h4 class="modal-title"
                id="Material_issue_attachment_label">Modal title</h4>
            <br>
                ...
                <form role="form" id="item_detail_form" class="form-horizontal">
                    <table class="table table-bordered table-condensed no-color" id="MaterialIssue_detail_add_table">
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <th style="width: 150px;">Requested Qty <?php required_mark(); ?></th>
...
<!--                            <td>
            ...
            <div class="modal-footer">
                <button data-dismiss="modal" class="btn btn-default"
                        type="button">Close </button><!--Close-->
                <button class="btn btn-primary" type="button"
                        onclick="saveMaterialIssue_addItem()">Save changes
                </button>
            </div>
        </div>
    </div>
                ...
                <form role="form" id="edit_item_detail_form" class="form-horizontal">
                    <table class="table table-bordered table-condensed no-color" id="MaterialIssue_detail_edit_table">
                        ...
                        <tr>
                            ...
                            <th style="width:200px;">Current Stock <?php required_mark(); ?></th>
                            <!--<th style="width: 150px;">Segment <?php /*required_mark(); */?></th>-->
                            <?php if ($projectExist == 1) { ?>
                            <th>Project <?php required_mark(); ?></th>
                            <?php } ?>
...
<!--                            <td>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" type="button"
                        onclick="updateMaterialIssue_addItem()">Update changes
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary"
                        onclick="fetch_employee_detail()">Add employee </button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" style="width: 40%;">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h5 class="modal-title">GL Account </h5>
            </div>
            ...
            <div class="modal-footer">
                <button data-dismiss="modal" class="btn btn-default"
                        type="button">Close </button>
                <button class="btn btn-primary" type="button"
                        onclick="materialAccountUpdate(1)">Apply to All
                </button>
                <button class="btn btn-primary" type="button"
                        onclick="materialAccountUpdate(0)">Save changes
                </button>
    ...
    <div class="modal-dialog" style="width: 85%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" type="button" onclick="save_material_request_detail_multiple_edit()">Update changes
                </button>
            </div>
