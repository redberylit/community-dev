    ...
    <table class="table table-bordered table-striped  table-condensed">
       ...
       <!-- <tr>
        ...
        <tr>
            ...
            <th class='theadtr' style="min-width: 10%">Invoice Code</th>
        ...
        if (!empty($extra['detail'])) {
            ...
            foreach ($extra['detail'] as $val) { ?>
                <tr>
                    ...
                    <td style="text-align:right;"><?php echo $val['salesPrice']; ?></td>
        ...
        <tfoot>
        <tr>
            <td class="text-right sub_total" colspan="7"><?php echo $this->lang->line('sales_markating_view_invoice_item_total');?></td><!--Item Total-->
