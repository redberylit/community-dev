    ...
    <table class="table table-bordered table-striped">
        <thead>
            <tr>
                ...
                <th class='theadtr' colspan="2"><?php echo $this->lang->line('transaction_common_qty');?> </th><!--Qty-->
                <th class='theadtr' >&nbsp; </th>
            </tr>
            <tr>
        ...
        <tfoot>
            <tr>
                <td class="text-right sub_total" colspan="6"><?php echo $this->lang->line('transaction_common_item_total');?> </td><!--Item Total-->
