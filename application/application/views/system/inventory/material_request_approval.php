...
echo head_page('Material Request Approval', false);
...
<div class="table-responsive">
    <table id="material_request_approval_table" class="<?php echo table_class() ?>">
        ...
        <tr>
            ...
            <th style="min-width: 10%"> MR Code </th>
            <th style="min-width: 10%">Requested Date </th>
            <th style="min-width: 30%">Warehouse Description</th>
            <th style="min-width: 20%">Request By</th>
    ...
    function material_request_table() {
         Otable = $('#material_request_approval_table').DataTable({
            ...
            "aoColumns": [
             ...
             "columnDefs": [{"targets": [8], "orderable": false},{"visible":false,"searchable": true,"targets": [8,9,10] }],
