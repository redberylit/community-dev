...
/*echo head_page('Material Receipt Note',true);*/
...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/inventory/MaterialReceipt/erp_material_receipt',null,'Add New Material Receipt Note','MRN');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('transaction_create_material_receipt_note');?>  </button><!--Create Material Receipt Note-->
    </div>
</div><hr>
