...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <?php echo form_dropdown('approvedYN', array('0' => 'Pending', '1' => 'Approved'), '', 'class="form-control" id="approvedYN" required onchange="paymentVoucher_table()"'); ?>
    </div>
</div>
<hr>
...
<script type="text/javascript">
    ...
    function paymentVoucher_table() {
        var Otable = $('#paymentVoucher_table').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            "bDestroy": true,
            "bStateSave": true,
