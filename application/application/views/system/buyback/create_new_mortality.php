    ...
    <div class="modal-dialog modal-lg" style="width: 60%;">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title">Add New Mortality Birds</h5>
            </div>
                    ...
                    <table class="table table-bordered table-condensed no-color" id="po_detail_add_table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="noOfBirds[]" id="noOfBirds" onfocus="this.select();"
                                       class="form-control number" onkeyup="greaterthantest(this)" required></td>
            ...
            <form role="form" id="mortality_edit_item_form" class="form-horizontal">
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-condensed" id="">
                        ...
                        <tr>
                            <td>
                                <?php echo form_dropdown('causeID', $mortality_causes_arr, '', 'class="form-control" id="causeID"'); ?>
                            </td>
                            <td>
                                <input type="text" name="noOfBirds" onfocus="this.select();" id="noOfBirds"
