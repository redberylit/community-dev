            ...
            <div class="row">
                <div class="col-sm-9">
                    <table class="property-table">
                        ...
                        <tr>
                            <td class="ralign"><span class="title">Deposit Amount</span></td>

                            <td><span
                                        class="tddata"><?php echo $header['depositAmount'] . " ( " . $header['CurrencyCode'] . " )"; ?></span>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="col-sm-3">
                    <div class="fileinput-new thumbnail" style="border: none">
                        <?php if ($header['farmImage'] != '') { ?>
                            <img src="<?php echo base_url('uploads/buyback/farmMaster/' . $header['farmImage']); ?>"
