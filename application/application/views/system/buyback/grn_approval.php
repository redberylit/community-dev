...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <?php echo form_dropdown('approvedYN', array('0' => 'Pending', '1' => 'Approved'), '', 'class="form-control" id="approvedYN" required onchange="goodReceiptNote_table()"'); ?>
    </div>
</div>
<hr>
...
<script type="text/javascript">
    ...
    function goodReceiptNote_table() {
        var Otable = $('#goodReceiptNote_table').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            "bDestroy": true,
            "bStateSave": true,
