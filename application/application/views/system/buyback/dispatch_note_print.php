...
<h4 class="modal-title" style="padding-left: 25%"><span aria-hidden="true" class="glyphicon glyphicon-hand-right color"></span> &nbsp;Feed Summary</h4>-->
<div class="row">
    ...
    <?php   foreach ($feed_header as $row) {
        ...
        if($row['qtyD'] > $qtrtot)
     {
         echo ' <div class="col-sm-12" align="center" style="padding-right: 12%;margin-top: -3%;">
