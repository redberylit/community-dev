...
<div id="confrimDiv" style="margin-bottom: 60px">
    <span class="pull-right"><?php echo export_buttons('table1', 'Bank/Cash Register', True, False, 'btn-xs') ?></span>
     ...
     <!--   <th>Party Type</th>-->
      ...
      <!--  <th>Party No</th>-->
        ...
        if(!empty($openingbalance)){
            ?>
            <tr>
                <td colspan="8"><strong><?php echo $this->lang->line('treasury_bta_opening_balance');?><!--Opening Balance--></strong></td>
           ...
           <!-- <td><?php /*echo $val['partyName']; */?></td>-->
            ...
            <td style="text-align: right"><?php echo $val['bankCurrencyAmount']; ?></td>
                ...
                <td style="text-align: right"></td>
                  <?php  } ?>
            <td><?php if($val['clearedYN']==1){ ?><i style="color: #00a65a" class="glyphicon glyphicon-ok"></i><?php } ?></td>
