...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="modal_budget_transfer_header();"><i
                class="fa fa-plus"></i> Create Budget Transfer
        </button>
    </div>
</div>
<hr>
<div class="table-responsive">
    <table id="budget_transfer_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 12%">Budget Transfer Code</th>
            <th style="min-width: 8%">Document Date</th>
            <th style="min-width: 12%">Financial Year</th>
            <th style="min-width: 12%">Currency</th>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Budget Transfer Header</h4></div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        <label for="transactionCurrencyID">Currency <?php required_mark(); ?></label>
                        <!--Currency-->
