...
<div class="table-responsive">
    <table id="budget_approval_table" class="<?php echo table_class() ?>">
        ...
        <tr>
            ...
            <th style="min-width: 12%">Budget Code</th>
            <th style="min-width: 15%">Details</th>
            <th style="min-width: 15%">Segment</th>
            <th style="min-width: 15%">Financial Year</th>
            <th style="min-width: 15%">Currency</th>
