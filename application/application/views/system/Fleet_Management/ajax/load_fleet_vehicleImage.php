...
if (!empty($master)) {
    ...
    <ul class="nav nav-tabs" id="main-tabs">
        ...
        <li><a href="#files" onclick="vehicle_attachments()" data-toggle="tab"><i class="fa fa-television"></i>Attachments
            </a></li>
    </ul>
                ...
                <div class="col-sm-3">
                    <div class="fileinput-new thumbnail">
                        <?php if ($master['vehicleImage'] != '') { ?>
                            ...
                            <img src="<?php echo base_url('uploads/Fleet/VehicleImg/' . $master['vehicleImage'] . '?' . time()); ?>"
