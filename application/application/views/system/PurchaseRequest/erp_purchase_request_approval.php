...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <?php echo form_dropdown('approvedYN', array('0' => $this->lang->line('common_pending')/*'Pending'*/, '1' => $this->lang->line('common_approved')/*'Approved'*/), '', 'class="form-control" id="approvedYN" required onchange="purchase_request_table()"'); ?>
    </div>
</div>
<hr>
...
<script type="text/javascript">
    ...
    function purchase_request_table() {
        var Otable = $('#purchase_request_table').DataTable({
            "language": {
