...
<div class="tab-content">
    ...
    <div id="step2" class="tab-pane">
        ...
        <div class="row">
            <!--<div class="col-md-5">
                <label for="exampleInputName2" id="tax_tot">Tax for </label>
                ...
                <form role="form" id="purchase_order_detail_edit_form" class="form-horizontal">
                    <table class="table table-bordered table-condensed no-color" id="po_detail_edit_table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="discount_amount_edit" name="discount_amount" placeholder="0.00"
                    ...
                    <div class="col-md-10">
                        <table class="table table-bordered table-striped table-condesed ">
                            ...
                            <tr>
                                ...
                                <th colspan='5'>Ordered Item <span
                                        class="currency"> </span></th>
                            <tr>
                            <tr>
                                <th>#</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#discount_form').bootstrapValidator({
            ...
            excluded: [':disabled'],
            fields: {
                disc_amount: {validators: {notEmpty: {message: 'Tax Amount is required.'}}},
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (jQuery.isEmptyObject(data['tax_detail'])) {
                        $('#tax_table_body_recode').append('<tr class="danger"><td colspan="6" class="text-center"><b>No Records Found</b></td></tr>');
                    } else {
                        x = 1;
                        t_total = 0;
                ...
                success: function (data) {
                    ...
                    if (jQuery.isEmptyObject(data['detail'])) {
                        ...
                        $.each(data['detail'], function (key, value) {
                            ...
                            cost_status = '<input type="text" class="number" size="10" id="amount_' + value['purchaseRequestDetailsID'] + '" value="' + parseFloat(value['unitAmount']).toFixed(currency_decimal) + '" onkeyup="select_value(' + value['purchaseRequestDetailsID'] + ')" >';
                            ...
                            $('#table_body_pr_detail').append('<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-right">' + (value['requestedQty'] - value['prQty'] ) + '</td><td class="text-right">' + parseFloat(value['unitAmount']).toFixed(currency_decimal) + '</td><td class="text-center"><input type="text" class="number" size="8" id="qty_' + value['purchaseRequestDetailsID'] + '" onkeyup="select_check_box(this,' + value['purchaseRequestDetailsID'] + ',' + value['unitAmount'] + ',' + (value['requestedQty'] - value['prQty'] ) + ' )" ></td><td class="text-center">' + cost_status + '</td>' + discount_status + '<td class="text-center"><p id="tot_' + value['purchaseRequestDetailsID'] + '"> </p></td><td class="text-right" style="display: none;"><input class="checkbox" id="check_' + value['purchaseRequestDetailsID'] + '" type="checkbox" value="' + value['purchaseRequestDetailsID'] + '"></td></tr>');
                            x++;
