...
<ul class="nav nav-tabs" id="main-tabs">
    <li class="active"><a href="#qualityassurance" data-toggle="tab"><i class="fa fa-television"></i>QA
        </a></li>
    ...
    <li><a href="#review_<?php echo $documentID ?>" data-toggle="tab"><i class="fa fa-television"></i>Review/Print
        </a>
    </li>
</ul>
            ...
            <div class="row">
                ...
                <div class="col-md-12 animated zoomIn">
                    <header class="head-title">
                        <h2>QUALITY ASSURANCE CRITERIA</h2>
                    </header>
                        ...
                        <form action="" role="form" id="frm_machine_<?php echo $documentID ?>">
                            ...
                            <div class="table-responsive">
                                <table id="mfq_machine_<?php echo $documentID ?>" class="table table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <th style="min-width: 12%">Main Cat</th>
                                        <th style="min-width: 12%">Sub Cat</th>
                                        <th style="min-width: 12%">Sub Sub Cat</th>
                                        <th style="min-width: 12%">Asset Code</th>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-right">
                                        <button class="btn btn-primary" type="button"
                                                onclick="save_machine('<?php echo $documentID ?>')">Save
                                        </button>
                                    </div>
                                </div>
                            </div>
