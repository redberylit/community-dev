...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab">Step 1 - Workflow Header</a>
    <a class="btn btn-default btn-wizard" href="#step2" onclick="workflow_detail()" data-toggle="tab">Step
        2 - Workflow Configuration</a>
</div>
<hr>
