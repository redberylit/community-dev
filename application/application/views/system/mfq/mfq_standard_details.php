<?php echo head_page('Standard Details', false); ?>
    ...
    <div class="col-md-3 text-right">
        <button type="button" style="margin-right: 17px;" class="btn btn-primary pull-right"
                onclick="open_mfq_standard_details()"><i
                    class="fa fa-plus"></i> Add Standard Details
        </button>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function open_mfq_standard_details() {
        $('#standard_detail_header').text('Add Standard Details');
    ...
    function edit_standard_details(mfqStandardDetailMasterID) {
        $.ajax({
            ...
            beforeSend: function () {
                $('#standard_detail_header').text('Edit Standard Details');
                startLoad();
