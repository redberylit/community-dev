...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab">Step 1 - Job Header</a>
    <a class="btn btn-default btn-wizard" href="#step2" onclick="load_workflow_design()" data-toggle="tab">Step
        2 - Job Detail</a>
</div>
<hr>
            ...
            <div class="col-md-12 animated zoomIn">
                ...
                <div class="col-md-12" style="margin-top: 10px" id="closedYN">
                    <div class="pull-right">
                        <button class="btn btn-primary" type="button" onclick="close_job()"><i class="fa fa-times"
                                                                                               aria-hidden="true"></i>
                            Close Job
                        </button>
                    </div>
