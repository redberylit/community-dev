...
echo head_page('Group Structure', true);
?>
...
<div class="row">
    <div class="col-md-12">
        <div class="pull-right">
            <button onclick="createGroup()" class="btn btn-primary btn-xs">Create a Group
        </div>
    </div>
    <hr>
    <div class="col-md-12">
        <div id="loadstructurePage">
            ...
            <table id="cTable" class="table " style="width: 100%">
                ...
                <tr>
                    ...
                    <th>
                        <div class="pull-right">
                            <button onclick="pullcompanies()" class="btn btn-primary btn-xs">Add Companies
                        </div>
                    </th>
            ...
            <form role="form" id="groupStructureForm" class="form-horizontal">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Share Holder Name </label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Share Holding %</label>
                        <div class="col-sm-6">
        ...
        <div class="modal-content">
            ...
            <form role="form" id="createGroupForm" class="form-horizontal">
                <div class="modal-body" id="loadcreateGroup">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Group Description </label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Group To </label>
