    ...
    <div id="step1" class="tab-pane active" style="box-shadow: none;">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <strong><i>Item Category:</i></strong> <?php echo join(",", $result) ?>
                <br>
                <strong><i>Location:</i></strong> <?php echo join(",", $locatn) ?>
                <br>
                <strong><i>Segment:</i></strong> <?php echo join(",", $segmnt) ?>
            </div>
        </div>
        <div class="row">
            <table class="<?php echo table_class(); ?>" id="asset_register_table">
                ...
                <tr>
                    ...
                    <th rowspan="2">Origin Document Code</th>
