...
if (is_null($datas['companyFinanceYearID'])) {
    $finanaceYear = $this->common_data['company_data']['companyFinanceYearID'];
} else {
    $finanaceYear = $datas['companyFinanceYearID'];
}


$finanaceYearPeriod = financeYearPeriod($finanaceYear);

if ($datas['FYPeriodDateFrom']) {
    $finanaceYearPeriodId = $datas['FYPeriodDateFrom'] . '|' . $datas['FYPeriodDateTo'];
} else {
    $finanaceYearPeriodId = $this->common_data['company_data']['FYPeriodDateFrom'] . '|' . $this->common_data['company_data']['FYPeriodDateTo'];
}
