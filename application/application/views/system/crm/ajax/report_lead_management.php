                                            ...
                                            foreach ($lead as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: right">
                                                        ...
                                                        $product = $this->db->query("SELECT CurrencyCode,SUM(price) AS Total FROM srp_erp_crm_leadproducts INNER JOIN srp_erp_currencymaster ON srp_erp_crm_leadproducts.transactionCurrencyID = srp_erp_currencymaster.currencyID WHERE companyID = {$companyID}  AND leadID ='{$row['leadID']}' ")->row_array();
