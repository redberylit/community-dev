                    ...
                    <td class="mailbox-name" style="width: 22%;">
                        <div class="contact-box">
                            <div class="link-box"><strong class="contacttitle"><a
                                        ...
                                        onclick="fetchPage('system/crm/project_edit_view','<?php echo $val['projectID'] ?>','View Project','CRM')"><?php if(!empty($val['organizationName'])){ echo $val['organizationName']."<br>"; } echo $val['projectName'] ?>
