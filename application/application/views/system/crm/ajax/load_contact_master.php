...
<style>
    ...
    .user_icon{border-radius:50%; center;color: #fff;padding: 15px;text-transform: uppercase; position: absolute;}
</style>
<?php
if (!empty($header)) { ?>
                    ...
                    <td class="mailbox-name suptable">
                        <div class="contact-box">
                            <div class="link-box"><strong class="contacttitle"><a class="link-person noselect" href="#"
                                                                                  onclick="fetchPage('system/crm/contact_edit_view','<?php echo $val['contactID'] ?>','View Contact','CRM')"><?php echo $val['firstName'] . " " . $val['lastName'] ?></a>
