        ...
        <table class="table table-hover table-striped">
            ...
            <tr class="task-cat noselect" style="background: white;">
                <td class="task-cat-upcoming" colspan="10">
                    <div class="task-cat-upcoming-label">Opportunity Tasks</div>
            ...
            foreach ($tasks as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-name"><a href="#" class="<?php echo $textdecoration; ?>"
                                                onclick="fetchPage('system/crm/task_edit_view','<?php echo $val['taskID'] ?>','View Task',<?php echo $masterID ?>,'opportunityTaks')"><?php echo $val['subject'] ?></a>
                    </td>
