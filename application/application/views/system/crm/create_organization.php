...
<div class="row">
    <div class="col-md-12 animated zoomIn">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                <span class="input-req" title="Required Field"><input type="text" name="email" id="email" class="form-control" placeholder="<?php echo $this->lang->line('common_email');?>" required>
                    <span class="input-req-inner"></span></span><!--Email-->
            </div>
        </div>
        <div class="row" style="margin-top: 10px;">
            <div class="form-group col-sm-1">
            ...
            <div class="form-group col-sm-4">
                                     <span class="input-req" title="Required Field"><input type="text"
                                                                                           ...
                                                                                           id="telephoneNo"
                                                                                           class="form-control"
                                                                                           placeholder="<?php echo $this->lang->line('crm_phone_no');?>"
                                                                                           required><span
                                             class="input-req-inner"></span></span><!--Phone No-->
            </div>
        </div>
        <div class="row" style="margin-top: 10px;">
            <div class="form-group col-sm-1">
...
<div class="row">
    <div class="col-md-12 animated zoomIn">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
               <span class="input-req" title="Required Field"><textarea class="form-control" id="billingAddress" name="billingAddress" rows="2" required></textarea>
    ...
    $(document).ready(function () {
        ...
        $('#organization_form').bootstrapValidator({
            ...
            fields: {
                ...
                telephoneNo: {validators: {notEmpty: {message: '<?php echo $this->lang->line('crm_phone_no_is_required');?>.'}}},/*Phone No is required*/
                billingAddress: {validators: {notEmpty: {message: '<?php echo $this->lang->line('crm_billing_address_is_required');?>.'}}},/*Billing Address is required*/
            },
