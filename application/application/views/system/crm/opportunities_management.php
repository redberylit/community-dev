...
<script type="text/javascript">
    ...
    function getOpportunityManagement_tableView(filtervalue) {
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: {'searchTask': searchTask, 'filtervalue': filtervalue,status:status,responsible:responsible},
            url: "<?php echo site_url('CrmLead/load_opportunityManagement_view'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                $('#OpportunityMaster_view').html(data);
                stopLoad();
            },
    ...
    function clearSearchFilter() {
        ...
        $('#searchTask').val('');
        $('#filter_statusID').val('');
        $('#filter_responsiblePersonEmpID').val('');
        getOpportunityManagement_tableView();
    }
