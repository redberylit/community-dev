        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                            <span class="input-req"
                                  title="Required Field"><?php echo form_dropdown('projectStatus', $status_arr, '', 'class="form-control" id="projectStatus" '); ?>
                                <span class="input-req-inner"></span></span>
            </div>
            <div class="form-group col-sm-3 hide">
                <?php echo form_dropdown('convertProject', array('0' => 'Select Close Status', '1' => 'Closed', '2' => 'Convert to Project'), '', 'class="form-control" id="convertProject"'); ?>
            </div>
        </div>
                ...
                <div class="form-group col-sm-4">
                    <div class="input-group datepic">
                        ...
                        <input type="text" name="closedDate"
                               data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                               value="" id="closedDate" class="form-control">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12 animated zoomIn">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="col-md-4 pipelinebtn">
                <button type="button" onclick="pipelinemodel()" name="singlebutton" class="btn btn-primary btn-xs"> Add Pipeline</button>
            </div>
        ...
        if (projectID) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if((data['header']['responsibleEmpID'] == '<?php echo $current_userid?>') && ('<?php echo $admin['isSuperAdmin']?>' != 1) && ('<?php echo $isgroupadmin['adminYN']?>' != 1) && (data['header']['createdUserID'] != '<?php echo $current_userid?>'))
                    {
