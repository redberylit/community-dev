...
<div class="modal fade" id="receipt_match_model" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                ...
                if (jQuery.isEmptyObject(data['receipt'])) {
                    ...
                    $.each(data['receipt'], function (key, value) {
                        ...
                        if((value['transactionAmount'] - paid_amount)>0){
                            $('#match_ad_table').append('<tr><td>' + x + '</td><td>' + value['RVcode'] + '</td><td>' + value['RVdate'] + '</td><td class="text-right">' + parseFloat(value['transactionAmount']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right">' + parseFloat((value['transactionAmount'] - paid_amount)).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right"><select class="inv_drop" onchange="showBalanceAmount('+value['receiptVoucherDetailAutoID']+')"  id="inv_' + value['receiptVoucherDetailAutoID'] + '"><option  value="">Select Invoice</option></select></td><td class="text-right" id="balamount_'+value['receiptVoucherDetailAutoID']+'"></td><td class="text-right"><input type="text" name="amount[]" style="width: 100px" id="amount_' + value['receiptVoucherDetailAutoID'] + '" onkeypress="return validateFloatKeyPress(this,event);" onkeyup="select_check_box(this,' + value['receiptVoucherDetailAutoID'] + ',' + (value['transactionAmount'] - paid_amount) + ')" class="number"></td><td class="text-right" style="display:none;"><input class="checkbox" id="check_' + value['receiptVoucherDetailAutoID'] + '" type="checkbox" value="' + value['receiptVoucherDetailAutoID'] + '"></td></tr>');
                        }
