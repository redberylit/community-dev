...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <?php echo form_dropdown('approvedYN', array('0' => $this->lang->line('common_pending')/*'Pending'*/, '1' => $this->lang->line('common_approved')/*'Approved'*/), '', 'class="form-control" id="approvedYN" required onchange="receipt_voucher_table()"'); ?>
    </div>
</div>
<hr>
...
<script type="text/javascript">
    ...
    function receipt_voucher_table() {
        var Otable = $('#receipt_voucher_table').DataTable({
            "language": {
