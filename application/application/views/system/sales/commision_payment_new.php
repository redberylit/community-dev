...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab"><?php echo $this->lang->line('salescommision_step_one');?><!--Step 1--> - <?php echo $this->lang->line('salescommision_commision_payment_header');?><!--Commission Payment Header--></a>
    <a class="btn btn-default btn-wizard" href="#step2" onclick="fetch_details(4);" data-toggle="tab"><?php echo $this->lang->line('salescommision_step_two');?><!--Step 2--> - <?php echo $this->lang->line('salescommision_commission_payment_detail');?><!--Commission Payment Detail--></a>
    <a class="btn btn-default btn-wizard" href="#step3" onclick="load_conformation();" data-toggle="tab"><?php echo $this->lang->line('salescommision_step_three');?><!--Step 3--> - <?php echo $this->lang->line('salescommision_commission_payment_confirmation');?><!--Commission Payment Confirmation--></a>
</div>
<hr>
    ...
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            <!-- <div class="form-group col-sm-4">
                ...
                <?php //echo form_dropdown('paymentMode', array('' => 'Select Payment', '1' => ' Cash', '2' => ' Cheque'), '', 'class="form-control " id="paymentMode" onchange="set_payment_method(this.value)" '); ?>
            </div> -->
        ...
        <div class="text-right m-t-xs">
            <button id="submitbtn" class="btn btn-primary" type="submit"><?php echo $this->lang->line('common_save_and_next');?><!--Save & Next--></button>
        </div>
        </form>
    </div>
        ...
        $('#paymentvoucher_form').bootstrapValidator({
            ...
            fields: {
               ...
               // financeyear: {validators: {notEmpty: {message: '<?php //echo $this->lang->line('salescommision_fianancial_year_is_required');?>.'}}},/*Financial Year is required*/
                ...
                paymentMode: {validators: {notEmpty: {message: '<?php echo $this->lang->line('salescommision_mode_of_payment_is_required');?>.'}}}/*Mode of Payment is required*/
            },
