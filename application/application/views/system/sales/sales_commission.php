...
<div class="row">
    ...
    <div class="col-md-7 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/sales/sale_commission_generate',null,' Generate Sales Commission','SC');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('sales_markating_transaction_sales_commission_generate_sales_commission');?>
...
<div class="table-responsive">
    <table id="sales_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 30%"><?php echo $this->lang->line('common_action');?> </th><!--Action-->
        </tr>
        </thead>
    </table>
</div>
