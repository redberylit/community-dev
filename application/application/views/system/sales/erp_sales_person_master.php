...
<div class="row">
    ...
    <div class="col-md-7 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/sales/erp_sales_person_new','','Sales Person')" ><i class="fa fa-plus"></i> <?php echo $this->lang->line('sales_maraketing_masters_new_sales_person');?>  </button><!--New Sales Person-->
    </div>
</div><hr>
...
function sales_person_table(){
     Otable = $('#sales_person_table').DataTable({
        ...
        "columnDefs": [{"targets": [5], "orderable": false},{"visible":false,"searchable": true,"targets": [6,7,8,9] }],
