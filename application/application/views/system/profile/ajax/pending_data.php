                        ...
                        <div class="tab-pane active" id="changesTab">
                            ...
                            <table class="table table-striped" id="profileInfoTable" style="background-color: #ffffff;width: 100%">
                                ...
                                if( $initial !== null || $eName4 !== null ){ ?>
                                    <tr>
                                        <td><strong><?php echo $this->lang->line('emp_name_with_initials'); ?></strong></td>
                                        <td>
                                            <?php
                                ...
                                if( !empty($isPending) ){ ?>
                                    <tr>
                                        <td><strong><?php echo $this->lang->line('profile_surname'); ?><!--Surname:--> </strong></td>
                                        <?php echo $isPending ?>
                                    </tr>
                                    <?php
                                }
                                        ...
                                        <div class="col-md-5">
                                            <div class="familyContainer">
                                                <div class="show-image" style="text-align: center;">
                                                    ...
                                                    <?php } else { ?>
                                                        <img class="familyImgSize" style="height: 185px;"
                                                             src="<?php echo base_url('../community/images/no_image.jpg'); ?>"
                                                             alt="image">
                                                    <?php } ?>
                                                </div>
                                                <table class="table table-condensed">
