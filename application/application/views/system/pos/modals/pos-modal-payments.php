                                ...
                                foreach ($payments as $payment) {
                                    ...
                                    <tr>
                                        ...
                                        <td> <!--style="width:50px;"-->
                                            ...
                                            } else if ($payment['autoID'] == 3 || $payment['autoID'] == 4 || $payment['autoID'] == 6 || $payment['autoID'] == 1 || $payment['autoID'] == 27 || $payment['autoID'] == 28) {
            ...
            <form class="form-horizontal">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="number" onkeydown="remove_item_all_description_edit(event)" name="customerTelephoneTmp" id="customerTelephoneTmp"
                                   class="form-control">
