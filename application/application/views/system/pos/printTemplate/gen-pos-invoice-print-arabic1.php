...
<table id="itemTable" width="100%" style="border: 1px solid black; margin-top: 5px;">
    <tr>
        ...
        <th class="borderlefttopnot" style="text-align: center !important;">  خصم </th>
    ...
    <tr>
        <td class="borderleftnot" colspan="2" rowspan="3" style="border-bottom: none;">&nbsp; الإجمالي
            - <?php echo $items ?> <br> &nbsp;  بواسطة &nbsp;   : <?php echo $invMaster['repName']; ?></td>
        <td class="borderleftnot" colspan="2"><b>&nbsp; الإجمالي </b></td>
    ...
    <tr>
        <td class="borderlefttopnot" colspan="2"><b> &nbsp;  خصم </b></td>
    ...
    <tr>
        <td class="borderlefttopnot" colspan="2"><b>&nbsp;  الصافي </b></td>
        <td class="borderlefttopnot" colspan="2"
