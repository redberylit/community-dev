...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="bankTransferHead"><?php if($_POST['bankTransferAutoID']==''){ echo 'Create Bank Transaction';}else{echo 'Edit Bank Transaction';} ?> <span id=""></span></h4></div>
<?php echo form_open('','role="form" id="bank_transaction_form"'); ?>
<div class="modal-body" id="">
<input type="hidden" id="decimal" name="decimal" value="2">
<input type="hidden" id="fromBankCurrencyID" value="<?php echo $master['fromBankCurrencyID']?>" name="fromBankCurrencyID">
<input type="hidden" id="toBankCurrencyID" value="<?php echo $master['toBankCurrencyID']?>" name="toBankCurrencyID">
<input type="hidden" id="toBankCurrencyCode" value="<?php echo $master['tocurrency'] ?>" name="toBankCurrencyCode">
<input type="hidden" id="fromBankCurrencyCode" value="<?php echo $master['fromcurrency'] ?>" name="fromBankCurrencyCode">
...
<div class="row">
    ...
    <div class="form-group col-sm-4"><label for="financeyear"><?php echo $this->lang->line('treasury_common_financial_period');?><!--Financial Period--> <?php required_mark(); ?></label>
        <?php echo form_dropdown('financeyear_period', array('' => 'Select Finance Period'), '', 'class="form-control" id="financeyear_period" required'); ?>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="form-group col-sm-4"><label for=""><?php echo $this->lang->line('treasury_common_bank_account');?><!--Bank Account --></label> <?php echo form_dropdown('bankFrom', company_bank_account_drop(), $master['fromBankGLAutoID'], 'class="form-control select2" onchange="fetch_cheque_number(this.value)" id="bankFrom" required"'); ?>
    </div>
    <div class="col-sm-3">
        <div class="form-group"><label for="creditPeriod"><?php echo $this->lang->line('common_amount');?><!--Amount--></label>
            <div class="input-group">
                <div class="input-group-addon"><span id="fromcurrency"><?php echo $master['fromcurrency']?></span></div>
                <input type="text" style="text-align: right" class="form-control" id="fromAmount" value="<?php echo $master['transferedAmount']?>" onkeypress="return validateFloatKeyPress(this,event)" onchange="gettransferedAmount(this.value)" name="fromAmount" placeholder="00"></div>
        </div>
    </div>
    <div class="col-sm-2">
        <div class="form-group"><label for="creditPeriod"><?php echo $this->lang->line('treasury_common_exchange_rate');?><!--Exchange Rate--></label>
            <div class="input-group"><input type="text" onchange="cal_exchangeAmount(this.value)" style="text-align: right"  class="form-control" value="<?php echo $master['exchangeRate']?>" id="conversion" name="conversion" placeholder="00"></div>
        </div>
    </div>
    <div class="col-sm-2">
        <div class="form-group"><label for="creditPeriod"><?php echo $this->lang->line('treasury_ap_br_un_book_balance');?><!--Book Balance--></label>
            <div class="input-group"><input type="text" style="text-align: right" readonly value="<?php echo $master['fromBankCurrentBalance']?>" class="form-control" id="fromBankCurrentBalance" name="fromBankCurrentBalance" placeholder="00">
            </div>
        </div>
    </div>
</div>
...
<div class="row hidden chequerow">
    <div class="form-group col-sm-4">
        ...
        <input type="text" class="form-control" id="chequeNo" value="<?php echo $master['chequeNo']?>"  name="chequeNo">
    </div>
    <div class="form-group col-sm-4">
        <label for="">
    ...
    <div class="form-group col-sm-4">
        ...
        <input type="text" class="form-control" id="nameOnCheque" value="<?php echo $master['nameOnCheque']?>"  name="nameOnCheque">
    </div>
</div>
<div class="row chequerow">
    <?php
    $checked='';
    if($master['accountPayeeOnly']==1){
        $checked= 'checked';
    }
    ?>
...
<div class="row">
    <div class="form-group col-sm-4"><label for=""><?php echo $this->lang->line('treasury_common_bank_account');?><!--Bank Account--> </label> <?php echo form_dropdown('bankTo', company_bank_account_drop(), $master['toBankGLAutoID'], 'class="form-control select2" onchange="bankchange()" id="bankTo" required"'); ?>
    </div>
    <div class="col-sm-3">
        <div class="form-group"><label for="creditPeriod"><?php echo $this->lang->line('common_amount');?><!--Amount--></label>
            <div class="input-group">
                <div class="input-group-addon"><span id="tocurrency"><?php echo $master['tocurrency']?></span></div> <input value="<?php echo $master['toBankCurrencyAmount']?>" type="text" style="text-align: right" class="form-control" readonly id="toAmount" name="toAmount" placeholder="00"></div>
        </div>
    </div>
</div>
    </div>
...
<script>
    ...
    currency_decimal = <?php echo $master['fromDecimalPlaces']?>
    <?php } ?>
