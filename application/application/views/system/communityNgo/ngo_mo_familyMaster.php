...
?>
    ...
    <div class="row">
        ...
        <div class="col-md-3 text-right">
            ...
            <button type="button" class="btn btn-warning pull-left CA_Alter_btn" style="display: none;"
                    onclick="UpdateFamily_del()"><i
                        class="fa fa-plus"></i> <?php echo $this->lang->line('CommunityNgo_update_family'); ?><!--Update Family Del-->
            </button>
        </div>
    </div>
<br>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-2">
                                    <label
                                            for="AncestId"><?php echo $this->lang->line('CommunityNgo_fam_ancestryState'); ?>
                                        <!--Status--></label><br>
                                ...
                                <div class="form-group col-sm-2">
                                    <label
                                            for="isDeleted"><?php echo $this->lang->line('communityngo_com_member_header_Status'); ?>
                                        <!--Status--></label><br>
                                ...
                                <div class="form-group col-sm-1">
                                    <button type="button" class="btn btn-primary pull-left" onclick="clearFamily_all_filters()"
                                            style="margin-top:9%;">
                                ...
                                <div class="form-group col-sm-1">
                                    <label class="switch" style="">
                                        <input type="checkbox"
                                               id="chDate" onclick="switchInApplySN(this);">
                                        <span id="titleId" class="slider round snAppTitleCls" title="Switch On Apply Serial No"></span>
                                    </label>
                                    <button type="button" id="applySNbtn" class="btn-small btn-default pull-right" onclick="apply_serialNoFormat()"
