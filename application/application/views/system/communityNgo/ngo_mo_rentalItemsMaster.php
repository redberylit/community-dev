...
?>
    ...
    <div class="row">
        <div class="col-md-7 pull-right">
            <button type="button" class="btn btn-info btn-sm CA_Alter_btn" onclick="rent_stockUpdate()" ><i class="fa fa-cubes"></i>&nbsp;Stock Update</button>
            <button type="button" class="btn btn-primary btn-sm pull-right CA_Alter_btn" onclick="openDocument_modal()" ><i class="fa fa-plus-square"></i>&nbsp; <?php echo $this->lang->line('common_add');?><!--Add--> </button>
        </div>
    </div><hr>
    <div class="row" style="margin-top: 2%;">
        ...
        <div class="col-sm-4" style="float: right;">
            ...
            <button href="#" type="button" class="btn btn-success btn-sm pull-right CA_Print_Excel_btn" onclick="excelrentSet_Export()">
                <i class="fa fa-file-excel-o"></i> Excel
            </button>
            <button href="#" type="button" style="margin-right: 2px;" class="btn btn-danger btn-sm pull-right CA_Print_Excel_btn" onclick="generate_rentSetPdf()">
...
<?php echo footer_page('Right foot','Left foot',false); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            control_staff_access(0, 'system/communityNgo/ngo_mo_rentalItemsMaster', 0);
