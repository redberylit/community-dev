...
<?php echo footer_page('Right foot','Left foot',false); ?>
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" id="add-rentItems_form" >
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-sm CA_Submit_btn" onclick="save_rentalWHmaster()"><?php echo $this->lang->line('common_save');?><!--Save--></button>
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" id="edit-documents_form" >
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary btn-sm CA_Submit_btn" onclick="update_rentalItem()"><?php echo $this->lang->line('common_update');?><!--Update--></button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            control_staff_access(0, 'system/communityNgo/ngo_mo_rentalWarehouseMaster', 0);
