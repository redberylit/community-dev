...
<div class="row">
    ...
    <div class="col-md-7 pull-right">
        <button type="button" class="btn btn-primary btn-sm pull-right CA_Alter_btn" onclick="openCommitteePosition_modal()" ><i class="fa fa-plus-square"></i>&nbsp; <?php echo $this->lang->line('common_add');?><!--Add--> </button>
    </div>
</div><hr>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="add-CommitteePosition_form" >
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm CA_Submit_btn" onclick="save_CommitteePosition()"><?php echo $this->lang->line('common_save');?><!--Save--></button>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-sm CA_Submit_btn" onclick="updateCommitteePosition()"><?php echo $this->lang->line('common_update');?><!--Update--></button>
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><?php echo $this->lang->line('common_Close');?><!--Close--></button>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        control_staff_access(0, 'system/communityNgo/ngo_mo_committeePositionsView', 0);
