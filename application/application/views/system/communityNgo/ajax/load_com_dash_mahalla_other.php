                                ...
                                <div class="box box-info collapsed-box box-solid">
                                    ...
                                    <div class="box-body">
                                        <ul class="chart-responsive circleUl">
                                            <li class="merr-item">
                                                <div class="bg-success"><span style="color: transparent;">...</span> <?php echo $this->lang->line('comNgo_dash_total_confirmed_members');?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge" style="text-align: center;font-weight: bolder;"> <?php
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div>
                                ...
                                <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="fetch_rentalDel_modal(1);"><i class="fa fa-cart-arrow-down" style="font-size:49px;color:#088da5;">  </i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<li class="fa fa-circle-o text"> <?php echo $this->lang->line('comNgo_dash_products_goods');?>:</li> <span><input id="prGoodsTotal" value="" style="border: none;font-weight: bold;"></span></a>
                                <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="fetch_rentalDel_modal(2);"><i class="fa fa-cubes" style="font-size:40px;color:#20b2aa;"></i> &nbsp;&nbsp;&nbsp;<li class="fa fa-circle-o text"> <?php echo $this->lang->line('comNgo_dash_fixed_assets');?>:</li> <span><input id="assetTotal" value="" style="border: none;font-weight: bold;"></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="box-body">
...
<?php
    ...
    <div class="no_padding col-md-12" style="padding:20px;text-align: center;font-weight:bold;background:linear-gradient(to right, #e24952 , whitesmoke);">
        No rental process available yet !
    </div>
    <?php
}
?>
