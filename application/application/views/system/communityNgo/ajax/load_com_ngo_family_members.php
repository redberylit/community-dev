                ...
                $rowUserImg = '<i class="fa fa-user" style="float: right;" title="Head Of The Family"></i>';
                  ...
                  ?>
                    <tr <?php echo $rowColor; ?>>
                        <td class="mailbox-star" width="5%"><?php echo $x .' '.$rowUserImg; ?></td>
                        ...
                        <td class="mailbox-star">
                            ...
                            <a onclick="fetchPage('<?php echo $page; ?>','<?php echo $val['Com_MasterID'] ?>','Edit Member','<?php echo $val['FamMasterID'] ?>','<?php echo $val['FamMasterID'] ?>');"><span title="Edit Community" style="height:18px;width:20px;color: white;background-color:#51a251;text-align: center;" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>
                            </span>
                        </td>
                    </tr>
                  <?php
