                ...
                <div class="col-sm-3">
                    <div class="fileinput-new thumbnail">
                        ...
                        <?php if ($header['Com_MasterID'] != NULL || $header['Com_MasterID'] != '') { ?>
                                <img src="<?php echo base_url('uploads/NGO/communitymemberImage/' . $header['contactImage']); ?>"
                                     id="changeImg" style="width: 200px; height: 145px;">
                                <?php
                            }      else{
                            ?>
                            <img src="<?php echo base_url('uploads/NGO/donorsImage/' . $header['contactImage']); ?>"
                                 id="changeImg" style="width: 200px; height: 145px;">
...
<script type="text/javascript">
    ...
    function document_uplode() {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'JSON',
            url: "<?php echo site_url('CommunityNgo/comDonor_attachment_upload'); ?>",
            data: formData,
            contentType: false,
            cache: false,
            processData: false,
    ...
    function delete_comDonor_attachment(id, fileName) {
        swal({
                title: "Are you sure?",
