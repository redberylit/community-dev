            ...
            foreach ($rentalMas as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-attachment"><span class="pull-right">
                               <a class="CA_Alter_btn" onclick="edit_rentalSetup('<?php echo $val['rentalItemID'] ?>', this)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>
                             &nbsp;&nbsp;|&nbsp;&nbsp;<a class="CA_Alter_btn" onclick="delete_rentalItm(<?php echo $val['rentalItemID'] ?>);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a></span>
