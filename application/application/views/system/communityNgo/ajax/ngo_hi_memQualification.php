...
$socialGrants = load_socialGrants();
$communityPeriods = load_communityPeriods();
...
<div id="details">
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs" id="education-tab" style="border: 1px solid rgba(150, 145, 145, 0.21); margin-bottom: 5px;">
            <li class="other_details_li active" data-value="languageTab">
                <a href="#languageTab" data-toggle="tab" id="lanTab" aria-expanded="true"> <i class="fa fa-language"></i> <?php echo $this->lang->line('communityngo_Language'); ?></a>
                <!--Language-->
            </li>
            <li class="other_details_li" data-value="occupationTab">
                <a href="#occupationTab" data-toggle="tab" id="occTab" aria-expanded="true"> <i class="fa fa-user-md"></i> <?php echo $this->lang->line('communityngo_Job'); ?></a>
                <!--Occupation-->
            </li>
            <li class="other_details_li" data-value="certificationTab">
                <a href="#certificationTab" data-toggle="tab" id="quaTab" aria-expanded="false"> <i class="fa fa-graduation-cap"></i> <?php echo $this->lang->line('communityngo_Qualification'); ?>
                </a>
                <!--Qualification-->
            </li>
            <li class="other_details_li" data-value="healthStatus_Tab">
                <a href="#healthStatus_Tab" data-toggle="tab" id="hsTab" aria-expanded="true"> <i class="fa fa-medkit"></i> <?php echo $this->lang->line('communityngo_CPermanent_sickness'); ?>
                </a>
                <!--Health Status-->
            </li>
            <li class="other_details_li" data-value="vehicleStatus_Tab">
                <a href="#vehicleStatus_Tab" data-toggle="tab" id="vehTab" aria-expanded="true"> <i class="glyphicon glyphicon-duplicate"></i> <?php echo $this->lang->line('communityngo_properties_details'); ?></a>
                <!--properties Status-->
            </li>
            <li class="other_details_li" data-value="memHeplRStatus_Tab">
                <a href="#memHeplRStatus_Tab" data-toggle="tab" id="helpRTab" aria-expanded="true"><i class="fa fa-question-circle"></i> <?php echo $this->lang->line('communityngo_memHelp_require'); ?>
                </a>
                <!--help req Status-->
            </li>
            <li class="other_details_li" data-value="willingToHelp_Tab">
                <a href="#willingToHelp_Tab" data-toggle="tab" id="willingToHeplTab" aria-expanded="true"><i class="glyphicon glyphicon-leaf"></i> <?php echo $this->lang->line('communityNgo_willing_to_help'); ?>
                </a>
                <!--willing to help-->
            </li>
            <li class="other_details_li" data-value="socialGrants_Tab">
                <a href="#socialGrants_Tab" data-toggle="tab" id="socialGrantTab" aria-expanded="true"><i class="fa fa-users"></i> <?php echo $this->lang->line('communityNgo_socialGrant'); ?>
                </a>
                <!--social grants-->
            </li>
            <li class="pull-right" style="padding: 4px 0px;">
                <div class="pull-right">
                    <a onclick="open_add_modal()" data-toggle="modal" class="btn btn-mini btn-primary" style="padding: 2px 6px;">
        ...
        <div class="tab-content" style=" padding-top: 0px;">
            <div class="tab-pane disabled language active" id="languageTab">
                <div class="" style="" id="">
                    <?php
                    $a = 1;
                ...
                <div class="tab-pane" id="" style="">
                    ...
                    foreach ($Occupation as $key => $row) {
                        ...
                        if ($row['OccTypeID'] == 1) {
                            ...
                            if ($row['JobMonthlyIncome'] == '' || $row['JobMonthlyIncome'] == null) {
                                $JobMonthlyIncome = '';
                            } else {
                                $JobMonthlyIncome = 'Monthly Income : ' . $currencyCode . ' ' . number_format($row['JobMonthlyIncome'], $decimals);
                            }

                            if ($row['MonthlyExpenditure'] == '' || $row['MonthlyExpenditure'] == null) {
                                $MonthlyExpenditure = '';
                            } else {
                                $MonthlyExpenditure = 'Monthly Expenditure : ' . $currencyCode . ' ' . number_format($row['MonthlyExpenditure'], $decimals);
                            }
                            ...
                            echo '  <div><h4>' . $JobCategory . '</h4></div>
                                        ...
                                        <div>' . $JobMonthlyIncome . '</div>
                                        <div>' . $MonthlyExpenditure . '</div>
                                        <div><h5>' . $Address . '</h5></div>
                                        <div><h5>' . $DateFrom . '</h5></div>';
                        }
                ...
                <div class="" style="" id="">
                    ...
                    foreach ($Sickness as $key => $det) {
                        ...
                        if ($det['monthlyExpenses'] == 0 || $det['monthlyExpenses'] == null) {
                            ...
                            $monthlyExpenses = 'Monthly Expenses :' . $currencyCode . ' ' . number_format($det['monthlyExpenses'], $decimals);
                        }
                        ...
                        echo '
                           <table class="table table-condensed">
                                    <tr>
                                      ...
                                      <div><h5>' . $startedFrom . '</h5></div>
                                      <div><h5>' . $medicalCondition . '</h5></div>
                                      <div><h5>' . $monthlyExpenses . '</h5></div>
                                      <div><h5>' . $sickRemarks . '</h5></div></td>
                                      <td>
                                      
                                      <span class="pull-right">
                               <span class="attachmentSpan" style="display: inline-block;"><a
                                                   onclick="add_other_attachment(' . $det['memPSicknessID'] . ', \'Sickness Attachments\',12)"><span
                                                        title="Attachment" rel="tooltip" class="glyphicon glyphicon-paperclip "
                                                        style="color:green;"
                                                        data-original-title="Edit"></span></a></span>
                            </span>
                ...
                <div class="" style="" id="">
                    ...
                    foreach ($VehicleConfig as $key => $det) {
                        ...
                        if ($det['PropertyDes'] == null) {
                            ...
                            $PropertyDes = 'Property Type : ' . $det['PropertyDes'];
                        }
                        if ($det['PropertyID'] == 1) {
                            $vehiType = 'Type Of Vehicle :' . $det['vehicleDescription'];
                        } else {
                            $vehiType = '';
                        }
                        if ($det['vehiDescription'] == null) {
                            ...
                            $vehiDesc = 'Description :' . $det['vehiDescription'];
                        }
                        if ($det['vehiStatus'] == 0 || $det['vehiStatus'] == null) {
                            $vehiStatus = 'Status : <span class="label label-success">Own</span>';
                        } else {
                            $vehiStatus = 'Status : <span class="label label-warning">Lease</span>';
                        }

                        if ($det['propertyValue'] == 0 || $det['propertyValue'] == null) {
                            $propertyValue = '';
                        } else {
                            $propertyValue = 'Value :' . $currencyCode . '  ' . number_format($det['propertyValue'], $decimals);
                        }

                        if ($det['vehiRemark'] == '') {
                            $vehiRemarks = '';
                        } else {
                            $vehiRemarks = 'Remarks :' . $det['vehiRemark'];
                        }

                        $propertyDesc =  $PropertyDes . ' Attachments';
                        echo '
                           <table class="table table-condensed">
                                    <tr>
                                      <td style="width: 10px"><h5>' . $a . '</h5></td>
                                      <td><div><h5 style="text-decoration: underline;">' . $PropertyDes . '</h5></div>
                                      <div><h5>' . $vehiType . '</h5></div>
                                      <div><h5>' . $vehiDesc . '</h5></div>
                                      <div><h5>' . $vehiStatus . '</h5></div>
                                      <div><h5>' . $propertyValue . '</h5></div>
                                      <div><h5>' . $vehiRemarks . '</h5></div></td>
                                      <td>
                                      
                                                                                                                             
                                      <span class="pull-right">
                               <span class="attachmentSpan" style="display: inline-block;"><a
                                                   onclick="add_other_attachment(' . $det['memVehicleID'] . ', \'' . $propertyDesc . '\',13)"><span
                                                        title="Attachment" rel="tooltip" class="glyphicon glyphicon-paperclip "
                                                        style="color:green;"
                                                        data-original-title="Edit"></span></a></span>
                            </span>
            ...
            <div class="tab-pane disabled memHeplRStatus" id="memHeplRStatus_Tab">
                <div class="" style="" id="">
                        ...
                        foreach ($HelpReqConGv as $key => $det) {
                           ...
                           <table class="table table-condensed">
                                    <tr>
                                      ...
                                      <td><div><h5 style="text-decoration: underline;">' . $det['helpRequireDesc'] . '</h5></div>
                                      <div><h5>' . $helpDesc . '</h5></div>
                                      </td>
                                      <td>
                    ...
                    if ($HelpReqComOther) {
                        ...
                        echo '<div style="color: #00a5e6;">Requirement Type : Other</div>';

                        $otr = 1;
                        foreach ($HelpReqComOther as $key => $det) {
                           ...
                           <table class="table table-condensed">
                                    <tr>
                                      <td style="width: 10px"><h5>' . $otr . '</h5></td>
                                      <td><div><h5 style="text-decoration: underline;">' . $det['helpRequireDesc'] . '</h5></div>
                                      <div><h5>' . $helpDesc . '</h5></div>
                                      </td>
                                      <td>
            ...
            <div class="tab-pane disabled willingToHelp" id="willingToHelp_Tab">
                <div class="" style="" id="">
                    ...
                    echo '<br><div style="color: #00a5e6;"> ' . $memberName['CName_with_initials'] . '\'s Community Involvement </div>';
                    ...
                    foreach ($willingToHelp as $key => $det) {
                        ...
                        if ($det['helpComments'] == null) {
                            ...
                            $comInvolvement = 'Comments :' . $det['helpComments'];
                        }
                        ...
                        echo '
                           <table class="table table-condensed">
                                    <tr>
                                      <td style="width: 10px"><h5>' . $c . '</h5></td>
                                      <td><div><h5 style="text-decoration: underline;">' . $det['helpCategoryDes'] . '</h5></div>
                                      <div><h5>' . $comInvolvement . '</h5></div>
                                      </td>
                                      <td>
                                           ...
                                           <span class="pull-right">
                               <span class="attachmentSpan" style="display: inline-block;"><a
                                                   onclick="add_other_attachment(' . $det['willingToHelpID'] . ', \'Community Involvement\',14)"><span
                                                        title="Attachment" rel="tooltip" class="glyphicon glyphicon-paperclip "
                                                        style="color:green;"
                                                        data-original-title="Edit"></span></a></span>
                            </span>
            ...
            <div class="tab-pane disabled socialGrant" id="socialGrants_Tab">
                <div class="" style="" id="">
                    <?php

                    echo '<br><div style="color: #00a5e6;"> ' . $memberName['CName_with_initials'] . '\'s Social Grants </div>';

                    $c = 1;
                    foreach ($socialGrant as $key => $det) {

                        if ($det['SocialGrantRemark'] == null) {
                            $socialGRemark = '';
                        } else {
                            $socialGRemark = 'Remarks :' . $det['SocialGrantRemark'];
                        }

                        if ($det['PeriodTypeID'] == null) {
                            $grantPeriod = '';
                        } else {
                            $grantPeriod = 'Grant Period :' . $det['Description'];
                        }

                        if ($det['GrantAmount'] == '' || $det['GrantAmount'] == null) {
                            $GrantAmount = '';
                        } else {
                            $GrantAmount = 'Grant Amount : ' . $currencyCode . ' ' . number_format($det['GrantAmount'], $decimals);
                        }
                        echo '
                           <table class="table table-condensed">
                                    <tr>
                                      <td style="width: 10px"><h5>' . $c . '</h5></td>
                                      <td><div><h5 style="text-decoration: underline;">' . $det['SocialGrantDescription'] . '</h5></div>
                                      <div><h5>' . $grantPeriod . '</h5></div>
                                      <div><h5>' . $GrantAmount . '</h5></div>
                                      <div><h5>' . $socialGRemark . '</h5></div>
                                      </td>
                                      <td>
                                                                                                            
                                             <span class="pull-right">
                               <span class="attachmentSpan" style="display: inline-block;"><a
                                                   onclick="add_other_attachment(' . $det['MemSocialGrantID'] . ', \'Social Grant\',15)"><span
                                                        title="Attachment" rel="tooltip" class="glyphicon glyphicon-paperclip "
                                                        style="color:green;"
                                                        data-original-title="Edit"></span></a></span>
                            </span>
                             ...
                             <span class="pull-right" style="margin-top: 22px;margin-right: -13px;">
                               <span class="editSpan" style="display: inline-block;"><a
                                                   onclick="edit_memSocialGrant(\'' . $det['MemSocialGrantID'] . '\')"><span
                                                        title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil "
                                                        style="color:blue;"
                                                        data-original-title="Edit"></span></a></span>
                            </span>
                            <span class="pull-right" style="margin-top: 44px; margin-right: -13px;">
                               <span class="deleteSpan" style="display: inline-block;"><a
                                                   onclick="delete_memSocialGrant(\'' . $det['MemSocialGrantID'] . '\')"><span
                                                        title="Delete" rel="tooltip" class="glyphicon glyphicon-trash"
                                                        style="color:rgb(209, 91, 71);"
                                                        data-original-title="Delete"></span></a></span>
                            </span>
...
<div class="modal fade bs-example-modal-lg" id="com_memLangAdd_modal" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="exampleModalLabel">
                    <?php echo $this->lang->line('communityngo_addLanguage'); ?></h4>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" onclick="sendemail('sickness')" style="height: 27px; padding: 2px 10px;">
                        ...
                        <div class="form-group" style="margin-top: 20%;">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="monthlyExpenses" value="" id="monthlyExpenses" class="form-control">
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm actionBtn" id="save-btn-hs" onclick="save_healthStatus()">
                    <?php echo $this->lang->line('common_save'); ?>
                    <!--Save-->
                </button>
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">
                    ...
                    <div class="col-md-12">
                        <div class="form-group" style="margin-bottom: 6%;">
                            ...
                            <div class="col-sm-7">
                                ...
                                <div class="input-group">
                                    <select id="DegreeID" class="form-control select2" name="DegreeID" onchange="display_grade_for_school();" data-placeholder="<?php echo $this->lang->line('communityngo_QualificationType'); ?>">
                                        <option value=""></option>
                                        <?php
                                        if (!empty($degree)) {
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" onclick="sendemail('qualification')" style="height: 27px; padding: 2px 10px;">
                                            <i class="fa fa-envelope" style="font-size: 11px"></i>
                                        </button>
                                    </span>
                                </div>
                        ...
                        <div class="form-group university_div" style="margin-bottom: 12%; display: block;" id="university_div">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" onclick="sendemail('institute')" style="height: 27px; padding: 2px 10px;">
                                            <i class="fa fa-envelope" style="font-size: 11px"></i>
                                        </button>
                                    </span>
                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <select id="OccTypeID" class="form-control select2 occupationType" onchange="change_dropdown();" data-placeholder="<?php echo $this->lang->line('communityngo_occupationType'); ?>" name="OccTypeID">
                                    ...
                                    if (!empty($occupationTypes)) {
                                        foreach ($occupationTypes as $val) {
                                            if ($val['OccTypeID'] == 1) {
                                    ?>
                                                <option selected="selected" value="<?php echo $val['OccTypeID'] ?>"><?php echo $val['Description'] ?></option>
                                            <?php
                                            } else {
                                            ?>
                        ...
                        <div class="form-group School" style="padding:15px">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    <select id="schoolComID" class="form-control select2" onchange="get_sch_medium(this.value); get_sch_address(this.value);" data-placeholder="<?php echo $this->lang->line('communityngo_School'); ?>" name="schoolComID">
                                        <option value=""></option>
                                        <?php
                                        if (!empty($schools)) {
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" onclick="sendemail('school')" style="height: 27px; padding: 2px 10px;">
                                            <i class="fa fa-envelope" style="font-size: 11px"></i>
                                        </button>
                                    </span>
                        ...
                        <div class="form-group JobCategoryID hide" style="padding:15px">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" onclick="sendemail('job_category')" style="height: 27px; padding: 2px 10px;">
                                            <i class="fa fa-envelope" style="font-size: 11px"></i>
                                        </button>
                                    </span>
                                </div>
                        ...
                        <div class="form-group specializationID hide" style="padding:15px">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" onclick="sendemail('job_specialization')" style="height: 27px; padding: 2px 10px;">
                                            <i class="fa fa-envelope" style="font-size: 11px"></i>
                                        </button>
                                    </span>
                                </div>
                        ...
                        <div class="form-group JobMonthlyIncome hide" style="padding:15px;">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    <div class="input-group-addon"><?php echo $currencyCode; ?></div>
                                    <input type="number" name="JobMonthlyIncome" value="" id="JobMonthlyIncome" placeholder="<?php echo $this->lang->line('communityngo_Job_MonthlyIncome'); ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group MonthlyExpenditure hide" style="padding: 15px;">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    <div class="input-group-addon"><?php echo $currencyCode; ?></div>
                                    <input type="number" name="MonthlyExpenditure" value="" id="MonthlyExpenditure" placeholder="<?php echo $this->lang->line('communityngo_Job_MonthlyHHExpenditure'); ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group DateFrom" style="padding:15px">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group datepic">
                                    ...
                                    <input type="text" name="DateFrom" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="" id="DateFrom" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group DateTo " style="padding:15px">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group datepic">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input type="text" name="DateTo" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="" id="DateTo" class="form-control">
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm actionBtn" id="save-btn-occ" onclick="saveOccupation()">
                    <?php echo $this->lang->line('common_save'); ?>
                    <!--Save-->
                </button>
                <button type="button" class="btn btn-primary btn-sm actionBtn" id="update-btn-occ" onclick="updateOccupation()">
                    <?php echo $this->lang->line('common_update'); ?>
                    <!--Update-->
                </button>
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                    ...
                    <div class="col-md-12">
                                ...
                                <select id="PropertyID" class="form-control select2 occupationType" onchange="change_property_dropdown();" data-placeholder="<?php echo $this->lang->line('communityngo_property_type'); ?>" name="PropertyID">
                                    ...
                                    if (!empty($propertyTypes)) {
                                        foreach ($propertyTypes as $val) {
                                            if ($val['PropertyID'] == 1) {
                                    ?>
                                                <option selected="selected" value="<?php echo $val['PropertyID'] ?>"><?php echo $val['PropertyDes'] ?></option>
                                            <?php
                                            } else {
                                            ?>
                                                <option value="<?php echo $val['PropertyID'] ?>"><?php echo $val['PropertyDes'] ?></option>
                                            <?php
                                            }
                                            ?>
                                    <?php
                        ...
                        <div class="form-group vehicleAutoID" style="margin-top: 6%;">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" onclick="sendemail('mem_vehicle')" style="height: 27px; padding: 2px 10px;">
                                            <i class="fa fa-envelope" style="font-size: 11px"></i>
                                        </button>
                                    </span>
                                </div>
                        ...
                        <div class="form-group" style="margin-top: 18%;">
                            ...
                            <div class="col-sm-7" style="margin-bottom:6px;">
                                <div class="input-group">
                                    <div class="input-group-addon"><?php echo $currencyCode; ?></div>
                                    <input type="number" name="propertyValue" value="" id="propertyValue" placeholder="<?php echo $this->lang->line('common_value'); ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" style="margin-top: 18%;">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm actionBtn" id="save-btn-vehi" onclick="save_vehicleStatus()">
                    <?php echo $this->lang->line('common_save'); ?>
                    <!--Save-->
                </button>
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group col-sm-7">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" id="email_btn" disabled onclick="sendemail('help_details')" style="height: 27px; padding: 2px 10px;">
                                            <i class="fa fa-envelope" style="font-size: 11px"></i>
                                        </button>
                                    </span>
                                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm actionBtn" id="save-btn-hlp" onclick="save_memHeplRStatus()">
                    <?php echo $this->lang->line('common_save'); ?>
                    <!--Save-->
                </button>
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group col-sm-7">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" id="email_btn_help" onclick="sendemail('help_category')" style="height: 27px; padding: 2px 10px;">
                                            <i class="fa fa-envelope" style="font-size: 11px"></i>
                                        </button>
                                    </span>
                                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm actionBtn" id="save-btn-willingToHelp" onclick="save_willingToHelp()">
                    <?php echo $this->lang->line('common_save'); ?>
                    <!--Save-->
                </button>
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">
...
<div class="modal" id="socialGrant_modal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php echo form_open('', 'role="form" id="socialGrant_form"'); ?>
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="socialGrant_modal-title"></h4>
            </div>
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="form-group col-sm-7">
                                <div class="input-group">
                                    <select name="SocialGrantID" class="form-control select2" id="SocialGrantID" data-placeholder="Select a social grant">
                                        <option value=""></option>
                                        <?php
                                        if (!empty($socialGrants)) {
                                            foreach ($socialGrants as $val) {
                                        ?>
                                                <option value="<?php echo $val['SocialGrantID'] ?>"><?php echo $val['SocialGrantDescription'] ?></option>
                                        <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" id="email_btn_grant" onclick="sendemail('social_grant')" style="height: 27px; padding: 2px 10px;">
                                            <i class="fa fa-envelope" style="font-size: 11px"></i>
                                        </button>
                                    </span>
                                </div>
                        ...
                        <div class="form-group" style="margin-top: 6%;">
                            ...
                            <div class="col-sm-7">
                                <select name="PeriodTypeID" class="form-control select2" id="PeriodTypeID" data-placeholder="Select a period">
                                    <option value=""></option>
                                    <?php
                                    if (!empty($communityPeriods)) {
                                        foreach ($communityPeriods as $val) {
                                    ?>
                                            <option value="<?php echo $val['PeriodTypeID'] ?>"><?php echo $val['Description'] ?></option>
                                    <?php
                                        }
                                    }
                                    ?>
                        ...
                        <div class="form-group" style="margin-top: 6%;">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    <div class="input-group-addon"><?php echo $currencyCode; ?></div>
                                    <input type="number" name="GrantAmount" value="" id="GrantAmount" placeholder="<?php echo $this->lang->line('communityNgo_socialGrant_amount'); ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        <br>
            ...
            <div class="modal-footer">
                <input type="hidden" id="hidden-id-socialGrant" name="hidden-id-socialGrant" value="0">
                <button type="button" class="btn btn-primary btn-sm actionBtn" id="save-btn-socialGrant" onclick="save_memSocialGrant()">
                    <?php echo $this->lang->line('common_save'); ?>
                    <!--Save-->
                </button>
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" style="padding:5px">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="sender_name" value="" id="sender_name" class="form-control">
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function add_vehicleStatus() {
        ...
        $('#save-btn-vehi').show();
        $('#vehicleStatus_modal-title').text('<?php echo $this->lang->line('communityngo_property_details'); ?>');
        $('#vehicleStatus_modal').modal({
            backdrop: "static"
        });
    }
    ...
    function edit_vehicleStatus(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#PropertyID").val(data['PropertyID']).change();
                ...
                $('#propertyValue').val(data['propertyValue']);
    ...
    function edit_memHeplRStatus(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                } else if (data['helpRequireType'] == 'OTHER') {
                    $("#memHelpType").val(4).change();
                }
    ...
    function add_occupation() {
        ...
        $('.JobMonthlyIncome').addClass('hide');
        $('.MonthlyExpenditure').addClass('hide');
    ...
    function change_dropdown() {
        ...
        switch (dropdownvalue) {
            ...
            default:
                ...
                $('.JobMonthlyIncome').removeClass('hide');
                $('.MonthlyExpenditure').removeClass('hide');
    ...
    function change_property_dropdown() {

        var Property_dropValue = $("select#PropertyID option").filter(":selected").val();

        switch (Property_dropValue) {
            case '1':

                $('.vehicleAutoID').removeClass('hide');

                break;

            default:
                $('.vehicleAutoID').addClass('hide');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data['OccTypeID'] == 1) {
                    ...
                    $('#JobMonthlyIncome').val(data['JobMonthlyIncome']);
                    $('#MonthlyExpenditure').val(data['MonthlyExpenditure']);
        ...
        if (Com_MasterID) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    } else if (tab == 'socialGrants_Tab') {
                        $('#socialGrantTab').tab('show');
                        $('[href=#socialGrants_Tab]').addClass('active');
                        $('.socialGrant').addClass('active');
                    } else {
                        $('#lanTab').tab('show');
    ...
    function add_other_attachment(other_documentSystemCode, other_document_name, other_documentID) {
        ...
        if (other_documentSystemCode) {
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    'other_documentSystemCode': other_documentSystemCode,
                    'other_documentID': other_documentID
                },
                success: function(data) {
    ...
    //social Grants
    function add_memSocialGrant() {

        $('#socialGrant_form').trigger("reset");
        $('#save-btn-socialGrant').show();
        $('#socialGrant_modal-title').text('<?php echo $this->lang->line('communityNgo_socialGrant'); ?>');
        $('#socialGrant_modal').modal({
            backdrop: "static"
        });
    }
    ...
    function save_memSocialGrant() {
        ...
        var postData = $('#socialGrant_form').serializeArray();
        var Com_MasterID = <?php echo json_encode(trim($this->input->post('Com_MasterID'))); ?>;
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo site_url('CommunityNgo/save_memSocialGrant'); ?>',
            data: postData,
            dataType: 'json',
            beforeSend: function() {
                startLoad();
            ...
            success: function(data) {
                ...
                if (data[0] == 's') {
                    fetch_alldetails('socialGrants_Tab');
                }

                $('#socialGrant_modal').modal('hide');
    ...
    function edit_memSocialGrant(id) {

        $.ajax({
            type: 'post',
            url: '<?php echo site_url('CommunityNgo/edit_memSocialGrant'); ?>',
            data: {
                id: id
            },
            dataType: 'JSON',
            ...
            success: function(data) {
                ...
                $("#SocialGrantID").val(data['SocialGrantID']).change();
                $("#PeriodTypeID").val(data['PeriodTypeID']).change();
                $('#GrantAmount').val(data['GrantAmount']);
                $('#SocialGrantRemark').val(data['SocialGrantRemark']);

                $('#hidden-id-socialGrant').val(id);

                $('.actionBtn').show();
                $('#socialGrant_modal-title').text('<?php echo $this->lang->line('communityNgo_socialGrant_edit'); ?>');
                $('#socialGrant_modal').modal({
                    backdrop: "static"
                });
            },
    ...
    function delete_memSocialGrant(id) {
        swal({
                title: "<?php echo $this->lang->line('common_are_you_sure'); ?>",
                /*Are you sure?*/
                text: "<?php echo $this->lang->line('common_you_want_to_delete'); ?>",
            ...
            function() {
                $.ajax({
                    async: true,
                    url: "<?php echo site_url('CommunityNgo/delete_memSocialGrant'); ?>",
                    type: 'post',
                    dataType: 'json',
                    data: {
                        'id': id
