...
?>
        ...
        <div class="col-sm-12 table-responsive mailbox-messages">
            ...
            if (!empty($Com_MemID)) {
                ...
                if ($CollectionType == 3) { // Cash collaboration tax (sittu tax)
                    ?>
                    <table class="table table-hover table-striped" id="sittuTable">
                        <thead>
                        ...
                        foreach ($Com_MemID as $row) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $row["MemberCode"] . ' | ' . $row["CName_with_initials"]; ?>
                                    <input type="text" name="Com_MasterID2[]" value="<?php echo $row["Com_MasterID"]; ?>"
                                ...
                                <td>
                                 <a class="CA_Alter_btn" onclick="delete_sittu_member(this);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a>
                    ...
                    ?>
                    <table class="table table-hover table-striped" id="sandhaTable">
                        <thead>
                        <tr class="task-cat-upcoming" style="font-size:12px; color: black;font-weight: bold;">
                            <td style="border-bottom: solid 1px #f76f01;">#</td>
                            <td style="border-bottom: solid 1px #f76f01;">Member</td>
                        ...
                        foreach ($Com_MemID as $row) {
                            ...
                            <tr>
                                <td class="mailbox-star"><?php echo $r; ?></td>
                                <td><?php echo $row["CName_with_initials"]; ?>
                                    <input type="text" name="Com_MasterID2[]" value="<?php echo $row["Com_MasterID"]; ?>"
                                           class="form-control" style="display: none;">
                                </td>
                                <td>
                                ...
                                <td>
                                    <a class="CA_Alter_btn" onclick="delete_sandha_member(this);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a>
                    ...
                    <table class="table table-hover table-striped" id="marriageTable">
                        ...
                        foreach ($Com_MemID as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="CA_Alter_btn" onclick="delete_marriage_member(this);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a>
    ...
    <script>
        ...
        function delete_sittu_member(id) {

            var i = id.parentNode.parentNode.rowIndex;
            document.getElementById("sittuTable").deleteRow(i);
        }

        function delete_sandha_member(id) {

            var i = id.parentNode.parentNode.rowIndex;
            document.getElementById("sandhaTable").deleteRow(i);
        }

        function delete_marriage_member(id) {
            var i = id.parentNode.parentNode.rowIndex;
            document.getElementById("marriageTable").deleteRow(i);
        }
