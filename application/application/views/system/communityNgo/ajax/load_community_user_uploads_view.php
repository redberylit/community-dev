                                    ...
                                    <?php if ($resuDoc->ComUploadType == 3) { ?>
                                        <li>
                                            ...
                                            <div class="timeline-item" style="overflow-y: auto;">
                                                <div class="btn-group" role="group">
                                                    <button title="Edit" rel="tooltip" class="btn btn-xs btn-default" type="button"
                                                            onclick="com_user_uploadEdit(<?php echo $resuDoc->ComUploadID; ?>)">
                                                        <i class="fa fa-edit"></i>
                                                    </button>
                                                    <button class="btn btn-xs btn-danger" onclick="com_user_uploadDelete(<?php echo $resuDoc->ComUploadID; ?>)"
                                                            title="Delete" rel="tooltip" type="button">
                                                        <i class="fa fa-trash"></i>
                                                    </button>
                                                </div>
                                                ...
                                                <div class="timeline-body">
                                                    <table>
                                                            ...
                                                            <td colspan="4">
                                                                <img src="<?php echo base_url('images/community/icon_pic.gif'); ?>"
                                                                     style="vertical-align:top"> &nbsp;<a target="_blank" class="nopjax"
                                                                                                          href="<?php echo familyDocUploadPath(). $resuDoc->ComUploadFileName ?>"><?php echo $resuDoc->ComUploadFileName; ?></a>
                                                        ...
                                                        <tfoot style="border: none;"><tr style="text-align: center;"><td colspan="6">
                                                                <?php if($resuDoc->familyUplaod_active == 1) { ?>
                                                                    <div class="blink_div"><strong
                                                                            style=" color: green;font-weight:600;">
                                                                            Approved    </strong></div>
                                                                <?php } else{ ?>
