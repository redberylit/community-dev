                                    ...
                                    <div class="box-body">
                                        ...
                                        <div id="glclassDatatableDiv" style="overflow-x:auto; margin: 1%;">
                                            <table id="glclassDatatables" class="nowrap" cellspacing="0" width="100%"
                                                ...
                                                <thead>
                                                <tr>
                                                    <th><?php echo $this->lang->line('comNgo_dash_invoices');?></th>
                                                    <th><?php echo $this->lang->line('comNgo_dash_cr');?></th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <tr>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var tdyFeeData = {
            ...
            datasets: [
                {
                    label: "<?php echo $this->lang->line('comNgo_dash_todayFeeCollections');?>",
