...
if (!empty($comCommittees)) {
    ...
    <div class="row" style="margin-top: 5px">
        <div class="col-md-12">
            <?php
            if ($type == 'html') {
                echo export_buttons('comCommitteesRprt', 'Community Committees Report', True, False);
            } ?>
        </div>
    </div>
    <div class="row" style="margin-top: 5px">
        <div class="col-md-12 " id="comCommitteesRprt">
            <div class="reportHeaderColor" style="text-align: center">
                <strong><?php echo current_companyName(); ?></strong></div>
            <div class="reportHeader reportHeaderColor" style="text-align: center;">
                <strong>Community Committees Report</strong></div>
            <?php
            if ($comCommittees) {
                $r = 1;
                $totalComMm = 1;
                foreach ($comCommittees as $valComm) {
