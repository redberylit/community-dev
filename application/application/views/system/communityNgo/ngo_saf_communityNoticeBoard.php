...
?>
    ...
    <div class="row">
        ...
        <div class="col-md-3 text-right">
            <button type="button" class="btn btn-info btn-sm pull-right CA_Alter_btn"  onclick="fetchPage('system/communityNgo/ngo_saf_newNotice', '', 'Add New Announcement')"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary CA_Submit_btn" onclick="Save_new_attachment()">
...
<?php echo footer_page('Right foot','Left foot',false); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            control_staff_access(0, 'system/communityNgo/ngo_saf_communityNoticeBoard', 0);
