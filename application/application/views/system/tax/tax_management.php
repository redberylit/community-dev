...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/tax/erp_tax_new',null,'Add Tax','Tax');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('tax_create_tax');?><!--Create Tax--> </button>
    </div>
</div><hr>
    ...
    <table id="tax_table" class="<?php echo table_class(); ?>">
        <thead>
            <tr>
                ...
                <th style="min-width: 30%">Authority</th>
