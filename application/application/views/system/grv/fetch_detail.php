                        ...
                        <div class="col-md-9">
                            <table class="table table-bordered table-striped table-condesed ">
                                ...
                                <tr>
                                    ...
                                    <th colspan='3'><?php echo $this->lang->line('transaction_common_recived_item'); ?>
                                        <span
                                                class="currency"> (<?php echo $master['transactionCurrency'] ?>)</span>
                                    </th><!--Received Item-->
                                <tr>
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-condensed" id="">
                        ...
                        <tr>
                            ...
                            <!--UOM-->
                            <th style="width: 150px;"><?php echo $this->lang->line('common_qty'); ?><?php required_mark(); ?></th>
                            <!--Qty-->
...
<div class="table-responsive">
    <table id="add_new_grv_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th colspan="3"><?php echo $this->lang->line('transaction_common_recived_item'); ?> <span class="currency"> <span
        ...
        <tr>
            ...
            <th style="min-width: 5%"><?php echo $this->lang->line('transaction_common_qty'); ?>  </th><!--Qty-->
        ...
        if (!empty($detail)) {
            ...
            $norec = $this->lang->line('common_no_records_found');
            echo '<tr class="danger"><td colspan="11" class="text-center"><b>' . $norec . '<!--No Records Found--></b></td></tr>';
        }
        ?>
        </tbody>
        <tfoot>
                        ...
                        $.each(data['detail'], function (key, value) {
                            ...
                            if(grvType=="Standard")
                            {
                                cost_status = '<input type="text" class="number" size="15" id="amount_' + value['purchaseOrderDetailsID'] +
                                    '" value="' + parseFloat(value['unitAmount']-(value['generalDiscountAmount']/value['requestedQty'])).toFixed(currency_decimal) + '" onkeyup="select_value(' + value['purchaseOrderDetailsID'] + ')" >';
                            }else
                            {
                                cost_status = '<input type="text" class="number" size="15" id="amount_' + value['purchaseOrderDetailsID'] +
                                    '" value="' + parseFloat(value['unitAmount']-(value['generalDiscountAmount']/value['requestedQty'])) + '" onkeyup="select_value(' + value['purchaseOrderDetailsID'] + ')" >';
                            }
                            ...
                            $('#table_body').append('<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-right">' + (value['requestedQty'] - value['receivedQty']) + '</td><td class="text-right">' + parseFloat(value['unitAmount']-(value['generalDiscountAmount']/value['requestedQty'])).toFixed(currency_decimal) + '</td><td class="text-center"><input type="text" class="number" size="8" id="qty_' + value['purchaseOrderDetailsID'] + '" onkeyup="select_check_box(this,' + value['purchaseOrderDetailsID'] + ',' + value['unitAmount'] + ' )" ></td><td class="text-center">' + cost_status + '</td><td class="text-center"><p id="tot_' + value['purchaseOrderDetailsID'] + '"> </p></td><td class="text-right" style="display: none;"><input class="checkbox" id="check_' + value['purchaseOrderDetailsID'] + '" type="checkbox" value="' + value['purchaseOrderDetailsID'] + '"></td></tr>');
                            x++;
    ...
    function save_po_base_items() {
        ...
        if (!jQuery.isEmptyObject(selected)) {
            $.ajax({
                ...
                type: 'post',
                dataType: 'json',
                data: {'DetailsID': selected, 'grvAutoID': grvAutoID, 'amount': amount, 'qty': qty},
