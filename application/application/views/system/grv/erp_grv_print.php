    ...
    <table id="add_new_grv_table" class="<?php echo table_class(); ?>">
        <thead>
            <tr>
                ...
                <th class='theadtr' colspan="3"><?php echo $this->lang->line('transaction_common_recived_item');?> <span class="currency"> (<?php echo $extra['master']['transactionCurrency']; ?>)</span></th><!--Received Item-->
            </tr>
            <tr>
