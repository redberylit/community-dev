...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label for="">Customer Country <?php required_mark(); ?></label>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label for="customercustomerCreditPeriod">Credit Period</label>
                <div class="input-group">
            ...
            <div class="form-group col-sm-4">
                <label for="customercustomerCreditLimit">Credit Limit</label>
                <div class="input-group">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label for="customerAddress2">Secondary Address</label>
                <textarea class="form-control" rows="2" id="customerAddress2" name="customerAddress2"></textarea>
            </div>
        </div>
        <hr>
        <div class="text-right m-t-xs">
            <button class="btn btn-primary" id="customer_btn" type="submit"><?php echo $this->lang->line('config_add_customer');?><!--Add Customer--></button>
        </div>
        </form>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#customermaster_form').bootstrapValidator({
            ...
            excluded: [':disabled'],
            fields: {
                customercode: {validators: {notEmpty: {message: '<?php echo $this->lang->line('config_customer_code_is_required');?>.'}}},/*customer Code is required*/
                customerName: {validators: {notEmpty: {message: '<?php echo $this->lang->line('config_customer_name_is_required');?>.'}}},/*customer Name is required*/
                customercountry: {validators: {notEmpty: {message: 'customer Country is required.'}}},
                receivableAccount: {validators: {notEmpty: {message: '<?php echo $this->lang->line('config_gl_receivable_account_is_required');?>.'}}},/*Receivabl Account is required*/
                customerCurrency: {validators: {notEmpty: {message: '<?php echo $this->lang->line('config_gl_receivable_customer_currency_is_required');?>.'}}}/*customer Currency  is required*/
            },
            ...
            data.push({'name': 'groupCustomerAutoID', 'value': groupCustomerAutoID});
        ...
        $('#customerlink_form').bootstrapValidator({
            ...
            var bv = $form.data('bootstrapValidator');
            var data = $form.serializeArray();
            data.push({'name': 'groupCustomerDetailID', 'value': groupCustomerDetailID});
