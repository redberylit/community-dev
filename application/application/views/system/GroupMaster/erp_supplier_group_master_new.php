...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label for="supplierName">Name On Cheque <?php required_mark(); ?></label>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label for="suppliersupplierCreditPeriod">Credit Period</label>
                <div class="input-group">
        ...
        <div class="row">
            <div class="form-group col-sm-4">
                <label for="suppliersupplierCreditLimit">Credit Limit</label>
                <div class="input-group">
        ...
        <div class="text-right m-t-xs">
            <button class="btn btn-primary" id="supplier_btn" type="submit"><?php echo $this->lang->line('config_common_add_save');?><!--Add Save--></button>
        </div>
        </form>
    </div>
