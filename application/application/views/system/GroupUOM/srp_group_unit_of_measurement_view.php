<?php echo head_page('Unit Of Measurements', false); ?>
...
<div class="table-responsive">
    <table id="umo_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 15%">UOM Code</th>
            <th style="min-width: 50%">UOM Description</th>
            <th style="min-width: 20%">Created By</th>
    ...
    <div class="modal-dialog" style="width: 60%">
        <div class="modal-content" id="">
            ...
            <div class="modal-body" style="margin-left: 10px">
                <div class="row">
                    <div class="col-sm-12">
                        <label for="uomName"><h4>UOM :- </h4></label>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#add_conversion_form').bootstrapValidator({
            ...
            excluded: [':disabled'],
            fields: {
                subUnitID: {validators: {notEmpty: {message: ' UOM is required.'}}},
                conversion: {validators: {notEmpty: {message: ' Conversion is required.'}}}
            },
        ...
        $('#uom_form').bootstrapValidator({
            ...
            excluded: [':disabled'],
            fields: {
                UnitShortCode: {validators: {notEmpty: {message: ' Code is required.'}}},
                UnitDes: {validators: {notEmpty: {message: ' Description is required.'}}}
            },
        }).on('success.form.bv', function (e) {
            e.preventDefault();
            var $form = $(e.target);
    ...
    function link_uom(groupUOMMasterID) {
        $('#uomLinkModal').modal({backdrop: "static"});
        $('#companyID').val('').change();
    ...
    function load_company(groupUOMMasterID) {
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: {groupUOMMasterID: groupUOMMasterID, All: 'true'},
    ...
    function load_comapny_uom() {
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: {companyID: $('#companyID').val(), groupUOMMasterID: $('#groupUOMMasterID').val(), All: 'true'},
    ...
    function load_uom_details_table() {
        Otable = $('#uom_group_details').DataTable({
            ...
            "fnServerData": function (sSource, aoData, fnCallback) {
                aoData.push({"name": "groupUOMMasterID", "value": $('#groupUOMMasterID').val()});
                $.ajax({
                    'dataType': 'json',
                    'type': 'POST',
                    'url': sSource,
    ...
    function load_all_companies_uom() {
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: {groupUOMMasterID: $('#groupUOMMasterID').val()},
