...
<div class="row">
    <div class="col-md-12 pull-right">
        <button type="button" class="btn btn-primary btn-sm pull-right" onclick="openDepartment_modal()" ><i class="fa fa-plus-square"></i>&nbsp; Add </button>
    </div>
</div><hr>
<div class="table-responsive">
    <table id="load_location" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width:15%">Location Code</th>
...
<script type="text/javascript">
    ...
    function edit_location(id, des,locationCode){
    ...
    function add_more(){
        ...
        appendData += '<td><input type="text" name="locationcode[]" class="form-control saveInputs new-items" /></td>';
