    ...
    <div class="table-responsive mailbox-messages" id="advancerecid">
        <table class="table table-hover table-striped">
            ...
            <tr class="task-cat-upcoming">
                ...
                <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;">EXPENSE CODE</td>
                <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;">EXPENSE DESCRIPTION</td>
                ...
                <tr>
                    ...
                    <td class="mailbox-star">
                        <?php if ($val['submittedYN'] == 1 && $val['confirmedYN'] != 1 && $val['confirmedYN'] != 2) {
                            ...
                            <span class="label" style="background-color:#f39c12; color: #FFFFFF; font-size: 11px;">Confirmed</span>
