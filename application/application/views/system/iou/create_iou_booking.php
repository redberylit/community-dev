...
<div class="tab-content">
    ...
    <div id="step2" class="tab-pane">
        ...
        <div class="text-right m-t-xs">
            ...
            <button class="btn btn-warning" id="submitbtn" onclick="submit_booking()">Submit</button>
            <button class="btn btn-success submitWizard" id="confirmbtn" onclick="confirmation()">Confirm</button>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/iou/iou_booking', '', 'IOU Voucher')
        });
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data['error'] == 1) {
                                ...
                                fetchPage('system/iou/iou_booking', IOUbookingmasterid, 'IOU Booking');
                            }
                        }, error: function () {
                            swal("Cancelled", "Your file is safe :)", "error");
                        }
