...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab">Step 1 - IOU Expense Header</a>
    <a class="btn btn-default btn-wizard" href="#step2" data-toggle="tab" onclick="load_confirmation();">Step 2 -
        IOU Expense Submit</a>
...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-2">
                        <label class="title">IOU Voucher</label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
        ...
        <div class="row addTableView">
            <div class="col-md-12 animated zoomIn">
                <header class="head-title">
                    <h2>IOU VOUCHER EXPENSE DETAILS</h2>
                </header>
                <div class="row" style="margin-top: 10px;">

                    <div class="form-group col-sm-2">
                        <label class="titlebalance">Total Voucher Amount :</label>
                    </div>
                    ...
                    <div class="form-group col-sm-2">
                        <label class="titlebalance">Matched Amount :</label>
                    </div>
                    <div class="form-group col-sm-1">
                    ...
                    <div class="form-group col-sm-2">
                        <label class="titlebalance">Balance :</label>
                    </div>
    ...
    <div id="step2" class="tab-pane">
        ...
        <div class="text-right m-t-xs">
            ...
            <button class="btn btn-success submitWizard" onclick="confirmation()">Submit</button>
        </div>
    </div>
    ...
    <div class="modal-dialog" style="width: 80%;">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">IOU Booking</h4>
            </div>
            <div class="modal-body">
                <form role="form" id="iou_booking_det_form" class="form-horizontal">
                    <table class="table table-bordered table-condensed no-color" id="po_detail_add_table">
                        ...
                        <tr>
                            <th>Expense Category</th>
                            <th style="width: 350px;">Segment <?php required_mark(); ?></th>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" type="button" onclick="save_iou_bookingamt()">Save
                    changes
                </button>
            </div>
    ...
    <div class="modal-dialog modal-lg" style="width: 80%">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Edit IOU Booking Detail</h4>
            </div>
            <form role="form" id="iou_voucher_booking_edit_form" class="form-horizontal">
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-condensed" id="">
                        <thead>
                        <tr>
                            <th>IOU Voucher Code<?php required_mark(); ?></th>
                            <th>Balance <?php required_mark(); ?></th>
                            <th>Expense Category <?php required_mark(); ?></th>
                            <th>Segment <?php required_mark(); ?></th>
                            <th>Amount <?php required_mark(); ?></th>
                            <th>Description <span class="currency"></span> <?php required_mark(); ?></th>
                        </tr>
                        </thead>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/iou/iou_booking_employee', '', 'IOU Voucher')
        });
    ...
    $('#booking_header_form').bootstrapValidator({
        ...
        excluded: [':disabled'],
        fields: {
            bookingdate: {validators: {notEmpty: {message: 'Booking Date is required.'}}},
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    success: function (data) {
                        stopLoad();
                        myAlert('s', 'IOU Expense Detail Deleted Successfully');
                        get_iou_booking_detail_view(IOUbookingmasterid);
    ...
    function confirmation() {
        if (IOUbookingmasterid) {
            swal({
                    title: "Are you sure?",
                    text: "You want Submit this Booking!",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonColor: "#DD6B55",
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data['error'] == 1) {
                                ...
                                fetchPage('system/iou/iou_booking_employee', IOUbookingmasterid, 'IOU Booking Employee');
                            }
                        }, error: function () {
                            swal("Cancelled", "Your file is safe :)", "error");
                        }
    ...
    function save_draft() {
        if (IOUbookingmasterid) {
            swal({
                ...
                function () {
                    fetchPage('system/iou/iou_booking_employee', IOUbookingmasterid, 'IOU Booking');
                });
        }
    }
    ...
    function select_check_box(data, id, total) {
        ...
        if (data.value > 0) {
            if (total >= data.value) {
                ...
                $("#check_" + id).prop("checked", false);
                $("#amount_" + id).val('');
                myAlert('w', 'You can not enter Booking amount greater than selected IOU Voucher Amount')
            }
        }
    }
