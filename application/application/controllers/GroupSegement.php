...
class GroupSegement extends ERP_Controller{
    ...
    function fetch_segment_group()
    {
        ...
        $this->datatables->add_column('edit', '<a onclick="link_group_segment($1)"><span title="Link" rel="tooltip" class="glyphicon glyphicon-link" ></span></a>&nbsp;|&nbsp;<a onclick="edit_group_segment($1)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil" ></span></a>', 'segmentID');
