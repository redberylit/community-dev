...
class Journal_entry extends ERP_Controller
{
    ...
    function fetch_journal_entry()
    {
        ...
        $this->datatables->select("srp_erp_jvmaster.JVMasterAutoId as JVMasterAutoId,JVcode,JVdate,confirmedYN,approvedYN,transactionCurrency,transactionCurrencyDecimalPlaces, JVNarration,DATE_FORMAT(JVdate,'$convertFormat') AS JVdate ,JVType,transactionAmount,confirmedYN,approvedYN,createdUserID,isDeleted,confirmedByEmpID,IFNULL(debamt.debitAmount,0) as total_value,IFNULL(debamt.debitAmount,0) as total_value_search");
        ...
        $this->datatables->add_column('action', '$1', 'journal_entry_action(JVMasterAutoId,confirmedYN,approvedYN,createdUserID,isDeleted,JVType,confirmedByEmpID)');
