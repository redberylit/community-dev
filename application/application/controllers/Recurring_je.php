...
class Recurring_je extends ERP_Controller
{
    ...
    function fetch_recurring_journal_entry()
    {
        ...
        $this->datatables->select("srp_erp_recurringjvmaster.RJVMasterAutoId as RJVMasterAutoId,RJVcode,confirmedYN,approvedYN,transactionCurrency,transactionCurrencyDecimalPlaces, RJVNarration,DATE_FORMAT(RJVStartDate,'$convertFormat') AS RJVStartDate,DATE_FORMAT(RJVEndDate,'$convertFormat') AS RJVEndDate,transactionAmount,confirmedYN,approvedYN,createdUserID,isDeleted,confirmedByEmpID,IFNULL(debamt.debitAmount,0) as total_value");
