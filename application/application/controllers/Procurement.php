...
class Procurement extends ERP_Controller
{
    ...
    function fetch_purchase_order()
    {
        ...
        $this->datatables->select("srp_erp_purchaseordermaster.purchaseOrderID as purchaseOrderID,srp_erp_purchaseordermaster.companyCode,purchaseOrderCode,narration,srp_erp_suppliermaster.supplierName as supliermastername,confirmedYN,approvedYN ,DATE_FORMAT(expectedDeliveryDate,'.$convertFormat.') AS expectedDeliveryDate,transactionCurrency,purchaseOrderType ,srp_erp_purchaseordermaster.createdUserID as createdUser,srp_erp_purchaseordermaster.transactionAmount,transactionCurrencyDecimalPlaces,(det.transactionAmount-generalDiscountAmount) as total_value,(det.transactionAmount-generalDiscountAmount) as detTransactionAmount,isDeleted,DATE_FORMAT(documentDate,'$convertFormat') AS documentDate,documentDate AS documentDatepofilter,isReceived,closedYN,srp_erp_purchaseordermaster.confirmedByEmpID as confirmedByEmp");
