...
class Access_menu extends ERP_Controller
{
    ...
    function saveNavigationgroupSetup()
    {
        ...
        $accessControlYN = $this->input->post('accessControlYN');
        $viewID = $this->input->post('viewID');
        $addEditID = $this->input->post('addEditID');
        $printExcelID = $this->input->post('printExcelID');
       ...
       // var_dump($addEditID);
        ...
        if (!empty($accessControlYN) && $accessControlYN != "") {

            if (!empty($addEditID) && $addEditID != "") {

                $addEdit_update = $this->db->query("UPDATE srp_erp_navigationusergroupsetup INNER JOIN srp_erp_navigationmenus ON srp_erp_navigationmenus.navigationMenuID=srp_erp_navigationusergroupsetup.navigationMenuID SET Views = '1',srp_erp_navigationusergroupsetup.Add_Edit = '1'  WHERE srp_erp_navigationusergroupsetup.companyID={$companyID} AND srp_erp_navigationusergroupsetup.userGroupID={$userGroupID} AND accessControlYN='1' AND srp_erp_navigationusergroupsetup.navigationMenuID IN ({$addEditID})");


            $isNotExistAddEdit = $this->db->query("SELECT srp_erp_navigationusergroupsetup.navigationMenuID FROM srp_erp_navigationusergroupsetup INNER JOIN srp_erp_navigationmenus ON srp_erp_navigationmenus.navigationMenuID=srp_erp_navigationusergroupsetup.navigationMenuID WHERE srp_erp_navigationusergroupsetup.companyID={$companyID} AND srp_erp_navigationusergroupsetup.userGroupID={$userGroupID} AND accessControlYN='1' AND srp_erp_navigationusergroupsetup.navigationMenuID NOT IN ({$addEditID})")->result();
            foreach ($isNotExistAddEdit as $row_navAddEdit) {

                $addEdit_update = $this->db->query("UPDATE srp_erp_navigationusergroupsetup INNER JOIN srp_erp_navigationmenus ON srp_erp_navigationmenus.navigationMenuID=srp_erp_navigationusergroupsetup.navigationMenuID SET srp_erp_navigationusergroupsetup.Add_Edit = '0'  WHERE srp_erp_navigationusergroupsetup.companyID={$companyID} AND srp_erp_navigationusergroupsetup.userGroupID={$userGroupID} AND accessControlYN='1' AND srp_erp_navigationusergroupsetup.navigationMenuID = '" . $row_navAddEdit->navigationMenuID . "'");

            }
            }

            if (!empty($printExcelID) && $printExcelID != "") {

                $PrntExcl_update = $this->db->query("UPDATE srp_erp_navigationusergroupsetup INNER JOIN srp_erp_navigationmenus ON srp_erp_navigationmenus.navigationMenuID=srp_erp_navigationusergroupsetup.navigationMenuID SET Views = '1',srp_erp_navigationusergroupsetup.Print_Excel = '1'  WHERE srp_erp_navigationusergroupsetup.companyID={$companyID} AND srp_erp_navigationusergroupsetup.userGroupID={$userGroupID} AND accessControlYN='1' AND srp_erp_navigationusergroupsetup.navigationMenuID IN ({$printExcelID})");


            $isNotExistPrntExcl = $this->db->query("SELECT srp_erp_navigationusergroupsetup.navigationMenuID FROM srp_erp_navigationusergroupsetup INNER JOIN srp_erp_navigationmenus ON srp_erp_navigationmenus.navigationMenuID=srp_erp_navigationusergroupsetup.navigationMenuID WHERE srp_erp_navigationusergroupsetup.companyID={$companyID} AND srp_erp_navigationusergroupsetup.userGroupID={$userGroupID} AND accessControlYN='1' AND srp_erp_navigationusergroupsetup.navigationMenuID NOT IN ({$printExcelID})")->result();
            foreach ($isNotExistPrntExcl as $row_navPrntExcl) {

                $PrntExcl_update = $this->db->query("UPDATE srp_erp_navigationusergroupsetup INNER JOIN srp_erp_navigationmenus ON srp_erp_navigationmenus.navigationMenuID=srp_erp_navigationusergroupsetup.navigationMenuID SET srp_erp_navigationusergroupsetup.Print_Excel = '0'  WHERE srp_erp_navigationusergroupsetup.companyID={$companyID} AND srp_erp_navigationusergroupsetup.userGroupID={$userGroupID} AND accessControlYN='1' AND srp_erp_navigationusergroupsetup.navigationMenuID = '" . $row_navPrntExcl->navigationMenuID . "'");

            }
            }
            if (!empty($viewID) && $viewID != "") {

                $viewContrl_update = $this->db->query("UPDATE srp_erp_navigationusergroupsetup INNER JOIN srp_erp_navigationmenus ON srp_erp_navigationmenus.navigationMenuID=srp_erp_navigationusergroupsetup.navigationMenuID SET srp_erp_navigationusergroupsetup.Views = '1'  WHERE srp_erp_navigationusergroupsetup.companyID={$companyID} AND srp_erp_navigationusergroupsetup.userGroupID={$userGroupID} AND accessControlYN='1' AND srp_erp_navigationusergroupsetup.navigationMenuID IN ({$viewID})");


            $isNotExistViewContrl = $this->db->query("SELECT srp_erp_navigationusergroupsetup.navigationMenuID FROM srp_erp_navigationusergroupsetup INNER JOIN srp_erp_navigationmenus ON srp_erp_navigationmenus.navigationMenuID=srp_erp_navigationusergroupsetup.navigationMenuID WHERE srp_erp_navigationusergroupsetup.companyID={$companyID} AND srp_erp_navigationusergroupsetup.userGroupID={$userGroupID} AND accessControlYN='1' AND srp_erp_navigationusergroupsetup.navigationMenuID NOT IN ({$viewID})")->result();
            foreach ($isNotExistViewContrl as $row_navViewContrl) {

                $viewContrl_update = $this->db->query("UPDATE srp_erp_navigationusergroupsetup INNER JOIN srp_erp_navigationmenus ON srp_erp_navigationmenus.navigationMenuID=srp_erp_navigationusergroupsetup.navigationMenuID SET srp_erp_navigationusergroupsetup.Views ='0' ,srp_erp_navigationusergroupsetup.Add_Edit = '0',srp_erp_navigationusergroupsetup.Print_Excel = '0'  WHERE srp_erp_navigationusergroupsetup.companyID={$companyID} AND srp_erp_navigationusergroupsetup.userGroupID={$userGroupID} AND accessControlYN='1' AND srp_erp_navigationusergroupsetup.navigationMenuID = '" . $row_navViewContrl->navigationMenuID . "'");
