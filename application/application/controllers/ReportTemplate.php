...
class ReportTemplate extends ERP_Controller{
    ...
    {
        $str = '<div class="pull-right"><a onclick="setupTemplate($1, \'$2\')"><span title="Config" rel="tooltip" class="glyphicon glyphicon-cog" ></span></a>&nbsp;|&nbsp;';
        ...
        $this->datatables->add_column('edit', $str, 'companyReportTemplateID, description');
    ...
    function load_gl_data(){
        $data['templateID'] = $this->input->post('companyReportTemplateID');
