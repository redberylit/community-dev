    ...
    function __construct()
    {
        ...
        switch ($this->controllerName) {
            ...
            case "CommunityNgo":
                ...
                $this->getURL[] = 'CommunityNgo/comDonor_attachment_upload';
        ...
        if (!$CI->session->has_userdata('status')) {
            ...
            $this->common_data['familyDocUploadPath'] = trim($CI->session->userdata("familyDocUploadPath"));
        ...
        //echo '<pre> com data12: '; print_r($this->common_data);exit;
    }
}
