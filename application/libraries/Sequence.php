...
class Sequence {
  ...
  function sequence_generator($documentID, $count = 0) {
    ...
    function sequence_generator_location($documentID,$companyFinanceYearID = null,$locationid = NULL, $documentYear = NULL, $documentMonth = NULL, $count = 0) {    //location wise code generator
        $CI           = &get_instance();
        $companyID    = $CI->common_data['company_data']['company_id'];
