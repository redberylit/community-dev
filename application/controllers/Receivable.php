...
class Receivable extends ERP_Controller
{
    ...
    function fetch_credit_note()
    {
        ...
        $this->datatables->add_column('dn_detail', '<b>Customer Name : </b> $2 <br> <b>Date : </b> $3 <br> <b>Comments : </b> $1 ', 'comments,customermastername,creditNoteDate');
    ...
    function fetch_custemer_data_invoice()
    {
        ...
        $html = $this->load->view('system/accounts_receivable/erp_credit_note_detail', $data, true);
        echo $html;
    }
