...
class Quotation_contract extends ERP_Controller
{
    ...
    function fetch_Quotation_contract()
    {
        ...
        $this->datatables->add_column('edit', '$1', 'load_contract_action(contractAutoID,confirmedYN,approvedYN,createdUser,documentID,confirmedYN,isDeleted,confirmedByEmp)');
