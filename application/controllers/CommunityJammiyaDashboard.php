...
class CommunityJammiyaDashboard extends ERP_Controller
{
    ...
    function commPopulation_Count()
    {
        ...
        $occupation_count = $this->db->query("SELECT COUNT(*) as occupationCount FROM srp_erp_ngo_com_memjobs INNER JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_memjobs.Com_MasterID =srp_erp_ngo_com_communitymaster.Com_MasterID INNER JOIN srp_erp_ngo_com_occupationtypes ON srp_erp_ngo_com_memjobs.OccTypeID=srp_erp_ngo_com_occupationtypes.OccTypeID WHERE comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.isActive='1' AND srp_erp_ngo_com_communitymaster.isDeleted='0' AND srp_erp_ngo_com_memjobs.OccTypeID IN ('1','2','3','4','5','6') $areaMemIdS  " . " $gsDivitnIdS")->row_array();
        ...
        $marital_count = $this->db->query("SELECT COUNT(*) as maritalStCount FROM srp_erp_ngo_com_communitymaster WHERE srp_erp_ngo_com_communitymaster.isDeleted='0' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        ...
        $data['maritalSt_type6'] = $this->db->query("SELECT COUNT(*) as merrType6 FROM srp_erp_ngo_com_communitymaster WHERE srp_erp_ngo_com_communitymaster.isDeleted='0' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.CurrentStatus NOT IN ('1','2','3','4','5') $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
