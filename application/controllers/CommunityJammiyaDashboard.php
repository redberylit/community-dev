...
class CommunityJammiyaDashboard extends ERP_Controller
{
    ...
    function commPopulation_Count()
    {
        ...
        $member_count = $this->db->query("SELECT COUNT(*) as membersCount FROM srp_erp_ngo_com_communitymaster where companyID = '{$companyID}' AND (isDeleted IS NULL OR isDeleted = '' OR isDeleted = 0) AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS ")->row_array();

        $male_count = $this->db->query("SELECT COUNT(*) as malesCount FROM srp_erp_ngo_com_communitymaster where companyID = '{$companyID}' AND (isDeleted IS NULL OR isDeleted = '' OR isDeleted = 0) AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND GenderID='1' $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS")->row_array();

        $female_count = $this->db->query("SELECT COUNT(*) as femalesCount FROM srp_erp_ngo_com_communitymaster where companyID = '{$companyID}' AND (isDeleted IS NULL OR isDeleted = '' OR isDeleted = 0) AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND GenderID='2' $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS")->row_array();
        ...
        $data['loadBloodCount'] = $this->db->query("SELECT COUNT(*) AS `NoOfGrpMem`,BloodDescription FROM srp_erp_ngo_com_communitymaster LEFT JOIN srp_erp_bloodgrouptype ON srp_erp_ngo_com_communitymaster.BloodGroupID=srp_erp_bloodgrouptype.BloodTypeID WHERE companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND BloodGroupID IN ($BloodTypeID) $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS GROUP BY BloodGroupID")->result_array();

        //end of blood group counts

        //get Marital Status
        $data['maritalBase'] = $this->db->query("SELECT srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_maritalstatus INNER JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS GROUP BY srp_erp_ngo_com_maritalstatus.maritalstatusID ORDER BY srp_erp_ngo_com_maritalstatus.maritalstatusID DESC")->result_array();
        $marital_count = $this->db->query("SELECT COUNT(*) as maritalStCount FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['maritalSt_type1'] = $this->db->query("SELECT COUNT(*) as merrType1,srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.CurrentStatus='1' $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['maritalSt_type2'] = $this->db->query("SELECT COUNT(*) as merrType2,srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.CurrentStatus='2' $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['maritalSt_type3'] = $this->db->query("SELECT COUNT(*) as merrType3,srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.CurrentStatus='3' $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['maritalSt_type4'] = $this->db->query("SELECT COUNT(*) as merrType4,srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.CurrentStatus='4' $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['maritalSt_type5'] = $this->db->query("SELECT COUNT(*) as merrType5,srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.CurrentStatus='5' $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        ...
        $data['loadEconSte'] = $this->db->query("SELECT COUNT(*) AS `countEconSte` FROM srp_erp_ngo_com_familymaster LEFT JOIN srp_erp_ngo_com_familyeconomicstatemaster ON srp_erp_ngo_com_familymaster.ComEconSteID=srp_erp_ngo_com_familyeconomicstatemaster.EconStateID LEFT JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_familymaster.LeaderID=srp_erp_ngo_com_communitymaster.Com_MasterID WHERE srp_erp_ngo_com_familymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_familymaster.isDeleted='0' AND srp_erp_ngo_com_familymaster.isVerifyDocApproved='1' AND srp_erp_ngo_com_familymaster.ComEconSteID IN ($EconStateIDS) $where_clsDsh " . " $areaMemIdS  " . " $gsDivitnIdS GROUP BY srp_erp_ngo_com_familymaster.ComEconSteID ORDER BY srp_erp_ngo_com_familymaster.ComEconSteID ASC")->result_array();
...
WHERE hEnr.companyID = '".$companyID."' AND (hEnr.FamHouseSt = '0' OR hEnr.FamHouseSt = NULL) $areaMemIdS  " . " $gsDivitnIdS  ORDER BY hEnr.hEnrollingID")->result_array();
    ...
    function load_otrFamily_del(){
        ...
        $data['otrFamily'] = $this->db->query("SELECT srp_erp_ngo_com_familymaster.companyID,srp_erp_ngo_com_familymaster.createdUserID,LeaderID,FamilyCode,FamilyName,confirmedYN,srp_erp_ngo_com_familymaster.FamMasterID,FamilySystemCode,DATE_FORMAT(FamilyAddedDate,'{$convertFormat}') AS FamilyAddedDate, LedgerNo, CName_with_initials,FamAncestory,ComEconSteID,TP_home,TP_Mobile FROM srp_erp_ngo_com_familymaster INNER JOIN srp_erp_ngo_com_communitymaster on Com_MasterID=srp_erp_ngo_com_familymaster.LeaderID  WHERE srp_erp_ngo_com_familymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_familymaster.isDeleted = '0' AND srp_erp_ngo_com_familymaster.isVerifyDocApproved='1' AND srp_erp_ngo_com_familymaster.FamMasterID ='".$FamMasterID."'")->result_array();
