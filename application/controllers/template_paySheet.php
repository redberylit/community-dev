    ...
    function get_payScale_report()
    {
        ...
        if ($query == '') {
            ...
            if (!empty($segment)) {
                ...
                $data['details'] = $this->db->query("SELECT * FROM ( 
                                                     SELECT srp_erp_segment.description as segment,ECode, Ename2,
                                                     ...
                                                     $filter GROUP BY employeeNo, transactionCurrency ) t1 WHERE isDischarged2 = 0")->result_array();
