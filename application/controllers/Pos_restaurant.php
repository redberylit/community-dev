    ...
    function submit_pos_payments()
    {
        ...
        if ($invoiceID) {
            ...
            if(!empty($this->input->post('customerID'))){
                ...
                if(!empty($this->input->post('customerName'))){
                    ...
                    $data_poscus['CustomerName'] = $this->input->post('customerName');
                    $data_poscus['customerTelephone'] = $this->input->post('customerTelephone');
                    $data_poscus['CustomerAddress1'] = $this->input->post('customerAddress');
                    ...
                    $this->db->insert('srp_erp_pos_customermaster', $data_poscus);
                    $poscusid=$this->db->insert_id();

                    $data['customerName'] = $this->input->post('customerName');
                    $data['customerTelephone'] = $this->input->post('customerTelephone');
                    $data['customerID'] = $poscusid;
                }else{
                    $data['customerName'] = $this->input->post('customerName');
                    $data['customerTelephone'] = $this->input->post('customerTelephone');
                    $data['customerID'] = $this->input->post('customerID');
