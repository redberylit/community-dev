...
class CommunityNgoDashboard extends ERP_Controller
{
    ...
    function commPopulation_Count()
    {
        ...
        $data['loadPerEconState'] = $this->db->query("SELECT COUNT(*) AS `countComState`,EconStateDes FROM srp_erp_ngo_com_familymaster LEFT JOIN srp_erp_ngo_com_familyeconomicstatemaster ON srp_erp_ngo_com_familymaster.ComEconSteID=srp_erp_ngo_com_familyeconomicstatemaster.EconStateID LEFT JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_familymaster.LeaderID=srp_erp_ngo_com_communitymaster.Com_MasterID WHERE srp_erp_ngo_com_familymaster.companyID = '" . $companyID . "' AND srp_erp_ngo_com_familymaster.isDeleted='0' AND srp_erp_ngo_com_familymaster.isVerifyDocApproved='1' AND srp_erp_ngo_com_familymaster.ComEconSteID IN ($EconStateIDS) $areaMemIdS  " . " $gsDivitnIdS GROUP BY srp_erp_ngo_com_familymaster.ComEconSteID ORDER BY srp_erp_ngo_com_familymaster.ComEconSteID ASC")->result_array();
