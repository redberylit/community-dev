...
class CommunityNgoDashboard extends ERP_Controller
{
    ...
    function commPopulation_Count()
    {
        ...
        $female_count = $this->db->query("SELECT COUNT(*) as femalesCount FROM srp_erp_ngo_com_communitymaster where companyID = '{$companyID}' AND (isDeleted IS NULL OR isDeleted = '' OR isDeleted = 0) AND isActive='1' AND GenderID='2' AND comVerifiApproved='1' $areaMemIdS  " . " $gsDivitnIdS")->row_array();
        ...
        //get Occupation-Wise
        $data['OccupationBase'] = $this->db->query("SELECT srp_erp_ngo_com_occupationtypes.Description FROM  srp_erp_ngo_com_occupationtypes INNER JOIN srp_erp_ngo_com_memjobs ON srp_erp_ngo_com_memjobs.OccTypeID=srp_erp_ngo_com_occupationtypes.OccTypeID LEFT JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_memjobs.Com_MasterID =srp_erp_ngo_com_communitymaster.Com_MasterID WHERE srp_erp_ngo_com_memjobs.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' $areaMemIdS  " . " $gsDivitnIdS GROUP BY srp_erp_ngo_com_occupationtypes.OccTypeID ")->result_array();
        $occupation_count = $this->db->query("SELECT COUNT(*) as occupationCount FROM  srp_erp_ngo_com_memjobs LEFT JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_memjobs.Com_MasterID =srp_erp_ngo_com_communitymaster.Com_MasterID INNER JOIN srp_erp_ngo_com_occupationtypes ON srp_erp_ngo_com_memjobs.OccTypeID=srp_erp_ngo_com_occupationtypes.OccTypeID WHERE srp_erp_ngo_com_memjobs.companyID = '".$companyID."' AND comVerifiApproved='1'")->row_array();
        $data['occupation_type1'] = $this->db->query("SELECT COUNT(*) as occType1,srp_erp_ngo_com_occupationtypes.Description FROM  srp_erp_ngo_com_memjobs LEFT JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_memjobs.Com_MasterID =srp_erp_ngo_com_communitymaster.Com_MasterID INNER JOIN srp_erp_ngo_com_occupationtypes ON srp_erp_ngo_com_memjobs.OccTypeID=srp_erp_ngo_com_occupationtypes.OccTypeID WHERE srp_erp_ngo_com_memjobs.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_memjobs.OccTypeID='1'  $areaMemIdS  " . " $gsDivitnIdS")->row_array();
        $data['occupation_type2'] = $this->db->query("SELECT COUNT(*) as occType2,srp_erp_ngo_com_occupationtypes.Description FROM  srp_erp_ngo_com_memjobs LEFT JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_memjobs.Com_MasterID =srp_erp_ngo_com_communitymaster.Com_MasterID INNER JOIN srp_erp_ngo_com_occupationtypes ON srp_erp_ngo_com_memjobs.OccTypeID=srp_erp_ngo_com_occupationtypes.OccTypeID WHERE srp_erp_ngo_com_memjobs.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_memjobs.OccTypeID='2'  $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['occupation_type3'] = $this->db->query("SELECT COUNT(*) as occType3,srp_erp_ngo_com_occupationtypes.Description FROM  srp_erp_ngo_com_memjobs LEFT JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_memjobs.Com_MasterID =srp_erp_ngo_com_communitymaster.Com_MasterID INNER JOIN srp_erp_ngo_com_occupationtypes ON srp_erp_ngo_com_memjobs.OccTypeID=srp_erp_ngo_com_occupationtypes.OccTypeID WHERE srp_erp_ngo_com_memjobs.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_memjobs.OccTypeID='3'  $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['occupation_type4'] = $this->db->query("SELECT COUNT(*) as occType4,srp_erp_ngo_com_occupationtypes.Description FROM  srp_erp_ngo_com_memjobs LEFT JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_memjobs.Com_MasterID =srp_erp_ngo_com_communitymaster.Com_MasterID INNER JOIN srp_erp_ngo_com_occupationtypes ON srp_erp_ngo_com_memjobs.OccTypeID=srp_erp_ngo_com_occupationtypes.OccTypeID WHERE srp_erp_ngo_com_memjobs.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_memjobs.OccTypeID='4' $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['occupation_type5'] = $this->db->query("SELECT COUNT(*) as occType5,srp_erp_ngo_com_occupationtypes.Description FROM  srp_erp_ngo_com_memjobs LEFT JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_memjobs.Com_MasterID =srp_erp_ngo_com_communitymaster.Com_MasterID INNER JOIN srp_erp_ngo_com_occupationtypes ON srp_erp_ngo_com_memjobs.OccTypeID=srp_erp_ngo_com_occupationtypes.OccTypeID WHERE srp_erp_ngo_com_memjobs.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_memjobs.OccTypeID='5' $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['occupation_type6'] = $this->db->query("SELECT COUNT(*) as occType6,srp_erp_ngo_com_occupationtypes.Description FROM  srp_erp_ngo_com_memjobs LEFT JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_memjobs.Com_MasterID =srp_erp_ngo_com_communitymaster.Com_MasterID INNER JOIN srp_erp_ngo_com_occupationtypes ON srp_erp_ngo_com_memjobs.OccTypeID=srp_erp_ngo_com_occupationtypes.OccTypeID WHERE srp_erp_ngo_com_memjobs.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_memjobs.OccTypeID='6'  $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
       ...
       // $data['loadBloodDes'] = $this->db->query("SELECT BloodTypeID,BloodDescription FROM srp_erp_bloodgrouptype WHERE BloodTypeID IN ($BloodTypeID) ORDER BY BloodTypeID ASC ")->result_array();
        ...
        $data['loadBloodCount'] = $this->db->query("SELECT COUNT(*) AS `NoOfGrpMem`,BloodDescription FROM srp_erp_ngo_com_communitymaster LEFT JOIN srp_erp_bloodgrouptype ON srp_erp_ngo_com_communitymaster.BloodGroupID=srp_erp_bloodgrouptype.BloodTypeID WHERE companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND BloodGroupID IN ($BloodTypeID)  $areaMemIdS  " . " $gsDivitnIdS GROUP BY BloodGroupID")->result_array();

        //end of blood group counts

        //get Marital Status
        $data['maritalBase'] = $this->db->query("SELECT srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_maritalstatus INNER JOIN srp_erp_ngo_com_communitymaster ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' $areaMemIdS  " . " $gsDivitnIdS GROUP BY srp_erp_ngo_com_maritalstatus.maritalstatusID ORDER BY srp_erp_ngo_com_maritalstatus.maritalstatusID DESC")->result_array();
        $marital_count = $this->db->query("SELECT COUNT(*) as maritalStCount FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['maritalSt_type1'] = $this->db->query("SELECT COUNT(*) as merrType1,srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.CurrentStatus='1'  $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['maritalSt_type2'] = $this->db->query("SELECT COUNT(*) as merrType2,srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.CurrentStatus='2'  $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['maritalSt_type3'] = $this->db->query("SELECT COUNT(*) as merrType3,srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.CurrentStatus='3'  $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['maritalSt_type4'] = $this->db->query("SELECT COUNT(*) as merrType4,srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.CurrentStatus='4'  $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
        $data['maritalSt_type5'] = $this->db->query("SELECT COUNT(*) as merrType5,srp_erp_ngo_com_maritalstatus.maritalstatus FROM  srp_erp_ngo_com_communitymaster INNER JOIN srp_erp_ngo_com_maritalstatus ON srp_erp_ngo_com_communitymaster.CurrentStatus=srp_erp_ngo_com_maritalstatus.maritalstatusID WHERE srp_erp_ngo_com_communitymaster.companyID = '".$companyID."' AND srp_erp_ngo_com_communitymaster.isActive='1' AND comVerifiApproved='1' AND srp_erp_ngo_com_communitymaster.CurrentStatus='5'  $areaMemIdS  " . " $gsDivitnIdS ")->row_array();
...
WHERE srp_erp_customerinvoicemaster.companyID = '".$companyID."' AND srp_erp_customermaster.communityMemberID IS NOT NULL GROUP BY srp_erp_customerinvoicemaster.invoiceNarration ORDER BY srp_erp_customerinvoicemaster.invoiceNarration DESC")->result_array();
    ...
    function load_beneficiary_family_del()
    {
        ...
        $data['beneMem'] = $this->db->query("SELECT *,CountryDes,DATE_FORMAT(bfm.createdDateTime,'" . $convertFormat . "') AS createdDate,DATE_FORMAT(bfm.modifiedDateTime,'" . $convertFormat . "') AS modifydate,DATE_FORMAT(bfm.registeredDate,'" . $convertFormat . "') AS registeredDate,DATE_FORMAT(bfm.dateOfBirth,'" . $convertFormat . "') AS dateOfBirth,bfm.createdUserName as contactCreadtedUser,bfm.email as contactEmail,bfm.phonePrimary as contactPhonePrimary,bfm.phoneSecondary as contactPhoneSecondary,project.projectName as projectName,benType.description as benTypeDescription,smpro.Description as provinceName,smdis.Description as districtName,smdiv.Description as divisionName,smsubdiv.Description as subDivisionName,bfm.projectID FROM srp_erp_ngo_beneficiarymaster bfm LEFT JOIN srp_erp_countrymaster ON srp_erp_countrymaster.countryID = bfm.countryID LEFT JOIN srp_erp_ngo_projects project ON project.ngoProjectID = bfm.projectID LEFT JOIN srp_erp_ngo_benificiarytypes benType ON benType.beneficiaryTypeID = bfm.benificiaryType LEFT JOIN srp_erp_statemaster smpro ON smpro.stateID = bfm.province LEFT JOIN srp_erp_statemaster smdis ON smdis.stateID = bfm.district LEFT JOIN srp_erp_statemaster smdiv ON smdiv.stateID = bfm.division LEFT JOIN srp_erp_statemaster smsubdiv ON smsubdiv.stateID = bfm.subDivision WHERE bfm.companyID = '" . $companyID . "' AND project.templateID='beneficiary_feed_zakat_template' AND bfm.confirmedYN = '" . $conform . "'")->result_array();
...
WHERE hEnr.companyID = '".$companyID."' AND (hEnr.FamHouseSt = '0' OR hEnr.FamHouseSt = NULL) AND cm.comVerifiApproved='1' $areaMemIdS  " . " $gsDivitnIdS  ORDER BY hEnr.hEnrollingID")->result_array();
...
WHERE hEnr.companyID = '".$companyID."' AND (hEnr.FamHouseSt = '0' OR hEnr.FamHouseSt = NULL) AND cm.comVerifiApproved ='1' $areaMemIdS  " . " $gsDivitnIdS  ORDER BY hEnr.hEnrollingID")->result_array();
    ...
    function load_comFamMembers_del(){
        ...
        $data['comFamMembers'] = $this->db->get()->result_array();
